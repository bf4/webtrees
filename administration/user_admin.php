...
if ($action == "cleanup") {
	?>
	<form name="cleanupform" method="post" action="user_admin.php">
...
//	if (!isset($month)) $month = 1;
	...
	for($i=1; $i<=12; $i++) {
		echo "<option value=\"user_admin.php?action=cleanup&amp;month=$i\"";
	...
	<input type="button" value="<?php echo i18n::translate('Back'); ?>" onclick="window.location='user_admin.php';"/>
	</td></tr></table>
	</form><?php
//	print_footer();
	exit;

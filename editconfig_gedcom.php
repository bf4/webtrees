...
<table class="facts_table">
	<tr>
		...
		if ($source == "upload_form" || $source=="replace_form") {
			print_help_link("upload_path", "qm", "upload_path"); print $pgv_lang["upload_path"];
			...
			print_help_link("gedcom_path", "qm", "gedcom_path"); print $pgv_lang["gedcom_path"];
			print "</td><td class=\"optionbox\">";
			?>
	...
	<tr>
		<td class="descriptionbox wrap width20">
		<?php print_help_link("gedcom_path", "qm", "gedcom_path"); print $pgv_lang["gedcom_path"]; ?></td>
		<td class="optionbox">
	...
	<tr>
		<td class="descriptionbox wrap width20">
		<?php print_help_link("LANGUAGE", "qm", "LANGUAGE"); print $pgv_lang["LANGUAGE"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20">
		<?php print_help_link("CHARACTER_SET", "qm", "CHARACTER_SET"); print $pgv_lang["CHARACTER_SET"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20">
		<?php print_help_link("PEDIGREE_ROOT_ID", "qm", "PEDIGREE_ROOT_ID"); print $pgv_lang["PEDIGREE_ROOT_ID"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20">
		<?php print_help_link("CALENDAR_FORMAT", "qm", "CALENDAR_FORMAT"); print $pgv_lang["CALENDAR_FORMAT"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20">
		<?php print_help_link("DISPLAY_JEWISH_THOUSANDS", "qm", "DISPLAY_JEWISH_THOUSANDS"); print $pgv_lang["DISPLAY_JEWISH_THOUSANDS"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20">
		<?php print_help_link("DISPLAY_JEWISH_GERESHAYIM", "qm", "DISPLAY_JEWISH_GERESHAYIM"); print $pgv_lang["DISPLAY_JEWISH_GERESHAYIM"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20">
		<?php print_help_link("JEWISH_ASHKENAZ_PRONUNCIATION", "qm", "JEWISH_ASHKENAZ_PRONUNCIATION"); print $pgv_lang["JEWISH_ASHKENAZ_PRONUNCIATION"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20">
		<?php print_help_link("USE_RIN", "qm", "USE_RIN"); print $pgv_lang["USE_RIN"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20">
		<?php print_help_link("GENERATE_GUID", "qm", "GENERATE_GUID"); print $pgv_lang["GENERATE_GUID"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20">
		<?php print_help_link("GEDCOM_ID_PREFIX", "qm", "GEDCOM_ID_PREFIX"); print $pgv_lang["GEDCOM_ID_PREFIX"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20">
		<?php print_help_link("FAM_ID_PREFIX", "qm", "FAM_ID_PREFIX"); print $pgv_lang["FAM_ID_PREFIX"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SOURCE_ID_PREFIX", "qm", "SOURCE_ID_PREFIX"); print $pgv_lang["SOURCE_ID_PREFIX"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("REPO_ID_PREFIX", "qm", "REPO_ID_PREFIX"); print $pgv_lang["REPO_ID_PREFIX"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("MEDIA_ID_PREFIX", "qm", "MEDIA_ID_PREFIX"); print $pgv_lang["MEDIA_ID_PREFIX"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SEARCHLOG_CREATE", "qm", "SEARCHLOG_CREATE"); print $pgv_lang["SEARCHLOG_CREATE"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("CHANGELOG_CREATE", "qm", "CHANGELOG_CREATE"); print $pgv_lang["CHANGELOG_CREATE"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("TIME_LIMIT", "qm", "TIME_LIMIT"); print $pgv_lang["TIME_LIMIT"]; ?></td>
...
<table class="facts_table">
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("MULTI_MEDIA", "qm", "MULTI_MEDIA"); print $pgv_lang["MULTI_MEDIA"]; ?></td>
...
<table class="facts_table">
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("MEDIA_EXTERNAL", "qm", "MEDIA_EXTERNAL"); print $pgv_lang["MEDIA_EXTERNAL"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("MEDIA_DIRECTORY", "qm", "MEDIA_DIRECTORY"); print $pgv_lang["MEDIA_DIRECTORY"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("MEDIA_DIRECTORY_LEVELS", "qm", "MEDIA_DIRECTORY_LEVELS"); print $pgv_lang["MEDIA_DIRECTORY_LEVELS"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("THUMBNAIL_WIDTH", "qm", "THUMBNAIL_WIDTH"); print $pgv_lang["THUMBNAIL_WIDTH"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("AUTO_GENERATE_THUMBS", "qm", "AUTO_GENERATE_THUMBS"); print $pgv_lang["AUTO_GENERATE_THUMBS"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("USE_THUMBS_MAIN", "qm", "USE_THUMBS_MAIN"); print $pgv_lang["USE_THUMBS_MAIN"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("USE_SILHOUETTE", "qm", "USE_SILHOUETTE"); print $pgv_lang["USE_SILHOUETTE"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SHOW_HIGHLIGHT_IMAGES", "qm", "SHOW_HIGHLIGHT_IMAGES"); print $pgv_lang["SHOW_HIGHLIGHT_IMAGES"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("USE_MEDIA_VIEWER", "qm", "USE_MEDIA_VIEWER"); print $pgv_lang["USE_MEDIA_VIEWER"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SHOW_MEDIA_FILENAME", "qm", "SHOW_MEDIA_FILENAME"); print $pgv_lang["SHOW_MEDIA_FILENAME"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SHOW_MEDIA_DOWNLOAD", "qm", "SHOW_MEDIA_DOWNLOAD"); print $pgv_lang["SHOW_MEDIA_DOWNLOAD"]; ?></td>
...
<table class="facts_table">
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("USE_MEDIA_FIREWALL", "qm", "USE_MEDIA_FIREWALL"); print $pgv_lang["USE_MEDIA_FIREWALL"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("MEDIA_FIREWALL_ROOTDIR", "qm", "MEDIA_FIREWALL_ROOTDIR"); print $pgv_lang["MEDIA_FIREWALL_ROOTDIR"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("MEDIA_FIREWALL_THUMBS", "qm", "MEDIA_FIREWALL_THUMBS"); print $pgv_lang["MEDIA_FIREWALL_THUMBS"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SHOW_NO_WATERMARK", "qm", "SHOW_NO_WATERMARK"); print $pgv_lang["SHOW_NO_WATERMARK"]; ?></td>
		<td class="optionbox">
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("WATERMARK_THUMB", "qm", "WATERMARK_THUMB"); print $pgv_lang["WATERMARK_THUMB"]; ?></td>
		<td class="optionbox">
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SAVE_WATERMARK_IMAGE", "qm", "SAVE_WATERMARK_IMAGE"); print $pgv_lang["SAVE_WATERMARK_IMAGE"]; ?></td>
		<td class="optionbox">
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SAVE_WATERMARK_THUMB", "qm", "SAVE_WATERMARK_THUMB"); print $pgv_lang["SAVE_WATERMARK_THUMB"]; ?></td>
		<td class="optionbox">
...
<table class="facts_table">
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("HIDE_LIVE_PEOPLE", "qm", "HIDE_LIVE_PEOPLE"); print $pgv_lang["HIDE_LIVE_PEOPLE"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("CHECK_CHILD_DATES", "qm", "CHECK_CHILD_DATES"); print $pgv_lang["CHECK_CHILD_DATES"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("REQUIRE_AUTHENTICATION", "qm", "REQUIRE_AUTHENTICATION"); print $pgv_lang["REQUIRE_AUTHENTICATION"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("PAGE_AFTER_LOGIN", "qm", "PAGE_AFTER_LOGIN"); print $pgv_lang["PAGE_AFTER_LOGIN"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"> <?php print_help_link("WELCOME_TEXT_AUTH_MODE", "qm", "WELCOME_TEXT_AUTH_MODE"); print $pgv_lang["WELCOME_TEXT_AUTH_MODE"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("WELCOME_TEXT_AUTH_MODE_CUST_HEAD", "qm", "WELCOME_TEXT_AUTH_MODE_CUST_HEAD"); print $pgv_lang["WELCOME_TEXT_AUTH_MODE_CUST_HEAD"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("WELCOME_TEXT_AUTH_MODE_CUST", "qm", "WELCOME_TEXT_AUTH_MODE_CUST"); print $pgv_lang["WELCOME_TEXT_AUTH_MODE_CUST"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SHOW_REGISTER_CAUTION", "qm", "SHOW_REGISTER_CAUTION"); print $pgv_lang["SHOW_REGISTER_CAUTION"]; ?></td>
...
<table class="facts_table">
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SHOW_MARRIED_NAMES", "qm", "SHOW_MARRIED_NAMES"); print $pgv_lang["SHOW_MARRIED_NAMES"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("UNDERLINE_NAME_QUOTES", "qm", "UNDERLINE_NAME_QUOTES"); print $pgv_lang["UNDERLINE_NAME_QUOTES"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SHOW_ID_NUMBERS", "qm", "SHOW_ID_NUMBERS"); print $pgv_lang["SHOW_ID_NUMBERS"]; ?></td>
...
<table class="facts_table">
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("COMMON_NAMES_THRESHOLD", "qm", "COMMON_NAMES_THRESHOLD"); print $pgv_lang["COMMON_NAMES_THRESHOLD"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("COMMON_NAMES_ADD", "qm", "COMMON_NAMES_ADD"); print $pgv_lang["COMMON_NAMES_ADD"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("COMMON_NAMES_REMOVE", "qm", "COMMON_NAMES_REMOVE"); print $pgv_lang["COMMON_NAMES_REMOVE"]; ?></td>
...
<table class="facts_table">
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("DEFAULT_PEDIGREE_GENERATIONS", "qm", "DEFAULT_PEDIGREE_GENERATIONS"); print $pgv_lang["DEFAULT_PEDIGREE_GENERATIONS"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("MAX_PEDIGREE_GENERATIONS", "qm", "MAX_PEDIGREE_GENERATIONS"); print $pgv_lang["MAX_PEDIGREE_GENERATIONS"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("MAX_DESCENDANCY_GENERATIONS", "qm", "MAX_DESCENDANCY_GENERATIONS"); print $pgv_lang["MAX_DESCENDANCY_GENERATIONS"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("PEDIGREE_LAYOUT", "qm", "PEDIGREE_LAYOUT"); print $pgv_lang["PEDIGREE_LAYOUT"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SHOW_PEDIGREE_PLACES", "qm", "SHOW_PEDIGREE_PLACES"); print $pgv_lang["SHOW_PEDIGREE_PLACES"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SHOW_LIST_PLACES", "qm", "SHOW_LIST_PLACES"); print $pgv_lang["SHOW_LIST_PLACES"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("ZOOM_BOXES", "qm", "ZOOM_BOXES"); print $pgv_lang["ZOOM_BOXES"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("LINK_ICONS", "qm", "LINK_ICONS"); print $pgv_lang["LINK_ICONS"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("GEDCOM_DEFAULT_TAB", "qm", "GEDCOM_DEFAULT_TAB"); print $pgv_lang["GEDCOM_DEFAULT_TAB"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20">
			<?php print_help_link("EXPAND_RELATIVES_EVENTS", "qm", "EXPAND_RELATIVES_EVENTS"); print $pgv_lang["EXPAND_RELATIVES_EVENTS"]; ?>
		</td>
		<td class="optionbox">
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SHOW_RELATIVES_EVENTS", "qm", "SHOW_RELATIVES_EVENTS"); print $pgv_lang["SHOW_RELATIVES_EVENTS"]; ?></td>
		<td class="optionbox">
...
?>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("POSTAL_CODE", "qm", "POSTAL_CODE"); print $pgv_lang["POSTAL_CODE"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SUBLIST_TRIGGER_I", "qm", "SUBLIST_TRIGGER_I"); print $pgv_lang["SUBLIST_TRIGGER_I"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SUBLIST_TRIGGER_F", "qm", "SUBLIST_TRIGGER_F"); print $pgv_lang["SUBLIST_TRIGGER_F"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SURNAME_LIST_STYLE", "qm", "SURNAME_LIST_STYLE"); print $pgv_lang["SURNAME_LIST_STYLE"]; ?></td>
...
<table class="facts_table">
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("DAYS_TO_SHOW_LIMIT", "qm", "DAYS_TO_SHOW_LIMIT"); print $pgv_lang["DAYS_TO_SHOW_LIMIT"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SHOW_EMPTY_BOXES", "qm", "SHOW_EMPTY_BOXES"); print $pgv_lang["SHOW_EMPTY_BOXES"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("ABBREVIATE_CHART_LABELS", "qm", "ABBREVIATE_CHART_LABELS"); print $pgv_lang["ABBREVIATE_CHART_LABELS"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("PEDIGREE_FULL_DETAILS", "qm", "PEDIGREE_FULL_DETAILS"); print $pgv_lang["PEDIGREE_FULL_DETAILS"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("PEDIGREE_SHOW_GENDER", "qm", "PEDIGREE_SHOW_GENDER"); print $pgv_lang["PEDIGREE_SHOW_GENDER"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SHOW_PARENTS_AGE", "qm", "SHOW_PARENTS_AGE"); print $pgv_lang["SHOW_PARENTS_AGE"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SHOW_LDS_AT_GLANCE", "qm", "SHOW_LDS_AT_GLANCE"); print $pgv_lang["SHOW_LDS_AT_GLANCE"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("CHART_BOX_TAGS", "qm", "CHART_BOX_TAGS"); print $pgv_lang["CHART_BOX_TAGS"]; ?></td>
		<td class="optionbox">
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SHOW_GEDCOM_RECORD", "qm", "SHOW_GEDCOM_RECORD"); print $pgv_lang["SHOW_GEDCOM_RECORD"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("HIDE_GEDCOM_ERRORS", "qm", "HIDE_GEDCOM_ERRORS"); print $pgv_lang["HIDE_GEDCOM_ERRORS"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("WORD_WRAPPED_NOTES", "qm", "WORD_WRAPPED_NOTES"); print $pgv_lang["WORD_WRAPPED_NOTES"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SHOW_FACT_ICONS", "qm", "SHOW_FACT_ICONS"); print $pgv_lang["SHOW_FACT_ICONS"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("EXPAND_SOURCES", "qm", "EXPAND_SOURCES"); print $pgv_lang["EXPAND_SOURCES"]; ?></td>
		<td class="optionbox">
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("EXPAND_NOTES", "qm", "EXPAND_NOTES"); print $pgv_lang["EXPAND_NOTES"]; ?></td>
		<td class="optionbox">
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SHOW_LEVEL2_NOTES", "qm", "SHOW_LEVEL2_NOTES"); print $pgv_lang["SHOW_LEVEL2_NOTES"]; ?></td>
		<td class="optionbox">
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SHOW_AGE_DIFF", "qm", "SHOW_AGE_DIFF"); print $pgv_lang["SHOW_AGE_DIFF"]; ?></td>
		<td class="optionbox">
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("FAVICON", "qm", "FAVICON"); print $pgv_lang["FAVICON"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SHOW_COUNTER", "qm", "SHOW_COUNTER"); print $pgv_lang["SHOW_COUNTER"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SHOW_SPIDER_TAGLINE", "qm", "SHOW_SPIDER_TAGLINE"); print $pgv_lang["SHOW_SPIDER_TAGLINE"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SHOW_STATS", "qm", "SHOW_STATS"); print $pgv_lang["SHOW_STATS"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SHOW_LAST_CHANGE", "qm", "SHOW_LAST_CHANGE"); print $pgv_lang["SHOW_LAST_CHANGE"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SHOW_EST_LIST_DATES", "qm", "SHOW_EST_LIST_DATES"); print $pgv_lang["SHOW_EST_LIST_DATES"]; ?></td>
...
<table class="facts_table">
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("ALLOW_EDIT_GEDCOM", "qm", "ALLOW_EDIT_GEDCOM"); print $pgv_lang["ALLOW_EDIT_GEDCOM"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SYNC_GEDCOM_FILE", "qm", "SYNC_GEDCOM_FILE"); print $pgv_lang["SYNC_GEDCOM_FILE"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("ENABLE_AUTOCOMPLETE", "qm", "ENABLE_AUTOCOMPLETE"); print $pgv_lang["ENABLE_AUTOCOMPLETE"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("INDI_FACTS_ADD", "qm", "INDI_FACTS_ADD"); print $pgv_lang["INDI_FACTS_ADD"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("INDI_FACTS_UNIQUE", "qm", "INDI_FACTS_UNIQUE"); print $pgv_lang["INDI_FACTS_UNIQUE"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("INDI_FACTS_QUICK", "qm", "INDI_FACTS_QUICK"); print $pgv_lang["INDI_FACTS_QUICK"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("FAM_FACTS_ADD", "qm", "FAM_FACTS_ADD"); print $pgv_lang["FAM_FACTS_ADD"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("FAM_FACTS_UNIQUE", "qm", "FAM_FACTS_UNIQUE"); print $pgv_lang["FAM_FACTS_UNIQUE"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("FAM_FACTS_QUICK", "qm", "FAM_FACTS_QUICK"); print $pgv_lang["FAM_FACTS_QUICK"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SOUR_FACTS_ADD", "qm", "SOUR_FACTS_ADD"); print $pgv_lang["SOUR_FACTS_ADD"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SOUR_FACTS_UNIQUE", "qm", "SOUR_FACTS_UNIQUE"); print $pgv_lang["SOUR_FACTS_UNIQUE"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SOUR_FACTS_QUICK", "qm", "SOUR_FACTS_QUICK"); print $pgv_lang["SOUR_FACTS_QUICK"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("REPO_FACTS_ADD", "qm", "REPO_FACTS_ADD"); print $pgv_lang["REPO_FACTS_ADD"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("REPO_FACTS_UNIQUE", "qm", "REPO_FACTS_UNIQUE"); print $pgv_lang["REPO_FACTS_UNIQUE"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("REPO_FACTS_QUICK", "qm", "REPO_FACTS_QUICK"); print $pgv_lang["REPO_FACTS_QUICK"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("EDIT_AUTOCLOSE", "qm", "EDIT_AUTOCLOSE"); print $pgv_lang["EDIT_AUTOCLOSE"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SPLIT_PLACES", "qm", "SPLIT_PLACES"); print $pgv_lang["SPLIT_PLACES"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("QUICK_REQUIRED_FACTS", "qm", "QUICK_REQUIRED_FACTS"); print $pgv_lang["QUICK_REQUIRED_FACTS"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("QUICK_REQUIRED_FAMFACTS", "qm", "QUICK_REQUIRED_FAMFACTS"); print $pgv_lang["QUICK_REQUIRED_FAMFACTS"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SURNAME_TRADITION", "qm", "SURNAME_TRADITION"); print $pgv_lang["SURNAME_TRADITION"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("ADVANCED_NAME_FACTS", "qm", "ADVANCED_NAME_FACTS"); print $pgv_lang["ADVANCED_NAME_FACTS"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("ADVANCED_PLAC_FACTS", "qm", "ADVANCED_PLAC_FACTS"); print $pgv_lang["ADVANCED_PLAC_FACTS"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("USE_GEONAMES", "qm", "USE_GEONAMES"); print $pgv_lang["USE_GEONAMES"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("FULL_SOURCES", "qm", "FULL_SOURCES"); print $pgv_lang["FULL_SOURCES"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("PREFER_LEVEL2_SOURCES", "qm", "PREFER_LEVEL2_SOURCES"); print $pgv_lang["PREFER_LEVEL2_SOURCES"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("no_update_CHAN", "qm", "no_update_CHAN"); print $pgv_lang["no_update_CHAN"]; ?></td>
...
<table class="facts_table">
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("ENABLE_MULTI_LANGUAGE", "qm", "ENABLE_MULTI_LANGUAGE"); print $pgv_lang["ENABLE_MULTI_LANGUAGE"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SHOW_CONTEXT_HELP", "qm", "SHOW_CONTEXT_HELP"); print $pgv_lang["SHOW_CONTEXT_HELP"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("THEME_DIR", "qm", "THEME_DIR"); print $pgv_lang["THEME_DIR"]; ?></td>
		<td class="optionbox">
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("ALLOW_THEME_DROPDOWN", "qm", "ALLOW_THEME_DROPDOWN"); print $pgv_lang["ALLOW_THEME_DROPDOWN"]; ?></td>
...
<table class="facts_table">
	<tr>
		...
		?>
		<td class="descriptionbox wrap width20"><?php print_help_link("PHPGEDVIEW_EMAIL", "qm", "PHPGEDVIEW_EMAIL"); print $pgv_lang["PHPGEDVIEW_EMAIL"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("CONTACT_EMAIL", "qm", "CONTACT_EMAIL"); print $pgv_lang["CONTACT_EMAIL"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("CONTACT_METHOD", "qm", "CONTACT_METHOD"); print $pgv_lang["CONTACT_METHOD"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("WEBMASTER_EMAIL", "qm", "WEBMASTER_EMAIL"); print $pgv_lang["WEBMASTER_EMAIL"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("SUPPORT_METHOD", "qm", "SUPPORT_METHOD"); print $pgv_lang["SUPPORT_METHOD"]; ?></td>
...
<table class="facts_table">
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("HOME_SITE_URL", "qm", "HOME_SITE_URL"); print $pgv_lang["HOME_SITE_URL"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("HOME_SITE_TEXT", "qm", "HOME_SITE_TEXT"); print $pgv_lang["HOME_SITE_TEXT"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("META_AUTHOR", "qm", "META_AUTHOR"); print $pgv_lang["META_AUTHOR"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("META_PUBLISHER", "qm", "META_PUBLISHER"); print $pgv_lang["META_PUBLISHER"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("META_COPYRIGHT", "qm", "META_COPYRIGHT"); print $pgv_lang["META_COPYRIGHT"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("META_DESCRIPTION", "qm", "META_DESCRIPTION"); print $pgv_lang["META_DESCRIPTION"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("META_PAGE_TOPIC", "qm", "META_PAGE_TOPIC"); print $pgv_lang["META_PAGE_TOPIC"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("META_AUDIENCE", "qm", "META_AUDIENCE"); print $pgv_lang["META_AUDIENCE"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("META_PAGE_TYPE", "qm", "META_PAGE_TYPE"); print $pgv_lang["META_PAGE_TYPE"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("META_ROBOTS", "qm", "META_ROBOTS"); print $pgv_lang["META_ROBOTS"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("META_REVISIT", "qm", "META_REVISIT"); print $pgv_lang["META_REVISIT"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("META_KEYWORDS", "qm", "META_KEYWORDS"); print $pgv_lang["META_KEYWORDS"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("META_TITLE", "qm", "META_TITLE"); print $pgv_lang["META_TITLE"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("ENABLE_RSS", "qm", "ENABLE_RSS"); print $pgv_lang["ENABLE_RSS"]; ?></td>
	...
	<tr>
		<td class="descriptionbox wrap width20"><?php print_help_link("RSS_FORMAT", "qm", "RSS_FORMAT"); print $pgv_lang["RSS_FORMAT"]; ?></td>

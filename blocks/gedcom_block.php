 ...
 *
 * @version $Id: gedcom_block.php,v 1.1.2.12 2006/04/13 12:06:36 canajun2eh Exp $
 * @package PhpGedView
 * @subpackage Blocks
 */
...
function print_gedcom_block($block = true, $config="", $side, $index) {
	...
	if (userGedcomAdmin(getUserName())) {
		print "<a href=\"javascript:;\" onclick=\"window.open('index_edit.php?name=".preg_replace("/'/", "\'", $GEDCOM)."&amp;command=gedcom', '_blank', 'top=50,left=10,width=600,height=500,scrollbars=1,resizable=1'); return false;\">".$pgv_lang["customize_gedcom_page"]."</a>\n";
	}
	print "</div>";
	print "</div>\n";
	print "</div>";

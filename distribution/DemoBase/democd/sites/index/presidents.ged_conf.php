 ...
 * @version $Id: config_gedcom.php 1371 2007-08-02 17:23:14Z canajun2eh $
 */
...
$USE_RTL_FUNCTIONS = true;				//-- Use processing to properly display GEDCOM data in RTL languages
...
$PHPGEDVIEW_EMAIL = "phpgedview-noreply@localhost";		    		// -- "From:" address for automatically generated e-mails
$CONTACT_EMAIL = "admin";		    // -- this is who the user should contact for more information
$CONTACT_METHOD = "messaging2";						// -- the method to allow users to contact you. options are: mailto, messaging, messaging2
$WEBMASTER_EMAIL = "admin";		// -- this is who the user should contact in case of errors

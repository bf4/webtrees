...
$pgv_lang["privacy_error"]			= "Chi tiết của người này không được bộc lộ.";
...
$pgv_lang["user_cannot_edit"]		= "Thành viên với tên này không có quyền sửa GEDCOM này.";
...
$pgv_lang["pwreqinfo"]				= "Chào bạn...<br /><br />Đã có bức thư điện tử gửi tới địa chỉ (#user[email]#).<br /><br />Xin nhìn trong hộp thư điện tử của bạn; chẳng mấy chốc thư đó phải tới nơi.<br /><br />Lời khuyên:<br />Bạn nên truy nhập nơi đây với mật khẩu mới càng sớm càng tốt, và bạn nên đổi mật khẩu đặng bảo vệ dữ liệu của bạn.";
...
$pgv_lang["messaging2_help"]		= "Khi nào bức điện này gửi đi, bạn sẽ nhận một bản chép tại địa chỉ thư điện tử bạn đã cho";
...
$pgv_lang["gedcom_favorites_descr"] = "Cái khối Ưa Chuộng GEDCOM dùng cho quản lý chỉ định một vài người trong kho dữ kiện đặng chuyện biết về họ có thể xem được một cách nhanh nhẹn bởi tất cả mọi người. Đấy là một cách đề cao những người quan trọng trong lịch sử của gia đình của bạn.";

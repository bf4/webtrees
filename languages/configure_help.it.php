...
$pgv_lang["can_edit"]			= "Livello di accesso";
$pgv_lang["access"]				= "Accesso";
$pgv_lang["accept"]				= "Accettazione";
...
$pgv_lang["DBHOST_help"] = "Il DNS o l'indirizzo IP del computer che ospita il tuo database. Questo parametro è ignorato se utilizzi un database SQLite.<br /><br />Questo modfica \$DBHOST in <i>config.php</i>.";
...
$pgv_lang["edit_lang_utility_warning"]	= "ATTENZIONE!<br /><br />Se premi il pulsante <b>#pgv_lang[close_window_without_refresh]#</b>, potresti non vedere i tuoi cambiamenti sullo schermo finché non ricaricherai la pagina manualmente. E' possibile che il tuo file della lingua venga dsitrutto se aggiungi un messaggio che non è ancora apparso all'interno del file di linguaggio o se modifichi un messaggio ancora.<br /><br />Se non sai quello che stai facendo,  per favore non usare il pulsante <b>#pgv_lang[close_window_without_refresh]#</b>.";

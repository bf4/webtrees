...
$pgv_lang["accept_gedcom"]		= "Bestem dig for om du vil godkende eller afvise de enkelte ændringer.<dl><dt>For at godkende <i>alle</i> ændringer på en gang</dt><dd>Klik på linket <b>Godkend alle ændringer</b> i boksen nedenunder.</dd><dt>For at få mere information om en ændring kan du klikke på:</dt><dd><b>Vis ændring, forskelle</b> for at se på forskellen mellem gammelt og nyt indhold.<br /><b>Vis GEDCOM-post</b> for at se på det nye indhold i GEDCOM-format.</dd></dl>";
...
$pgv_lang["change_family_instr"]	= "Brug denne side til at redigere eller fjerne familiemedlemmer.<br /><br />For hver medlem af familien kan du bruge linket: Rediger for at udskifte en person med en anden.  Du kan også bruge linket: Fjern til at fjerne personen fra familien.<br /><br />Klik på knappen: Gem, når du er færdig med at redigere familiemedlemmerne.";

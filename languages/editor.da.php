...
$pgv_lang["main_media_ok2"]				= "Mediefilen <b>#GLOBALS[oldMediaName]#</b> er korrekt flyttet fra <b>#GLOBALS[oldMediaFolder]#</b> til <b>#GLOBALS[newMediaFolder]#</b>.";
$pgv_lang["main_media_ok3"]				= "Mediefilen er korrekt flyttet og omdøbt fra <b>#GLOBALS[oldMediaFolder]##GLOBALS[oldMediaName]#</b> til <b>#GLOBALS[newMediaFolder]##GLOBALS[newMediaName]#</b>.";
...
$pgv_lang["main_media_fail3"]			= "Mediefilen kunne ikke flyttes eller omdøbes fra <b>#GLOBALS[oldMediaFolder]##GLOBALS[oldMediaName]#</b> til <b>#GLOBALS[newMediaFolder]##GLOBALS[newMediaName]#</b>.";
$pgv_lang["resn_disabled"]				= "Bemærk: Du skal aktivere \'Brug GEDCOM (RESN) privatlivsbegrænsning\' funktionen for at denne indstilling skal virke.";
...
$pgv_lang["edit_concurrency_reload"]	= "Brug venligst din browsers Forrige side knap og genindlæs den forige side for at sikre at du arbejder med den nyeste post.";
$pgv_lang["edit_concurrency_msg1"]	= "Der optod en fejl ved oprettelse af Rediger formularen. En anden bruger kan have ændret denne post siden du sidst så den.";
$pgv_lang["add_marriage"]			= "Tilføj nyt ægteskab";

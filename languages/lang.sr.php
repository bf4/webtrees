...
##$pgv_lang["click_here_help"]		= "~Klikni ovde da nastaviš~<br /><br />Click this button to save your changes.<br /><br />You will be returned to the Dobrodošli or Moj portal page, but your changes may not be shown.  You may need to use the Page Reload function of your browser to view your changes properly.";
##$pgv_lang["block_summaries"]		= "~#pgv_lang[block_desc]#~<br /><br />Here is a short description of each of the blocks you can place on the Dobrodošli or Moj portal page.<br /><table border='1' align='center'><tr><td class='list_value'><b>Ime</b></td><td class='list_value'><b>Opis</b></td></tr>&nbsp;</table><br /><br />";

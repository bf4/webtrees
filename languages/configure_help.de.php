...
$pgv_lang["jewish_and_gregorian"]	= "Jüdisch und Gregorianisch";
$pgv_lang["hebrew_and_gregorian"]	= "Hebräisch und Gregorianisch";
...
$pgv_lang["DBHOST_help"]		= "Die DNS- oder IP-Adresse Ihres Datenbank-Servers.<br />Diese Einstellung ändert die Variable \$DBHOST in der Datei <i>config.php</i>.";
$pgv_lang["DBUSER"]			= "Datenbank-Benutzername";
$pgv_lang["DBUSER_help"]		= "Der Benutzername der benötigt wird, um eine Verbindung zu Ihrer Datenbank herzustellen.<br />Diese Einstellung ändert die Variable \$DBUSER in der Datei <i>config.php</i>.";
$pgv_lang["DBPASS"]			= "Datenbank-Kennwort";
$pgv_lang["DBPASS_help"]		= "Das Kennwort das für den oben von Ihnen angegebenen Benutzernamen benötigt wird, um eine Verbindung zu Ihrer Datenbank herzustellen.<br />Diese Einstellung ändert die Variable \$DBPASS in der Datei <i>config.php</i>.";
$pgv_lang["DBNAME"]			= "Datenbank-Name";
$pgv_lang["DBNAME_help"]		= "Die Datenbank auf Ihrem Server, die Sie mit PhpGedView nutzen möchten.<br /><br />Der Benutzername aus dem Benutzerfeld muss über Generierungs-, Einfügungs-, Update-, Lösch- und Auswahlrechte innerhalb dieser Datenbank verfügen.<br /><br />Diese Einstellung ändert die Variable \$DBNAME in der Datei <i>config.php</i>.";
$pgv_lang["TBLPREFIX"]			= "Präfix der Datenbank Tabellennamen";
$pgv_lang["TBLPREFIX_help"]		= "Ein Präfix der an die Tabellennamen angehängt wird, die von PhpGedView erstellt werden. Durch Ändern dieses Wertes können Sie mehrere PhpGedView-Sites bestimmen, die die gleiche Datenbank jedoch unterschiedliche Tabellen benutzen.<br /><br />Diese Einstellung ändert die Variable \$TBLPREFIX in der Datei <i>config.php</i>.";
$pgv_lang["ALLOW_CHANGE_GEDCOM"]	= "Zugang zu mehreren GEDCOMs freigeben";
$pgv_lang["ALLOW_CHANGE_GEDCOM_help"]	= "Die Einstellung «Ja» erlaubt den Besuchern <b>und</b> angemeldeten Benutzern die verwendete GEDCOM-Datei selbst auszuwählen, sofern Ihre Konfiguration mehrere GEDCOM-Dateien enthält. <br /><br />Bei Einstellung «Nein», können <b>weder</b> Besucher, <b>noch</b> angemeldete Benutzer die GEDCOM-Datei auswählen können.<br /><br />Diese Einstellung ändert die Variable \$ALLOW_CHANGE_GEDCOM in der Datei <i>config.php</i>.";
$pgv_lang["upload_path"]			= "Pfad zur zu hochladenden Datei";
$pgv_lang["gedcom_path"]			= "Server-Pfad und Name der GEDCOM-Datei";
$pgv_lang["gedcom_path_help"]		= "Bitte speichern Sie Ihre GEDCOM-Datei zunächst an einer Stelle auf Ihrem Servers, auf die man mit PHP zugreifen kann. Dann geben Sie hier den Pfad und Dateinamen dieser Datei an: z.B.: <b>./index/name.ged</b>.</br></br>Für weitere Hilfe schauen Sie in die Datei <a href=\"readme.txt\"><b>Readme.txt</b></a>";
...
$pgv_lang["MAX_PEDIGREE_GENERATIONS_help"]	= "Ändert die Anzahl der Generationen, die maximal in der Stammbaum Ansicht angezeigt werden.";
$pgv_lang["MAX_DESCENDANCY_GENERATIONS"]	= "Maximale Anzahl Generationen im Nachfahrenbaum";
$pgv_lang["MAX_DESCENDANCY_GENERATIONS_help"]	= "Ändert die Anzahl der Generationen, die maximal im Nachfahrenbaum angezeigt werden.";
...
$pgv_lang["GEDCOM_ID_PREFIX_help"]	= "In Stammbäumen, Nachfahrenbäumen, Verwandtschafts- und anderen Darstellungen wird dieses Präfix der ID vorangestellt, die der Besucher zur Personen-Auswahl eingeben kann, sofern er das Präfix nicht selbst voranstellt.";
...
$pgv_lang["WELCOME_TEXT_AUTH_MODE_CUST_HEAD_help"] = "Wählen Sie, ob ein (mehrsprachiger) Kopf für Ihren selbsterstellten Willkommens-Text angezeigt werden soll.<br /><br />Wenn Sie «Ja» wählen, wird folgender Kopf angezeigt:<div class=\"list_value_wrap\">#pgv_lang[welcome_text_cust_head]#</div>";
...
$pgv_lang["INDEX_DIRECTORY_help"]	= "Der Pfad zu einem Verzeichnis mit Lese- und Schreibrechten, in dem PhpGedView die Index-Dateien speichern soll (einschließlich des führenden «/»).<br />Dieses Feld definiert den Inhalt der Variable \$INDEX_DIRECTORY in der Datei <i>config.php</i>.";
...
$pgv_lang["MEDIA_EXTERNAL_help"]	= "Ein vorkommender Multimedia-Link, der z.B. mit http://, ftp://, mms:// beginnt, wird nicht ändert, wenn Sie «Links bebehalten» auf «Ja» setzen. Wenn Sie diesen Wert auf «Nein» setzen, dann wird der Link wie ein Verweis auf die Multimedia-Daten behandelt und die Einstellung bezüglich Multimedie-Verzeichnis etc. werden berücksichtigt. z.B.: http://www.meinefamilie.de/foto/papa.jpg wird geändert zu .media/papa.jpg";
...
$pgv_lang["USE_THUMBS_MAIN"]	= "Miniaturbilder für Bild-Darstellung auf der Personen-Seite verwenden";
$pgv_lang["USE_THUMBS_MAIN_help"]	= "Je nachdem wie die Bilder gespeichert sind, kann es günstiger sein, Miniaturbilder auf der Personen-Seite zu verwenden, anstelle der Bilder in Original-Größe. Wenn Ihre Bilder sehr groß sind, kann der Download entsprechend lange dauern und wenn die Miniaturbilder in guter Qualität vorliegen, können sie hier anstelle der großen Bilder verwendet werden. Bei «Ja» werden die Miniaturbilder benutzt, bei «Nein» die großen Bilder.";
...
$pgv_lang["SERVER_URL_help"]		= "Wenn Sie https oder einen anderen Port benutzen, müssen Sie hier die URL eingeben, über die Ihr Server erreicht werden kann.<br /><br />Diese Einstellung ändert die Variable \$SERVER_URL in der Datei config.php.";
...
$pgv_lang["PGV_SESSION_TIME_help"]	= "Die Zeit nach der man sich für eine PhpGedView-Sitzung erneut anmelden muss (login). Der Standard-Wert ist 2 Stunden.<br /><br />Diese Einstellung ändert die Variable \$PGV_SESSION_TIME in der Datei config.php.";
...
$pgv_lang["USE_REGISTRATION_MODULE_help"]	= "Erlaubt den Benutzern, sich selbst für einen Benutzerzugang zu diesen Seiten zu registrieren. <br /><br />Der Benutzer wird eine Mail erhalten mit einem Code zur Bestätigung der Anmeldung.<br />Danach muss der Verwalter diese Registrierung freischalten, bevor sie aktiv wird<br /><br />Diese Einstellung ändert die Variable \$USE_REGISTRATION_MODULE in der Datei config.php.";
$pgv_lang["ALLOW_USER_THEMES"]		= "Besuchern die Auswahl eines Themes erlauben";
$pgv_lang["ALLOW_USER_THEMES_help"]	= "Erlaubt den Benutzern eigene Themes auszuwählen.<br /><br />Diese Einstellung ändert die Variable \$ALLOW_USER_THEMES in der Datei config.php.";
$pgv_lang["PGV_SIMPLE_MAIL"] = "Einfache Mail-Header bei Mails verwenden";
$pgv_lang["PGV_SIMPLE_MAIL_help"] = "Normalerweise enthält der Mail-Header die Mail-Adresse und den Namen des Absenders. Einige Mailsysteme akzeptieren diese Angaben nicht. Setzen Sie diesen Wert auf «Ja», damit nur die Mail-Adresse verwendet wird.<br /><br />Diese Einstellung ändert die Variable \$PGV_SIMPLE_MAIL in der Datei config.php.";
...
$pgv_lang["LOGFILE_CREATE_help"]	= "Bestimmt, in welchem Rhythmus eine neue Log-Datei erzeugt wird.<br /><br />Diese Einstellung ändert die Variable \$LOGFILE_CREATE in der Datei config.php.";
...
$pgv_lang["META_PUBLISHER_help"]	= "Der Wert für das META Tag Feld «Publisher» im HTML-Seiten-Kopf. Lassen Sie dieses Feld leer, um den vollständigen Namen der GEDCOM-Kontaktperson zu verwenden.<br />Diese Einstellung ändert die Variable \$META_PUBLISHER in der Datei config.php.";
...
$pgv_lang["META_COPYRIGHT_help"]	= "Der Wert für das META Tag Feld «Copyright» im HTML-Seiten-Kopf. Lassen Sie dieses Feld leer, um den vollständigen Namen der GEDCOM-Kontaktperson zu verwenden.<br />Diese Einstellung ändert die Variable \$META_COPYRIGHT in der Datei config.php.";
...
$pgv_lang["META_DESCRIPTION_help"]	= "Der Wert für das META Tag Feld «description» im HTML-Seiten-Kopf. Lassen Sie dieses Feld leer, um den Titel der aktuellen GEDCOM-Datei zu verwenden.<br />Diese Einstellung ändert die Variable \$META_DESCRIPTION in der Datei config.php.";
...
$pgv_lang["META_PAGE_TOPIC_help"]	= "Der Wert für das META Tag Feld «Page-Topic» im HTML-Seiten-Kopf. Lassen Sie dieses Feld leer, um den Titel der aktuellen GEDCOM-Datei zu verwenden.<br />Diese Einstellung ändert die Variable \$META_PAGE_TOPIC in der Datei config.php.";
...
$pgv_lang["META_AUDIENCE_help"]	= "Der Wert für das META Tag Feld «Audience» im HTML-Seiten-Kopf.<br />Diese Einstellung ändert die Variable \$META_AUDIENCE in der Datei config.php.";
$pgv_lang["META_PAGE_TYPE"]		= "META Tag Page Type";
$pgv_lang["META_PAGE_TYPE_help"]	= "Der Wert für das META Tag Feld «Page-Type» im HTML-Seiten-Kopf.<br />Diese Einstellung ändert die Variable \$META_PAGE_TYPE in der Datei config.php.";
$pgv_lang["META_ROBOTS"]		= "META Tag Robots";
$pgv_lang["META_ROBOTS_help"]	= "Der Wert für das META Tag Feld «Robots» im HTML-Seiten-Kopf. Viele Robots und Crawler missachten diesen Wert.<br />Diese Einstellung ändert die Variable \$META_ROBOTS in der Datei config.php.";
$pgv_lang["META_REVISIT"]		= "Gibt an, wie oft Suchmaschinen die META Tags untersuchen sollen";
$pgv_lang["META_REVISIT_help"]	= "Der Wert für das META Tag Feld «Revisit» im HTML-Seiten-Kopf. Viele Crawler missachten diesen Wert.<br />Diese Einstellung ändert die Variable \$META_REVISIT in der Datei config.php.";
$pgv_lang["META_KEYWORDS"]		= "META Tag Keywords";
$pgv_lang["META_KEYWORDS_help"]	= "Der Wert für das META Tag Feld «Keywords» im HTML-Seiten-Kopf. Viele Suchmaschinen nutzen die Keyword-Meta-Tags zur Indizierung von Webseiten. Ihre Angabe hier wird ergänzt durch die Liste der häufigsten Nachnamen, so wie sie auf der Willkommens-Seite erscheint.<br />Diese Einstellung ändert die Variable \$META_KEYWORDS in der Datei config.php.";
...
$pgv_lang["META_TITLE_help"]	=	"Was Sie hier eingeben wird in der TITLE-Kennung (title-tag) hinter dem regulären Seitentitel und vor dem PhpGedView-Hinweis eingefügt.<br />Diese Einstellung ändert die Variable \$META_TITLE in der Datei config.php.";
...
$pgv_lang["SHOW_LIVING_NAMES_help"]		= "Namen lebender Personen anzeigen<br /><br />Mit dieser Einstellung können Sie definieren, wem die Namen lebender Personen angezeigt werden.<br />Üblicherweise sollte diese Variable die Einstellung «Nur angemeldeten Benutzern zeigen» haben. Dies dient dem Datenschutz lebender Personen, die in Ihrer GEDCOM-Datenbank enthalten sind, denn Sie können selber bestimmen, wem Sie den allgemeinen Zugriff auf Ihre Ahnenforschungsdaten geben.<br />Die Einstellung «Nur Verwaltern zeigen» verhindert die Anzeige der Namen lebender Personen auch für angemeldete Besucher, die jedoch keinen Verwalterstatus haben.<br /><br />Diese Einstellung ändert die Variable \$SHOW_LIVING_NAMES in der gewählten Datenschutz-Datei.";
$pgv_lang["SHOW_RESEARCH_ASSISTANT"]			= "Forschungs-Assistent zeigen";
$pgv_lang["USE_RELATIONSHIP_PRIVACY_help"]	= "Verwandtschafts-Datenschutz einschalten.<br /><br />«Nein» bedeutet, dass alle authentifizierten Benutzer alle Daten lebender Personen zu sehen bekommen.<br /><br />«Ja» bedeutet, dass authentifizierte Benutzer nur die Daten lebender Personen zu sehen bekommen, mit denen sie verwandt sind.<br />Der Verwandtschaftsgrad wird mit der Einstellung «Max. Länge der Verwandtschaft» eingestellt.<br /><br />Diese Einstellung ändert die Variable \$USE_RELATIONSHIP_PRIVACY in der gewählten Datenschutz-Datei.";
$pgv_lang["MAX_RELATION_PATH_LENGTH_help"]	= "Maximalen Verwandtschaftsgrad einstellen<br /><br />Diese Einstellung ändert die Variable \$MAX_RELATION_PATH_LENGTH in der gewählten Datenschutz-Datei.<br /><br />Wenn '#pgv_lang[USE_RELATIONSHIP_PRIVACY]#' aktiv ist, können angemeldete Benutzer nur die Daten lebender Personen bis zu diesem Verwandschaftsgrad ansehen oder bearbeiten.";
$pgv_lang["CHECK_MARRIAGE_RELATIONS_help"]	= "Verwandtschaft anhand von Eheschließungen überprüfen<br /><br />Soll der Verwandtschaftsgrad auch durch Zurhilfenahme von Eheschließungsdaten geprüft werden?<br /><br />Diese Einstellung ändert die Variable \$CHECK_MARRIAGE_RELATIONS in der gewählten Datenschutz-Datei.";
...
$pgv_lang["lang_edit_help"]			= "Auf dieser Seite können Sie Ihre Sprachdateien verwalten.<br />Sie können Sprachdateien übersetzen, vergleichen und exportieren. Außerdem können Sie auswählen, welche Sprachen vom Programm unterstützt werden.<br /><br />Sie können die folgenden Optionen und Tools nutzen:";
$pgv_lang["language_to_edit_help"]		= "#pgv_lang[edit_lang_utility]# >> <b>#pgv_lang[language_to_edit]#</b><br /><br />Hier können Sie die Sprache auswählen, deren Texte Sie <b>bearbeiten</b> möchten.<br /><br />";
$pgv_lang["file_to_edit_help"]			= "#pgv_lang[edit_lang_utility]# >> <b>#pgv_lang[file_to_edit]#</b><br /><br /><br />Hier können Sie den Typ der Sprachdatei auswählen, die Sie ändern möchten.<br /><br />Folgende Typen sind vorhanden:<br />admin.xx.php<br />configure_help.xx.php<br />edit.xx.php<br />facts.xx.php<br />help_text.xx.php<br />lang.xx.php<br /><br />Hierbei steht xx für den Sprachcode der von Ihnen gewählten Sprache und wird automatisch eingefügt.<br /><br />";
$pgv_lang["hide_translated_help"]		= "#pgv_lang[edit_lang_utility]# >> <b>#pgv_lang[hide_translated]#</b><br /><br />Wenn auf 'Ja' eingestellt, sehen Sie nur die Meldungen der gewählten Sprache, die noch nicht übersetzt wurden, d.h. die Meldungen, die in der Sprachdatei noch fehlen.  Nachdem Sie die Übersetzung eines Textes eingegeben haben, wird diese folglich dann auch sofort ausgeblendet.<br /><br />";
$pgv_lang["language_to_export_help"]		= "#pgv_lang[export_lang_utility]# >> <b>#pgv_lang[language_to_export]#</b><br /><br />Hier können Sie die Sprache wählen, aus der Sie Texte <b>exportieren</b> möchten.<br /><br />";
$pgv_lang["new_language_help"]			= "#pgv_lang[compare_lang_utility]# >> <b>#pgv_lang[new_language]#</b><br /><br />Hier können Sie die Sprache einstellen, die Sie als Referenz für den Vergleich mit einer anderen Datei verwenden möchten.<br /><br />Alle Änderungen und Ergänzungen werden vom Programmiererteam zuerst in den <u>englischen</u> Dateien vorgenommen.<br /><br />";
$pgv_lang["old_language_help"]			= "#pgv_lang[compare_lang_utility]# >> <b>#pgv_lang[old_language]#</b><br /><br />Hier können Sie die Sprache einstellen, deren Texte Sie mit der zuvor ausgewählten Sprache vergleichen möchten.<br /><br />Nachdem Sie die Auswahl getroffen haben, klicken Sie auf den Button <b>Vergleichen</b> und Sie erhalten eine Liste der Unterschiede.<br /><br />Zum Verständnis:<br /><b>Ergänzungen</b> bedeutet: Dieser Text <b>besteht</b> in der Referenz-Datei aber <b>nicht</b> in der zweiten Datei.<br /><br /><b>Entfernte Teile</b> bedeutet: Der Text besteht <b>nicht</b> in der Referenzdatei aber <b>ist</b> in der zweiten Datei vorhanden.<br /><br />";
...
$pgv_lang["lang_filenames_help"]		= "~#pgv_lang[lang_filenames]#~<br />#pgv_lang[lang_file_descriptions]#";
...
$pgv_lang["um_tool_help"] = "~#pgv_lang[um_header]#~<br />#pgv_lang[um_explain]#";
$pgv_lang["um_sql_index_help"] = "~Benutzer-Datei auf den Index-Modus umstellen~<br />#pgv_lang[um_sql_index]#";
$pgv_lang["um_index_sql_help"] = "~Benutzer-Datei auf den SQL Modus umstellen~<br />#pgv_lang[um_index_sql]#";
...
$pgv_lang["um_bu_help"] = "~#pgv_lang[um_backup]#~<br />#pgv_lang[um_bu_explain]#";
...
$pgv_lang["REPO_FACTS_UNIQUE_help"]	= "~#pgv_lang[REPO_FACTS_UNIQUE]#~<br />Diese Liste enthält alle Ereignisse die im Archiv-Datensatz nur <u>einmal</u> vorkommen dürfen.  Z.B., wenn DATE hier eingegeben ist, darf jeder Archiv-Datensatz nur eine DATE Zeile enthalten. Ereignis-Codes dieser Liste dürfen <u>nicht</u> in der <i>#pgv_lang[REPO_FACTS_ADD]#</i> Liste vorkommen.  D.h., jedes Ereignis-Code darf in nur einer Liste vorkommen.<br /><br />";
$pgv_lang["REPO_FACTS_QUICK"] 		= "Schnell hinzugefügte Archivdaten";
$pgv_lang["REPO_FACTS_QUICK_help"]	= "~#pgv_lang[REPO_FACTS_QUICK]#~<br />Diese Liste, die neben der komplettenereignisliste gezeigt wird, bestimmt welche Ereignisse durch klicken des jeweiligen Links leicht zu diesem Archiv hinzugefügt werden können.<br /><br />";

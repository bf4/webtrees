...
$pgv_lang["DBPASS_help"]		= "Das Kennwort das für den oben von Ihnen angegebenen Benutzernamen benötigt wird, um eine Verbindung zu Ihrer Datenbank herzustellen.<br />Diese Einstellung verändert die Variable \$DBPASS in der Datei «config.php».";
...
$pgv_lang["TBLPREFIX_help"]		= "Ein Präfix der an die Tabellennamen angehängt wird, die von PhpGedView erstellt werden. Durch Ändern dieses Wertes können Sie mehrere PhpGedView-Sites bestimmen, die die gleiche Datenbank jedoch unterschiedliche Tabellen benutzen.<br /><br />Diese Einstellung verändert die Variable \$TBLPREFIX in der Datei «config.php».";
...
$pgv_lang["GEDCOM_ID_PREFIX"]		= "GEDCOM ID Präfix";

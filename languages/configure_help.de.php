...
$pgv_lang["DBPORT_help"]		= "~#pgv_lang[DBPORT]#~<br /><br />Das TCP Protokoll, das benutzt werden soll, um eine Verbindung zum Datenbank-Server herzustellen.  Lassen Sie dieses Feld leer, um das standardmäßige Protokoll zu benutzen.  Bei SQLite Datenbanken hat dieses Feld keine Bedeutung.<br />";
...
$pgv_lang["DEFAULT_PEDIGREE_GENERATIONS_help"]	= "~#pgv_lang[DEFAULT_PEDIGREE_GENERATIONS]#~<br /><br />Bestimmt die Anzahl standardmäßig dargestellter Generationen, die in Nachfahrenbaum- und Stammbaum-Darstellungen gleichzeitig angezeigt werden.<br />";
...
$pgv_lang["MEDIA_EXTERNAL_help"]	= "~#pgv_lang[MEDIA_EXTERNAL]#~<br /><br />Ein vorkommender Multimedia-Link, der z.B. mit http://, ftp://, mms:// beginnt, wird nicht geändert, wenn Sie «Links beibehalten» auf «Ja» setzen. Wenn Sie diesen Wert auf «Nein» setzen, dann wird der Link wie ein Verweis auf die Multimedia-Daten behandelt und die Einstellung bezüglich Multimedien-Verzeichnis etc. werden berücksichtigt. z.B.: http://www.meinefamilie.de/foto/papa.jpg wird geändert zu ./media/papa.jpg";
$pgv_lang["MEDIA_DIRECTORY"]		= "Verzeichnis der Multimedia-Dateien";
$pgv_lang["MEDIA_DIRECTORY_help"]	= "~#pgv_lang[MEDIA_DIRECTORY]#~<br /><br />Der Pfad zu einem Verzeichnis mit universellen Leserechten, in dem PhpGedView nach den Multimedia-Dateien suchen soll, die in den jeweiligen Datensätzen der Datenbank definiert wurden (einschließlich des «/» am Ende).<br /><br />Obwohl die Medien-Feuerwand Ihnen es erlaubt, solche Dateien anderswo auf dem Server zu speichern so daß sie nicht vom Internet direkt zugreifbar sind, muss das hier genannte Verzeichnis mit universellen Leserechten und Schreibrechten für PhpGedView bestehen. Eine ausführliche Beschreibung finden Sie in der «Medien-Feurwand» Optionengruppe unter dem Thema «Multimedia» der GEDCOM-Konfiguration.<br />";

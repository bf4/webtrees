...
$pgv_lang["PEDIGREE_FULL_DETAILS"]	= "Geburts- und Todesdetails im Stammbaum und Nachfahrenbaum zeigen";
$pgv_lang["PEDIGREE_FULL_DETAILS_help"]	= "~#pgv_lang[PEDIGREE_FULL_DETAILS]#~<br /><br />Dieses Feld bestimmt, ob die Einzelheiten der Geburts- und Sterbedaten von Personen standardmäßig dargestellt werden oder nicht.<br />";
...
$pgv_lang["ABBREVIATE_CHART_LABELS_help"]		= "~#pgv_lang[ABBREVIATE_CHART_LABELS]#~<br /><br />Legt fest, ob in den Diagrammen Bezeichnungen wie 'Geburt' nur mit dem Anfangsbuchstaben ('G') abgekürzt werden.<br />";
$pgv_lang["SHOW_AGE_DIFF"]					= "Altersdifferenzen zeigen";
$pgv_lang["SHOW_AGE_DIFF_help"]				= "~#pgv_lang[SHOW_AGE_DIFF]#~<br /><br />Diese Option bestimmt, ob Altersdifferenzen zwischen Gatten und zwischen Kindern im «Direkte Verwandtschaft» Ordner der «Persönliche Informationen» Seite gezeigt werden sollen oder nicht.<br />";
...
$pgv_lang["META_AUTHOR_help"]	= "~#pgv_lang[META_AUTHOR]#~<br /><br />Der Wert für das META Tag Feld «Autor» im HTML-Seiten-Kopf. Lassen Sie dieses Feld leer, um den vollständigen Namen der GEDCOM-Kontaktperson zu verwenden.<br />";
...
$pgv_lang["META_PUBLISHER_help"]	= "~#pgv_lang[META_PUBLISHER]#~<br /><br />Der Wert für das META Tag Feld «Publisher» im HTML-Seiten-Kopf. Lassen Sie dieses Feld leer, um den vollständigen Namen der GEDCOM-Kontaktperson zu verwenden.<br />";
...
$pgv_lang["META_COPYRIGHT_help"]	= "~#pgv_lang[META_COPYRIGHT]#~<br /><br />Der Wert für das META Tag Feld «Copyright» im HTML-Seiten-Kopf. Lassen Sie dieses Feld leer, um den vollständigen Namen der GEDCOM-Kontaktperson zu verwenden.<br />";
...
$pgv_lang["META_DESCRIPTION_help"]	= "~#pgv_lang[META_DESCRIPTION]#~<br /><br />Der Wert für das META Tag Feld «description» im HTML-Seiten-Kopf. Lassen Sie dieses Feld leer, um den Titel der aktuellen GEDCOM-Datei zu verwenden.<br />";
...
$pgv_lang["META_PAGE_TOPIC_help"]	= "~#pgv_lang[META_PAGE_TOPIC]#~<br /><br />Der Wert für das META Tag Feld «Page-Topic» im HTML-Seiten-Kopf. Lassen Sie dieses Feld leer, um den Titel der aktuellen GEDCOM-Datei zu verwenden.<br />";
...
$pgv_lang["META_AUDIENCE_help"]	= "~#pgv_lang[META_AUDIENCE]#~<br /><br />Der Wert für das META Tag Feld «Audience» im HTML-Seiten-Kopf.<br />";
$pgv_lang["META_PAGE_TYPE"]		= "META Tag Page Type";
$pgv_lang["META_PAGE_TYPE_help"]	= "~#pgv_lang[META_PAGE_TYPE]#~<br /><br />Der Wert für das META Tag Feld «Page-Type» im HTML-Seiten-Kopf.<br />";
$pgv_lang["META_ROBOTS"]		= "META Tag Robots";
$pgv_lang["META_ROBOTS_help"]	= "~#pgv_lang[META_ROBOTS]#~<br /><br />Der Wert für das META Tag Feld «Robots» im HTML-Seiten-Kopf. Viele Robots und Crawler missachten diesen Wert.<br />";
$pgv_lang["META_REVISIT"]		= "Gibt an, wie oft Suchmaschinen die META Tags untersuchen sollen";
$pgv_lang["META_REVISIT_help"]	= "~#pgv_lang[META_REVISIT]#~<br /><br />Der Wert für das META Tag Feld «Revisit» im HTML-Seiten-Kopf. Viele Crawler missachten diesen Wert.<br />";
...
$pgv_lang["SHOW_LIVING_NAMES_help"]		= "~#pgv_lang[SHOW_LIVING_NAMES]#~<br /><br />Namen lebender Personen zeigen<br /><br />Mit dieser Einstellung können Sie definieren, wem die Namen lebender Personen angezeigt werden.<br /><br />Üblicherweise sollte diese Variable die Einstellung «Nur angemeldeten Benutzern zeigen» haben. Dies dient dem Datenschutz lebender Personen, die in Ihrer GEDCOM-Datenbank enthalten sind, denn Sie können selber bestimmen, wem Sie den allgemeinen Zugriff auf Ihre Ahnenforschungsdaten geben.<br /><br />Die Einstellung «Nur Verwaltern zeigen» verhindert die Anzeige der Namen lebender Personen auch für angemeldete Besucher, die jedoch keinen Verwalterstatus haben.<br />";
$pgv_lang["SHOW_RESEARCH_ASSISTANT"]			= "Forschungs-Assistent zeigen";
$pgv_lang["USE_RELATIONSHIP_PRIVACY_help"]	= "~#pgv_lang[USE_RELATIONSHIP_PRIVACY]#~<br /><br />Verwandtschafts-Datenschutz einschalten.<br /><br />«Nein» bedeutet, dass alle authentifizierten Benutzer alle Daten lebender Personen zu sehen bekommen.<br /><br />«Ja» bedeutet, dass authentifizierte Benutzer nur die Daten lebender Personen zu sehen bekommen, mit denen sie verwandt sind.<br /><br />Der Verwandtschaftsgrad wird mit der Einstellung «Max. Länge der Verwandtschaft» eingestellt.<br />";
$pgv_lang["MAX_RELATION_PATH_LENGTH_help"]	= "~#pgv_lang[MAX_RELATION_PATH_LENGTH]#~<br /><br />Maximalen Verwandtschaftsgrad einstellen<br /><br />Wenn '#pgv_lang[USE_RELATIONSHIP_PRIVACY]#' aktiv ist, können angemeldete Benutzer nur die Daten lebender Personen bis zu diesem Verwandschaftsgrad ansehen oder bearbeiten.<br />";
...
$pgv_lang["SHOW_DEAD_PEOPLE_help"]		= "~#pgv_lang[SHOW_DEAD_PEOPLE]#~<br /><br />Verstorbene Personen zeigen<br /><br />Setzt die Datenschutz-Einstellungen für alle verstorbenen Personen.<br />";
...
$pgv_lang["alphabet_upper_help"]	= "~#pgv_lang[alphabet_upper]#~<br /><br />Großbuchstaben-Alphabet. Dieses Alphabet wird benutzt, um die groß geschriebenen Namen in den Namen-Listen von PhpGedView zu sortieren (in der gewählte Sprache).<br />";
$pgv_lang["alphabet_lower"]		= "Alphabet Kleinbuchstaben";
$pgv_lang["alphabet_lower_help"]	= "~#pgv_lang[alphabet_lower]#~<br /><br />Kleinbuchstaben-Alphabet. Dieses Alphabet wird benutzt, um die klein geschriebenen Namen in den Namen-Listen von PhpGedView zu sortieren (in der gewählte Sprache).<br />";
...
$pgv_lang["USE_MEDIA_FIREWALL_help"]	= "~#pgv_lang[USE_MEDIA_FIREWALL]#~<br /><br />Die Medien-Feuerwand ist im Wikipedia beschrieben. <a href=\"http://wiki.phpgedview.net/en/index.php/Media_Firewall\" target=\"_blank\">http://wiki.phpgedview.net/en/index.php/Media_Firewall</a><br />";

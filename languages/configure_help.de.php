...
$pgv_lang["SHOW_AGE_DIFF_help"]				= "~#pgv_lang[SHOW_AGE_DIFF]#~<br /><br />Diese Option bestimmt, ob Altersdifferenzen zwischen Gatten und zwischen Kindern im «Direkte Verwandtschaft» Ordner der «Persönliche Informationen» Seite gezeigt werden sollen oder nicht.<br /><br />";
...
$pgv_lang["EXPAND_RELATIVES_EVENTS_help"] = "~#pgv_lang[EXPAND_RELATIVES_EVENTS]#~<br /><br />Diese Option bestimmt, ob die Liste der Ereignisse naher Verwandten im «Persönliche Fakten und Details» Ordner der «Persönliche Informationen» Seite automatisch erweitert werden soll oder nicht.<br /><br />";
$pgv_lang["EXPAND_SOURCES"]					= "Quellenangaben automatisch erweitern";
$pgv_lang["EXPAND_SOURCES_help"] = "~#pgv_lang[EXPAND_SOURCES]#~<br /><br />Diese Option bestimmt, ob der Inhalt von Quellenangaben auf der «Persönliche Informationen» Seite automatisch gezeigt werden soll oder nicht.<br /><br />";
$pgv_lang["EXPAND_NOTES"]      = "Bemerkungen automatisch erweitern";
$pgv_lang["EXPAND_NOTES_help"] = "~#pgv_lang[EXPAND_NOTES]#~<br /><br />Diese Option bestimmt, ob der Inhalt von Bemerkungen auf der «Persönliche Informationen» Seite automatisch gezeigt werden soll oder nicht.<br /><br />";
...
$pgv_lang["SHOW_COUNTER_help"]		= "~#pgv_lang[SHOW_COUNTER]#~<br /><br />Den Besucher-Zähler auf der Portalseite und auf anderen Seiten zeigen.<br /><br />";
...
$pgv_lang["SHOW_DEAD_PEOPLE_help"]		= "~#pgv_lang[SHOW_DEAD_PEOPLE]#~<br /><br />Verstorbene Personen zeigen<br /><br />Setzt die Datenschutz-Einstellungen für alle verstorbenen Personen.<br /><br />";
...
$pgv_lang["add_faq_header_help"] = "~#pgv_lang[add_faq_header]#~<br /><br />Titel oder Thema des FAQ-Eintrags.<br /><br />Ihre Eingabe kann formatiert werden. HTML-Befehle wie &lt;b&gt; und &lt;br&gt; sowie HTML-Einheiten wie &amp;amp; und &amp;nbsp; sind erlaubt.<br /><br />#pgv_lang[add_faq_HTML]#<br /><br />#pgv_lang[add_faq_pgvLangRefs]#<br /><br />";
$pgv_lang["add_faq_body_help"] = "~#pgv_lang[add_faq_body]#~<br /><br />Text des FAQ-Eintrags.<br /><br />Ihre Eingabe kann formatiert werden. HTML-Befehle wie &lt;b&gt; und &lt;br&gt; sowie HTML-Einheiten wie &amp;amp; und &amp;nbsp; sind erlaubt.<br /><br />#pgv_lang[add_faq_HTML]#<br /><br />#pgv_lang[add_faq_pgvLangRefs]#<br /><br />";

...
$pgv_lang["upload_gedcom_help"]="Selecione, em seu computador, o arquivo GEDCOM ou ZIP a ser enviado para o servidor e gravado na pasta <b>#INDEX_DIRECTORY#</b>.<br /><br />Caso o arquivo esteja no formato ZIP, este deve conter apenas um arquivo GEDCOM e é este arquivo que será utilizado nos próximos passos.";
...
$pgv_lang["pls_note06a"]="Um email será enviado para o endereço #user_email#, com as instruções para desbloquear sua conta. A conta será removida se não for desbloqueada em 7 dias.<br /><br />Após o desbloqueio, informe seu Nome de Usuário/Senha e entre no site.";
...
$pgv_lang["mail04_line05"]="Após identificar-se, clique em 'Minha Conta' da opção de menu 'Meu Portal' e altere sua senha.";
...
$pgv_lang["welcome_text_cust_head"]="<b>BEM-VINDO A ESTE SITE GENEALÓGICO</b><br /><br />O acesso é permitido a todos que tenham uma conta.";
...
$pgv_lang["click_here_help"]="Clique neste botão para salvar as alterações.<br /><br />Ao retornar para a página Bem-Vindo ou para Meu Portal, caso não veja suas alterações, clique no botão Atualizar de seu Navegador (Browser).";
$pgv_lang["block_summaries"]="Descrição sucinta de cada bloco que você pode colocar em Bem-Vindo ou na página Meu Portal.<br /><table border='1' align='center'><tr><td class='list_value'><b>Nome</b></td><td class='list_value'><b>Descrição</b></td></tr>&nbsp;</table>";

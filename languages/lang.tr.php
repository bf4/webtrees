...
$pgv_lang["no_favorites"]		= "Halen <b>Benim Sık Kullanılanlar</b>a hiç kimseyi eklemediniz. <b>Benim Sık Kullanılanlar</b>a bir şahsı eklemek için aşağıdaki <b>Sık Kullanılanlara yeni ekle</b> başındaki \"<b>+</b>\" artı ikona basın açılacak açılacak alanda <b>Kişi, Aile, veya Kaynak ID gir</b> in altına ID bilgisi girilir bilmiyorsanız gireceğinize göre sağındaki ikonu seçip arama yapınız veya daha altındaki alana web sitelerinizi ekleyebilirsiniz ve bu <b>Sık Kullanılanlara yeni ekle</b> alanınıza ekleyecekleriniz hakkında bir açıklama gire bileceğiniz <b>Bu sık kullanılanlarınız hakkında bir açıklama gir</b> alana detaylı bilgi girebilirsiniz ve Ekle butona basarak eklemenizi bitirebilirsiniz.";
...
$pgv_lang["mail04_line05"]			= "Soyağacı websitesine giriş yaptıktan sonra 'Benim GedView Anasayfam' nden 'Profil ayarlarım' linkini tıklatın açılan sayfada 'Şifre ve Şifre tekrarla' her iki alanını yeni aynı şifrenizi girerek aşağıdaki 'Benim üyelik verilerimi güncelleştir' butonunu tıklamanız yeterli olacaktır.";
...
$pgv_lang["welcome_text_cust_head"] 	= "<center><b>Soyağacı Websitesine Hoş Geldiniz</b></center><br />Erişim, Bu website için kayıtlı kullanıcı adı ve şifresi olan kullanıcılara giriş inzi verilir.";
...
$pgv_lang["todays_events_descr"]	= "Bu blok Bugünkü hadiseler... bloğudur bu blok günlük yıl dönümleri Doğum, Ölüm, Evlenme, Hadise vs tüm yıl dönümleri göstermesini sağlar günlük olarak.";
...
$pgv_lang["recent_changes_none"]	= "<b>Son #pgv_lang[global_num1]# gün için hiç değişmeyenler.</b>";
$pgv_lang["recent_changes_some"]	= "<b>Son #pgv_lang[global_num1]# gün içinde yapılan değişiklikler</b>";
...
$pgv_lang["charts_block_descr"]		= "Bu blok Çizgeler bloğudur, Hoş geldiniz sayfasında veya <b>#GLOBALS[HOME_SITE_TEXT]#</b>da yerleştirmenize izin verir. Bu bloğa <b>Soyağacı Ağaç Çizelgesi</b>, <b>Kum saati Çizelgesi</b> ve <b>Şahsı İzleyen Nesiller Çizelgesi</b> kısa Çizgeleri yerleştirebilirsiniz bu şekilde ziyaretçilerinize kısa bir örneklemede yapabilirsiniz.";
...
$pgv_lang["click_here_help"]		= "Değişikliklerinizi kurtarması için bu düğmeyi tıklayın.<br /><br />Hoş geldiniz veya Benim GedView Anasayfam sayfasına dönmüş olacaksınız, ama değişikliklerinizi gösterilmeyebilir. Sayfanın uygun şekilde değişikliklerinizi görmeniz için tarayıcınızın görevini tekrar doldurduğunu kullanmaya ihtiyaç duyabilirsin.";
$pgv_lang["block_summaries"]		= "Sizin Hoş geldiniz veya Benim GedView Anasayfam sayfasında yerleştirebileceğiniz blokların her birinin kısa bir tanımlaması buradadır.<br /><table border='1' align='center'><tr><td class='list_value'><b>İsim</b></td><td class='list_value'><b>Açıklaması</b></td></tr>&nbsp;</table>";
...
$pgv_lang["portal_config_intructions"]	= "Bunları istediğiniz gibi sayfaya blokları yerleştirerek sayfayı ihtiyacınıza göre özelleştirebilirsiniz.<br /><br /> Sayfa <b>Ana</b> ve <b>Sağ</b> bölümler içine bölünür. <b>Ana</b> bölüm blokları geniş belirirler ve sayfa başlığın altında belirir. <b>Sağ</b> bölüm sağda belirir ve sayfa başlığın altının sağında listelenir.<br /><br />Her bir bölüm listelendiği düzende sayfada yazılan blokların kendi listesine sahip olur.<br /><br />Blok listelerinin biri boş olduğunda kalan bloklar sayfanın tümünün genişliğini kapsayacaktır.";

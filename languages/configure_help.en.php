...
$pgv_lang["SURNAME_TRADITION_help"] = "~#pgv_lang[SURNAME_TRADITION]#~<br /><br />When you add new members to a family, phpGedView can supply default values for surnames, according to regional custom.  In the Paternal tradition, all family members share the father's surname.  In the Spanish and Portuguese tradition, children receive a surname from each parent.  In the Icelandic tradition, children receive their parent's given name as a surname.";
$pgv_lang["ADVANCED_NAME_FACTS_help"] = "~#pgv_lang[ADVANCED_NAME_FACTS]#~<br /><br />This is a comma separated list of GEDCOM fact tags that will be shown on the add/edit name form.  If you use non-latin alphabets such as hebrew or arabic, you may want to add tags such as _HEB, ROMN, FONE, etc. to allow you to store names in both the latin and local alphabet.";

...
$pgv_lang["ADVANCED_PLAC_FACTS_help"] = "~#pgv_lang[ADVANCED_PLAC_FACTS]#~<br /><br />This is a comma separated list of GEDCOM fact tags that will be shown when you add/edit place-names.  If you use non-Latin alphabets such as Hebrew or Arabic, you may want to add tags such as _HEB, ROMN, FONE, etc. to allow you to store place-names in both the Latin and local alphabet.<br />";

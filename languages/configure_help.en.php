...
$pgv_lang["USE_MEDIA_VIEWER_help"]		= "~#pgv_lang[USE_MEDIA_VIEWER]#~<br /><br /><ul><li><b>#pgv_lang[yes]#</b>&nbsp;&nbsp;When users click on thumbnails, they will be taken to the Media View page.  The Media View page shows the details of the image and allows you to edit them.</li><li><b>#pgv_lang[no]#</b>&nbsp;&nbsp;Clicking on the thumbnail displays the full-size image in a new popup window.</li></ul>";
$pgv_lang["USE_MEDIA_FIREWALL"]			= "Use Media Firewall";
$pgv_lang["USE_MEDIA_FIREWALL_help"]	= "~#pgv_lang[USE_MEDIA_FIREWALL]#~<br /><br />See the Wiki for a description of how to use the Media Firewall: http://wiki.phpgedview.net/en/index.php/Media_Firewall<br /><br />";
$pgv_lang["MEDIA_FIREWALL_ROOTDIR"]			= "Media Firewall Root Directory";
$pgv_lang["MEDIA_FIREWALL_ROOTDIR_help"]	= "~#pgv_lang[MEDIA_FIREWALL_ROOTDIR]#~<br /><br />Directory that contains the protected image directory.  If empty, will use index directory.  Should be the same for all GEDCOMs in this site.<br /><br />";
$pgv_lang["MEDIA_FIREWALL_THUMBS"]			= "Protect Thumbnails of Protected Images";
$pgv_lang["MEDIA_FIREWALL_THUMBS_help"]	= "~#pgv_lang[MEDIA_FIREWALL_THUMBS]#~<br /><br />When an image is in the protected image directory, should the thumbnail be protected as well?<br /><br />";
...
$pgv_lang["SHOW_NO_WATERMARK_help"]		= "~#pgv_lang[SHOW_NO_WATERMARK]#~<br /><br />If the Media Firewall is enabled and a watermark module is installed, users will see watermarks if they do not have the privilege level specified here.<br />";
$pgv_lang["SHOW_NO_WATERMARK"]			= "Who can view non-watermarked images?";
$pgv_lang["WATERMARK_THUMB_help"]		= "~#pgv_lang[WATERMARK_THUMB]#~<br /><br />If the Media Firewall is enabled and a watermark module is installed, do you want to watermark thumbnails? (Your media lists will load faster if you don't watermark the thumbnails.)<br />";
$pgv_lang["WATERMARK_THUMB"]			= "Add watermarks to thumbnails?";
$pgv_lang["SAVE_WATERMARK_THUMB_help"]	= "~#pgv_lang[SAVE_WATERMARK_THUMB]#~<br /><br />If the Media Firewall is enabled and a watermark module is installed, do you want to store copies of watermarked thumbnails on the server? (Storing a watermarked copy of thumbnails shouldn't take too much space, and is the best way to speed up media lists while retaining the watermarks.)<br />";

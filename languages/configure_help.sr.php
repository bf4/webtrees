...
##$pgv_lang["SHOW_LIST_PLACES_help"]	= "This determines how much of the Place information is shown in the Place fields on lists.<br /><br />Setting the value to <b>9</b> will ensure that all Place information will be shown.  Setting the value to <b>0</b> (zero) will hide places completely.  Setting the value to <b>1</b> will show the topmost level, which is normally the country.  Setting it to <b>2</b> will show the topmost two levels.  The second topmost level, below the country, is often the state, province, or territory. Etc.";

##$pgv_lang["new_gedcom_title"]		= "Genealogy from [#GEDCOMFILE#]";
##$pgv_lang["keep_media_help"]		= "Should existing media links be retained in the database when a replacement GEDCOM is being uploaded. The <b>No</b> option removes existing media links from the database, while the <b>Yes</b> option keeps them.<br /><br />This option is useful when you export your GEDCOM from PhpGedView to an off-line GEDCOM maintenance program that does not handle embedded media pointers properly, and then subsequently re-import that changed GEDCOM into PhpGedView.  Under such circumstances, the media pointers within the GEDCOM you exported to your off-line editing program are destroyed, and you would have to re-link all of your media files to the proper Person, Family, and Source records after you re-import the GEDCOM into PhpGedView.<br /><br />The <b>Yes</b> option tells PhpGedView to keep the existing media links so that you do not have to re-create them after you import the changed GEDCOM, but this requires the off-line editing program to always produce the same Person, Family, and Source identification numbers.<br /><br /><i>Family Tree Maker</i> is one of several off-line editing programs that does <u>not</u> properly handle media object pointers within the GEDCOM.  <i>Legacy</i>, among many others, <u>does</u> handle these properly.";
##$pgv_lang["USE_MEDIA_VIEWER"]			= "Use Media Viewer";
##$pgv_lang["USE_MEDIA_VIEWER_help"]		= "When this option is <b>Da</b>, clicking on images will produce the Media Viewer page.  This page shows the details of the image.  If you have sufficient rights, you can also edit these details.<br /><br />When this option is <b>Ne</b>, clicking on images will produce a full-size image in a new window.";
##$pgv_lang["USE_MEDIA_FIREWALL"]			= "Use Media Firewall";
##$pgv_lang["USE_MEDIA_FIREWALL_help"]	= "See the Wiki for a description of how to use the Media Firewall. <a href=\"#PGV_PHPGEDVIEW_WIKI#/en/index.php?title=Media_Firewall\" target=\"_blank\">#PGV_PHPGEDVIEW_WIKI#</a>";
##$pgv_lang["MEDIA_FIREWALL_ROOTDIR"]			= "Media Firewall Root Directory";
##$pgv_lang["MEDIA_FIREWALL_ROOTDIR_help"]	= "Directory in which the protected Media directory can be created.  #pgv_lang[MEDIA_FIREWALL_ROOTDIR_note]#";
...
##$pgv_lang["MEDIA_FIREWALL_THUMBS_help"]	= "When an image is in the protected Media directory, should its thumbnail be protected as well?";
##$pgv_lang["SHOW_SPIDER_TAGLINE"]		= "Show spider tagline";
##$pgv_lang["SHOW_SPIDER_TAGLINE_help"]		= "On pages generated for search engines, display as the last line the particular search engine the page detected.  If this option is on, it can bias Google&reg; AdSense towards search engine optimization tools.";
##$pgv_lang["SHOW_PRIVATE_RELATIONSHIPS_help"] = "This option will retain family links in privatized records.  This means that you will see empty \"private\" boxes on the pedigree chart and on other charts with private people.<br /><br />This is similar to the behavior of PhpGedView versions prior to v4.0.<br /><br />This setting is off by default.  It is recommended instead of turning this on, to point your pedigree root person in your GEDCOM configuration to a person who is not private.";
##$pgv_lang["SHOW_PRIVATE_RELATIONSHIPS"]	= "Show private relationships";
##$pgv_lang["SYNC_GEDCOM_FILE_help"] 			= "In past versions of PGV the pending edits were stored in the GEDCOM file and the changed records were then \"accepted\" into the database.  Starting with v4.1 pending changes are no longer stored in the GEDCOM file but in the changes file.  <br /><br />Setting this value to true will update the GEDCOM file when changes are accepted into the database.  This will keep the GEDCOM file synchronized with the database.  For greater compatibility with previous versions the default value of this field is on.<br /><br />You may want to turn it off to conserve memory when accepting changes.";
##$pgv_lang["SYNC_GEDCOM_FILE"]			= "Synchronize edits into GEDCOM file";
##$pgv_lang["COMMIT_COMMAND_help"] 			= "If you wish to use a version control system such as CVS to archive changes to your GEDCOM file and your configuration or privacy settings, enter the command here.  Leave the box blank if you do not wish to use a version control system.  Valid options are <b>cvs</b> and <b>svn</b>.";
##$pgv_lang["COMMIT_COMMAND"] 			= "Version Control Commit Command";
##$pgv_lang["SHOW_MULTISITE_SEARCH_help"]	= "Multi-site search allows users to search across multiple PhpGedView websites which you have setup in the Manage Sites administration area or remotely linked to.  This option controls whether the Multi-site Search feature is available to everyone or only to authenticated users.";
##$pgv_lang["SHOW_MULTISITE_SEARCH"]		= "Show Multi-Site Search";
##$pgv_lang["SHOW_NO_WATERMARK"]			= "Who can view non-watermarked images?";
##$pgv_lang["SHOW_NO_WATERMARK_help"]		= "If the Media Firewall is enabled, users will see watermarks if they do not have the privilege level specified here.";
##$pgv_lang["WATERMARK_THUMB"]			= "Add watermarks to thumbnails?";
##$pgv_lang["WATERMARK_THUMB_help"]		= "If the Media Firewall is enabled, should thumbnails be watermarked? Your media lists will load faster if you don't watermark the thumbnails.";
##$pgv_lang["SAVE_WATERMARK_THUMB"]		= "Store watermarked thumbnails on server?";
##$pgv_lang["SAVE_WATERMARK_THUMB_help"]	= "If the Media Firewall is enabled, should copies of watermarked thumbnails be stored on the server in addition to the same thumbnails without watermarks?<br /><br />When set to <b>Da</b>, media lists containing watermarked thumbnails will be produced more quickly at the expense of higher server disk space requirements.";
##$pgv_lang["SAVE_WATERMARK_IMAGE"]		= "Store watermarked full size images on server?";
##$pgv_lang["SAVE_WATERMARK_IMAGE_help"]	= "If the Media Firewall is enabled, should copies of watermarked full size images be stored on the server in addition to the same images without watermarks?<br /><br />When set to <b>Da</b>, full-sized watermarked images will be produced more quickly at the expense of higher server disk space requirements.";
...
##$pgv_lang["INDI_FACTS_ADD_help"]		= "This is the list of GEDCOM facts that your users can add to individuals.  You can modify this list by removing or adding fact names, even custom ones, as necessary.  Fact names that appear in this list must not also appear in the <i>#pgv_lang[INDI_FACTS_UNIQUE]#</i> list.";
##$pgv_lang["INDI_FACTS_UNIQUE"] 			= "Unique Individual Facts";
##$pgv_lang["INDI_FACTS_UNIQUE_help"]		= "This is the list of GEDCOM facts that your users can only add <u>once</u> to individuals.  For example, if BIRT is in this list, users will not be able to add more than one BIRT record to an individual.  Fact names that appear in this list must not also appear in the <i>#pgv_lang[INDI_FACTS_ADD]#</i> list.";
##$pgv_lang["INDI_FACTS_QUICK"] 			= "Quick Individual Facts";
##$pgv_lang["INDI_FACTS_QUICK_help"]	= "This is the short list of GEDCOM individual facts that appears next to the full list and can be added with a single click.";
##$pgv_lang["FAM_FACTS_ADD"] 			= "Family Add Facts";
##$pgv_lang["FAM_FACTS_ADD_help"]		= "This is the list of GEDCOM facts that your users can add to families.  You can modify this list by removing or adding fact names, even custom ones, as necessary.  Fact names that appear in this list must not also appear in the <i>#pgv_lang[FAM_FACTS_UNIQUE]#</i> list.";
##$pgv_lang["FAM_FACTS_UNIQUE"] 			= "Unique Family Facts";
##$pgv_lang["FAM_FACTS_UNIQUE_help"]		= "This is the list of GEDCOM facts that your users can only add <u>once</u> to families.  For example, if MARR is in this list, users will not be able to add more than one MARR record to a family.  Fact names that appear in this list must not also appear in the <i>#pgv_lang[FAM_FACTS_ADD]#</i> list.";
##$pgv_lang["FAM_FACTS_QUICK"] 			= "Quick Family Facts";
##$pgv_lang["FAM_FACTS_QUICK_help"]	= "This is the short list of GEDCOM family facts that appears next to the full list and can be added with a single click.";
##$pgv_lang["SOUR_FACTS_ADD"] 			= "Source Add Facts";
##$pgv_lang["SOUR_FACTS_ADD_help"]		= "This is the list of GEDCOM facts that your users can add to sources.  You can modify this list by removing or adding fact names, even custom ones, as necessary.  Fact names that appear in this list must not also appear in the <i>#pgv_lang[SOUR_FACTS_UNIQUE]#</i> list.";
##$pgv_lang["SOUR_FACTS_UNIQUE"] 			= "Unique Source Facts";
##$pgv_lang["SOUR_FACTS_UNIQUE_help"]		= "This is the list of GEDCOM facts that your users can only add <u>once</u> to sources.  For example, if TITL is in this list, users will not be able to add more than one TITL record to a source.  Fact names that appear in this list must not also appear in the <i>#pgv_lang[SOUR_FACTS_ADD]#</i> list.";
##$pgv_lang["SOUR_FACTS_QUICK"] 			= "Quick Source Facts";
##$pgv_lang["SOUR_FACTS_QUICK_help"]	= "This is the short list of GEDCOM source facts that appears next to the full list and can be added with a single click.";
##$pgv_lang["REPO_FACTS_ADD"] 			= "Repository Add Facts";
##$pgv_lang["REPO_FACTS_ADD_help"]		= "This is the list of GEDCOM facts that your users can add to repositories.  You can modify this list by removing or adding fact names, even custom ones, as necessary.  Fact names that appear in this list must not also appear in the <i>#pgv_lang[REPO_FACTS_UNIQUE]#</i> list.";
##$pgv_lang["REPO_FACTS_UNIQUE"] 			= "Unique Repository Facts";
##$pgv_lang["REPO_FACTS_UNIQUE_help"]		= "This is the list of GEDCOM facts that your users can only add <u>once</u> to repositories.  For example, if NAME is in this list, users will not be able to add more than one NAME record to a repository.  Fact names that appear in this list must not also appear in the <i>#pgv_lang[REPO_FACTS_ADD]#</i> list.";
##$pgv_lang["REPO_FACTS_QUICK"] 			= "Quick Repository Facts";
##$pgv_lang["REPO_FACTS_QUICK_help"]	= "This is the short list of GEDCOM repository facts that appears next to the full list and can be added with a single click.";
##$pgv_lang["LANG_SELECTION_help"]		= "You can change the list of languages supported by your PhpGedView site by adding or removing checkmarks as appropriate.  This changes the language choices available to your users.<br /><br />You can achieve the same thing through the <b>#pgv_lang[enable_disable_lang]#</b> link on the Admin menu, where you can also change things such as the language's flag icon, the date format, or whether the surname should always be printed first.";
##$pgv_lang["MEDIA_ID_PREFIX"]		= "Media ID prefix";
##$pgv_lang["MEDIA_ID_PREFIX_help"]	= "When a new media record is added online in PhpGedView, a new ID for that media will be generated automatically. The media ID will have this prefix.";
...
##$pgv_lang["QUICK_REQUIRED_FACTS_help"]		= "This is a comma separated list of GEDCOM fact tags that will always be shown on the Quick Update form whether or not they already exist in the individual's record.  For example, if BIRT is in the list, fields for birth date and birth place will always be shown on the form.";
##$pgv_lang["SURNAME_TRADITION_help"] = "When you add new members to a family, PhpGedView can supply default values for surnames according to regional custom.<br /><br /><ul><li>In the <b>Paternal</b> tradition, all family members share the father's surname.</li><li>In the <b>Spanish</b> and <b>Portuguese</b> tradition, children receive a surname from each parent.</li><li>In the <b>Icelandic</b> tradition, children receive their male parent's given name as a surname, with a suffix that denotes gender.</li><li>In the <b>Polish</b> tradition, all family members share the father's surname. For some surnames, the suffix indicates gender.  The suffixes <i>ski</i>, <i>cki</i>, and <i>dzki</i> indicate male, while the corresponding suffixes <i>ska</i>, <i>cka</i>, and <i>dzka</i> indicate female.</li></ul>";
##$pgv_lang["ADVANCED_NAME_FACTS_help"] = "This is a comma separated list of GEDCOM fact tags that will be shown on the add/edit name form.  If you use non-Latin alphabets such as Hebrew, Greek, Cyrillic or Arabic, you may want to add tags such as _HEB, ROMN, FONE, etc. to allow you to store names in several different alphabets.";
##$pgv_lang["ADVANCED_PLAC_FACTS_help"] = "This is a comma separated list of GEDCOM fact tags that will be shown when you add or edit place names.  If you use non-Latin alphabets such as Hebrew, Greek, Cyrillic or Arabic, you may want to add tags such as _HEB, ROMN, FONE, etc. to allow you to store place names in several different alphabets.";
##$pgv_lang["USE_GEONAMES"]				= "Use GeoNames database";
##$pgv_lang["USE_GEONAMES_help"]			= "Should the GeoNames database be used to provide more suggestions for place names?<br /><br />When this option is set to <b>Da</b>, the GeoNames database will be queried to supply suggestions for the place name being entered.  When set to <b>Ne</b>, only the current genealogical database will be searched.  As you enter more of the place name, the suggestion will become more precise.  This option can slow down data entry, particularly if your Internet connection is slow.<br /><br />The GeoNames geographical database is accessible free of charge. It currently contains over 8,000,000 geographical names.";
##$pgv_lang["AUTO_GENERATE_THUMBS"]			= "Automatically generated thumbnails";
##$pgv_lang["AUTO_GENERATE_THUMBS_help"]		= "Should the system automatically generate thumbnails for images that do not have them.  Your PHP installation might not support this functionality.";
##$pgv_lang["phpinfo_help"]				= "This page provides extensive information about the server on which PhpGedView is being hosted.  Many configuration details about the server's software, as it relates to PHP and PhpGedView, can be viewed.";
##$pgv_lang["config_help_help"]			= "This page collects all of the major topics of Configuration Help into one place.  You can view the information on your screen, or you can print it for later use.";
##$pgv_lang["more_help_advice"]			= "<br /><b>More help</b><br />More help is available by clicking the <b>?</b> next to items on the page.";
##$pgv_lang["THUMBNAIL_WIDTH"]			= "Width of generated thumbnails";
##$pgv_lang["THUMBNAIL_WIDTH_help"]		= "This is the width (in pixels) that the program will use when automatically generating thumbnails.  The default setting is 100.";
...
##$pgv_lang["REQUIRE_ADMIN_AUTH_REGISTRATION_help"]	= "If the option <b>#pgv_lang[USE_REGISTRATION_MODULE]#</b> is enabled this setting controls whether the admin must approve the registration.<br /><br />Setting this to <b>Yes</b> will require that all new users first verify themselves and then be approved by an admin before they can login.  With this setting on <b>No</b>, the <b>#pgv_lang[verified_by_admin]#</b> checkbox will be checked automatically when users verify their account, thus allowing an immediate login afterwards without admin intervention.";
##$pgv_lang["SPLIT_PLACES"]		= "Split places in Edit mode";
##$pgv_lang["SPLIT_PLACES_help"]	= "Set this to <b>Yes</b> to split each place name by commas into subfields for easier editing.  Example :<br /><ol><li>Default mode<br /><u>Place</u>: Half Moon Bay, San Mateo, California, USA<br /><br /></li><li>Split mode<br /><u>Country</u>: USA<br /><u>State</u>: California<br/><u>County</u>: San Mateo<br/><u>City</u>: Half Moon Bay</li></ol>";
...
##$pgv_lang["GEDCOM_DEFAULT_TAB_help"]	= "This option allows you to choose which tab opens automatically on the Individual page when that page is accessed.";
##$pgv_lang["SHOW_MARRIED_NAMES"]			= "Show married names on Individual list";
##$pgv_lang["SHOW_MARRIED_NAMES_help"]	= "This option will show the married names of females on the Individual list.  This option requires that you calculate the married names when you import the GEDCOM file.";
##$pgv_lang["SEARCHLOG_CREATE"]		= "Archive SearchLog files";
##$pgv_lang["SEARCHLOG_CREATE_help"]	= "How often should the program archive Searchlog files.";
##$pgv_lang["CHANGELOG_CREATE"]		= "Archive ChangeLog files";
##$pgv_lang["CHANGELOG_CREATE_help"]	= "How often should the program archive Changelog files.";
##$pgv_lang["CHART_BOX_TAGS"]		= "Other facts to show in charts";
##$pgv_lang["CHART_BOX_TAGS_help"]		= "This should be a comma or space separated list of facts, in addition to Birth and Death, that you want to appear in chart boxes such as the Pedigree chart.  This list requires you to use fact tags as defined in the GEDCOM 5.5.1 Standard.  For example, if you wanted the occupation to show up in the box, you would add \"OCCU\" to this field.";
##$pgv_lang["FULL_SOURCES"]		= "Use full source citations";
##$pgv_lang["FULL_SOURCES_help"]		= "Source citations can include fields to record the quality of the data (primary, secondary, etc.) and the date the event was recorded in the source.  If you don't use these fields, you can disable them when creating new source citations.";
##$pgv_lang["PREFER_LEVEL2_SOURCES"]		= "Source type";
##$pgv_lang["PREFER_LEVEL2_SOURCES_help"]		= "When adding new close relatives, you can add source citations to the records (e.g. INDI, FAM) or the facts (BIRT, MARR, DEAT).  This option controls which checkboxes are ticked by default.";
...
##$pgv_lang["DBTYPE_help"]		= "The type of PEAR supported database to connect to.<br /><br />PhpGedView supports MySQL, PostgreSQL, and SQLite databases.  MySQL and PostgreSQL both require libraries to be installed in PHP.  SQLite comes installed by default in PHP 5.<br /><br />With SQLite you don't need to configure #pgv_lang[DBHOST]#, #pgv_lang[DBUSER]#, or #pgv_lang[DBPASS]#, but you will need to set a file path for your database in the #pgv_lang[DBNAME]# field.";
##$pgv_lang["DBHOST"]			= "Database Host";
##$pgv_lang["DBHOST_help"]		= "The DNS or IP address of the computer hosting your database server.  This setting is ignored if you are using an SQLite database.";
##$pgv_lang["DBPORT"]			= "Database Port";
##$pgv_lang["DBPORT_help"]		= "The TCP Port that should be used when connecting to your database server.  Leave this setting blank to use the default port for your particular type of database.  This setting is ignored if you are using an SQLite database.";
##$pgv_lang["DBUSER"]			= "Database Username";
##$pgv_lang["DBUSER_help"]		= "The database username required to login to your database.  This setting is ignored if you are using an SQLite database.";
##$pgv_lang["DBPASS"]			= "Database Password";
##$pgv_lang["DBPASS_help"]		= "The database password for the user you entered in the #pgv_lang[DBUSER]# field.  This setting is ignored if you are using an SQLite database.";
...
##$pgv_lang["DEFAULT_PEDIGREE_GENERATIONS_help"]	= "Set the default number of generations to display on Descendancy and Pedigree charts.";
...
##$pgv_lang["GEDCOM_ID_PREFIX_help"]	= "When a new individual record is added online in PhpGedView, a new ID for that individual will be generated automatically. The individual ID will have this prefix.";
...
##$pgv_lang["PEDIGREE_FULL_DETAILS_help"]	= "This option controls whether or not to show the Birth and Death details of an individual on charts.";
##$pgv_lang["PEDIGREE_SHOW_GENDER"]	= "Show gender icon on charts";
##$pgv_lang["PEDIGREE_SHOW_GENDER_help"]	= "This option controls whether or not to show the individual's gender icon on charts.<br /><br />Since the gender is also indicated by the color of the box, this option doesn't conceal the gender. The option simply removes some duplicate information from the box.";
...
##$pgv_lang["ABBREVIATE_CHART_LABELS_help"]		= "This option controls whether or not to abbreviate labels like <b>Birth</b> on charts with just the first letter like <b>B</b>.<br /><br />You can customize the abbreviations by supplying overriding values in the <i>languages/extra.xx.php</i> file for each language.  For example, if you want to use <b>*</b> instead of <b>N</b> to abbreviate the BIRT fact in the French language, you should put the following entry into the <i>languages/extra.fr.php</i> file:<br /><br /><code>\$factAbbrev[\"BIRT\"]&nbsp;=&nbsp;\"*\";</code><br /><br />The lengths of abbreviations specified this way are not limited to 1 character.";
##$pgv_lang["SHOW_AGE_DIFF"]			= "Show Date Differences";
##$pgv_lang["SHOW_AGE_DIFF_help"]		= "This option controls whether or not the Close Relatives tab should show differences between birth dates of spouses, between marriage date and birth date of first child, and between birth dates of children.";
...
##$pgv_lang["SHOW_RELATIVES_EVENTS_help"] = "Births, marriages, and deaths of relatives are important events in one's life. This option controls whether or not to show these events on the <i>Personal facts and details</i> tab on the Individual page.<br /><br />The events affected by this option are:<ul><li>Death of spouse</li><li>Birth and death of children</li><li>Death of parents</li><li>Birth and death of siblings</li><li>Death of grand-parents</li><li>Birth and death of parents' siblings</li></ul>";
##$pgv_lang["EXPAND_RELATIVES_EVENTS"]      = "Automatically expand list of events of close relatives";
##$pgv_lang["EXPAND_RELATIVES_EVENTS_help"] = "This option controls whether or not to automatically expand the <i>Events of close relatives</i> list.";
##$pgv_lang["EXPAND_SOURCES"]      = "Automatically expand sources";
##$pgv_lang["EXPAND_SOURCES_help"] = "This option controls whether or not to automatically display content of a <i>Source</i> record on the Individual page.";
##$pgv_lang["EXPAND_NOTES"]      = "Automatically expand notes";
##$pgv_lang["EXPAND_NOTES_help"] = "This option controls whether or not to automatically display content of a <i>Note</i> record on the Individual page.";
##$pgv_lang["SHOW_LEVEL2_NOTES"]      = "Show all Notes and Source references on Notes and Sources tabs";
##$pgv_lang["SHOW_LEVEL2_NOTES_help"] = "This option controls whether Notes and Source references that are attached to Facts should be shown on the Notes and Sources tabs of the Individual page.<br /><br />Ordinarily, the Notes and Sources tabs show only Notes and Source references that are attached directly to the individual's database record.  These are <i>level 1</i> Notes and Source references.<br /><br />The <b>Da</b> option causes these tabs to also show Notes and Source references that are part of the various Facts in the individual's database record.  These are <i>level 2</i> Notes and Source references because the various Facts are at level 1.";
...
##$pgv_lang["EDIT_AUTOCLOSE_help"]	= "This option controls whether or not to automatically close the Edit window after a successful update.";
##$pgv_lang["INDEX_DIRECTORY_help"]	= "The path to a readable and writable directory where PhpGedView should store index files (include the trailing \"/\").  PhpGedView does not require this directory's name to be \"index\".  You can choose any name you like.<br /><br />For security, this directory should be placed somewhere in the server's file space that is not accessible from the Internet. An example of such a structure follows:<br /><b>PhpGedView:</b> dir1/dir2/dir3/PhpGedView<br /><b>Index:</b> dir1/dir4/dir5/dir6/index<br /><br />For the example shown, you would enter <b>../../dir4/dir5/dir6/index/</b> in this field.";
##$pgv_lang["POSTAL_CODE"]  = "Postal Code position";
##$pgv_lang["POSTAL_CODE_help"] = "Different countries use different ways to write the address. This option will enable you to place the postal code either before or after the city name.";
##$pgv_lang["SUBLIST_TRIGGER_I"]		= "Maximum number of surnames";
##$pgv_lang["SUBLIST_TRIGGER_I_help"]	= "Long lists of persons with the same surname can be broken into smaller sub-lists according to the first letter of the individual's given name.<br /><br />This option determines when sub-listing of surnames will occur.  To disable sub-listing completely, set this option to zero.";
##$pgv_lang["SUBLIST_TRIGGER_F"]		= "Maximum number of family names";
##$pgv_lang["SUBLIST_TRIGGER_F_help"]	= "Long lists of families with the same name can be broken into smaller sub-lists according to the first letter of the given name.<br /><br />This option determines when sub-listing of family names will occur.  To disable sub-listing completely, set this option to zero.";
##$pgv_lang["SURNAME_LIST_STYLE"]		= "Surname list style";
##$pgv_lang["SURNAME_LIST_STYLE_help"]	= "Lists of surnames, as they appear in the #pgv_lang[block_top10]# block, the Lista pojedinaca, and the Lista porodica, can be shown in different styles.<ul><li><b>#pgv_lang[style2]#</b>&nbsp;&nbsp;&nbsp;In this style, the surnames are shown in a table that can be sorted either by surname or by count.</li><li><b>#pgv_lang[style3]#</b>&nbsp;&nbsp;&nbsp;In this style, the surnames are shown in a list, and the font size used for each name depends on the number of occurrences of that name in the database.  The list is not sortable.</li></ul>";
##$pgv_lang["SHOW_ID_NUMBERS_help"]	= "This option controls whether or not to show ID numbers in parentheses after names on charts and lists.";
##$pgv_lang["SHOW_LAST_CHANGE"]		= "Show GEDCOM record last change date on lists";
##$pgv_lang["SHOW_LAST_CHANGE_help"]	= "This option controls whether or not to show GEDCOM record last change date on lists.";
##$pgv_lang["SHOW_EST_LIST_DATES"]		= "Show estimated dates for birth and death";
##$pgv_lang["SHOW_EST_LIST_DATES_help"]	= "This option controls whether or not to show estimated dates for birth and death instead of leaving blanks on individual lists and charts for individuals whose dates are not known.";
...
##$pgv_lang["USE_THUMBS_MAIN_help"]	= "This option determines whether images associated with persons, families, or sources are shown by using a thumbnail image or whether the main image is used.  Several pages, such as the Media Viewer page, also honor this setting.  The Manage Media and Media List pages, on the other hand, always use the thumbnail.<br /><br />When this option is set to <b>Da</b>, all pages, except the Charts, will show the thumbnail image exactly as it is in the database.  This means that no size checks are performed, and if the thumbnail is larger than normal, the display results can be surprising.<br /><br />When this option is set to <b>Ne</b>, your browser will reduce the main image to thumbnail size before showing it on the Person, Family, and Source pages.  This image will have a width of 150 pixels, and will be shown with a border (when the existing thumbnail is used, there is no border).  The Media Viewer page will show the main picture with a maximum width of 300 pixels.  If the main picture is smaller, the Media Viewer will show it in full size.<br /><br />You should avoid setting this option to <b>Ne</b> because PhpGedView will send the full-sized image to the browser even when the browser will be showing a smaller version.  Thus, this option can result in excessive data transfer between PhpGedView and the browser.";
##$pgv_lang["SHOW_MEDIA_FILENAME"]		= "Show file name in Media Viewer";
##$pgv_lang["SHOW_MEDIA_FILENAME_help"]	= "The Media Viewer can show the name of the Media file being viewed.  This option determines whether that file name is shown to users or not.<br /><br />You may want to hide the file name for security reasons.";
##$pgv_lang["SHOW_MEDIA_DOWNLOAD"]		= "Show download link in Media Viewer";
##$pgv_lang["SHOW_MEDIA_DOWNLOAD_help"]	= "The Media Viewer can show a link which, when clicked, will download the Media file to the local PC.<br /><br />You may want to hide the download link for security reasons.";
...
##$pgv_lang["PHPGEDVIEW_EMAIL_help"]	= "E-mail address to be used in the &laquo;From:&raquo; field of e-mails that PhpGedView creates automatically.<br /><br />PhpGedView can automatically create e-mails to notify administrators of changes that need to be reviewed.  PhpGedView also sends notification e-mails to users who have requested an account.<br /><br />Usually, the &laquo;From:&raquo; field of these automatically created e-mails is something like <i>From: phpgedview-noreply@yoursite</i> to show that no response to the e-mail is required.  To guard against spam or other e-mail abuse, some e-mail systems require each message's &laquo;From:&raquo; field to reflect a valid e-mail account and will not accept messages that are apparently from account <i>phpgedview-noreply</i>.";
...
##$pgv_lang["SHOW_FACT_ICONS_help"]	= "Set this to <b>Da</b> to display icons near Fact names on the Lični podaci page.  Fact icons will be displayed only if they exist in the <i>images/facts</i> directory of the current theme.";
...
##$pgv_lang["PGV_SESSION_SAVE_PATH_help"]	= "The path to store PhpGedView session files.<br /><br />Some hosts do not have PHP configured properly and sessions are not maintained between page requests.  This option lets site administrators overcome that problem by saving files in one of their local directories.  The ./index/ directory is a good choice if you need to change this.  The default is to leave the field empty, which will use the Save path as configured in <i>php.ini</i>.";
##$pgv_lang["SERVER_URL_help"]		= "If you use https or a port other than the default, you will need to enter the URL to access your server here.";
...
##$pgv_lang["PGV_SESSION_TIME_help"]	= "The time in seconds that a PhpGedView session remains active before requiring a login.  The default is 7200, which is 2 hours.";
...
##$pgv_lang["PGV_SIMPLE_MAIL_help"] = "In normal mail headers for external mails, the email address as well as the name are used. Some mail systems will not accept this. When set to <b>Yes</b>, only the email address will be used.";
##$pgv_lang["PGV_SMTP_ACTIVE_help"] = "Use SMTP to send e-mails from PhpGedView.<br /><br />This option requires access to an SMTP mail server.  When set to <b>Ne</b> PhpGedView will use the e-mail system built into PHP on this server.";
##$pgv_lang["PGV_SMTP_HOST_help"] = "This is the name of the SMTP mail server.  Example: <b>smtp.foo.bar.com</b>.";
##$pgv_lang["PGV_SMTP_HELO_help"] = "This is the domain part of a valid e-mail address on the SMTP server.<br /><br />For example, if you have an e-mail account such as <b>yourname@abc.xyz.com</b>, you would enter <b>abc.xyz.com</b> here.";
##$pgv_lang["PGV_SMTP_PORT_help"] = "The port number to be used for connections to the SMTP server.  Generally, this is port <b>25</b>.";
##$pgv_lang["PGV_SMTP_AUTH_help"] = "Use name and password authentication to connect to the SMTP server.<br /><br />Some SMTP servers require all connections to be authenticated before they will accept outbound e-mails.";
##$pgv_lang["PGV_SMTP_AUTH_USER_help"] = "The user name required for authentication with the SMTP server.";
##$pgv_lang["PGV_SMTP_AUTH_PASS_help"] = "The password required for authentication with the SMTP server.";
##$pgv_lang["PGV_SMTP_FROM_NAME_help"] = "Enter the name to be used in the &laquo;From:&raquo; field of e-mails originating at this site.<br /><br />For example, if your name is <b>John Smith</b> and you are the site administrator for a site that is  known as <b>Jones Genealogy</b>, you could enter something like <b>John Smith</b> or <b>Jones Genealogy</b> or even <b>John Smith, Administrator: Jones Genealogy</b>.  You may enter whatever you wish, but HTML is not permitted.";
...
##$pgv_lang["PGV_MEMORY_LIMIT_help"]	= "The maximum amount of memory that can be consumed by PhpGedView scripts.  The default is 32 Mb.  Many hosts disable this option in their PHP configuration; changing this value may not actually affect the current maximum memory setting.";
##$pgv_lang["PGV_STORE_MESSAGES_help"]	= "Specifies whether messages sent through PhpGedView can be stored in the database.  If set to <b>Yes</b> users will be able to retrieve their messages when they login to PhpGedView.  If set to <b>No</b> messages will only be emailed.";
##$pgv_lang["ALLOW_THEME_DROPDOWN"]		= "Display theme dropdown selector for theme changes";
##$pgv_lang["ALLOW_THEME_DROPDOWN_help"]	= "Gives users the option of selecting their own theme from a menu.<br /><br />Even with this option set, the theme currently in effect may not provide for such a menu.  To be effective, this option requires the <b>#pgv_lang[ALLOW_USER_THEMES]#</b> option to be set as well.";
##$pgv_lang["MAX_VIEW_RATE"]		= "Maximum page view rate";
##$pgv_lang["MAX_VIEW_RATE_help"]	= "This option limits the rate at which a user can view pages.<br /><br />If that rate is exceeded, PhpGedView treats the session as a hacking attempt;  the session will be terminated with a suitable message.  These two values should place a reasonable limit on the amount of bandwith and downloaded bytes from the server.  This feature can be switched off by setting the time interval to 0.";
##$pgv_lang["META_AUTHOR"]		= "Author META tag";
##$pgv_lang["META_AUTHOR_help"]	= "The value to place in the Author meta tag in the HTML page header.  Leave this field empty to use the full name of the #pgv_lang[CONTACT_EMAIL]#.";
...
##$pgv_lang["META_PUBLISHER_help"]	= "The value to place in the Publisher meta tag in the HTML page header.  Leave this field empty to use the full name of the #pgv_lang[CONTACT_EMAIL]#.";
...
##$pgv_lang["META_COPYRIGHT_help"]	= "The value to place in the Copyright meta tag in the HTML page header.  Leave this field empty to use the full name of the #pgv_lang[CONTACT_EMAIL]#.";
...
##$pgv_lang["META_DESCRIPTION_help"]	= "The value to place in the Description meta tag in the HTML page header.  Leave this field empty to use the title of the currently active database.";
...
##$pgv_lang["META_PAGE_TOPIC_help"]	= "The value to place in the Page-topic meta tag in the HTML page header.  Leave this field empty to use the title of the currently active database.";
...
##$pgv_lang["META_ROBOTS_help"]	= "The value to place in the Robots meta tag in the HTML page header.  Some robots or web crawlers ignore this value.";
##$pgv_lang["META_REVISIT"]		= "How often should crawlers revisit META tag";
##$pgv_lang["META_REVISIT_help"]	= "The value to place in the Revisit meta tag in the HTML page header.  Some web crawlers ignore this value.";
##$pgv_lang["META_KEYWORDS"]		= "Keywords META tag";
##$pgv_lang["META_KEYWORDS_help"]	= "The value to place in the Keywords meta tag in the HTML page header.  Some search engines will use the Keywords meta tag to help index your page.<br /><br />The Najčešća prezimena list that appears in the Statistički podaci block on your Welcome page can also be added to anything you enter here.";
...
##$pgv_lang["SECURITY_CHECK_GEDCOM_DOWNLOADABLE_help"] = "For security reasons, GEDCOM files should not be in a location where they can be directly downloaded, thus bypassing privacy checks. Clicking this link will check if your GEDCOM files can be downloaded over the network.<br /><br />On some systems this check has been known to take a really long time or not even complete.  If that is the case for you, then you should try to point your browser directly at your GEDCOM to see if it can be downloaded.";
...
##$pgv_lang["SHOW_LIVING_NAMES_help"]		= "Should the names of living people be shown to the public?";
##$pgv_lang["SHOW_RESEARCH_ASSISTANT"]			= "Show Research Assistant";
##$pgv_lang["SHOW_RESEARCH_ASSISTANT_help"]		= "What type of user can view the Research Assistant module if it is installed?";
##$pgv_lang["USE_RELATIONSHIP_PRIVACY"]		= "Use relationship privacy";
##$pgv_lang["USE_RELATIONSHIP_PRIVACY_help"]	= "<b>No</b> means that authenticated users can see the details of all living people.  <b>Yes</b> means that users can only see the private information of living people they are related to.<br /><br />This option sets the default for all users who have access to this genealogical database.  The Administrator can override this option for individual users by editing the user's account details.";
##$pgv_lang["MAX_RELATION_PATH_LENGTH"]		= "Max. relation path length";
##$pgv_lang["MAX_RELATION_PATH_LENGTH_help"]	= "If the <i>#pgv_lang[USE_RELATIONSHIP_PRIVACY]#</i> option is enabled, logged-in users will only be able to see or edit individuals within this number of relationship steps.<br /><br />This option sets the default for all users who have access to this genealogical database.  The Administrator can override this option for individual users by editing the user's account details.";
##$pgv_lang["CHECK_MARRIAGE_RELATIONS"]		= "Check marriage relations";
##$pgv_lang["CHECK_MARRIAGE_RELATIONS_help"]	= "Check relationships that are related by marriage.";
...
##$pgv_lang["language_to_edit_help"]		= "In this list box you select the language whose messages you want to edit.";
...
##$pgv_lang["name_reverse_help"]		= "In some languages the surname should be displayed first instead of the default to display it last.  Enabling this option will display the surname first.  Hungarian, Chinese, and Japanese are examples where the surname (the family name) is usually given first.";
...
##$pgv_lang["multi_letter_alphabet_help"]	= "Multi-letter combinations that are to be treated as a single distinct letter when sorting lists of names and titles in this language.<br /><br />Some languages, Hungarian and Slovak for example, consider certain combinations of letters to be distinct letters in their own right.  The order in which you specify these letter combinations determines the order in which they are inserted into the normal alphabet during sorting.  This is important when several multi-letter combinations have the same first letter.  Except for <b>ch</b>, these letter combinations are inserted into the normal alphabet according to their first letter.  <b>ch</b> is always inserted after <b>h</b>.";
##$pgv_lang["multi_letter_equiv"]		= "Multi-letter equivalents";
##$pgv_lang["multi_letter_equiv_help"]	= "In some languages, multiple letters are often treated as equivalent to a single letter when generating lists of names.<br /><br />For example, in Dutch, names beginning with IJ are listed together with names beginning with Y. In Norwegian, names beginning with AA are listed with &Aring;. In some languages, there are letters that can be written as one character or two. For example in Slovakian, the two characters D and \xC5\xBE can be written as the single character \xC7\x85. By specifying equivalents here, you can allow names beginning with these letters to be grouped together on the individual list pages.<br /><br />You should specify a comma-separated list of equivalents. To support databases that don't recognize UTF-8 encoding, you should specify both upper and lower case equivalents. This example demonstrates the format to use.<br /><br />Aa=&Aring;,aa=&aring;";
##$pgv_lang["dictionary_sort"]		= "Use dictionary rules while sorting";
##$pgv_lang["dictionary_sort_help"]	= "This option controls how characters with diacritic marks are handled when sorting lists of names and titles.<br /><br />When set to <b>Da</b>, all characters with diacritic marks are treated as if they did not have any marks.  Diacritic marks are considered only when the two words being considered are otherwise identical.  When set to <b>Ne</b>, all letters are distinct, regardless of the presence or absence of diacritic marks.";
##$pgv_lang["collation"]		= "Database collation sequence";
##$pgv_lang["collation_help"]	= "If you are using the database's built-in collation rules, this option specifies the collation sequence to use for this language.  You should ensure that your database supports all the collation sequences you intend to use.<br /><br />The use of database collation is controlled in the site configuration settings.";
...
##$pgv_lang["hide_translated_help"]		= "If set to <b>Yes</b> you will only see those messages of your selected language file which have not been translated.  This means the new message does <u>not</u> appear in the target language file.<br /><br />Some language files contain English text for various untranslated messages.  This routine cannot identify these untranslated items, since they already are present in the target file.  The assumption is, \"If the message is present in the target file, it must have been translated.\"";
...
##$pgv_lang["um_proceed"] = "Choose an option or click the link below to return to the Administration menu";
...
##$pgv_lang["um_bu_help"] = "#pgv_lang[um_bu_explain]#";
...
##$pgv_lang["preview_faq_item_help"] = "This option lets an admin user view the FAQ page without all the editing options and links.<br /><br />Except for a single <b>Edit</b> link above the first FAQ item, the appearance of the FAQ page will be identical to what an ordinary user would see. This special <b>Edit</b> link will restore full Edit functionality to the FAQ page.";
##$pgv_lang["restore_faq_edits"] = "Restore FAQ edit functionality";
##$pgv_lang["restore_faq_edits_help"] = "This option restores the FAQ page to what an admin user normally sees, so that individual FAQ items may be edited.";
##$pgv_lang["add_faq_item"] = "Add FAQ item";
##$pgv_lang["add_faq_item_help"] = "This option will let you add an item to the FAQ page.";
##$pgv_lang["edit_faq_item"] = "Edit FAQ item";
##$pgv_lang["edit_faq_item_help"] = "This option will let you edit an item on the FAQ page.";
##$pgv_lang["delete_faq_item"] = "Delete FAQ item";
##$pgv_lang["delete_faq_item_help"] = "This option will let you delete an item from the FAQ page";
##$pgv_lang["moveup_faq_item"] = "Move FAQ item up";
##$pgv_lang["moveup_faq_item_help"] = "This option will let you move an item upwards on the FAQ page.<br /><br />Each time you use this option, the FAQ Position number of this item is reduced by one.  You can achieve the same effect by editing the item in question and changing the FAQ Position field.  When more than one FAQ item has the same position number, only one of these items will be visible.";
##$pgv_lang["movedown_faq_item"] = "Move FAQ item down";
##$pgv_lang["movedown_faq_item_help"] = "This option will let you move an item downwards on the FAQ page.<br /><br />Each time you use this option, the FAQ Position number of this item is increased by one.  You can achieve the same effect by editing the item in question and changing the FAQ Position field.  When more than one FAQ item has the same position number, only one of these items will be visible.";
##$pgv_lang["add_faq_header_help"] = "This is the title or subject of the FAQ item.<br /><br />What you enter here can be formatted. HTML tags such as &lt;b&gt; and &lt;br /&gt; are allowed, as are HTML entities such as &amp;amp; and &amp;nbsp;.  HTML tags other than &lt;br /&gt; are probably not very useful in the FAQ title and should be avoided.<br /><br />#pgv_lang[add_faq_HTML]#<br /><br />#pgv_lang[add_faq_pgvLangRefs]#";
##$pgv_lang["add_faq_body_help"] = "The text of the FAQ item is entered here.<br /><br />The text can be formatted. HTML tags such as &lt;b&gt; and &lt;br /&gt; are allowed, as are HTML entities such as &amp;amp; and &amp;nbsp;.<br /><br />#pgv_lang[add_faq_HTML]#<br /><br />#pgv_lang[add_faq_pgvLangRefs]#";
...
##$pgv_lang["time_limit_help"]			= "The maximum time the import is allowed to run for processing the GEDCOM file.";
...
##$pgv_lang["ged_filter_description_help"] = "This option lets you search the text associated with configuration options.<br /><br />As you type letters, the search will find all configuration options that contain that letter sequence.  The search becomes more precise as you type more letters.";

...
$pgv_lang["label_added_servers"]				= "Uzak Eklenen Sunucuar";
...
$pgv_lang["user_time"]							= "Kullanıcın Gerçerli Zamanı: ";
...
$pgv_lang["sanity_warn3"]			= "GD resim kütüphanesi mevcut değil. PhpGedView tırnak önizleme fonksiyonları çalışacak ancak çizimlerde GD kütüphanesi olmadan Diyagram Daire Çizimi çalışmayacaktır. Bu sorun hakkında bilgi görmek için lütfen <a href='http://www.php.net/manual/en/ref.image.php'>http://www.php.net/manual/en/ref.image.php</a> burayı tıklayıp görün. PHP.ini düzenleme imkanınız varsa extension=php_gd2.dll açın.";

...
$pgv_lang["privacy_error"]	    				= "A személy adatai bizalmas jellegűek.";
...
$pgv_lang["pls_note07"]						= "Kérem írja be a felhasználónevét, a jelszavát és az email-ben az ellenőrzéshez kapott aktiváló kódot.";
...
$pgv_lang["mail04_line05"]					= "Miután be jelentkezett, válassza a 'Felhasználói adataim' linket a 'MyGedView Portál' menü alatt és töltse ki a jelszó mezőket hogy megváltoztassa a jelszavát.";
...
$pgv_lang["welcome_text_cust_head"]				= "<center><b>Üdvözöljük ezen a Családfakutató-Honlapon</b></center><br />A honlapot érvényes felhasználói névvel és jelszóval rendelkező felhasználók látogathatják.";
...
$pgv_lang["no_favorites"]					= "Önnek nincsenek kijelölt Kedvencei.<br /><br />Ha egy személyt, családot vagy forrást fel kíván venni Kedvencek közé, keresse meg és kattintson a <b>Új kedvenc hozzáadása</b> hivatkozásra, vagy használja az alábbi beviteli mezőt az azonosító alapján történő felvételhez. Azonosító szám helyett be írhat egy URL -t és egy címet.";
...
$pgv_lang["recent_changes_some"]				= "<b>Változás történt az elmúlt #pgv_lang[global_num1]# napban.</b>";
$pgv_lang["recent_changes_none"]				= "<b>Nem történt semmi változás az elmúlt #pgv_lang[global_num1]# napban.</b>";
...
$pgv_lang["add_fav_or_enter_url"]				= "VAGY<br />Írjon be egy URL-t és egy címet";
...
$pgv_lang["click_here_help"]					= "Kattintson erre a gombra hogy elmentse a változtatásokat.<br /><br />Vissza fog kerülni a Üdvözöljük vagy a MyGedView Portál oldalra, de a változtatásai lehet hogy még nem fognaklátsztani. Lehet hogy az oldalt frissítenie kell a változások megjelenítéséhez.";
$pgv_lang["block_summaries"]		= "Egy rövid leírás minden egyes blokkról amit a Üdvözöljük vagy a MyGedView Portál oldalra tud tenni.<br /><table border='1' align='center'><tr><td class='list_value'><b>Név</b></td><td class='list_value'><b>Leírás</b></td></tr>&nbsp;</table>";

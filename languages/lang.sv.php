...
$pgv_lang["welcome_text_cust_head"]		=	"<center><b>Välkommen till denna genealogiska websajt</b></center><br />Access är tillåten för användare som har ett användarkonto och lösenord för denna websajt.";
...
$pgv_lang["click_here_help"]	= "Klicka på denna knapp för att spara dina ändringarna.<br /><br />Du kommer att returneras till Välkommen eller Min GedViewPortal-sidan, men ändringar kanske inte syns. Du kan behöva att ladda om sidan för att den ska visa sidan korrekt.";
$pgv_lang["block_summaries"]	= "Här är en kort beskrivning för varje område som du kan placera på Välkommen eller Min GedViewPortal sidan.<br /><table border='1' align='center'><tr><td class='list_value'><b>Namn</b></td><td class='list_value'><b>Beskrivning</b></td></tr>&nbsp;</table>";

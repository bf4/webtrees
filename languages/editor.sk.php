...
$pgv_lang["upload_media_help"]		= "~Nahrať multimediálne súbory~<br /><br />Vyberte súbory na vašom lokálnom počítači pre načítanie na váš server. Všetky súbory budú načítané do adresára <b>#MEDIA_DIRECTORY#</b> alebo do niektorého z poddaresárov.<br /><br />Adresár, ktorého meno ste zadali, bude pridaný do #MEDIA_DIRECTORY#. Napríklad, #MEDIA_DIRECTORY#mojarodina. Ak adresár náhľadov neexistuje, bude založený automaticky.";

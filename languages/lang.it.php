...
$pgv_lang["welcome_text_cust_head"] 	= "<center><b>Benvenuti in questo sito Genealogico</b></center><br />L'accesso è permesso agli utenti che hanno un account e una password per questo sito.";
...
$pgv_lang["add_fav_or_enter_url"]	= "O<br />Inserisci una URL e un titolo";
...
$pgv_lang["mail04_line05"]			= "Dopo aver effettuato l'accesso, selezionare il link «Il mio account» sotto il menu «Il mio GEDView» e riempire i campi password per cambiarla.";
...
$pgv_lang["recent_changes_none"]	= "<b>Non ci sono state modifiche negli ultimi #pgv_lang[global_num1]# giorni.</b>";
$pgv_lang["recent_changes_some"]	= "<b>Modifiche fatte negli ultimi #pgv_lang[global_num1]# giorni</b>";
...
$pgv_lang["click_here_help"]		= "Clicca questo pulsante per salvare le tue modifiche.<br /><br />Sarai reindirizzato alla pagina Benvenuto o alla pagina Il mio GEDView , ma le tue modifiche potrebbero non essere visibili. Potrebbe essere necessario utilizzare la funzione Ricarica Pagina del tuo browser per vedere correttamente le modifiche.";
$pgv_lang["block_summaries"]		= "Qui c'è una breve descrizione di ciascuno dei blocchi che tu puoi mettere nella pagina Benvenuto o o nella pagina Il mio GEDView .<br /><table border='1' align='center'><tr><td class='list_value'><b>Nome:</b></td><td class='list_value'><b>Descrizione</b></td></tr>&nbsp;</table>";

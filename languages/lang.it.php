...
$pgv_lang["click_here_help"]		= "~Clicca qui per continuare~<br /><br />Clicca questo pulsante per salvare le tue modifiche.<br /><br />Sarai reindirizzato alla pagina Benvenuto o alla pagina Il mio GEDView , ma le tue modifiche potrebbero non essere visibili. Potrebbe essere necessario utilizzare la funzione Ricarica Pagina del tuo browser per vedere correttamente le modifiche.";
$pgv_lang["block_summaries"]		= "~Descrizione dei blocchi~<br /><br />Qui c'è una breve descrizione di ciascuno dei blocchi che tu puoi mettere nella pagina Benvenuto o o nella pagina Il mio GEDView .<br /><table border='1' align='center'><tr><td class='list_value'><b>Nome:</b></td><td class='list_value'><b>Descrizione</b></td></tr>&nbsp;</table><br /><br />";

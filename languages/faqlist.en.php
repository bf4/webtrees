...
$faqlist["FAQ_030_PLACES5"] = "The field \"Hebrew\" under the \"Place\" data is intended to fill the place in Hebrew in addition to the place in Latin letters";
...
$faqlist["FAQ_030_AKANAME"] = "<u>AKA NAME</u> is an additional name the person is known by. It could be the birth name of persons who changed their name later in life or it could be an alias, stage or pen name. It could also be a married name. The given name entered here can be different from the given name of the main name. PhpGedView expects you to fill the surname in slashes. The name <i>James Adams</i> would be filled as <i>James /Adams/</i>.";

...
$faqlist["FAQ_030_AKANAME"] = "<u>AKA NAME</u> is an additional name the person is known by. It could be the birth name of persons who changed their name later in life or it could be an alias, stage or pen name. It could also be a married name. The given name entered here can be different from the given name of the main name. PhpGedView expects you to fill the surname in slashes. The name <i>James Adams</i> would be filled as <i>James /Adams/</i>. Additional Hebrew names or Yiddish names are also filled as AKA names.";

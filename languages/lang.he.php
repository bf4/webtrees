...
$pgv_lang["privacy_error"]		= ".הנתונים הם פרטיים ולא ניתן להראות אותם<br />"; 
...
$pgv_lang["media_dir_3"]		= "ישות המדיה הזו נימצאת בתיקיית המדיה המוגנת"; 
$pgv_lang["thumb_dir_1"]		= "התמונה הממוזערת הזו נימצאת על שרת חיצוני"; 
$pgv_lang["thumb_dir_2"]		= "התמונה הממוזערת הזו נימצאת בתיקיית המדיה הרגילה"; 
$pgv_lang["thumb_dir_3"]		= "התמונה הממוזערת הזו נימצאת בתיקיית המדיה המוגנת"; 
...
$pgv_lang["media_firewall_rootdir_no_exist"]			= " ספריית השורש של חומת האש של מדיה שביקשת אינה קיימת. עלך ליצור אותה תחילה."; 
$pgv_lang["media_firewall_protected_dir_no_exist"]		= "לא ניתן ליצור את הספרייה המוגנת בספריית השורש של חומת האש.  נא צור את הסיפרייה והפוך אותה לניתנת לכתיבה עולמית.";
...
$pgv_lang["statmess1"]		 = "<b>הכניסות הבאות מתיחסות לפרמטרי ציר ה-X וציר ה-Y של התרשים שמעל</b>";
$pgv_lang["statar_xgp"]			 = "גבולות ציר ה-X (תקופות):"; 
$pgv_lang["statar_xgl"]			 = "גבולות ציר ה-X (גילים):"; 
$pgv_lang["statar_xgm"]			 = "גבולות ציר ה-X (חודשים):"; 
$pgv_lang["statar_xga"]			 = "גבולות ציר ה-X (מספרים):"; 
$pgv_lang["statar_zgp"]			 = "גבולות ציר ה-X (תקופות):";
...
$pgv_lang["stpl"]			= "...";
$pgv_lang["stplGDno"]		= "ספרית Graphics Display אינה מותקנת על השרת. פנה למינהלן המערכת";
$pgv_lang["stpljpgraphno"]	 	= "מודולי JPgraph אינם קיימים בPhpGedView.  ניתן להוריד אותם מ-http://www.aditus.nu/jpgraph/jpdownload.php<br /> ולהעתיק אותם לתיקית משנה <i>/jpgraph/</i> על השרת."; 

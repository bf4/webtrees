...
$pgv_lang["pls_note07"]		= "~אמות משתמש~<br /><br />כדי לאשר את הבקשה שלך לקוד משתמש, הכנס את קוד המשתמש, הסיסמא וקוד האישור שקיבלת בדואר האלקטרוני.";
...
$pgv_lang["click_here_help"]		= "~לחץ כאן כדי להמשיך~<br /><br />לחץ על כפתור זה כדי לשמור את השינויים שלך.<br /><br />תוחזר לדף ברוך הבא או לדף דף MyGedView, אבל יתכן שהשינויים שלך לא יוצגו. יתכן שעליך להשתמש בפונקצית רענון תצוגה של הדפדפן כדי שהשינויים שלך יוצגו.";
$pgv_lang["block_summaries"]		= "~תיאורי אזורים~<br /><br />כאן תמצא תאור קצר של כל אזור שניתן לשים על דף הברוך הבא או דף MyGedView.<br /><table border='1' align='center'><tr><td class='list_value'><b>שם</b></td><td class='list_value'><b>תאור</b></td></tr>&nbsp;</table><br /><br />";

...
$pgv_lang["add_fav_or_enter_url"]	= "או<br />הכנס URL וכותרת";
...
$pgv_lang["pls_note06"]		= "נשלח לך דואר של אישור לכתובת האלקטרונית <span dir=\"ltr\"><b>#user_email#</b></span>. עליך לאשר את בקשת קוד המשתמש שלך לפי ההוראות המופיעות בדואר של האישור. אם לא תאשר את בקשת קוד המשתמש תוך שבעה ימים,  הבקשה לקוד משתמש תדחה באופן אוטומטי ואז יהיה עליך להירשם שנית.<br /><br />אחרי שתנהג לפי ההוראות המופיעות בדואר של האישור, על המנהלן עדיין לאשר את המשתמש שלך לפני שיהיה ניתן להשתמש בקוד המשתמש שלך.<br /><br />כדי להתחבר לאתר זה, עליך לדעת קוד משתמש וסיסמא.";
$pgv_lang["pls_note06a"]		= "נשלח לך דואר של אישור לכתובת האלקטרונית <span dir=\"ltr\"><b>#user_email#</b></span>. עליך לאשר את בקשת קוד המשתמש שלך לפי ההוראות המופיעות בדואר של האישור. אם לא תאשר את בקשת קוד המשתמש תוך שבעה ימים,  הבקשה לקוד משתמש תדחה באופן אוטומטי ואז יהיה עליך להירשם שנית.<br /><br />אחרי שתנהג לפי ההוראות המופיעות בדואר של האישור תוכל להתחבר לאתר. כדי להתחבר לאתר זה, יש לדעת קוד משתמש וסיסמא.";
...
$pgv_lang["mail04_line05"]		= "אחרי שהתחברת, בחר בקישור המשתמש שלי מתחת לתפריט דף MyGedView ומלא את שדות הסיסמא כדי לשנות את הסיסמא שלך.";
...
$pgv_lang["welcome_text_cust_head"]	= "<center><b>ברוכים הבאים לאתר הזה של חקר שושלת היוחסין</b></center><br />גישה לאתר זה מותרת למשתמשים בעלי קוד משתמש וסיסמא.";
...
$pgv_lang["no_favorites"]		= "לא בחרת מועדפים.<br /><br />כדי להוסיף אדם, משפחה או מקור לרשימת המועדפים שלך, לחץ על קישור <b>הוסף מועדף חדש</b> כדי להציג מספר שדות שבהם ניתן למלא או לחפש קוד זיהוי. במקום קוד זיהוי ניתן למלא URL וכותרת.";
...
$pgv_lang["recent_changes_none"]	= "<b>לא היו שינויים במשך #pgv_lang[global_num1]# הימים האחרונים.</b>";
$pgv_lang["recent_changes_some"]	= "<b>שינויים שבוצעו תוך #pgv_lang[global_num1]# הימים האחרונים</b>";
...
$pgv_lang["click_here_help"]		= "לחץ על כפתור זה כדי לשמור את השינויים שלך.<br /><br />תוחזר לדף ברוך הבא או לדף דף MyGedView, אבל יתכן שהשינויים שלך לא יוצגו. יתכן שעליך להשתמש בפונקצית רענון תצוגה של הדפדפן כדי שהשינויים שלך יוצגו.";
$pgv_lang["block_summaries"]		= "כאן תמצא תאור קצר של כל אזור שניתן לשים על דף הברוך הבא או דף MyGedView.<br /><table border='1' align='center'><tr><td class='list_value'><b>שם</b></td><td class='list_value'><b>תאור</b></td></tr>&nbsp;</table>";

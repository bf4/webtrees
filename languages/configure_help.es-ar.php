...
$pgv_lang["PGV_DATABASE_help"] = "Indica a PhpGedView qué el tipo de almacenamiento de datos quiere utilizar al importar un archivo GEDCOM al sistema.<br />Seleccione \"Índices\" para utilizar archivos índice almacenados en el directorio index, o seleccione \"MySQL\" para utilizar una base de datos MySQL.";
$pgv_lang["DBHOST"] = "Servidor MySQL";
$pgv_lang["DBHOST_help"] = "El URL o dirección IP del servidor de su base de datos MySQL.";
$pgv_lang["DBUSER"] = "Nombre de usuario MySQL";
$pgv_lang["DBUSER_help"] = "Se requiere el Nombre de Usuario de la base de datos MySQL actual para conectarse con ella.";
$pgv_lang["DBPASS"] = "Contraseña de la base de datos MySQL";
$pgv_lang["DBPASS_help"] = "La contraseña de la base de datos MySQL para el usuario que ha ingresado en el campo de Nombre de Usuario MySQL.";
$pgv_lang["DBNAME"] = "Nombre de la Base de Datos";
$pgv_lang["DBNAME_help"] = "La Base de Datos en el servidor MySQL que desea que PhpGedView utilice. El Nombre de Usuario que escribió en el campo de Nombre de Usuario debe tener privilegios para poder crear, insertar, actualizar, borrar, y seleccionar en esta base de datos.";
$pgv_lang["TBLPREFIX"] = "Prefijo de las Tablas de la Base de Datos";
$pgv_lang["TBLPREFIX_help"] = "Un prefijo para añadir a los nombres de las tablas MySQL creadas por PhpGedView. Cambiando este valor puede gestionar múltiples sitios PhpGedView y utilizar la misma base de datos pero con diferentes tablas.";
...
$pgv_lang["REQUIRE_AUTHENTICATION_help"] = "Habilitando esta opción obligará a los usuarios a registrarse antes de poder ver información en el sitio.";
$pgv_lang["CHECK_CHILD_DATES"] = "Comprobar fechas de los hijos";
$pgv_lang["CHECK_CHILD_DATES_help"] = "Comprueba las fechas de los hijos, cuando determina si una persona ya ha fallecido. En sistemas GEDCOMs grandes y anticuados puede demorar la respuesta de su sitio.";
$pgv_lang["MAX_ALIVE_AGE"] = "Edad a la cual presumiblemente una persona ha fallecido";
$pgv_lang["MAX_ALIVE_AGE_help"] = "Edad máxima que una persona pueda tener o edad máxima de sus hijos para determinar si han fallecido o no.";
$pgv_lang["SHOW_GEDCOM_RECORD"] = "Permitir ver los registros originales del GEDCOM a los usuarios";
$pgv_lang["SHOW_GEDCOM_RECORD_help"] = "Seleccionando \"Sí\" aparecerán vínculos en las páginas de personas, fuentes y familias que permitirán a los usuarios abrir una nueva ventana que permitirá visualizar los datos originales del archivo GEDCOM.";
$pgv_lang["ALLOW_EDIT_GEDCOM"] = "Activar Edición en línea";
$pgv_lang["ALLOW_EDIT_GEDCOM_help"] = "Permite la edición en línea; para este GEDCOM, así los usuarios con privilegio de edición podrán modificar el contenido del GEDCOM en línea.";
$pgv_lang["INDEX_DIRECTORY"] = "Directorio de los archivos de índice";
$pgv_lang["INDEX_DIRECTORY_help"] = "La ruta a un directorio de lectura y escritura, donde PhpGedView guardará los archivos de índices (incluya la \"/\" final).";
$pgv_lang["ALPHA_INDEX_LISTS"] = "Fraccionar las listas largas por la primera letra";
$pgv_lang["ALPHA_INDEX_LISTS_help"] = "Para listas muy largas de personas y familias, seleccione \"Sí\" para fraccionar el listado en páginas ordenadas por la primera letra del apellido.";
...
$pgv_lang["ENABLE_CLIPPINGS_CART_help"] = "El Carrito Genealógico permite a los visitantes de su sitio añadir la información de personas a un archivo GEDCOM que luego podrán descargar e importar en su propio programa de genealogía.";
...
$pgv_lang["FAVICON_help"] = "Indique aquí la ubicación donde se encuentra el icono que quiere que aparezca en el menú Favoritos del navegador del usuario, cuando un visitante agregue el vínculo (marcador) de su sitio.";
...
$pgv_lang["PGV_SESSION_SAVE_PATH_help"] = "La ruta para guardar los archivos de sesión de PhpGedView.<br />Algunos servidores no tienen PHP configurado adecuadamente y las sesiones no se mantienen entre solicitudes de página. Permite a los administradores del sitio evitarlo, grabando el archivo en uno de sus directorios locales.<br />Si necesita cambiarlo, el directorio ./index/ es una buena opción. Por omisión el campo estará vacío, que utilizará la ruta configurada en el archivo php.ini.";
$pgv_lang["SERVER_URL"] = "URL del servidor";
$pgv_lang["SERVER_URL_help"] = "Si utiliza https o un puerto distinto al de por omisión, necesitará ingresar aquí el URL para acceder a su servidor.";
$pgv_lang["PGV_SIMPLE_MAIL_help"] = "En encabezamientos normales para correos externos, se utilizan la dirrección de correo y el nombre. Algunos sistemas de correo no lo aceptan. Optando por si, sólo se utilizará la dirrección de correo.";
...
$pgv_lang["PGV_SESSION_TIME_help"] = "El tiempo en segundos que la sesión de PhpGedView permanece activa antes de requerir nuevamente la contraseña. Por omisión, es de 2 horas.";
$pgv_lang["SHOW_STATS"] = "Mostrar Estadísticas de Ejecución";
$pgv_lang["SHOW_STATS_help"] = "Muestra el tiempo demorado en la ejecución de la página y las consultas a la base de datos al pié de cada página.";
$pgv_lang["SHOW_COUNTER"]	= "Mostrar contadores de aciertos";
$pgv_lang["SHOW_COUNTER_help"]	= "Muestra contadores de aciertos en el portal y páginas individuales.";
...
$pgv_lang["ALLOW_THEME_DROPDOWN_help"]	= "Permite al usuario seleccionar su propio tema desde un menu descolgable (si está implemetado en el tema)<br />Require qe la variable ALLOW_USER_THEMES esté seleccionada como verdadera.";
$pgv_lang["ALLOW_THEME_DROPDOWN"]		= "Mostrar el selector de Temas descolgable, para cambiar el Tema.";
$pgv_lang["USE_REGISTRATION_MODULE_help"] = "Proporciona a los usuarios la opción de autorregistrarse en el sitio.<br /><br />El visitante recibirá un correo electrónico con el código para verificar su solicitud.<br />Después de la verificación el administrador deberá aprobar la registración para que sea válida.";
$pgv_lang["ALLOW_USER_THEMES"] = "Permitir a los usuarios elegir su propio tema.";
$pgv_lang["ALLOW_USER_THEMES_help"] = "Proporciona a los usuarios la opción de seleccionar su propio tema.";
$pgv_lang["CREATE_GENDEX"] = "Crea archivos GENDEX";
$pgv_lang["CREATE_GENDEX_help"] = "Activa la posibilidad de generar archivos GENDEX cuando se importa un archivo GEDCOM. Los archivos Gendex se almacenan en el directorio <b>./index</b>.";
...
$pgv_lang["LOGFILE_CREATE_help"] = "Frecuencia con la que el programa deberá guardar archivos de registro de las operaciones realizadas.";
$pgv_lang["PGV_MEMORY_LIMIT"]	= "Límite máximo de memoria.";
$pgv_lang["PGV_MEMORY_LIMIT_help"]	= "La cantidad máxima de memoria utilizable por las funciones de PhpGedView. Por omisión es 16Mb. Muchos 'hosts' deshabilitan esta opción en su configuración PHP; de tal forma, un cambio en este valor puede no afectar el ajuste de memoria máxima.";
$pgv_lang["PGV_STORE_MESSAGES"]	= "Permitir el archivo de mensajes en línea:";
$pgv_lang["PGV_STORE_MESSAGES_help"] = "Especifica si los mensajes enviados por PhpGedView serán archivados en la base de datos. Establecido en Sí, permitirá a los usuarios recuperar sus mensajes cuando ingresen a PGV. Si está establecido en No, sólo se enviarán mensajes por correo electrónico.";
...
$pgv_lang["SHOW_LIVING_NAMES_help"] = "Mostrar nombres de personas vivas<br /><br />Los nombres de las personas vivas deben mostrarse al público";
$pgv_lang["SHOW_RESEARCH_LOG_help"] = "Mostrar el Registro de Investigación<br /><br />Qué tipo de usuario puede ver el Registro de Investigación si está instalado.";
$pgv_lang["USE_RELATIONSHIP_PRIVACY_help"] = "Usar privacidad de parentesco<br /><br />Un valor \"No\" significa que los usuarios registrados pueden ver los detalles de todas las personas vivas.<br />Un valor \"Sí\" significa que los usuarios sólo pueden ver los detalles de las personas vivas de las cuales son parientes.";
$pgv_lang["MAX_RELATION_PATH_LENGTH_help"] = "Máxima longitud de la línea de parentesco.<br /><br />Si está activada #pgv_lang[USE_RELATIONSHIP_PRIVACY] los usuarios registrados que hayan ingresado, sólo podrán ver y editar individuos comprendidos dentro de este nivel de parentesco.";
$pgv_lang["CHECK_MARRIAGE_RELATIONS_help"] = "Controlar parentesco por matrimonio<br /><br />Controla el parentesco político por matrimonio.";

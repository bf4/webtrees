...
$pgv_lang["upload_a_gedcom"] 		= "Envoyer un fichier GEDCOM";
...
$pgv_lang["get_started_instructions"]	= "Choisissez l'une des options ci-dessous pour commencer à utiliser PhpGedView";
$pgv_lang["admin_users_exists"]		= "Les utilisateurs administrateurs suivants exsitent déjà";
$pgv_lang["install_step_1"] = "Vérifiez l'environnement";
$pgv_lang["install_step_2"] = "Connexion à la base de données";
$pgv_lang["install_step_3"] = "Créer des tableaux";
...
$pgv_lang["install_step_7"] = "Créer un utilisateur administrateur";
$pgv_lang["install_wizard"] = "Assistant d'installation";
$pgv_lang["basic_site_config"] = "Paramètres de base";
$pgv_lang["adv_site_config"] = "Paramètres avancés";
$pgv_lang["config_not_saved"] = "*Vos paramètres ne <br /> seront pas sauvegardés avant l'étape 6";
$pgv_lang["download_config"] = "Télécharger config.php";
$pgv_lang["site_unavailable"] = "Le site est actuellement indisponible";
$pgv_lang["to_manage_users"] = "Pour administrer les utilisateurs, utilisez la page d'Administration des utilisateurs </ a>.";
$pgv_lang["db_tables_created"] = "Tables de base de données créée avec succès";
$pgv_lang["db_tables_created"] = "";
$pgv_lang["db_tables_created"] = "Les tables de la base de données ont été créées avec succès";
$pgv_lang["config_saved"] = "Configuration sauvegardée avec succès";
$pgv_lang["checking_errors"]		= "Vérification des erreurs ...";
$pgv_lang["checking_php_version"]		= "Vérification de la version PHP requise:";
$pgv_lang["failed"]		= "Échec";
$pgv_lang["using_php_version"]		= "Vous utilisez la version PHP";
$pgv_lang["checking_db_support"]		= "Vérification du soutien minimum de la base de données :";
$pgv_lang["no_db_extensions"]		= "Vous n'avez aucune des extensions de base de données supportées";
$pgv_lang["db_ext_support"]		= "Vous avez le support  #DBEXT# ";
$pgv_lang["checking_config.php"]		= "Vérification de config.php:";
$pgv_lang["config.php_missing"]		= "Le fichier config.php n'a pas été trouvé.";
$pgv_lang["config.php_not_writable"]		= "config.php ne peut pas être modifié.";
$pgv_lang["passed"]		= "Passée";
$pgv_lang["config.php_writable"]		= "config.php est présent et peut être modifié.";
...
$pgv_lang["pgv_requires_version"]		= "PhpGedView nécessite la version PHP ".PGV_REQUIRED_PHP_VERSION." ou une version supérieure.";

...
$pgv_lang["upload_path_help"]		= "~Cesta načítania~<br /><br />To je cesta ku GEDCOM súboru, ktorý chcete načítať. Pre nájdenie cesty, kliknite na <b>Prehliadať</b>, nájdite váš GEDCOM súbor a potom kliknite na <b>Otvoriť</b>.";
...
$pgv_lang["AUTO_GENERATE_THUMBS_help"]	= "|~Automaticky generovať náhľady~<br /><br />Systém by mal automaticky generovať náhľady pre obrázky, ktoré ich nemajú. Vaša PHP inštalácia nepodporuje túto funkčnosť.<br />";
$pgv_lang["phpinfo_help"]		= "~PHPInfo~<br /><br />Táto stránka poskytuje rozšírené informácie o servere na ktorom je hostovaný  PhpGedView. Veľa konfiguračných detailov o softvare na servere, ktorý je relevantný pre PHP a PhpGedView, môže byť zobrazených.<br />";
$pgv_lang["config_help_help"]		= "~Nápoveda konfigurácie~<br /><br />Táto stránka odsahuje hlavné položky nápovedy Konfigurácie. Môžete si infiormácie zobraziť, alebo vytlačiť pre neskoršie použitie.<br />";
...
$pgv_lang["THUMBNAIL_WIDTH_help"]	= "~Šírka generovaných náhľadov~<br /><br />Toto je šírka (v pixeloch) ktorú program použije keď automaticky generuje náhľady. Implicitné nastavenie je 100.<br />";
...
$pgv_lang["SHOW_RELATIVES_EVENTS_help"] 	= "~Zobraziť udalosti blízkych príbuzných na stránke osoby~<br /><br />Narodenia, sobáše a úmrtia príbuzných sú dôležité udalosti v živote. Táto voľba riadi či sú alebo nie sú zobrazené tieto udalosti na záložke  <i>Osobné údaje a detaily</i> na stránke osoby.<br /><br />Udalosti ovplyvnené touto voľbou sú:<ul><li>Úmrtie partnera</li><li>Narodenie a úmrtie detí</li><li>Úmrtie rodičov</li><li>Narodenie a úmrtie súrodencov</li><li>Úmrtie starých rodičov</li><li>Narodenie a úmrtie súrodencov rodičov</li></ul><br />";
$pgv_lang["EXPAND_RELATIVES_EVENTS"]    	= "Automaticky ukázať zoznam udalostí";
$pgv_lang["EXPAND_RELATIVES_EVENTS_help"] 	= "~Automaticky ukázať zoznam udalostí~<br /><br />Táto voľba určuje či bude alebo nebude automaticky zobrazený obsah zoznamu <i>Udalosti blízkych príbuzných</i>.<br />";
$pgv_lang["EXPAND_SOURCES"]      		= "Automaticky zobraziť zdroje";
$pgv_lang["EXPAND_SOURCES_help"] 		= "~Automaticky zobraziť zdroje~<br /><br />Táto voľba určuje či bude alebo nebude automaticky zobrazený obsah záznamov  <i>Zdroje</i> na stránke osoby.<br />";
...
$pgv_lang["EDIT_AUTOCLOSE_help"]	= "~Automaticky zatvoriť editačné okno~<br /><br />Táto voľba riadi či bude, alebo nebude automaticky zatvorené editačné okno po úspešnom uložení zmien.<br />";
...
$pgv_lang["POSTAL_CODE_help"] 		= "~Pozícia poštového smerovacieho čísla~<br /><br />Rôzne krajiny používajú rôzne spôsoby zápisu adries. Táto voľba vám umožňuje nastaviť umiestnenie PSČ buď pred, alebo za meno mesta.<br />";
$pgv_lang["SUBLIST_TRIGGER_I"]		= "Maximálny počet priezvísk";
$pgv_lang["SUBLIST_TRIGGER_I_help"]	= "~Maximálny počet priezvísk~<br /><br />Dlhý zoznam osôb s rovnakým priezviskom môže byť rozdelený na menšie podľa prvého písmena v mene osôb.<br /><br />Táto voľba určuje kedy sa zobrazí rozdelený zoznam. Nastavte hodnotu na nulu, ak chcete rozdelenie úplne vypnúť.<br />";
$pgv_lang["SUBLIST_TRIGGER_F"]		= "Maximálny počet priezvísk rodin";
$pgv_lang["SUBLIST_TRIGGER_F_help"]	= "~Maximálny počet priezvísk rodin~<br /><br />Dlhý zoznam rodín s rovnakým priezviskom môže byť rozdelený na menšie podľa prvého písmena v mene osôb.<br /><br />Táto voľba určuje kedy sa zobrazí rozdelený zoznam. Nastavte hodnotu na nulu, ak chcete rozdelenie úplne vypnúť.<br />";
$pgv_lang["SURNAME_LIST_STYLE"]		= "Štýl zoznamu priezvísk";
$pgv_lang["SURNAME_LIST_STYLE_help"]	= "~Štýl zoznamu priezvísk~<br /><br />Zoznam priezvísk, ktorý sa zobrazí v bloku Blok priezvísk Top-10,  Zoznam osôb, a v Zoznam rodín, môže byť zobrazený v roznych štýloch.<ul><li><b>Tabuľka</b>&nbsp;&nbsp;&nbsp;V tomto štýle sú priezviská zobrazené v tabuľke, ktorá môže byť triedená buď podľa priezviska, alebo podľa výskytu.</li><li><b>Zoznam</b>&nbsp;&nbsp;&nbsp;V tomto štýle sú priezviská zobrazené v zozname a veľkosť fontu použitá pre každé meno je závislá od počtu výskytu mena v databazi. Zoznam nie je možné triediť.</li></ul><br />";
...
$pgv_lang["SHOW_LAST_CHANGE_help"]	= "~Zobraziť zoznam GEDCOM záznamov s posledným dátumom zmeny~<br /><br />Táto voľba riadi či sa má, alebo nemá zobraziť zoznam GEDCOM záznamov s posledným dátumom zmeny.<br />";
...
$pgv_lang["SHOW_MEDIA_FILENAME_help"]	= "~Zobraziť mená súborov v Media Viewer~<br /><br />Media Viewer môže zobraziť mená súborov Médií, keď sú zobrazené. Táto voľba určuje či uživatelia uvidia mená súborov alebo nie.<br /><br />Môžete ukryť mená súborov z dôvodu ochrany.<br /><br />";
$pgv_lang["SHOW_MEDIA_DOWNLOAD"]		= "Zobraziť linky v  Media Viewer";
$pgv_lang["SHOW_MEDIA_DOWNLOAD_help"]	= "~Zobraziť linky v  Media Viewer~<br /><br />Media Viewer môže zobraziť linky, kliknutím na ne môžete načítať súbory médií na lokálne PC.<br /><br />Môžete ukryť linky z dôvodu ochrany.<br /><br />";
...
$pgv_lang["SHOW_FACT_ICONS_help"]	= "~Zobraziť ikonu Údaj~<br /><br />Nastavte na <b>Ano</b> pre zobrazenie ikon vedľa mena údaja na stránke Osobné údaje a podrobnosti. Ikony údajov budú zobrazené iba vtedy, ak existujú v adresári <i>images/facts</i> pre aktuálny motív.<br />";
...
$pgv_lang["return_editconfig"]			= "Ku konfigurovaniu sa môžete kedykoľvek vrátiť, keď otvoríte v prehliadači súbor <i>edit_config.php</i> alebo kliknete na odkaz <b>Konfigurácia</b> na stránke <b>Administrácia GEDCOM</b><br />";
$pgv_lang["return_editconfig_gedcom"]		= "Ku konfigurovaní sa môžete kedykoľvek vrátiť kliknutím na odkaz: <b>Upraviť</b> v tabuľke <b>Súčasné GEDCOM súbory</b> alebo na stránke <b>Administrácia GEDCOM</b> alebo otvorením súboru </i>editconfig_gedcom.php</i> vo svojom prehliadači.<br />";
...
$pgv_lang["SHOW_RESEARCH_ASSISTANT_help"]	= "~Zobraziť bádateľského asistenta~<br /><br />Ktorý typ uživateľa môže vidieť modul Bádateľský asistent, ak je tento nainštalovaný?";
...
$pgv_lang["lang_debug_help"]		= "~Voľba Help Text Debug~<br /><br />Ak zaktivujete túto voľbu, názvy jazykových premenných použitých v texte, budú zobrazené v okne nápovedy. To pomôže prekladateľom určiť názov premennej v prípade, že text musí byť upravený.<br /><br />Toto nastavenie je platné iba pre vaše aktuálne PhpGedView okno.<br />";
...
$pgv_lang["language_to_export_help"]	= "~Jazyk na exportovanie~<br /><br />Z tohoto zoznamu si môžete vybrať jazyk, ktorého texty chcete exportovať.<br /><br />Program exportuje iba obsah súboru <i>configure_help_text.php</i>. Výstupom je HTML súbor, ktorý si môžete vytlačť z vašeho prehliadača.<br />";
...
$pgv_lang["compare_lang_utility_help"]	= "~Pomôcka pre porovnávanie jazykových súborov~<br /><br />Tento modul porovná dva jazykové súbory a vytvorí zoznam rozdielov medzi nimi.<br />O všetkých zmenách v Anglickej verzii si prečítajte v súbore [<a href=\"languages/LANG_CHANGELOG.txt\" target=\"_blank\">LANG_CHANGELOG.txt</a>]. Anglické verzie jazykových súborov sú používané ako referenčné pre všetky ďalšie jazyky.<br />";
...
$pgv_lang["lang_filenames_help"]	= "~Jazykové súbory~<br /><br />~Typ jazykového súboru, ktorý sa má upraviť~<br /><br />PhpGedView má implementovanú podporu pre mnoho rôznych jazykov. To je urobené tak, že všetky texty, ktoré sa zobrazujú uživateľom sú uložené v súboroch oddelených od hlavného programu. Pre každý podporovaný jazyk je určená sada piatich súborov a variabilný text je uložený podľa funkcie v jednom z týchto súborov. V prípade, že text ešte nie je preložený PhpGedView použije anglickú verziu. .<br /><br />Súbory v každom jazykovej sade sú:<br /><ul><li><b><i>configure_help.xx.php</i></b>&nbsp;&nbsp;Tento súbor obsahuje termíny, obvyklé výrazy, a Help texty použité v priebehu konfigurácie PhpGedView. Help texty nie sú určené k zobrazeniu bežným uživateľom.</li><br /><li><b><i>countries.xx.php</i></b>&nbsp;&nbsp;Tento súbor obsahuje zoznam mien štátov a krajov z Web stránky úradu  Statistics Division, United Nations Department of Economic and Social Affairs. To je relevantné <a href=\"http://unstats.un.org/unsd/methods/m49/m49alpha.htm\" target=_blank><b>link</b></a> pre anglický zoznam. Zoznam je dostupný v angličtine alebo francúzštine.</li><br /><li><b><i>facts.xx.php</i></b>&nbsp;&nbsp;Tento súbor obsahuje textové ekvivalenty kódov GEDCOM údajov obsiahnutých v GEDCOM 5.5.1 Standard. Tiež obsahuje dodatočné kódy údajov ktoré nie sú v GEDCOM Standard ale sú používané v rôznych genealogických programoch.<br /><br />Anglickú kópiu Gedcom Standard si môžete stiahnuť vo formáte PDF z adrey <a href=\"http://www.phpgedview.net/ged551-5.pdf\" target=_blank><b>GEDCOM 5.5.1 Standard</b></a>.</li><br /><li><b><i>help_text.xx.php</i></b>&nbsp;&nbsp;Tento súbor obsahuje Help texty pre bežných uživateľov. Niektoré z týchto textov su určené administrátorom a sú skryté uživateľom, ktorý nemajú administrátorské práva.</li><br /><li><b><i>lang.xx.php</i></b>&nbsp;&nbsp;Veľa termínov a obvyklých výrazov je uložených v tomto súbore.</li></ul>";
...
$pgv_lang["um_tool_help"] 		= "~Nástroj pre presun informácií o uživateľoch~<br /><br />Tento nástroj exportuje uživateľské dáta z SQL do Index módu, alebo opačne z Index módu do tabuliek SQL.<br /><br />Uživateľské dáta, obľúbené, definície blokov, správy a novinky budú opäť dostupné po skončení importu.<br /><br />POZOR.<br /><br />Nemôžete použiť tento nástroj na prenos dát medzi rôznymi verziami PhpGedView.<br /><br />IMPORT.<br /><br />Ak vyberiete možnost importu uživateľských datových súborov z Index módu, všetky uživateľské dáta v databázy budú <u>prepísané</u>. Tento nástroj nespojuje dáta. Keď spustíte import, nie je žiadna možnosť ako sa dostať k starým dáta pomocou PhPGedView.<br /><br /><b>EXPORT</b><br />Ak exportujete uživateľské dáta zvašej SQL databázy do Index Mód súborov, vytvorí sa  </i>authenticate.php</i> a ďalšie <i>.dat</i> súbory vo vašom index adresári. V prípade, že tu už existujú súbory rovnakého mena program vás vyzve k potvrdeniu či ich môže prepísať. Po preponutí do Index módu sú všetky dáta okamžite dostupné.<br /><br /><b>Poznámka:</b> Po prepnutí do Index Módu musíte urobiť opäť import vášho GEDCOM súboru.<br /><br />";
$pgv_lang["um_sql_index_help"] 		= "~Presunúť uživateľov z SQL do Index módu~<br /><br />Tento nástroj vytvorí <i>authenticate.php</i> a niekoľko ďaľších <i>.dat</i> súborov vo vašom index adresári. Po vytvorení môžete prepnúť všetkých uživateľov a ich správy, obľúbené, novinky a MyGedView layout do Index módu.<br /><br />Poznámka: Po prepnutí do Index módu musíte tiež importovať váš GEDCOM súbor ešte raz.<br /><br />";
$pgv_lang["um_index_sql_help"] 		= "~Presunúť uživateľov z Index do SQL módu~<br /><br />Tento nástroj importuje <i>authenticate.php</i> a ďaľšie <i>.dat</i> súbory z vašeho index adresára do vašej databázy.";
...
$pgv_lang["um_bu_help"] 		= "~Záloha (backup)~<br /><br />Tento nástroj môže urobiť zálohu niektorých dát z PhpGedView. Dáta ktoré vyberiete budú skopírované do ZIP súboru, tento súbor môžete načítať na ľubovolné miesto. ZIP súbor je uložený vo vašom index adresári, až dokiaľ ho nezmažete manuálne.";
...
$pgv_lang["preview_faq_item_help"] 	= "~Zobraziť všetky položky FAQ~<br />Táto voľba umožňuje administrátorovi zobraziť stránku FAQ bez editačných volieb a linkov.<br /><br /> Okrem jedného tlačítka <b>Upraviť</b> nad prvou položkou FAQ bude zobrazenie stránky FAQ rovnaké ako ho uvidia obyčajný uživatelia. Toto špeciálne tlačítko <b>Upraviť</b> vás vráti do plnej funkčnosti Upraviť.<br />";
$pgv_lang["restore_faq_edits"] 		= "Obnoviť funkčnosť Upraviť FAQ";
$pgv_lang["restore_faq_edits_help"] 	= "~Obnoviť funkčnosť Upraviť FAQ~<br />Táto voľba obnoví stránku FAQ do režimu ako ju vidí obvykle administrátor, tak že jednotlivé položky FAQ môžu byť editované.<br />";
$pgv_lang["add_faq_item"] 		= "Pridať položku FAQ";
$pgv_lang["add_faq_item_help"] 		= "~Pridať položku FAQ~<br />Táto voľba vám umožňuje pridať položku na stránku FAQ.<br />";
$pgv_lang["edit_faq_item"] 		= "Upraviť položku FAQ";
$pgv_lang["edit_faq_item_help"] 	= "~Upraviť položku FAQ~<br />Táto voľba vám umožňuje upraviť položku na stránke FAQ.<br />";
$pgv_lang["delete_faq_item"] 		= "Zmazať položku FAQ";
$pgv_lang["delete_faq_item_help"] 	= "~Zmazať položku FAQ~<br />Táto voľba vám umožňuje zmazať položku na stránke FAQ<br />";
$pgv_lang["moveup_faq_item"] 		= "Presunúť položku FAQ hore";
$pgv_lang["moveup_faq_item_help"] 	= "~Presunúť položku FAQ hore~<br />Táto voľba vám umožní presunúť položku vyššie na stránke FAQ.<br /><br />Vždy keď použijete túto možnosť bude číslo pozície položky FAQ zmenšené o 1. Rovnaký efekt môžete dosiahnúť priamo zmenou čísla pozície položky FAQ. Pozor ak viacej položiek FAQ má rovnaké číslo tak bude zobrazená iba jedna.<br />";
$pgv_lang["movedown_faq_item"] 		= "Presunúť položku FAQ dole";
$pgv_lang["movedown_faq_item_help"] 	= "~Presunúť položku FAQ dole~<br />Táto voľba vám umožní presunúť položku nižšiee na stránke FAQ.<br /><br />Vždy keď použijete túto možnosť bude číslo pozície položky FAQ zväčšené o 1. Rovnaký efekt môžete dosiahnúť priamo zmenou čísla pozície položky FAQ. Pozor ak viacej položiek FAQ má rovnaké číslo tak bude zobrazená iba jedna.<br />";
...
$pgv_lang["add_faq_visibility_help"] = "~FAQ - zobrazenie~<br />Môžete určiť či FAQ bude zobrazené nbez ohľadu na GEDCOMe, alebo či bude zobrazné iba z aktuálnym GEDCOMom.<br /><ul><li><b>Všetky</b>&nbsp;&nbsp;&nbsp;FAQ bude zobrazené na zozname všetkých FAQ, bez ohľadu na GEDCOM.</li><li><b>#GLOBALS[GEDCOM]#</b>&nbsp;&nbsp;&nbsp;FAQ bude zobrazené iba na zozname FAQ aktuálneho aktívneho GEDCOMu.</li></ul><br />";
$pgv_lang["time_limit_help"]		= "~Časový limit:~<br /><br />Maximálny čas importu, ktorý je povolený na zpracovanie GEDCOM súboru.";
...
$pgv_lang["CHANGELOG_CREATE_help"]	= "~Archivácia ChangeLog súborov~<br /><br />Ako často má program archivovať Changelog súbory.";
...
$pgv_lang["LANG_SELECTION_help"]	= "~Podporované jazyky~<br /><br />Môžete zmeniť zoznam jazykov podporovaných vašimi PhpGedView stránkami označením alebo odznačením príslušného jazyka. Vaši uživatelia si potom môžu vyberať jazyk.<br /><br />To isté môžete urobiť pomocou linku <b>Konfigurovať podporované jazyky</b> v menu Admin, kde tiež môžete meniť nastavenia ako je ikona zástavy jazyka, formát datumu alebo či má byť zobrazované priezvisko ako prvé.<br />";
$pgv_lang["MEDIA_ID_PREFIX"]		= "Média&nbsp;ID prefix";
$pgv_lang["MEDIA_ID_PREFIX_help"]	= "~Média&nbsp;ID prefix~<br /><br />Keď je pridaný online nový mediálny záznam do PhpGedView je automaticky generované ID. Toto ID bude mať zadaný prefix.<br />";
$pgv_lang["new_gedcom_title"]		= "Genealógia z [#GEDCOMFILE#]";
$pgv_lang["USE_MEDIA_VIEWER"]		= "Použiť Media Viewer";
$pgv_lang["USE_MEDIA_VIEWER_help"]	= "~Použiť Media Viewer~<br /><br />Nastavte túto hodnotu na <b>Ano</b>, ak uživatelia kliknú na obrázky na vašej stránke otvorí sa stránka Media View obsiahnuté vo verzii 4.1. Stránka Media View zobrazí detaily obrázku a umožní upraviť obrázok. <br /><br />Nastavenie hodnoty na <b>Nie</b> poskytne zobrazenie vo formáte predchádzajúcich verzií PhpGedView pred verziou 4.1 Ak kliknete na obrázok tak sa otvorí v plnom rozlíšení v novom okne.<br /><br />";
$pgv_lang["USE_MEDIA_FIREWALL"]		= "Použiť Media Firewall";
$pgv_lang["USE_MEDIA_FIREWALL_help"]	= "~Použiť Media Firewall~<br /><br />Prečítajte si vo Wiki popis ako použiť Media Firewall. <a href=\"http://wiki.phpgedview.net/en/index.php/Media_Firewall\" target=\"_blank\">http://wiki.phpgedview.net/en/index.php/Media_Firewall</a><br /><br />";
$pgv_lang["MEDIA_FIREWALL_ROOTDIR"]			= "Koreňový adresár Media Firewallu";
$pgv_lang["MEDIA_FIREWALL_ROOTDIR_help"]	= "~Koreňový adresár Media Firewallu~<br /><br />Adresár v ktorom môže byť založený zabezpečený adresár Médií. Ak je toto pole prázdne, tak bude použitý adresár <b>#GLOBALS[INDEX_DIRECTORY]#</b>.<br /><br />";
$pgv_lang["SYNC_GEDCOM_FILE_help"] 	= "~Synchronizovať zmeny v súbore GEDCOM~<br /><br />V starších verziách PGV čakajúce zmeny boli ukladané v súbore GEDCOM a zmenené záznamy, ktoré boli 'akceptované' v databáze. Počínajúc verziou 4.1 už nie sú čakajúce zmeny ukladané v súbore GEDCOM ale v súbore zmien. <br /><br />Nastavenie tejto hodnoty na ano spôsobí aktualizáciu súboru GEDCOM keď budú zmeny akceptované v databáze. To udrží súbor GEDCOM synchronizovaný s databázou. Pre väčšiu kompatibilitu s predošlými verziami je default hodnota tohoto pola nastavená na ano.<br /><br />Môžete ju prestaviť na nie ak chcete šetriť pamäťou, keď akceptujete zmeny.<br />";
$pgv_lang["SYNC_GEDCOM_FILE"]		= "Synchronizovať zmeny v súbore GEDCOM";
$pgv_lang["COMMIT_COMMAND_help"] 	= "~Príkaz na riadenie verzií~<br /><br />Ak si želáte použiť riadenie verzií ako napríklad CVS na archiváciu zmien vo vašom GEDCOMe, konfigurácie alebo nastavenia utajenia, zadajte príkaz sem. Ponechajte box prázdny ak nechcete použiť systém riadenia verzií. Platné voľby sú <b>cvs</b> and <b>svn</b>.<br />";
$pgv_lang["COMMIT_COMMAND"] 		= "Príkaz na riadenie verzií";
$pgv_lang["SHOW_MULTISITE_SEARCH_help"]	= "~Zobraziť mnohostránkové vyhľadanie~<br /><br />Mnohostránové vyhľadávanie dovolí uživateľom hľadať naprieč stránkami PhpGedView ktoré máte nastavené administrátorom v Správe stránok alebo ktoré sú vzdialene pripojené. Táto voľba určuje či je mnohostránkové hľadanie povolené pre všetkých alebo iba pre autorizavaných užívateľov.<br />";
...
$pgv_lang["SHOW_NO_WATERMARK_help"]		= "~Kto môže vidieť obrázky bez vodoznaku?~<br /><br />Ak je aktívny Media Firewall, užívatelia uvidia vodoznak ak nemajú oprávnenia na úrovni špecifikovanej tu.<br />";
$pgv_lang["WATERMARK_THUMB"]			= "Pridať vodoznak do náhľadov?";
$pgv_lang["WATERMARK_THUMB_help"]		= "~Pridať vodoznak do náhľadov?~<br /><br />Majú byť náhľady označené vodoznakom ak je aktívny Media Firewall? Váš zoznam médií bude načítaný rýchlejšie bez vodoznaku.<br />";
?>

...
$pgv_lang["DBTYPE_help"]		= "Typ podporovanej PEAR databázy, ku ktorej sa má pripojiť. Možnosti sú: MySQL, PostgreSQL, Oracle a SQLite. MySQL a PostgreSQL vyžadujú knihovňu inštalovanú v PHP. SQLite je inštalovaná ako implicitná v PHP 5.<br /><br />Pre SQLite nemusíte mať nastavené Host databáza, Uživateľské meno ku databáze, alebo Heslo ku databáze, Ale musíte mať nastavenú  cestu ku vašej databáze v poli Meno databázy.";
...
$pgv_lang["DBPASS_help"]		= "Heslo ku databáze pre uživateľa, ktorého uživateľské meno ste zadali do políčka Uživateľské meno ku databáze.Toto nastavenie je ignorované ak používate SQLite databázu.";
$pgv_lang["DBNAME"]			= "Meno databázy";
$pgv_lang["DBNAME_help"]		= "Databáza na vašom serveri, ktorú má PhpGedView použiť.<br /><br />Uživateľ, ktorého uživateľské meno jste zadali do políčka Uživateľské meno ku databáze, musí mať práva Vytvoriť, Vložiť, Obnoviť, Zmazať a Vyberať z databázy. Pre SQLite musíte nastaviť súbor a adresár, pre ktorým má PHP právo zapisovať, napríklad váš indexový adresár (index/phpgedview.db).";
...
$pgv_lang["upload_path_help"]		= "To je cesta ku GEDCOM súboru, ktorý chcete načítať. Pre nájdenie cesty, kliknite na <b>Prehliadať</b>, nájdite váš GEDCOM súbor a potom kliknite na <b>Otvoriť</b>.";
...
$pgv_lang["LANGUAGE_help"]		= "Určite implicitný jazyk pre svoje stránky. Uživatelia majú možnosť si toto nastavenie zmeniť buď pomocou nastavenia prehliadača alebo formulárom dolu na stránke (ak je nastavené <b>Povoliť uživateľom zmenu jazyka</b>= true).";
...
$pgv_lang["AUTO_GENERATE_THUMBS_help"]	= "|~Automaticky generovať náhľady~<br /><br />Systém by mal automaticky generovať náhľady pre obrázky, ktoré ich nemajú. Vaša PHP inštalácia nepodporuje túto funkčnosť.";
$pgv_lang["phpinfo_help"]		= "Táto stránka poskytuje rozšírené informácie o servere na ktorom je hostovaný  PhpGedView. Veľa konfiguračných detailov o softvare na servere, ktorý je relevantný pre PHP a PhpGedView, môže byť zobrazených.";
$pgv_lang["config_help_help"]		= "Táto stránka odsahuje hlavné položky nápovedy Konfigurácie. Môžete si infiormácie zobraziť, alebo vytlačiť pre neskoršie použitie.";
$pgv_lang["more_help_advice"]		= "<br /><b>Ďalšia nápoveda</b><br />Ďalšia nápoveda je dostupná po kliknutí na <b>?</b> vedľa položky na stránke.";
$pgv_lang["THUMBNAIL_WIDTH"]		= "Šírka generovaných náhľadov";
$pgv_lang["THUMBNAIL_WIDTH_help"]	= "Toto je šírka (v pixeloch) ktorú program použije keď automaticky generuje náhľady. Implicitné nastavenie je 100.";
...
$pgv_lang["ZOOM_BOXES_help"]		= "Umožňuje uživateľovi zväčšiť jednotlivé políčka (rámčeky) v rodokmeni a získať viacej informácií. Ak chcete túto vlastnosť vypnúť, nastavte <b>Vypnuté</b>. Ak nastavíte na <b>Po prejdení myšou</b>, zväčší sa rámček, keď uživateľ prejede cez ikonku v rámčeku kurzorom. Ak nastavíte na <b>Po kliknutí myšou</b>, zväčší sa rámček, keď uživateľ klikne na ikonku v rámčeku.";
$pgv_lang["LINK_ICONS"]			= "PopUp odkazy v schémach";
$pgv_lang["LINK_ICONS_help"]		= "Umožní uživateľovi vybrať odkaz na iné schémy a blízke príbuzné osoby.  Ak nastavíte <b>Vypnuté</b>, táto vlastnosť bude vypnutá. Ak nastavíte <b>Po prejdení myšou</b>, odkazy sa zobrazia, keď uživateľ prejde kurzorom cez ikonku v rámčeku. Ak nastavíte <b>Po kliknutí myšou</b>, zobrazia sa odkazy v prípade, že uživateľ na ikonku klikne.";
...
$pgv_lang["SHOW_RELATIVES_EVENTS_help"] 	= "Narodenia, sobáše a úmrtia príbuzných sú dôležité udalosti v živote. Táto voľba riadi či sú alebo nie sú zobrazené tieto udalosti na záložke  <i>Osobné údaje a detaily</i> na stránke osoby.<br /><br />Udalosti ovplyvnené touto voľbou sú:<ul><li>Úmrtie partnera</li><li>Narodenie a úmrtie detí</li><li>Úmrtie rodičov</li><li>Narodenie a úmrtie súrodencov</li><li>Úmrtie starých rodičov</li><li>Narodenie a úmrtie súrodencov rodičov</li></ul>";
$pgv_lang["EXPAND_RELATIVES_EVENTS"]    	= "Automaticky ukázať zoznam udalostí";
$pgv_lang["EXPAND_RELATIVES_EVENTS_help"] 	= "Táto voľba určuje či bude alebo nebude automaticky zobrazený obsah zoznamu <i>Udalosti blízkych príbuzných</i>.";
$pgv_lang["EXPAND_SOURCES"]      		= "Automaticky zobraziť zdroje";
$pgv_lang["EXPAND_SOURCES_help"] 		= "Táto voľba určuje či bude alebo nebude automaticky zobrazený obsah záznamov  <i>Zdroje</i> na stránke osoby.";
...
$pgv_lang["WELCOME_TEXT_AUTH_MODE_help"]	= "Tu môžete zvoliť text, ktorý sa zobrazí na prihlasovacej stránke, ak je autorizačný mód nastavený na ano. Prosím, vyberte najvhodnejší prednastavený text.<br />Môžete zadať i svoj vlastný text, ale ten nebude mať preklad do iných jazykov.<br /><br />Prednastavené texty sú:<br /><br /><b>Prednastavený text, ktorý hovorí, že všetci uživatelia môžu zažiadať o zriadenie uživateľského účtu :</b><br /><br /><center><b>VITAJTE NA TÝCHTO RODOPISNÝCH STRÁNKACH</b></center><br />Prístup na tieto stránky je povolený všetkým návštevníkom, ktorý tu majú zriadený účet. Ak tu už máte svoj účet, môžete sa na tejto stránke prihlásiť.<br /><br />Ak ešte účet nemáte, môžete požiadať o založenie kliknutím na príslušný odkaz na tejto stránke.<br />Po overení zadaných údajov vám administrátor účet zprístupní. Oznámenie o zprístupnení obdržíte e-mailom.<br /><br /><b>Prednastavený text, ktorý hovorí, že administrátor rozhodne v prípade žiadosti o účet :</b><br /><br /><center><b>VITAJTE NA TÝCHTO RODOPISNÝCH STRÁNKÁCH</b></center><br/>Prístup na tieto stránky je umožnený iba <b>prihláseným</b> užívateľom.<br />Ak tu už máte svoj účet, môžete sa na tejto stránke prihlásiť.<br /><br />Ak ešte účet nemáte, môžete požiadať o založenie kliknutím na príslušný odkaz na tejto stránke.<br />Po overení zadaných údajov administrátor vašu žiadosť buď prijme, alebo zamietne.<br />Oznámenie o prijatí vašej žiadosti obdržíte e-mailom.<br /><br /><b>Prednastavený text, ktorý hovorí, že o zriadenie uživateľského účtu môžu žiadať iba členovia rodiny :</b><br /><br /><center><b>VITAJTE NA TÝCHTO RODOPISNÝCH STRÁNKACH</b></center><br />Prístup na tieto stránky je povolený iba <b>členom rodiny</b>.<br />Ak tu už máte svoj účet, môžete sa na tejto stránke prihlásiť.<br /><br />Ak ešte účet nemáte, môžete požiadať o založenie kliknutím na príslušný odkaz na tejto stránke.<br />Po overení zadaných údajov administrátor vašu žiadosť buď prijme, alebo odmietne.<br />Oznámenie o prijatí svojej žiadosti obdržíte e-mailom.";
...
$pgv_lang["WELCOME_TEXT_AUTH_MODE_CUST_HEAD_help"] = "Zvoľte túto možnosť, ak chcete mať pred svojím vlastným úvodným textom viacjazyčnú hlavičku.<br /><br />Ak je nastavené na \"ano\", hlavička bude vyzerať takto:<div class=\"list_value_wrap\"><center><b>VITAJTE NA TÝCHTO RODOPISNÝCH STRÁNKACH</b></center><br />Prístup na tieto stránky je umožnený iba užívateľom, ktorý tu majú zriadený svoj uživateľský účet z heslom.<br /></div>";
$pgv_lang["SHOW_REGISTER_CAUTION"]			= "Zobraziť uživateľov suhlas na stránke «Žiadosť o nový uživateľský účet».";
$pgv_lang["SHOW_REGISTER_CAUTION_help"]		= "Ak nastavíte <b>Ano</b>, zobrazí sa následujúca správa pod pod poľami «Zažiadať o nový uživateľský účet» na stránke:<div class=\"list_value_wrap\"><div class=\"largeError\">Poznámka:</div><div class=\"error\">Vyplnením a odoslanim tohoto formulára súhlasíte: <ul><li> s ochranou súkromia žijúcich osôb zobrazených na vašej stránke;</li><li>a v textovom okne nižšie, vysvetlite svoj príbuzenský vzťah k niektorej osobe z rodokmeňa, alebo nám poskytnite informácie o niekom kto je zobrazený na našej stránke.</li></ul></div></div>";
...
$pgv_lang["EDIT_AUTOCLOSE_help"]	= "Táto voľba riadi či bude, alebo nebude automaticky zatvorené editačné okno po úspešnom uložení zmien.";
...
$pgv_lang["POSTAL_CODE_help"] 		= "Rôzne krajiny používajú rôzne spôsoby zápisu adries. Táto voľba vám umožňuje nastaviť umiestnenie PSČ buď pred, alebo za meno mesta.";
$pgv_lang["SUBLIST_TRIGGER_I"]		= "Maximálny počet priezvísk";
$pgv_lang["SUBLIST_TRIGGER_I_help"]	= "Dlhý zoznam osôb s rovnakým priezviskom môže byť rozdelený na menšie podľa prvého písmena v mene osôb.<br /><br />Táto voľba určuje kedy sa zobrazí rozdelený zoznam. Nastavte hodnotu na nulu, ak chcete rozdelenie úplne vypnúť.";
$pgv_lang["SUBLIST_TRIGGER_F"]		= "Maximálny počet priezvísk rodin";
$pgv_lang["SUBLIST_TRIGGER_F_help"]	= "Dlhý zoznam rodín s rovnakým priezviskom môže byť rozdelený na menšie podľa prvého písmena v mene osôb.<br /><br />Táto voľba určuje kedy sa zobrazí rozdelený zoznam. Nastavte hodnotu na nulu, ak chcete rozdelenie úplne vypnúť.";
$pgv_lang["SURNAME_LIST_STYLE"]		= "Štýl zoznamu priezvísk";
$pgv_lang["SURNAME_LIST_STYLE_help"]	= "Zoznam priezvísk, ktorý sa zobrazí v bloku Blok priezvísk Top-10,  Zoznam osôb, a v Zoznam rodín, môže byť zobrazený v roznych štýloch.<ul><li><b>Tabuľka</b>&nbsp;&nbsp;&nbsp;V tomto štýle sú priezviská zobrazené v tabuľke, ktorá môže byť triedená buď podľa priezviska, alebo podľa výskytu.</li><li><b>Zoznam</b>&nbsp;&nbsp;&nbsp;V tomto štýle sú priezviská zobrazené v zozname a veľkosť fontu použitá pre každé meno je závislá od počtu výskytu mena v databazi. Zoznam nie je možné triediť.</li></ul>";
...
$pgv_lang["SHOW_LAST_CHANGE_help"]	= "Táto voľba riadi či sa má, alebo nemá zobraziť zoznam GEDCOM záznamov s posledným dátumom zmeny.";
...
$pgv_lang["SHOW_MEDIA_FILENAME_help"]	= "Media Viewer môže zobraziť mená súborov Médií, keď sú zobrazené. Táto voľba určuje či uživatelia uvidia mená súborov alebo nie.<br /><br />Môžete ukryť mená súborov z dôvodu ochrany.";
$pgv_lang["SHOW_MEDIA_DOWNLOAD"]		= "Zobraziť linky v  Media Viewer";
$pgv_lang["SHOW_MEDIA_DOWNLOAD_help"]	= "Media Viewer môže zobraziť linky, kliknutím na ne môžete načítať súbory médií na lokálne PC.<br /><br />Môžete ukryť linky z dôvodu ochrany.";
...
$pgv_lang["DAYS_TO_SHOW_LIMIT_help"] 	= "Vložte maximálny počet dní pre zobrazenie v bloku Aktuálnych udalostí. Toto číslo nesmie byť väčšie než 30. Ak zadáte väčšiu hodnotu bude použitá hodnotu 30.<br /><br />Hodnota ktorú sem vložíte určuje ako ďaleko dopredu PhpGedView hľadá aktuálne udalosti. Výsledky hľadania, vykonaného raz denne, sú zkopírované do dočasného súboru.<br /><br />Žiadne bloky Aktuálnych udalostí na Index alebo Portál stránkach nevyžadujú viac dní než je táto hodnota. Čím väčšiu hodnotu nastavíte, tým väčší bude denný výber z databázi a tým dlhšie budete čakať na zobrazenie ak požadujete zobraziť väčší počet dní než je toto nastavenie.";
...
$pgv_lang["CONTACT_METHOD_help"]	= "Spôsob, akým sa budú návštevníci obracať na \"Kontaktného uživateľa\" zo svojimi otázkami k rodokmeňu. Možnosť <b>Mailto link</b> znamená použitie e-mailového odkazu, na ktorý môžu návštevníci kliknúť a poslať e-mail cez svojho e-mailového klienta. Voľba <b>Interné správy PhpGedView</b> zaistí použitie systému zasielania správ vstavaného v PhpGedView bez použitia e-mailu. Voľba <b>Interné správy s e-mailami</b> je implicitná; ak je nastavená, použije sa vnútorný systém PhpGedView, avšak kópia správy sa odošle tiež e-mailom. Voľba <b>PhpGedView odosiela maily bez ukladania</b> umožní PhpGedView spracovávať správy a odosielať ich e-mailom, ale neumožní ukladanie správ do databázy. Ak zvolíte možnosť <b>Bez kontaktnej metódy</b>, nebudú vás môcť návštevníci vašich stránok kontaktovat.";
$pgv_lang["PHPGEDVIEW_EMAIL"]		= "PhpGedView adresa pre odpoveď";
$pgv_lang["PHPGEDVIEW_EMAIL_help"]	= "E-mail adresa bude použitá v poli &laquo;Od:&raquo; v e-mailoch ktoré PhpGedView odosiela automaticky.<br /><br />PhpGedView môže automaticky vytvoriť e-maily na upozornenie administrátorov o zmenách, ktoré čakajú na kontrolu. PhpGedView taktiež posiela upozornenie uživateľom, ktorý žiadajú o založenie účtu.<br /><br />Obvykle pole &laquo;Od:&raquo; automaticky vytvorených e-mailov obsahuje niečo takéto <i>Od: phpgedview-noreply@yoursite</i> pre upozornenie, že nie je potrebná odpoveď. Z dôvodu ochrany proti SPAMu prípadne inému zneužitiu, niektoré e-mail systémy požadujú vyplnenie poľa &laquo;Od:&raquo; platnou adresou a nebudú akceptovať mail odoslaný z adresy <i>phpgedview-noreply</i>.";
...
$pgv_lang["SUPPORT_METHOD_help"]	= "Spôsob, akým budú návštevníci kontaktovať \"Uživateľa pre technickú podporu\". Možnosť <b>Mailto link</b> znamená použitie e-mailového odkazu, na ktorý môžu návštevníci kliknúť a poslať e-mail cez svojho e-mailového klienta. Voľba <b>Interné správy PhpGedView</b> zaistí použitie systému zasielania správ vstavaného v PhpGedView bez použitia e-mailu. Voľba <b>Interné správy s e-mailami</b> je implicitná; ak je nastavená, použije sa vnútorný systém PhpGedView, ale kópia správy sa odošle tiež e-mailom. Voľba <b>PhpGedView odosiela maily bez ukladania</b> umožní PhpGedView spracovávať správy a odosielať ich e-mailom, ale neumožní ukladanie správ do databázy. Ak zvolíte možnosť <b>Bez kontaktnej metódy</b>, nebudú vás môcť návštevníci vašich stránok kontaktovať.";
$pgv_lang["SHOW_FACT_ICONS"] 		= "Zobraziť ikonu Údaj";
$pgv_lang["SHOW_FACT_ICONS_help"]	= "Nastavte na <b>Ano</b> pre zobrazenie ikon vedľa mena údaja na stránke Osobné údaje a podrobnosti. Ikony údajov budú zobrazené iba vtedy, ak existujú v adresári <i>images/facts</i> pre aktuálny motív.";
...
$pgv_lang["gedcom_title"]		= "Nadpis GEDCOMu";
...
$pgv_lang["ALLOW_THEME_DROPDOWN_help"]	= "Umožňuje uživateľovi zvoliť si vlastný motív z rolovacieho menu (ak je zabudované v aktuálnom motíve. Premenná <b>Umožniť uživateľom vybrať si vlastný motív</b> musí byť tiež nastavená na \"Ano\".";
$pgv_lang["MAX_VIEW_RATE"]		= "Maximálny počet zobrazení stránky";
$pgv_lang["MAX_VIEW_RATE_help"]		= "Táto voľba obmedzuje počet zobrazení stránky jedným uživateľom.<br /><br />Ak je tento počet prekročený, PhpGedView považuje tento režim za pokus o hacking (útok na stránky); režim bude zrušený zo zodpovedajúcou hláškou. Tieto dve hodnoty by mali vymedzit rozumný limit na množstvo  stiahnutých bajtov zo serveru. Táto vlastnosť môže byť vypnutá nastavením časového intervalu na 0.";
...
$pgv_lang["return_editconfig"]			= "Ku konfigurovaniu sa môžete kedykoľvek vrátiť, keď otvoríte v prehliadači súbor <i>edit_config.php</i> alebo kliknete na odkaz <b>Konfigurácia</b> na stránke <b>Administrácia GEDCOM</b>";
$pgv_lang["return_editconfig_gedcom"]		= "Ku konfigurovaní sa môžete kedykoľvek vrátiť kliknutím na odkaz: <b>Upraviť</b> v tabuľke <b>Súčasné GEDCOM súbory</b> alebo na stránke <b>Administrácia GEDCOM</b> alebo otvorením súboru </i>editconfig_gedcom.php</i> vo svojom prehliadači.";
$pgv_lang["save_config"] 			= "Uložiť konfiguráciu";
$pgv_lang["download_gedconf"]			= "Stiahnúť konfiguráciu GEDCOM.";
$pgv_lang["not_writable"]			= "Zistili sme, že PHP do vášho konfiguračného súboru nemôže zapisovať. Môžete použiť tlačítko <b>Stiahnuť súbor #GLOBALS[whichFile]#</b> pre uloženie svojho nastavenia do súboru, ktorý budete môcť ručne nahrať (uploadovať).";
...
$pgv_lang["general_privacy_help"]		= "<b>#pgv_lang[general_settings]#.</b><br />Toto nastavenie bude vaším implicitným nastavením pre konkrétny GEDCOM.<br />Podívajte sa pod titulok stránky, aby ste si overili, že upravujete správný GEDCOM.<br /><br />To zároveň znamená, že pre každý GEDCOM (ak máte viacej než jeden) vo vašam PhpGedView môžete mať samostané nastavenie.<br /><br />Toto všeobecné nastavenie môžete \"prebiť\" použitím ďalších formulárov utajenia na stránke Upraviť nastavenie utajenia v GEDCOMe.<br /><br /><b>Ďalšia nápoveda</b><br />Ďalšia nápoveda je k dispozícii z formulára.<br />Kliknite prosím na <b>?</b> za popiskami.";
...
$pgv_lang["SHOW_RESEARCH_ASSISTANT_help"]	= "Ktorý typ uživateľa môže vidieť modul Bádateľský asistent, ak je tento nainštalovaný?";
...
$pgv_lang["lang_edit_help"]			= "Táto stránka je určená pre prekľadateľov programu. Vy môžete prekladať, porovnávať a exportovať súbory jazykov. Tu je tiež nastavenie pomáhajúce prekľadateľom určiť orginálny text ktorý je zobrazený PhpGedView.<br /><br />Môžete použiť nasledujúce možnosti a pomôcky:";
...
$pgv_lang["lang_debug_help"]		= "Ak zaktivujete túto voľbu, názvy jazykových premenných použitých v texte, budú zobrazené v okne nápovedy. To pomôže prekladateľom určiť názov premennej v prípade, že text musí byť upravený.<br /><br />Toto nastavenie je platné iba pre vaše aktuálne PhpGedView okno.";
...
$pgv_lang["language_to_export_help"]	= "Z tohoto zoznamu si môžete vybrať jazyk, ktorého texty chcete exportovať.<br /><br />Program exportuje iba obsah súboru <i>configure_help_text.php</i>. Výstupom je HTML súbor, ktorý si môžete vytlačť z vašeho prehliadača.";
...
$pgv_lang["multi_letter_alphabet_help"]	= "Viacpísmenné kombinácie ktoré sú chápané ako jedno písmeno pri triedení zoznamov mien a titulov v tomto jazyku.<br /><br />Niektoré jazyky, maďarský a slovenský napríklad, považujú niektoré kombinácie písmen za odlišné písmená z vlastným významom. Poradie v ktorom špecifikujete tieto kombinácie určí poradie v ktorom budú vložené do normálnej abecedy v priebehu triedenia. To je dôležité ak niekoľko viacpísmenných kombinácií má rovnaké prvé písmeno. Z výnimkou <b>ch</b>, táto kombinácia písmen je vložená do normálnej abecdy podla jej prvého písmena. <b>ch</b> je vždy vložené za  <b>h</b>.";
$pgv_lang["dictionary_sort"]		= "Použiť pri triedení slovníkové pravidlá";
$pgv_lang["dictionary_sort_help"]	= "Táto voľba riadi ako sú spracované písmená s diakritickými znakmi pri triedení zoznamov mien a titulov.<br /><br />Ak nastavíte <b>Ano</b>, všetky písmená s diakritickými znamienkami budú považované ako keby nemali žiadne znamienka. Diakritické znamienka budú zohľadnené iba vtedy keď vyhodnocované dve slová sú inak identické. Ak nastavíte <b>Nie</b>, všetky písmená budú považované za rozdielne bez ohľadu na prítomnosť, alebo neprítomnosť diakritického znamienka.";
...
$pgv_lang["um_bu_help"] 		= "Tento nástroj môže urobiť zálohu niektorých dát z PhpGedView. Dáta ktoré vyberiete budú skopírované do ZIP súboru, tento súbor môžete načítať na ľubovolné miesto. ZIP súbor je uložený vo vašom index adresári, až dokiaľ ho nezmažete manuálne.";
...
$pgv_lang["preview_faq_item_help"] 	= "Táto voľba umožňuje administrátorovi zobraziť stránku FAQ bez editačných volieb a linkov.<br /><br /> Okrem jedného tlačítka <b>Upraviť</b> nad prvou položkou FAQ bude zobrazenie stránky FAQ rovnaké ako ho uvidia obyčajný uživatelia. Toto špeciálne tlačítko <b>Upraviť</b> vás vráti do plnej funkčnosti Upraviť.";
$pgv_lang["restore_faq_edits"] 		= "Obnoviť funkčnosť Upraviť FAQ";
$pgv_lang["restore_faq_edits_help"] 	= "Táto voľba obnoví stránku FAQ do režimu ako ju vidí obvykle administrátor, tak že jednotlivé položky FAQ môžu byť editované.";
$pgv_lang["add_faq_item"] 		= "Pridať položku FAQ";
$pgv_lang["add_faq_item_help"] 		= "Táto voľba vám umožňuje pridať položku na stránku FAQ.";
$pgv_lang["edit_faq_item"] 		= "Upraviť položku FAQ";
$pgv_lang["edit_faq_item_help"] 	= "Táto voľba vám umožňuje upraviť položku na stránke FAQ.";
$pgv_lang["delete_faq_item"] 		= "Zmazať položku FAQ";
$pgv_lang["delete_faq_item_help"] 	= "Táto voľba vám umožňuje zmazať položku na stránke FAQ";
$pgv_lang["moveup_faq_item"] 		= "Presunúť položku FAQ hore";
$pgv_lang["moveup_faq_item_help"] 	= "Táto voľba vám umožní presunúť položku vyššie na stránke FAQ.<br /><br />Vždy keď použijete túto možnosť bude číslo pozície položky FAQ zmenšené o 1. Rovnaký efekt môžete dosiahnúť priamo zmenou čísla pozície položky FAQ. Pozor ak viacej položiek FAQ má rovnaké číslo tak bude zobrazená iba jedna.";
$pgv_lang["movedown_faq_item"] 		= "Presunúť položku FAQ dole";
$pgv_lang["movedown_faq_item_help"] 	= "Táto voľba vám umožní presunúť položku nižšiee na stránke FAQ.<br /><br />Vždy keď použijete túto možnosť bude číslo pozície položky FAQ zväčšené o 1. Rovnaký efekt môžete dosiahnúť priamo zmenou čísla pozície položky FAQ. Pozor ak viacej položiek FAQ má rovnaké číslo tak bude zobrazená iba jedna.";
$pgv_lang["add_faq_header_help"] 	= "Tu je titulok, alebo predmet položky FAQ.<br /><br />Text môže byť formátovaný; HTML tagy ako <b> a <br> sú povolené, rovnako HTML entity ako  & a &nbsp;. Nie je tu žiadna možnosť zadať tagy tak, aby boli interpretované ako text.";
$pgv_lang["add_faq_body_help"] 		= "Tu je vložený text položky FAQ.<br /><br />Text môže byť formátovaný; HTML tagy ako  <b> a <br> sú povolené, rovnako HTML entity ako  &amp; a &nbsp;. Nie je tu žiadna možnosť zadať HTML tagy tak aby boli interpretované ako text.";
$pgv_lang["add_faq_order_help"] 	= "Toto pole riadi poradie v ktorom sú polžky FAQ zobrazené.<br /><br />Nemusíte zadávať čísla sekvenčne. Ak necháte prázdne miesta v číselnom poradí, môžete vložiť ďalšie položky neskoršie. Napríklad, ak použijete čísla 1, 6, 11, 16, môžete neskoršie vložiť položky s chýbajúcimi číslami. Záporné čísla a nula sú dovolené, a môžu byť použité na vloženie položiek pred prvú položku.<br /><br />Ak má viac než jedna položka FAQ rovnaké číslo pozície tak bude zobrazená iba jedna.";
$pgv_lang["add_faq_visibility_help"] = "Môžete určiť či FAQ bude zobrazené nbez ohľadu na GEDCOMe, alebo či bude zobrazné iba z aktuálnym GEDCOMom.<br /><ul><li><b>Všetky</b>&nbsp;&nbsp;&nbsp;FAQ bude zobrazené na zozname všetkých FAQ, bez ohľadu na GEDCOM.</li><li><b>#GLOBALS[GEDCOM]#</b>&nbsp;&nbsp;&nbsp;FAQ bude zobrazené iba na zozname FAQ aktuálneho aktívneho GEDCOMu.</li></ul>";
$pgv_lang["time_limit_help"]		= "Maximálny čas importu, ktorý je povolený na zpracovanie GEDCOM súboru.";
...
$pgv_lang["CHANGELOG_CREATE_help"]	= "Ako často má program archivovať Changelog súbory.";
...
$pgv_lang["LANG_SELECTION_help"]	= "Môžete zmeniť zoznam jazykov podporovaných vašimi PhpGedView stránkami označením alebo odznačením príslušného jazyka. Vaši uživatelia si potom môžu vyberať jazyk.<br /><br />To isté môžete urobiť pomocou linku <b>Konfigurovať podporované jazyky</b> v menu Admin, kde tiež môžete meniť nastavenia ako je ikona zástavy jazyka, formát datumu alebo či má byť zobrazované priezvisko ako prvé.";
$pgv_lang["MEDIA_ID_PREFIX"]		= "Média&nbsp;ID prefix";
$pgv_lang["MEDIA_ID_PREFIX_help"]	= "Keď je pridaný online nový mediálny záznam do PhpGedView je automaticky generované ID. Toto ID bude mať zadaný prefix.";
$pgv_lang["new_gedcom_title"]		= "Genealógia z [#GEDCOMFILE#]";
$pgv_lang["USE_MEDIA_VIEWER"]		= "Použiť Media Viewer";
$pgv_lang["USE_MEDIA_VIEWER_help"]	= "Nastavte túto hodnotu na <b>Ano</b>, ak uživatelia kliknú na obrázky na vašej stránke otvorí sa stránka Media View obsiahnuté vo verzii 4.1. Stránka Media View zobrazí detaily obrázku a umožní upraviť obrázok. <br /><br />Nastavenie hodnoty na <b>Nie</b> poskytne zobrazenie vo formáte predchádzajúcich verzií PhpGedView pred verziou 4.1 Ak kliknete na obrázok tak sa otvorí v plnom rozlíšení v novom okne.";
$pgv_lang["USE_MEDIA_FIREWALL"]		= "Použiť Media Firewall";
$pgv_lang["USE_MEDIA_FIREWALL_help"]	= "Prečítajte si vo Wiki popis ako použiť Media Firewall. <a href=\"http://wiki.phpgedview.net/en/index.php/Media_Firewall\" target=\"_blank\">http://wiki.phpgedview.net/en/index.php/Media_Firewall</a>";
$pgv_lang["MEDIA_FIREWALL_ROOTDIR"]			= "Koreňový adresár Media Firewallu";
$pgv_lang["MEDIA_FIREWALL_ROOTDIR_help"]	= "Adresár v ktorom môže byť založený zabezpečený adresár Médií. Ak je toto pole prázdne, tak bude použitý adresár <b>#GLOBALS[INDEX_DIRECTORY]#</b>.";
$pgv_lang["SYNC_GEDCOM_FILE_help"] 	= "V starších verziách PGV čakajúce zmeny boli ukladané v súbore GEDCOM a zmenené záznamy, ktoré boli 'akceptované' v databáze. Počínajúc verziou 4.1 už nie sú čakajúce zmeny ukladané v súbore GEDCOM ale v súbore zmien. <br /><br />Nastavenie tejto hodnoty na ano spôsobí aktualizáciu súboru GEDCOM keď budú zmeny akceptované v databáze. To udrží súbor GEDCOM synchronizovaný s databázou. Pre väčšiu kompatibilitu s predošlými verziami je default hodnota tohoto pola nastavená na ano.<br /><br />Môžete ju prestaviť na nie ak chcete šetriť pamäťou, keď akceptujete zmeny.";
$pgv_lang["SYNC_GEDCOM_FILE"]		= "Synchronizovať zmeny v súbore GEDCOM";
$pgv_lang["COMMIT_COMMAND_help"] 	= "Ak si želáte použiť riadenie verzií ako napríklad CVS na archiváciu zmien vo vašom GEDCOMe, konfigurácie alebo nastavenia utajenia, zadajte príkaz sem. Ponechajte box prázdny ak nechcete použiť systém riadenia verzií. Platné voľby sú <b>cvs</b> and <b>svn</b>.";
$pgv_lang["COMMIT_COMMAND"] 		= "Príkaz na riadenie verzií";
$pgv_lang["SHOW_MULTISITE_SEARCH_help"]	= "Mnohostránové vyhľadávanie dovolí uživateľom hľadať naprieč stránkami PhpGedView ktoré máte nastavené administrátorom v Správe stránok alebo ktoré sú vzdialene pripojené. Táto voľba určuje či je mnohostránkové hľadanie povolené pre všetkých alebo iba pre autorizavaných užívateľov.";
...
$pgv_lang["SHOW_NO_WATERMARK_help"]		= "Ak je aktívny Media Firewall, užívatelia uvidia vodoznak ak nemajú oprávnenia na úrovni špecifikovanej tu.";
$pgv_lang["WATERMARK_THUMB"]			= "Pridať vodoznak do náhľadov?";
$pgv_lang["WATERMARK_THUMB_help"]		= "Majú byť náhľady označené vodoznakom ak je aktívny Media Firewall? Váš zoznam médií bude načítaný rýchlejšie bez vodoznaku.";
?>

...
$pgv_lang["stpljpgraphno"]		= "JPgraph modules are not installed in PhpGedView. Please download them from http://www.aditus.nu/jpgraph/jpdownload.php<br /> and then copy them to subdirectory <i>jpgraph/</i> on the server.";

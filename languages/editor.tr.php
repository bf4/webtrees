...
$pgv_lang["change_family_instr"]	= "Aile üyelerini değiştirmek veya kaldırmak için bu sayfayı kullan.<br /><br />Her biri için sizin kullanabildiğiniz aile değişimdeki üye doldurana bir farklı lişiyi seçmeyi bağlar ailedeki o rol. Ayrıca ailede o kişiyi kaldırmak için kaldır bağlantıyı kullanabilirsiniz.<br /><br />Değiştirmeyi bitirdiğiniz zaman aile üyeler değişimleri kaydetmek için kaydet düğmesini tıklarlar..";
...
$pgv_lang["upload_media_help"]		= "Serverinize yüklemek için yerel bilgisayarınızdan dosyaları seçin. Dızın <b>#MEDIA_DIRECTORY#</b> ya da onun alt dizininin birisine tüm dosya yüklenecek..<br /><br />Sizin belirttiğiniz dosya adlar #MEDIA_DIRECTORY# ilave edilecekler. örneğin #MEDIA_DIRECTORY#benimailem.Tırnak önizleme dızın var olmazsa otomatik olarak oluşturulacak.";
...
$pgv_lang["shared_note_updated"] 	= "Paylaşılan not başarılı biçimde güncelledi.";
$pgv_lang["new_shared_note_created"] 	= "Yeni paylaşılan not başarılı biçimde oluşturuldu.";
$pgv_lang["create_shared_note"]		= "Yeni paylaşılan not oluştur";
$pgv_lang["add_shared_note_lbl"]	= "Paylaşılan not ekle";
$pgv_lang["add_shared_note"]		= "Yeni paylaşılan not ekle";
$pgv_lang["add_unlinked"]			= "Bağlantısız Kayıtlar";
$pgv_lang["add_unlinked_note"]		= "Bağlantısız not ekle";
$pgv_lang["create_shared_note_assisted"]	= "Yardımcıyı kullanarak yeni paylaşılan not oluştur";
$pgv_lang["to_note"]				= "Paylaşılan Not";
$pgv_lang["to_repository"]			= "Depoya";
$pgv_lang["shared_note_assisted"]	= "Paylaşılmış Not kullanma Asistanı";
$pgv_lang["add_new_event_assisted"]			= "Yeni hadise kullanma Asistanı oluştur";
?>

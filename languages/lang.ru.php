...
$pgv_lang["SHOW_ID_NUMBERS"]		= "Показать ID-номера имён:";
...
$pgv_lang["sorry"]				= "<b>Извините, текст помощи об этой странице или объекте пока ещё не закончен.</b>";
...
$pgv_lang["my_pedigree"]		= "Моё восходящее дерево";
$pgv_lang["my_indi"]			= "Я";
$pgv_lang["yes"]			= "Да";
$pgv_lang["no"]				= "Нет";
$pgv_lang["no_support"]			= "Ваша версия программ Интернета не достаточна для требований PhpGedView. Большинство современных версий удовлетворяют этим требованиям. Мы советуем Вам установить более новую версию программ Интернета.";
...
$pgv_lang["NN"]					= "(не определено)";
$pgv_lang["PN"]					= "(не определено)";
$pgv_lang["unrecognized_code"]		= "Неопознанный тэг GEDCOM";
$pgv_lang["unrecognized_code_msg"]	= "Ошибка, надо бы её исправить. Пожалуйста, сообщите об ошибке";
...
$pgv_lang["child"]			= "Ребёнок";
$pgv_lang["spouse"]			= "Супруг(а)";
$pgv_lang["surnames"]			= "Фамилии";
$pgv_lang["adopted"]			= "Усыновлён/удочерена";
$pgv_lang["foster"]			= "Приёмный (не родной по крови)";
...
$pgv_lang["person_parents_sibs"]	= "Добавить записи об этом лице, его родителях, братьях и сёстрах.";
...
$pgv_lang["unable_to_open"]		= "Невозможно открыть каталог Поддеревьев на запись";
...
$pgv_lang["download"]			= "Щёлкните правой кнопкой мыши на нижеследующую ссылку и выберите &quot;Save target as&quot; для загрузки файла.";
...
$pgv_lang["default_form"]		= "населённый пункт, уезд/район(уездн./рай. центр), губерния/область(губ./обл. центр)/штат, страна";
...
$pgv_lang["addmedia"]				= "Ввести медиа-инструменты (фото/аудио/видео)";
...
$pgv_lang["notes_sources_media"]	= "Примечания, источники и мультимедиа (фото/аудио/видео)";
...
$pgv_lang["skip_surnames"]		= "Пропустить лист список фамилий";
...
$pgv_lang["add_another"]		= "Добавить ещё одно лицо<br />Идентификационный номер:";
...
$pgv_lang["file_exists"]		= "GEDCOM файл с таким именем уже существует. Выберите другое имя или откорректируйте старый файл.";
$pgv_lang["new_gedcom_title"]		= "Генеалогия из [#GEDCOMFILE#] файла";
$pgv_lang["upload_help"]		= "Выберите файл, находящийся на локальном жёстком диске, который Вы хотите послать на сервер. Этот файл перезапишет существующий GEDCOM файл. После этого файл будет автоматически заново проиндексирован в:";
$pgv_lang["add_gedcom_instructions"]	= "Присвойте имя новому GEDCOM файлу. Этот файл будет перемещён в Index-папку.";
...
$pgv_lang["access_denied"]		= "Доступ отклонён. </b><br />У Вас нет доступа к этому источнику.";
$pgv_lang["changes_exist"]		= "Файл GEDCOM изменён.";
...
$pgv_lang["find_media"]			= "Искать фото/аудио/видео";
...
$pgv_lang["pls_note04"]			= "Поля со звёздочкой * должны быть заполнены";
$pgv_lang["pls_note05"]			= "Вы получите подтверждение на эл.адрес, который вы указали. С данными из этого письма Вы можете активизировать Ваше имя пользователя. Если Вы это не сделаете в течение 7 дней, то Ваш запрос будет удалён. Запрос всегда можно подать заново. Для полного доступа на этот сайт, Вы должны иметь имя пользователя и пароль. Вы должны указать на этом сайте Ваш действующий эл.адрес, на который Вы будете получать данные пользователя.<br /><br /> Если у Вас существуют проблемы с запросом имя пользователя для этого сайте, обратитесь к администратору сайта.";
$pgv_lang["pls_note04"]			= "Поля со звёздочкой должны быть заполнены.";
...
$pgv_lang["mail01_line02"]		= "На сервер ( #SERVER_NAME# ) пришёл запрос на регистрацию с Вашим эл.адресом ( #user_email# ).";
...
$pgv_lang["mail02_line04"]		= "Вы получите сообщение как только пользователь пошлёт данные для проверки. После этого Вы можете дать пользователю разрешение на вход на сайт.";
...
$pgv_lang["savedata"]			= "Сохранить изменённые данные";
...
$pgv_lang["user_theme"]			= "Моё оформление сайта";
...
$pgv_lang["welcome_text_cust_head"]		=	" <b>ДОБРО ПОЖАЛОВАТЬ НА ЭТОТ ГЕНЕАЛОГИЧЕСКИЙ САЙТ</b><br /><br />Доступ к данным сайта разрешён только зарегистрированным пользователям, имеющим учётную запись и пароль.";
...
$pgv_lang["message_instructions"]	= "<b>Внимание:</b>Конфиденциальная информация о ныне живущих лицах предоставляется только родственным и другим авторизированным лицам. Прежде чем получить конфиденциальную информацию, будет проверено Ваше родство с этим лицом. Иногда информация об уже умершем также является конфиденциальной. Это помогает предотвратить недоразумения если установлено не точно, действительно ли этот человек является умершим. Может быть также возможным что об этой персоне нет больше информации. <br /><br /> Прежде чем задавать запрос, проконтролируйте даты, географию и членов семьи чтобы убедиться что вы выбрали действительно ту персону, которая Вам нужна. Если Вы предоставляете информацию по генеалогии, укажите источник получения этой информации.";
...
$pgv_lang["welcome_descr"]		= "Блок приветствия пользователя отображает текущую дату, время, ссылку для изменения настроек, учётной записи и ссылку для быстрого перехода к собственному генеалогическому дереву.";
...
$pgv_lang["gedcom_stats_descr"]		= "Блок GEDCOM статистики отображает посетителем некоторую основную информацию о текущей базе данных GEDCOM, такую как дату её создания или количество персон в ней.";
...
$pgv_lang["enter_text"]			= "Пожалуйста введите какой-нибудь текст для этой заметки в Дневник или Новости.";
...
$pgv_lang["hit_count"]			= "Счётчик посещений";
...
$pgv_lang["recent_changes_descr"]	= "Блок последних изменений отображает список изменений сделанных в GEDCOM базе данных за последний месяц. Этот блок поможет Вам быть в курсе последних изменений.";
...
$pgv_lang["message_email1"]		= "Следующее сообщение послано Вашему пользователю PhpGedView:";
...
$pgv_lang["not_configured"]		= "Ваш PhpGedView ещё не конфигурирован.";
$pgv_lang["location_upgrade"]		= "Укажите место расположения файлов для обновления версии.";
$pgv_lang["cannot_read"]		= "Нечитаемый";
...
$pgv_lang["processing"]			= "Идёт обработка...";
$pgv_lang["privacy_open_error"] 	= "Ошибка при открытии файла [#PRIVACY_MODULE#].";
$pgv_lang["privacy_write_error"] 	= "Ошибка!!! Запись в [#PRIVACY_MODULE#] невозможна. <br /> Убедитесь что у Вас установлены полномочия на запись в этот файл. Установить эти полномочия можно в личном (персональном) файле.";
...
$pgv_lang["heading_image"]		= "Файлы мультимедиа (фото/аудио/видео):";
...
$pgv_lang["changed_mac"]		= "Обнаружены окончания строк в стиле Макинтош. Замените окончания строк состоящие только из ВВОДА на ВВОД и ПЕРЕВОД КАРЕТКИ.";
$pgv_lang["changed_places"]		= "Обнаружен неправильный формат географических названий. Исправьте записи географический названий в соответствии со спецификацией GEDCOM 5.5. Пример из Ваших данных GEDCOM:";
...
$pgv_lang["choose_report"]		= "Выберите отчёт для запуска";
$pgv_lang["enter_report_values"]	= "Введите значения отчёта";
$pgv_lang["selected_report"]		= "Выбранный отчёт";
$pgv_lang["run_report"]			= "Посмотреть отчёт";
$pgv_lang["select_report"]		= "Выбрать отчёт";
$pgv_lang["download_report"]			= "Скачать отчёт";
$pgv_lang["reports"]				= "Отчёты";
$pgv_lang["pdf_reports"]			= "PDF Отчёты";
$pgv_lang["html_reports"]			= "HTML Отчёты";
$pgv_lang["family_group_report"]	= "Групповой отчёт семьи";
$pgv_lang["family_group_report"]	= "Отчёт группы семей";
$pgv_lang["page"]					= "Страница";
$pgv_lang["of"] 					= " ";
$pgv_lang["enter_famid"]			= "Введите ID семьи";
...
$pgv_lang["individual_report"]		= "Персональный отчёт";
$pgv_lang["enter_pid"]				= "Введите ID персоны";
$pgv_lang["individual_list_report"]	= "Персональный отчёт списком";
$pgv_lang["generated_by"]			= "Сгенерировано ";
$pgv_lang["list_children"]			= "Список детей в порядке рождения.";
$pgv_lang["birth_report"]			= "Отчёт дня и места рождения";
...
$pgv_lang["excel_list"]			= "Вывод в EXCEL (slk) формате следующих файлов (сначала используется список основателей):";
...
$pgv_lang["merge_same"] 			= "Записи разных типов. Невозможно объединить записи разных типов.";
...
$pgv_lang["merge_to"]				= "Слить (объединить) в ID:";
$pgv_lang["merge_from"] 			= "Слить (объединить) из ID:";
$pgv_lang["merge_facts_same"]		= "Следующие факты абсолютно одинаковы в двух записях и будут автоматически объединены.";
...
$pgv_lang["merge_more"] 			= "Объединить больше записей.";
$pgv_lang["same_ids"]				= "Вы ввели такой же ID. Вы не можете объединить одинаковые записи.";

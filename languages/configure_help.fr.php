...
$pgv_lang["THUMBNAIL_WIDTH_help"]       = "C'est la largeur (en pixels) que le programme utilisera lors de la génération automatique de vignettes. Le réglage par défaut est 100. ";
...
$pgv_lang["CHANGELOG_CREATE_help"]      = "À quelle fréquence le programme doit archiver les fichiers de modifications des logs (Changelog). ";
...
$pgv_lang["SHOW_RESEARCH_ASSISTANT_help"]= "Quel type d'utilisateur peut afficher le module d'assistant de recherche s'il est installé? ";
...
$pgv_lang["commit_google_help"]         = "En cliquant sur ce lien, vous sauvegardez toutes les traductions proposées par Google. L'indicateur de progression de l'écriture des traductions est affiché ci-dessous. <br /> ";
...
$pgv_lang["language_to_edit_help"]      = "Dans cette liste, vous sélectionnez la langue avec laquelle vous souhaitez modifier les messages. ";
...
$pgv_lang["restore_faq_edits_help"]     = "Cette option restaure la page FAQ à ce qu'un utilisateur administrateur voit normalement, de sorte que les éléments de la page FAQ puissent être modifiés. ";
$pgv_lang["add_faq_item"]               = "Ajouter FAQ";
$pgv_lang["add_faq_item_help"]          = "Cette option vous permettra d'ajouter un élément à la page FAQ. ";
$pgv_lang["edit_faq_item"]              = "Editer FAQ";
$pgv_lang["edit_faq_item_help"]         = "Cette option vous permettra de modifier un élément sur la page FAQ. ";
$pgv_lang["delete_faq_item"]            = "Supprimer FAQ";
$pgv_lang["delete_faq_item_help"]       = "Cette option vous permettra de supprimer un élément de la page FAQ ";
$pgv_lang["moveup_faq_item"]            = "Déplacer FAQ vers le haut";
$pgv_lang["movedown_faq_item"]          = "Déplacer FAQ vers le bas";
$pgv_lang["time_limit_help"]            = "Le temps maximum qui est autorisé pour l'importation afin de procéder au traitement du fichier GEDCOM.";

...
$pgv_lang["DEFAULT_PEDIGREE_GENERATIONS_help"]	= "Seçere Çizelgesinde göstermek için nesillerin varsayılan sayıyı girin.";
$pgv_lang["MAX_PEDIGREE_GENERATIONS"]		= "Soyağacı Çizelgesinde maksimum nesil sayısı";
$pgv_lang["MAX_PEDIGREE_GENERATIONS_help"]	= "Seçere Çizelgesinde göstermek için nesillerin en fazla sayıyı girin.";
$pgv_lang["MAX_DESCENDANCY_GENERATIONS"]	= "Şahsı izleyen nesiller Çizelgesinde maksimum nesil sayısı";
$pgv_lang["MAX_DESCENDANCY_GENERATIONS_help"]	= "Şahsı izleyen nesiller Çizelgesinde göstermek için nesillerin en fazla sayıyı girin.";
...
$pgv_lang["PEDIGREE_ROOT_ID_help"]	= "Soyağacı ve şahsı izleyen nesiller Çizgelerinde göstermek için vaysayılan kişinin ID bilgisini girin.";
...
$pgv_lang["return_editconfig"]		= "Bu yapılandırma sayfasına her zaman tarayıcınızda <b>editconfig.php</b> dosyasını açarak ya da <b>Yönetim</b> sayfasındaki <b>Genel ayarlar</b> bağlantısını tıklayarak geri dönebilirsiniz.";
...
$pgv_lang["SHOW_DEAD_PEOPLE_help"]		= "Tüm ölü kişiler için gizlilik erişim düzeyi kur.";
$pgv_lang["help_info"]			= "Her nesne üzerine kırmızı &quot;?&quot; (soru işaretlerine) tıklayıp yardım elde edebilirsiniz.";
...
$pgv_lang["um_proceed"] = "Seçeneği seç veya yönetime dönmek için aşağıdaki Yönetim butonu tıklayın";
$pgv_lang["um_creating"] = "Oluşturuluyor";
$pgv_lang["um_sql_index"] = "Bu araç <i>authenticate.php</i> oluşturacak ve çeşitli <i>.dat</i> dosyalarla beraber sunucunuzdaki index klasörüne dosyalayacaktır.<br /><br /><br /><br />Tüm geçerli kullanıcılar, mesajlar, favoriler, haberler ve Benim Soyağacı Görüntüleme yerleşimi başarılı biçimde oluşturulduktan sonra buradan çalışacaktır.<br /><br /><br /><br />Not: İndex moduna geçtikten sonra tekrar veritabanına geçmek için GEDCOM dosyları içeri aktarmalısınız.";
...
$pgv_lang["USE_MEDIA_FIREWALL_help"]	= "Media Firewall kullanmak hakkında açıklama için Wiki web sitesini görün. <a href=\"#PGV_PHPGEDVIEW_WIKI#/en/index.php?title=Media_Firewall\" target=\"_blank\">#PGV_PHPGEDVIEW_WIKI#</a>";

$pgv_lang["FULL_SOURCES"]		= "Tam kaynak alıntıları kullan";
$pgv_lang["PREFER_LEVEL2_SOURCES"]		= "Gerçek kaynakları tercih et";
$pgv_lang["MEDIA_FIREWALL_ROOTDIR_help"]	= "Korunmuş medya rehberin oluşturulduğu rehber. Bu alan boş iken <b>#GLOBALS[INDEX_DIRECTORY]#</b> klasörü kullanılacak.";
$pgv_lang["MEDIA_FIREWALL_THUMBS_help"]	= "Resim korunmuş medya rehberde olduğu zaman resim tırnak önizlemeside korunmalımıdır?";
$pgv_lang["SHOW_NO_WATERMARK_help"]		= "Eğer Medya Firewall etkinleştirilirse kullanıcılar filigranları görecekler, eğer burada ayrıcalıklı bir seviyeye sahip olmazlar ise.";
...
$pgv_lang["add_faq_item_help"] = "Bu seçenek SSS sayfasına size bölümleri eklettirecek.";
$pgv_lang["delete_faq_item_help"] = "Bu seçenek SSS sayfasında size bölümleri sildirecek";
$pgv_lang["lang_filenames_help"]		= "#pgv_lang[lang_file_descriptions]#";
$pgv_lang["edit_faq_item_help"] = "Bu seçenek SSS sayfasında size bölümleri düzenletecek.";
$pgv_lang["um_bu_help"] = "Bu araç PhpGedViewdeki bir çok veri çeşitlerini yedekleyebilir bu yedek indirmenize izin verir.<br /><br />Bu verileri yedekleyip ZIP dosya olarak indirmek için yedeklemek istediğiniz bilgileri aşağıdaki seçim kutularında seçmelisiniz seçimlerinizi yaptıktan sonra aşağıdaki Yedeklemeyi yap düğmesine basınız.<br /><br />Bu oluşturulacak ZIP dosyası index dızınde siz elle silene kadar kalacaktır.";
$pgv_lang["more_help_advice"]			= "<br /><b>Daha çok yardım</b><br />Daha çok yardım sayfada bölümleri tıklatarak mevcutlar<b>?</b> .";
...
$pgv_lang["bom_check_help"]		= "#pgv_lang[bom_check_desc]#";
$pgv_lang["lang_debug_help"]	= "#pgv_lang[lang_debug_desc]#";
$pgv_lang["edit_lang_utility_help"]	= "#pgv_lang[edit_lang_utility_desc]#";
$pgv_lang["file_to_edit_help"]			= "#pgv_lang[lang_file_descriptions]#";
$pgv_lang["export_lang_utility_help"]	= "#pgv_lang[export_lang_utility_desc]#";
$pgv_lang["compare_lang_utility_help"]	= "#pgv_lang[compare_lang_utility_desc]#";
...
$pgv_lang["translation_forum_help"]	= "#pgv_lang[translation_forum_desc]#";
$pgv_lang["add_new_language_help"]	= "#pgv_lang[add_new_language_desc]#";
$pgv_lang["um_tool_help"] = "Bu araç dışarı aktarım için SQL den index klasörüne kaydıracak veya içeri aktarım için index klasöründen SQL tablolarına kaydıracaktır.<br /><br /> Kullanıcı bilgileri, Favoriler, Blok belirlemeleri, Mesajlar ve haberleri kaydırıldıktan sonra tekrar mevcut olacaklar.<br /><br /><b>UYARI</b><br />Bu araç farklı PhpGedView versiyonları arasında kullanıcı bilgilerini kaydırmak için kullanamazsınız.  Verinin orijinal olduğundan emin olun yada PhpGedViewnin aynı versiyonu olduğundan emin olun.<br /><br /><b>İÇERİ ALMAK</b><br />Kullanıcı bilgileri içeri aktarma seçerseniz index içindeki kullanıcı bilgileri içeren dosyadan tümü veritabanındaki mevcut <u>kullanıcı bilgilerinin üzerine yazılacaktır</u>. Bu araç <u>bilgileri birleştirmez</u>.  İçeri aktarımı yaptıktan sonra PhpGedViewde olan eski bilgileri geri almak için hiç bir yol yok ve <u>geri almak mümkün değildir</u>.<br /><br /><b>DIŞARI VERMEK</b><br />Kullanıcı bilgilerini Dışarı Aktar seçeneğini seçerseniz SQL veritabanınızdaki tüm kullanıcı bilgileri index klasörüne <i>authenticate.php</i> ve <i>.dat</i> dosyalar oluşturularak aktarılacaktır. Eğer index klasöründe aynı dosyalar mevcut ise bir yada birkaç dosya mevcutur onların üstüne yazmak istiyormusunuz diye sizi uyaracaktır. Dışarı Aktar butonuna bastıktan sonra tüm dosyalar index klasöründe mevcut olacaklardır.<br /><br /><b>Not:</b> İndex modu kapattıktan sonra GEDCOM dosyanızı tekrar içeri aktarma ihtiyaç duyacaksınız.( After switching to Index mode, you will need to import your GEDCOM files again.)";
$pgv_lang["um_sql_index_help"] = "Bu araç <i>authenticate.php</i> oluşturacak ve çeşitli <i>.dat</i> dosyalarla beraber sunucunuzdaki index klasörüne dosyalayacaktır.<br /><br /><br /><br />Tüm geçerli kullanıcılar, mesajlar, favoriler, haberler ve Benim Soyağacı Görüntüleme yerleşimi başarılı biçimde oluşturulduktan sonra buradan çalışacaktır.<br /><br /><br /><br />Not: İndex moduna geçtikten sonra tekrar veritabanına geçmek için GEDCOM dosyları içeri aktarmalısınız.";
$pgv_lang["um_index_sql_help"] = "Bu araç index klasörünüzdeki <i>authenticate.php</i> ve diğer <i>.dat</i> dosyaları veritabanınıza aktaracaktır.";
$pgv_lang["PAGE_AFTER_LOGIN"]		= "Girişten sonra karşılanacak sayfa";
$pgv_lang["SHOW_COUNTER_help"]		= "Portal ve Bireysel sayfaların hit sayaçları göster.";

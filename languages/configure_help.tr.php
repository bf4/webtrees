...
$pgv_lang["default_user"]		= "Genel yönetici üye oluştur.";
...
$pgv_lang["current_users"]		= "Geçerli üye listesi";
...
$pgv_lang["config_still_writable"]	= "Yapılandırma dosyanıza hala yazma izni vardır.<br />Yapılandırmayı tamamladıysanız güvenlik nedenleri yüzünden bu dosyanın izinlerini yalnız-okuma (read-only) türüne geri çevirin.";
$pgv_lang["admin_verification_waiting"] = "Yönetici onayı bekleyen üyeler";
...
$pgv_lang["TBLPREFIX"]			= "Database Tablo Öneki";
...
$pgv_lang["DEFAULT_PEDIGREE_GENERATIONS"]	= "Soyağacı çiziminde varsayılan nesil sayısı";
$pgv_lang["DEFAULT_PEDIGREE_GENERATIONS_help"]	= "~#pgv_lang[DEFAULT_PEDIGREE_GENERATIONS]#~<br /><br />Seçere çiziminde göstermek için nesillerin varsayılan sayıyı girin.<br />";
$pgv_lang["MAX_PEDIGREE_GENERATIONS"]		= "Soyağacı çiziminde maksimum nesil sayısı";
$pgv_lang["MAX_PEDIGREE_GENERATIONS_help"]	= "~#pgv_lang[MAX_PEDIGREE_GENERATIONS]#~<br /><br />Seçere çiziminde göstermek için nesillerin en fazla sayıyı girin.<br />";
$pgv_lang["MAX_DESCENDANCY_GENERATIONS"]	= "Şahsı izleyen nesiller çiziminde maksimum nesil sayısı";
$pgv_lang["MAX_DESCENDANCY_GENERATIONS_help"]	= "~#pgv_lang[MAX_DESCENDANCY_GENERATIONS]#~<br /><br />Şahsı izleyen nesiller çiziminde göstermek için nesillerin en fazla sayıyı girin.<br />";
...
$pgv_lang["PEDIGREE_ROOT_ID_help"]	= "~#pgv_lang[PEDIGREE_ROOT_ID]#~<br /><br />Soyağacı ve şahsı izleyen nesiller çizimlerinde göstermek için vaysayılan kişinin ID bilgisini girin.<br />";
$pgv_lang["GEDCOM_ID_PREFIX"]		= "GEDCOM - Kişisel ID ön eki";
$pgv_lang["SOURCE_ID_PREFIX"]		= "Kaynak ID ön eki";
$pgv_lang["REPO_ID_PREFIX"]		= "Havuz ID ön eki";
...
$pgv_lang["MULTI_MEDIA_DB"]		= "Multimedya kontrollü veritabanı kullan";
...
$pgv_lang["CREATE_GENDEX"]		= "GENDEX dosyalarını oluştur";
...
$pgv_lang["enable_disable_lang"]	= "Desteklenen lisanların ayarları";
$pgv_lang["translator_tools"]	= "Tercüman araçları";
...
$pgv_lang["users_unver"]			= "Kendini Onaylamadığı Kullanıcı";
...
$pgv_lang["cleanup_users"]			= "Kullanıcıları Silmek";
...
$pgv_lang["date_time"]				= "Tarih ve zaman";
$pgv_lang["message"]				= "Mesaj";
$pgv_lang["type"]					= "Tipi";
...
$pgv_lang["system_time"]		= "Sistemin geçerli zamanı:";
...
$pgv_lang["ALLOW_REMEMBER_ME"]		= "Giriş de <b>Beni Hatırla</b> göster";
...
$pgv_lang["LANG_SELECTION"] 			= "Desteklenecek Diller";
...
$pgv_lang["new_gedcom_title"]		= "[#GEDCOMFILE#] dan soy fromu";
?>

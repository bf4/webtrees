...
$pgv_lang["enter_db_pass"]		= "Veritabanı Kullanıcı adı ve MySQL Veritabanı şifresi her konfigürasyon değerleri değiştirdiğinizde girilmesi gerekiyor.";
...
$pgv_lang["DEFAULT_PEDIGREE_GENERATIONS_help"]	= "~Soyağacı Çizelgesinde varsayılan nesil sayısı~<br /><br />Seçere Çizelgesinde göstermek için nesillerin varsayılan sayıyı girin.<br />";
$pgv_lang["MAX_PEDIGREE_GENERATIONS"]		= "Soyağacı Çizelgesinde maksimum nesil sayısı";
$pgv_lang["MAX_PEDIGREE_GENERATIONS_help"]	= "~Soyağacı Çizelgesinde maksimum nesil sayısı~<br /><br />Seçere Çizelgesinde göstermek için nesillerin en fazla sayıyı girin.<br />";
$pgv_lang["MAX_DESCENDANCY_GENERATIONS"]	= "Şahsı izleyen nesiller Çizelgesinde maksimum nesil sayısı";
$pgv_lang["MAX_DESCENDANCY_GENERATIONS_help"]	= "~Şahsı izleyen nesiller Çizelgesinde maksimum nesil sayısı~<br /><br />Şahsı izleyen nesiller Çizelgesinde göstermek için nesillerin en fazla sayıyı girin.<br />";
...
$pgv_lang["PEDIGREE_ROOT_ID_help"]	= "~Soyağacı ya da şahsı izleyen nesiller Çizelgesinde kullanılacak ilk şahıs~<br /><br />Soyağacı ve şahsı izleyen nesiller Çizgelerinde göstermek için vaysayılan kişinin ID bilgisini girin.<br />";
...
$pgv_lang["not_writable"]		= "Konfigürasyon (confing.php) dosyanız PHP ile yazılabilir değildir. Konfigürasyon dosyanızı <b>Dosya indir #GLOBALS[whichFile]#</b> duğmesini tıklayarak dosyayı indirin FTP ile serverinize yükleyiniz. Yada confing.php dosyanın CHMOD izni 777 yapın.";
...
$pgv_lang["SHOW_DEAD_PEOPLE_help"]		= "~Hayatta olmayan şahısları göster~<br /><br />Tüm ölü kişiler için gizlilik erişim düzeyi kur.<br />";
...
$pgv_lang["USE_MEDIA_FIREWALL_help"]	= "~Medya Firewall Kullan~<br /><br />Media Firewall kullanmak hakkında açıklama için Wiki web sitesini görün. <a href=\"#PGV_PHPGEDVIEW_WIKI#/en/index.php?title=Media_Firewall\" target=\"_blank\">#PGV_PHPGEDVIEW_WIKI#</a><br />";

$pgv_lang["FULL_SOURCES"]		= "Tam kaynak alıntıları kullan";
$pgv_lang["PREFER_LEVEL2_SOURCES"]		= "Gerçek kaynakları tercih et";
$pgv_lang["MEDIA_FIREWALL_ROOTDIR_help"]	= "~Medya Firewall Kök Klasörü~<br /><br />Korunmuş medya rehberin oluşturulduğu rehber. Bu alan boş iken <b>#GLOBALS[INDEX_DIRECTORY]#</b> klasörü kullanılacak.<br />";
$pgv_lang["MEDIA_FIREWALL_THUMBS_help"]	= "~Korunmuş resimlerin tırnak önizlemelerini koru~<br /><br />Resim korunmuş medya rehberde olduğu zaman resim tırnak önizlemeside korunmalımıdır?<br />";
$pgv_lang["SHOW_NO_WATERMARK_help"]		= "~Filigranlı olmayan resimleri kim görüntüleyebilir?~<br /><br />Eğer Medya Firewall etkinleştirilirse kullanıcılar filigranları görecekler, eğer burada ayrıcalıklı bir seviyeye sahip olmazlar ise.<br />";
...
$pgv_lang["add_faq_item_help"] = "~SSS Bölüm Ekle~<br />Bu seçenek SSS sayfasına size bölümleri eklettirecek.<br />";
$pgv_lang["delete_faq_item_help"] = "~SSS parçası sil~<br />Bu seçenek SSS sayfasında size bölümleri sildirecek<br />";
$pgv_lang["lang_filenames_help"]		= "~Dil dosyaları~<br /><br />#pgv_lang[lang_file_descriptions]#";
$pgv_lang["edit_faq_item_help"] = "~SSS Bölümü Düzenle~<br />Bu seçenek SSS sayfasında size bölümleri düzenletecek.<br />";
$pgv_lang["um_bu_help"] = "~Yedekle~<br /><br />Bu araç PhpGedViewdeki bir çok veri çeşitlerini yedekleyebilir bu yedek indirmenize izin verir.<br /><br />Bu verileri yedekleyip ZIP dosya olarak indirmek için yedeklemek istediğiniz bilgileri aşağıdaki seçim kutularında seçmelisiniz seçimlerinizi yaptıktan sonra aşağıdaki Yedeklemeyi yap düğmesine basınız.<br /><br />Bu oluşturulacak ZIP dosyası index dızınde siz elle silene kadar kalacaktır.<br />";
...
$pgv_lang["gedcom_title"]			= "GEDCOM veritabanın başlığı";
$pgv_lang["google_translate"]	= "Googleden&reg; Tercüme Yap";
$pgv_lang["commit_google"]		= "Tercüme edilenleri Googleden&reg; Tercüme Yapılmış Yap";
$pgv_lang["commit"]				= "Onayla";
$pgv_lang["bom_check_help"]		= "~Dil dosyası içinde BOM denetimi~<br /><br />#pgv_lang[bom_check_desc]#<br />";
$pgv_lang["lang_debug_help"]	= "~Yardım metni hata giderme seçeneği~<br /><br />#pgv_lang[lang_debug_desc]#<br />";
$pgv_lang["edit_lang_utility_help"]	= "~Dil dosyalarının içeriğini değiştirme aracı~<br /><br />#pgv_lang[edit_lang_utility_desc]#<br />";
$pgv_lang["file_to_edit_help"]			= "~İçeriği değiştirilecek dosya tipi~<br /><br />#pgv_lang[lang_file_descriptions]#";
$pgv_lang["export_lang_utility_help"]	= "~Dil dosyasını ihraç etme aracı~<br /><br />#pgv_lang[export_lang_utility_desc]#<br />";
$pgv_lang["compare_lang_utility_help"]	= "~Dil dosyalarını karşılaştırma aracı~<br /><br />#pgv_lang[compare_lang_utility_desc]#<br />";
...
$pgv_lang["translation_forum_help"]	= "~SourceForge sitesindeki PhpGedView tercüme forumuna bağlantı~<br /><br />#pgv_lang[translation_forum_desc]#<br />";
$pgv_lang["add_new_language_help"]	= "~Yeni bir dil için gerekli olan dosya ve ayarları ekle~<br /><br />#pgv_lang[add_new_language_desc]#";
$pgv_lang["um_tool_help"] = "~Üye verilerini kaydırma aracı~<br /><br />Bu araç dışarı aktarım için SQL den index klasörüne kaydıracak veya içeri aktarım için index klasöründen SQL tablolarına kaydıracaktır.<br /><br /> Kullanıcı bilgileri, Favoriler, Blok belirlemeleri, Mesajlar ve haberleri kaydırıldıktan sonra tekrar mevcut olacaklar.<br /><br /><b>UYARI</b><br />Bu araç farklı PhpGedView versiyonları arasında kullanıcı bilgilerini kaydırmak için kullanamazsınız.  Verinin orijinal olduğundan emin olun yada PhpGedViewnin aynı versiyonu olduğundan emin olun.<br /><br /><b>İÇERİ ALMAK</b><br />Kullanıcı bilgileri içeri aktarma seçerseniz index içindeki kullanıcı bilgileri içeren dosyadan tümü veritabanındaki mevcut <u>kullanıcı bilgilerinin üzerine yazılacaktır</u>. Bu araç <u>bilgileri birleştirmez</u>.  İçeri aktarımı yaptıktan sonra PhpGedViewde olan eski bilgileri geri almak için hiç bir yol yok ve <u>geri almak mümkün değildir</u>.<br /><br /><b>DIŞARI VERMEK</b><br />Kullanıcı bilgilerini Dışarı Aktar seçeneğini seçerseniz SQL veritabanınızdaki tüm kullanıcı bilgileri index klasörüne <i>authenticate.php</i> ve <i>.dat</i> dosyalar oluşturularak aktarılacaktır. Eğer index klasöründe aynı dosyalar mevcut ise bir yada birkaç dosya mevcutur onların üstüne yazmak istiyormusunuz diye sizi uyaracaktır. Dışarı Aktar butonuna bastıktan sonra tüm dosyalar index klasöründe mevcut olacaklardır.<br /><br /><b>Not:</b> İndex modu kapattıktan sonra GEDCOM dosyanızı tekrar içeri aktarma ihtiyaç duyacaksınız.( After switching to Index mode, you will need to import your GEDCOM files again.)<br />";
$pgv_lang["um_sql_index_help"] = "~Kullanıcıları index modunda barındırmak için SQL den taşı~<br /><br />Bu araç <i>authenticate.php</i> oluşturacak ve çeşitli <i>.dat</i> dosyalarla beraber sunucunuzdaki index klasörüne dosyalayacaktır.<br /><br /><br /><br />Tüm geçerli kullanıcılar, mesajlar, favoriler, haberler ve Benim Soyağacı Görüntüleme yerleşimi başarılı biçimde oluşturulduktan sonra buradan çalışacaktır.<br /><br /><br /><br />Not: İndex moduna geçtikten sonra tekrar veritabanına geçmek için GEDCOM dosyları içeri aktarmalısınız.<br /><br />";
$pgv_lang["um_index_sql_help"] = "~Kullanıcıları SQL modunda barındırmak için index teen taşı~<br /><br />Bu araç index klasörünüzdeki <i>authenticate.php</i> ve diğer <i>.dat</i> dosyaları veritabanınıza aktaracaktır.<br />";
$pgv_lang["PAGE_AFTER_LOGIN"]		= "Girişten sonra karşılanacak sayfa";
$pgv_lang["SHOW_COUNTER_help"]		= "~Sayaçları göster~<br /><br />Portal ve Bireysel sayfaların hit sayaçları göster.<br />";
$pgv_lang["edit_lang_utility_warning"]	= "UYARI!<br /><br />Eğer <b>Pencereyi tazelemeden kapat</b> butonu tıklarsanız sayfayı yenilemeden yağtığınız değişikliği göremeyeceksiniz.It's possible that your language file may be destroyed if you add a message which has not yet appeared inside the language file or if you just edit a message you have edited directly before.<br /><br />Eğer ne yaptığınızı gerçekten bilmiyorsanız lütfen <b>Pencereyi tazelemeden kapat</b> butonu kullanın.";
?>

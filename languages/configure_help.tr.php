...
$pgv_lang["REQUIRE_ADMIN_AUTH_REGISTRATION"]		= "Yöneticinin yeni kullanıcı kayıtlarını onaylamasını gerektirir";
...
$pgv_lang["editopt_conf"]		= "Seçenekleri Düzenle";
...
$pgv_lang["user_relationship_priv"]	= "Üyelerle bağlantı kurmak için erişimi kısıtla";
...
$pgv_lang["PGV_SIMPLE_MAIL"] = "Kullan basit email üst kısımların dıştan gelen mailler";
...
$pgv_lang["cleanup_users"]			= "Kullanıcıları Silme";
...
$pgv_lang["usr_idle"]				= "Son x aydan önce giriş yapan kullanıcıları listelemek çin ay seçin, Silinecek üyeleri işaretleyin: ";
...
$pgv_lang["um_proceed"] = "Seçeneği seç veya yönetime dönmek için aşağıdaki İdare / Ayarlar butonu tıklayın<br />";

...
$pgv_lang["marr_name_import_instr"]	= "Klicken Sie auf diesen Button, wenn PhpGedView die Heiratsnamen von weiblichen Personen in dieser GEDCOM Datei ermitteln soll. Dann können Sie Ehefrauen auch nach ihren Heiratsnamen suchen oder auflisten lassen. <i>NB: Heiratsnamen werden nur gezeigt, wenn diese Option in der GEDCOM Konfiguration eingeschaltet ist.  <b>Die Ermittlung von Heiratsnamen ist nicht obligatorisch.</b></i>";
...
$pgv_lang["pls_note05"]                 = "Sie müssen eine gültige Mail Adresse angeben, um die Bestätigungsmail zu erhalten.<br /><br />wenn Sie dieses Formular ausgefüllt haben und ihre Antwort überprüft wurde, werden Sie eine Bestätigungsmail an die hier angegebene Adresse erhalten.  Mit der Bestätigungsmail können Sie Ihren Zugang aktivieren.  Falls Sie den Zugang nicht binnen 7 Tagen aktivieren, wird er gelöscht (Sie müssen sich dann erst erneut registrieren).<br /><br />Um sich an dieser Seite anzumelden benötigen Sie Ihren Benutzernamen und das Passwort.<br /><br />Falls bei der Registrierung Probleme auftreten, fragen Sie bitte den Webmaster um Hilfe.";
...
$pgv_lang["mail04_line05"]			= "Um Ihr Passwort, nachdem Sie sich angemeldet haben zu ändern, wählen Sie die «#pgv_lang[editowndata]#» Verbindung innerhalb des «#pgv_lang[mygedview]#» Menüs und tragen Sie dann in beiden Passwort Feldern Ihr gewünschtes Passwort ein.";
$pgv_lang["mail04_subject"]                = "Datenanforderung bei #SERVER_NAME#";
$pgv_lang["pwreqinfo"]                     = "Hallo...<br /><br />Das neue Passwort wurde an die uns bekannte Mail Adresse von <b>#user[email]#</b> versandt.<br /><br />Sie sollten das Mail bald in Ihrem Postfach finden.<br /><br />Hinweis:<br />Sie sollten sich baldmöglichst mit dem neuen Passwort anmelden und Ihr Passwort aus Datenschutzgründen sofort ändern.";
...
$pgv_lang["stplaomd"]			 = "Alter zum Zeitpunkt der Ehe";
$pgv_lang["stplcpm"]			 = "Kinder pro Ehe";
...
$pgv_lang["label_ban_view_links"]   = "Verbindungen zu dieser abgewiesenen Internetseite zeigen";

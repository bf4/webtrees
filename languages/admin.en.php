...
$pgv_lang['gedcheck_sync'] = "Edits to made to the database are not synchronised to the file #GLOBALS[ged]#.  The file contents may be out-of-date.  You can synchronise it with the database now by performing an <b><a \"#GLOBALS[ged_link]#\">export</a></b>.";

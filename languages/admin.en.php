...
$pgv_lang["download_note"]						= "NOTE: Large GEDCOMs can take a long time to process before downloading.  If PHP times out before the download is complete, you may not get a complete download.<br /><br />To make sure that the file was downloaded correctly, check that the last line of GEDCOM files is <b>0&nbsp;TRLR</b> or that the last line of XML files is <b>&lt;/database&gt;</b>.  GEDCOM files are text; you can use any suitable text editor, but be sure to <u>not</u> save the downloaded GEDCOM file after you have inspected it.<br /><br />In general, it could take as much time to download as it took to import your GEDCOM file.";

...
~#pgv_lang[SUBLIST_TRIGGER_F]#~<br /><br />Långa listor av familjer med samma namn kan brytas upp till mindre underlistor efter första bokstaven i personen förnamn.<br /><br />Detta val bestämmer när underlistor av famlijenamn ska skapas. För att stänga av detta val helt, sätt detta val till noll.<br />";

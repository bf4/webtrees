...
$pgv_lang['progress_bars_info']			= "Unten wird Ihnen der Fortschritt des Imports gezeigt.  Wenn die maximale Laufzeit erreicht wird, hält der Import.  Sie müssen dann auf den &laquo;Fortfahren&raquo; Button klicken, um den Import fortzusetzen.  Falls dieser Button fehlt, müssen Sie den Import neu anfangen, aber mit einer etwas kleineren maximalen Laufzeit.";
...
$pgv_lang["download_file"]						= "Datei herunterladen";
...
$pgv_lang["label_remove_search"]	= "IP Adresse als Internet Suchmaschine erkennen: ";
...
$pgv_lang["messaging2"]							= "Interne Nachrichten-Funktion und E-Mail";
...
$pgv_lang["REQUIRE_ADMIN_AUTH_REGISTRATION"] 	= "Benutzeranträge müssen vom Verwalter freigegeben werden";

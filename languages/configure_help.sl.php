...
$pgv_lang["enter_db_pass"]		= "Zaradi varnosti morate vedno vnesti Uporabniško ime za bazo podatkov in Geslo za bazo podatkov, ko spreminjate katero koli vrednost v nastavitvah.";
...
$pgv_lang["gedcom_title"]			= "GEDCOM naslov";
...
$pgv_lang["META_AUTHOR_descr"]		= "Pusti to polje prazno za uporabo polnega imena Kontakt za rodoslovje.";
$pgv_lang["META_PUBLISHER"]		= "META oznaka izdajatelja";
$pgv_lang["META_PUBLISHER_descr"]	= "Pusti to polje prazno za uporabo polnega imena Kontakt za rodoslovje.";
$pgv_lang["META_COPYRIGHT"]		= "META oznaka pravice kopiranja";
$pgv_lang["META_COPYRIGHT_descr"]	= "Pusti to polje prazno za uporabo polnega imena Kontakt za rodoslovje.";
...
$pgv_lang["edit_lang_utility_warning"]	= "Pozor!<br /><br />Če uporabite gumb <b>Zapri okno brez osvežitve</b> ne boste videli sprememb, ki ste jih vnesli, dokler ne osvežite stran. Možno je tudi, da bo datoteka za jezik uničena, če dodate sporočilo, ki se še ne nahaja v datoteki ali če ste popreje urejali sporočilo neposredno.<br /><br />Če ne veste kaj delate, potem ne uporabljajte gumba <b>Zapri okno brez osvežitve</b>.";

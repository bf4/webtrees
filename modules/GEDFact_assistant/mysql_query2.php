...
//Now Refresh the table .. id=from_mysql
	$row_count = 0;
	$output  = "<table width=\'220\' border=\'0\' cellpadding=\'0\' cellspacing=\'0\' class=\'table1\'>";
	$output .= "<tr>";
	...
	$output .= "<td width=\'20\' align=\'center\' bgcolor=\'#AAAAAA\'><span class=\'style1\'>Add</span></td>";
	$output .= "</tr>";
	...
	while ($rows = mysql_fetch_array($res_indis)) {
		...
		$output .= "<tr class=\'".$row_style."\'><td>".($row_count+1)."<td>".$srno."</td><td>".$u_name."</td><td align='center'><input type='checkbox' checked /></td></tr>";

...
<h3><?php print_help_link("SITEMAP", "qm", "SITEMAP"); echo i18n::translate('Generate Sitemap files')?></h3>
...
<form method="post" enctype="multipart/form-data" id="sitemap" name="sitemap" action="module.php?mod=sitemap">
	...
	<table class="facts_table width100">
		<tr>
			<td class="descriptionbox wrap width30"><?php print_help_link("SM_GEDCOM_SELECT", "qm", "SM_GEDCOM_SELECT"); echo i18n::translate('GEDCOMs to store in Sitemap:');?></td>
...
?>
		...
		<tr>
			<td class="descriptionbox wrap width30" rowspan="6">
				<?php print_help_link("SM_ITEM_SELECT", "qm", "SM_ITEM_SELECT"); echo i18n::translate('Selected items to store in Sitemap:');?>
			</td>

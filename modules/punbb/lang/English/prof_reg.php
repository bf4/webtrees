...
'Localisation legend'		=>	'Set your localization options',
'Timezone'					=>	'Timezone',
...
'Save user/pass info'		=>	'This option sets whether the forum should remember you between visits. If enabled, you will not have to login every time you visit the forum. You will be logged in automatically. Recommended, but you should not use this option when you access the forum from a publicly accessible computer.',
...
'Username reserved chars'	=>	'Usernames may not contain any of the characters \' or " or [ or ]. Please choose another username.',

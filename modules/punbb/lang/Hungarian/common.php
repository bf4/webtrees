...
'Bad referrer'			=>	'Rossz HTTP_REFERER. Egy érvénytelen forrástól küldtek erre a lapra. Ha a probléma továbbra is fennáll, ellenőrizd, hogy a \'Base URL\' helyesen van beállítva az Admin/Beállítások és hogy a fórumot a beállított címről látogatod. További információ a forrásokról a PunBB dokumentációban található meg.',
...
'Ban message'			=>	'Ki vagy tiltva erről a fórumról.',
'Ban message 2'			=>	'A tiltás lejár a hónap végén: ',
'Ban message 3'			=>	'Az adminisztrátor vagy moderátoroder, aki kitiltott, a következő üzenetet hagyta:',
'Ban message 4'			=>	'Ha kérdésed van, érdeklődj a fórum adminisztrátornál: ',
'Never'					=>	'Soha',
'Today'					=>	'Ma',
'Yesterday'				=>	'Tegnap',
...
'Click redirect'		=>	'Kattints ide, ha nem akarsz tovább várni (vagy ha a böngésződ nem továbbít automatikusan)',
'on'					=>	'be',		// as in "BBCode is on"
'off'					=>	'ki',
'Invalid e-mail'		=>	'A megadott e-mail cím érvénytelen.',
'required field'		=>	'egy szükséges mező ezen az űrlapon.',	// for javascript form validation
...
'New posts info'		=>	'A fórum első új üzenete.',	// the popup text for new posts links
...
'Code'					=>	'Kód',		// For [code]'s
'Mailer'				=>	'Levelező',	// As in "MyForums Mailer" in the signature of outgoing e-mails
...
'BBCode error 1'		=>	'Hiányzó kezdőcímke a [/quote]-hoz.',
'BBCode error 2'		=>	'Hiányzó zárócímke a [code]-hoz.',
'BBCode error 3'		=>	'Hiányzó kezdőcímke a [/code]-hoz.',
'BBCode error 4'		=>	'Hiányzik egy vagy több zárócímke a [quote]-hoz.',
'BBCode error 5'		=>	'Hiányzik egy vagy több kezdőcímke a [/quote]-hoz.',

...
//echo "<html>\n";
//echo created_by();
$pgvHeader = created_by();
//echo "<head>\n";
//echo "  <title>" . $text['title'], " -- ", $XPath->getData('/phpsysinfo/Vitals/Hostname'), " --</title>\n";

if (isset($charset) && $charset == 'euc-jp') {
$pgvHeader .= "  <meta http-equiv=\"content-type\" content=\"text/html;charset=$charset\">\n";
}
if (isset($refresh) && ($refresh = intval($refresh))) {
$pgvHeader .= "  <meta http-equiv=\"Refresh\" content=\"$refresh\">\n";
}
if (file_exists(APP_ROOT . "/templates/$template/$template.css")) {
$pgvHeader .= "  <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $webpath . "templates/" . $template . "/" . $template . ".css\">\n";
}

<?php 
/**
 * Search Plug-in for www.geneanet.org
 *
...
class AutoSearch extends Base_AutoSearch {
	function AutoSearch() {
		parent::__construct(
			...
			'http://search.geneanet.org/result.php3?',
			...
			array(
				'name'   =>array('function'=>'surname', 'extra'=>'checked="checked"'),
				'country'=>array('function'=>'country', 'extra'=>'checked="checked"'),
			)
		);
	}
}

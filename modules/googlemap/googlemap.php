...
global $GOOGLEMAP_ENABLED, $GOOGLEMAP_API_KEY, $GOOGLEMAP_MAP_TYPE, $GOOGLEMAP_MIN_ZOOM, $GOOGLEMAP_MAX_ZOOM, $GOOGLEMAP_XSIZE;
global $GOOGLEMAP_YSIZE, $GOOGLEMAP_PRECISION_0, $GOOGLEMAP_PRECISION_1, $GOOGLEMAP_PRECISION_2, $GOOGLEMAP_PRECISION_3;
global $GOOGLEMAP_PRECISION_4, $GOOGLEMAP_PRECISION_5, $GM_MAX_NOF_LEVELS, $GM_DEFAULT_TOP_VALUE, $GOOGLEMAP_COORD;
global $GOOGLEMAP_PLACE_HIERARCHY, $GOOGLEMAP_PH_XSIZE, $GOOGLEMAP_PH_YSIZE, $GOOGLEMAP_PH_MARKER, $GM_DISP_SHORT_PLACE;
global $GM_DISP_COUNT, $GOOGLEMAP_PH_WHEEL, $GOOGLEMAP_PH_CONTROLS, $GM_MARKER_COLOR, $GM_MARKER_SIZE, $GM_PREFIX, $GM_POSTFIX, $GM_PRE_POST_MODE;

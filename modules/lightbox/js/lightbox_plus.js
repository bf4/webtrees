...
//BH                var targ = { w:self._page.win.w - 30, h:self._page.win.h - 30 };
                var targ = { w:self._page.win.w - 18, h:self._page.win.h - 41 };
                var zoom = { x:2, y:2 };
...
//BH                                zoom.x = 15 + self._pos.x - self._imgpos.x;
                                zoom.x = 0 + self._pos.x - self._imgpos.x;
...
//BH                                zoom.y = 15 + self._pos.y - self._imgpos.y;
                                zoom.y = 0 + self._pos.y - self._imgpos.y;
                                navi.y = Math.floor(targ.h / 2) - 10 + self._pos.y - self._imgpos.y;
                        }
                        self._img.width  = width;
                        self._img.height = height;
// BH                       self._show_caption(false);
                        self._show_caption(true);						
        ...
        {
                var self = this;
//BH                if (self._zoomimg) self._zoomimg.style.display = 'none';
...
//BH                        if (closeBtn) closeBtn.style.display = 'none';
                }
        ...
        _show_caption : function(enable)
        {
                ...
                { // now display caption
                        caption.style.top = [self._img.height + 18,'px'].join(''); // 10 is top margin of lightbox
                        caption.style.left = '0px';
 // BH                      caption.style.width = [self._img.width + 16,'px'].join(''); // 20 is total side margin of lightbox
                        caption.style.width = [self._img.width + 16,'px'].join(''); // 16 is total side margin of lightbox						
...
Event.register(window,"load",function() {
        var lightbox = new LightBox({
                loadingimg:'modules/lightbox/images/loading.gif',
                expandimg:'modules/lightbox/images/zoom_1.gif',
                shrinkimg:'modules/lightbox/images/norm_2.gif',
                previmg:'modules/lightbox/images/prev.gif',
                nextimg:'modules/lightbox/images/next.gif',
                effectimg:'modules/lightbox/images/zzoop.gif',
                effectpos:{x:-40,y:-20},
                effectclass:'effectable',
                closeimg:'modules/lightbox/images/close_1.gif',
                resizable:true
        });
});
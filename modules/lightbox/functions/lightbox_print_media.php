...
// -----------------------------------------------------------------------------
	...
	$sqlmm .= "m_media, m_ext, m_file, m_titl, m_gedfile, rec_gedrec as m_gedrec, mm_gid, mm_gedrec FROM ".$TBLPREFIX."media, ".$TBLPREFIX."media_mapping, {$TBLPREFIX}records WHERE rec_xref=m_media AND rec_ged_id=m_file AND";
	$sqlmm .= "mm_gid IN (";
	$i=0;

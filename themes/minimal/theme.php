...
$PGV_USE_HELPIMG = false;		// set to true to use image for help questionmark, set to false to use i18n::translate('?')
...
$PGV_STATS_CHART_COLOR2 = "555555";
$PGV_STATS_CHART_COLOR3 = "cccccc";

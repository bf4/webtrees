...
loadLangFile('pgv_help, pgv_admin, pgv_editor, googlemap:lang, googlemap:help_text, lightbox:lang, lightbox:help_text, sitemap:lang, sitemap:help_text');
...
switch ($help) {
case 'ABBREVIATE_CHART_LABELS_help':
   $title=i18n::translate('Abbreviate chart labels');
   $text=i18n::translate('~Abbreviate chart labels~<br /><br />This option controls whether or not to abbreviate labels like <b>Birth</b> on charts with just the first letter like <b>B</b>.<br /><br />You can customize the abbreviations by supplying overriding values in the <i>languages/extra.xx.php</i> file for each language.  For example, if you want to use <b>*</b> instead of <b>N</b> to abbreviate the BIRT fact in the French language, you should put the following entry into the <i>languages/extra.fr.php</i> file:<br /><br /><code>$factAbbrev["BIRT"]&nbsp;=&nbsp;"*";</code><br /><br />The lengths of abbreviations specified this way are not limited to 1 character.<br />');
   break;
case 'ADVANCED_NAME_FACTS_help':
   $title=i18n::translate('Advanced name facts');
   $text=i18n::translate('~Advanced name facts~<br /><br />This is a comma separated list of GEDCOM fact tags that will be shown on the add/edit name form.  If you use non-Latin alphabets such as Hebrew, Greek, Cyrillic or Arabic, you may want to add tags such as _HEB, ROMN, FONE, etc. to allow you to store names in several different alphabets.<br />');
   break;
case 'ADVANCED_PLAC_FACTS_help':
   $title=i18n::translate('Advanced place name facts');
   $text=i18n::translate('~Advanced place name facts~<br /><br />This is a comma separated list of GEDCOM fact tags that will be shown when you add or edit place names.  If you use non-Latin alphabets such as Hebrew, Greek, Cyrillic or Arabic, you may want to add tags such as _HEB, ROMN, FONE, etc. to allow you to store place names in several different alphabets.<br />');
   break;
case 'ALLOW_CHANGE_GEDCOM_help':
   $title=i18n::translate('Allow GEDCOM switching');
   $text=i18n::translate('~Allow GEDCOM switching~<br /><br />If you have an environment with multiple GEDCOMs, setting this value to <b>Yes</b> allows your site visitors <u>and</u> users to have the option of changing GEDCOMs.  Setting it to <b>No</b> disables GEDCOM switching for both visitors <u>and</u> logged in users.<br />');
   break;
case 'ALLOW_EDIT_GEDCOM_help':
   $title=i18n::translate('Enable online editing');
   $text=i18n::translate('~Enable online editing~<br /><br />This option enables online editing features for this database so that users with Edit privileges may update data online.<br />');
   break;
case 'ALLOW_THEME_DROPDOWN_help':
   $title=i18n::translate('Display theme dropdown selector for theme changes');
   $text=i18n::translate('~Display theme dropdown selector for theme changes~<br /><br />Gives users the option of selecting their own theme from a menu.<br /><br />Even with this option set, the theme currently in effect may not provide for such a menu.  To be effective, this option requires the <b>Allow users to select their own theme</b> option to be set as well.<br />');
   break;
case 'ALLOW_USER_THEMES_help':
   $title=i18n::translate('Allow users to select their own theme');
   $text=i18n::translate('~Allow users to select their own theme~<br /><br />Gives users the option of selecting their own theme.<br />');
   break;
case 'AUTO_GENERATE_THUMBS_help':
   $title=i18n::translate('Automatically generated thumbnails');
   $text=i18n::translate('~Automatically generated thumbnails~<br /><br />Should the system automatically generate thumbnails for images that do not have them.  Your PHP installation might not support this functionality.<br />');
   break;
case 'BOM_detected_help':
...
case 'DB_UTF8_COLLATION_help':
   ...
   break;
case 'DEFAULT_PEDIGREE_GENERATIONS_help':
   $title=i18n::translate('Pedigree generations');
   $text=i18n::translate('~Pedigree generations~<br /><br />Set the default number of generations to display on Descendancy and Pedigree charts.<br />');
   break;
case 'DISPLAY_JEWISH_GERESHAYIM_help':
   $title=i18n::translate('Display Hebrew Gershayim');
   $text=i18n::translate('~Display Hebrew Gershayim~<br /><br />Show single and double quotes when displaying Hebrew dates.<br /><br />Setting this to <b>Yes</b> will display February 8 1969 as <span lang=\'he-IL\' dir=\'rtl\'>&#1499;\'&#160;&#1513;&#1489;&#1496;&#160;&#1514;&#1513;&#1499;&quot;&#1496;</span>&lrm; while setting it to <b>No</b> will display it as <span lang=\'he-IL\' dir=\'rtl\'>&#1499;&#160;&#1513;&#1489;&#1496;&#160;&#1514;&#1513;&#1499;&#1496;</span>&lrm;.  This has no impact on the Jewish year setting since quotes are not used in Jewish dates displayed with Latin characters.<br /><br />Note: This setting is similar to the PHP 5.0 Calendar constants CAL_JEWISH_ADD_ALAFIM_GERESH and CAL_JEWISH_ADD_GERESHAYIM.  This single setting affects both.<br />');
   break;
case 'DISPLAY_JEWISH_THOUSANDS_help':
   $title=i18n::translate('Display Hebrew Thousands');
   $text=i18n::translate('~Display Hebrew Thousands~<br /><br />Show Alafim in Hebrew calendars.<br /><br />Setting this to <b>Yes</b> will display the year 1969 as <span lang="he-IL" dir=\'rtl\'>&#1492;\'&#160;&#1514;&#1513;&#1499;&quot;&#1496;</span>&lrm; while setting it to <b>No</b> will display the year as <span lang="he-IL" dir=\'rtl\'>&#1514;&#1513;&#1499;&quot;&#1496;</span>&lrm;.  This has no impact on the Jewish year setting.  The year will display as 5729 regardless of this setting.<br /><br />Note: This setting is similar to the PHP 5.0 Calendar constant CAL_JEWISH_ADD_ALAFIM.<br />');
   break;
case 'EDIT_AUTOCLOSE_help':
   $title=i18n::translate('Autoclose edit window');
   $text=i18n::translate('~Autoclose edit window~<br /><br />This option controls whether or not to automatically close the Edit window after a successful update.<br />');
   break;
case 'ENABLE_AUTOCOMPLETE_help':
   $title=i18n::translate('Enable Autocomplete');
   $text=i18n::translate('~Enable Autocomplete~<br /><br />This option determines whether Autocomplete should be active while information is being entered into certain fields on input forms.  When this option is set to <b>Yes</b>, text input fields for which Autocomplete is possible are indicated by a differently colored background.<br /><br />When Autocomplete is active, PhpGedView will search its database for possible matches according to what you have already entered.  As you enter more information, the list of possible matches is refined.  When you see the desired input in the list of matches, you can move the mouse cursor to that line of the list and then click the left mouse button to complete the input.<br /><br />The disadvantages of Autocomplete are that it slows the program, entails significant database activity, and also results in more data being sent to the browser.<br />');
   break;
case 'ENABLE_CLIPPINGS_CART_help':
   $title=i18n::translate('Enable Clippings Cart');
   $text=i18n::translate('~Enable Clippings Cart~<br /><br />The clippings cart allows users to add people to a temporary file that they can download in GEDCOM format for subsequent import into their genealogy software.<br />');
   break;
case 'ENABLE_MULTI_LANGUAGE_help':
   $title=i18n::translate('Allow user to change language');
   $text=i18n::translate('~Allow user to change language~<br /><br />Set to <b>Yes</b> to allow users to override the site\'s default language.  They can do this through their browser\'s preferred language configuration, configuration options on their Account page, or through links or buttons on most PhpGedView pages.<br />');
   break;
case 'ENABLE_RSS_help':
   $title=i18n::translate('Enable RSS');
   $text=i18n::translate('~Enable RSS~<br /><br />This option lets you disable the RSS feature.<br /><br />RSS lets users monitor your site for changes to the Index page without actually visiting your site periodically.  If too many users make use of this feature or if the refresh frequency set by these users is too high, RSS can use up too much bandwidth or server capacity.<br /><br />This <a href=\'http://en.wikipedia.org/wiki/RSS\' target=\'_blank\' title=\'Wikipedia article\'><b>Wikipedia article</b></a> contains comprehensive information and links about RSS and the various RSS formats.<br />');
   break;
case 'EXPAND_NOTES_help':
   $title=i18n::translate('Automatically expand notes');
   $text=i18n::translate('~Automatically expand notes~<br /><br />This option controls whether or not to automatically display content of a <i>Note</i> record on the Individual page.<br />');
   break;
case 'EXPAND_RELATIVES_EVENTS_help':
   $title=i18n::translate('Automatically expand list of events of close relatives');
   $text=i18n::translate('~Automatically expand list of events of close relatives~<br /><br />This option controls whether or not to automatically expand the <i>Events of close relatives</i> list.<br />');
   break;
case 'EXPAND_SOURCES_help':
   $title=i18n::translate('Automatically expand sources');
   $text=i18n::translate('~Automatically expand sources~<br /><br />This option controls whether or not to automatically display content of a <i>Source</i> record on the Individual page.<br />');
   break;
case 'FAM_FACTS_ADD_help':
   $title=i18n::translate('Family Add Facts');
   $text=i18n::translate('~Family Add Facts~<br /><br />This is the list of GEDCOM facts that your users can add to families.  You can modify this list by removing or adding fact names, even custom ones, as necessary.  Fact names that appear in this list must not also appear in the <i>Unique Family Facts</i> list.<br />');
   break;
case 'FAM_FACTS_QUICK_help':
   $title=i18n::translate('Quick Family Facts');
   $text=i18n::translate('~Quick Family Facts~<br /><br />This is the short list of GEDCOM family facts that appears next to the full list and can be added with a single click.<br />');
   break;
case 'FAM_FACTS_UNIQUE_help':
   $title=i18n::translate('Unique Family Facts');
   $text=i18n::translate('~Unique Family Facts~<br /><br />This is the list of GEDCOM facts that your users can only add <u>once</u> to families.  For example, if MARR is in this list, users will not be able to add more than one MARR record to a family.  Fact names that appear in this list must not also appear in the <i>Family Add Facts</i> list.<br />');
   break;
case 'FAM_ID_PREFIX_help':
   $title=i18n::translate('Family ID prefix');
   $text=i18n::translate('~Family ID prefix~<br /><br />When a new family record is added online in PhpGedView, a new ID for that family will be generated automatically. The family ID will have this prefix.<br />');
   break;
case 'FAVICON_help':
   $title=i18n::translate('Favorites icon');
   $text=i18n::translate('~Favorites icon~<br /><br />Change this to point to the icon you want to display in peoples\' favorites menu when they bookmark your site.<br />');
   break;
case 'FULL_SOURCES_help':
   $title=i18n::translate('Use full source citations');
   $text=i18n::translate('~Use full source citations~<br /><br />Source citations can include fields to record the quality of the data (primary, secondary, etc.) and the date the event was recorded in the source.  If you don\'t use these fields, you can disable them when creating new source citations.<br />');
   break;
case 'GEDCOM_DEFAULT_TAB_help':
   $title=i18n::translate('Default tab to show on Individual page');
   $text=i18n::translate('~Default tab to show on Individual page~<br /><br />This option allows you to choose which tab opens automatically on the Individual page when that page is accessed.<br />');
   break;
case 'GEDCOM_ID_PREFIX_help':
   $title=i18n::translate('Individual ID prefix');
   $text=i18n::translate('~Individual ID prefix~<br /><br />When a new individual record is added online in PhpGedView, a new ID for that individual will be generated automatically. The individual ID will have this prefix.<br />');
   break;
case 'GENERATE_GUID_help':
   $title=i18n::translate('Automatically create globally unique IDs');
   $text=i18n::translate('~Automatically create globally unique IDs~<br /><br /><b>GUID</b> in this context is an acronym for &laquo;Globally Unique ID&raquo;.<br /><br />GUIDs are intended to help identify each individual in a manner that is repeatable, so that central organizations such as the Family History Center of the LDS Church in Salt Lake City, or even compatible programs running on your own server, can determine whether they are dealing with the same person no matter where the GEDCOM originates.  The goal of the Family History Center is to have a central repository of genealogical data and expose it through web services. This will enable any program to access the data and update their data within it.<br /><br />If you do not intend to share this GEDCOM with anyone else, you do not need to let PhpGedView create these GUIDs; however, doing so will do no harm other than increasing the size of your GEDCOM.<br />');
   break;
case 'HIDE_GEDCOM_ERRORS_help':
   $title=i18n::translate('Hide GEDCOM errors');
   $text=i18n::translate('~Hide GEDCOM errors~<br /><br />Setting this to <b>Yes</b> will hide error messages produced by PhpGedView when it doesn\'t understand a tag in your GEDCOM file.  PhpGedView makes every effort to conform to the GEDCOM 5.5.1 standard, but many genealogy software programs include their own custom tags.  See the <a href="readme.txt">readme.txt</a> file for more information.<br />');
   break;
case 'HIDE_LIVE_PEOPLE_help':
   $title=i18n::translate('Enable Privacy');
   $text=i18n::translate('~Enable Privacy~<br /><br />This option will enable all privacy settings and hide the details of living people.<br /><br />Living people are defined to be those who do not have an event more recent than the number of years specified in variable $MAX_ALIVE_AGE.  For this purpose, births of children are considered to be such events as well.<br />');
   break;
case 'HOME_SITE_TEXT_help':
   $title=i18n::translate('Main WebSite text');
   $text=i18n::translate('~Main WebSite text~<br /><br />The legend used to identify the link to your main Home page.<br />');
   break;
case 'HOME_SITE_URL_help':
   $title=i18n::translate('Main WebSite URL');
   $text=i18n::translate('~Main WebSite URL~<br /><br />Each PhpGedView page includes a link to your main Home page.  The appearance of this link is controlled by the theme being used.  You enter the actual URL to your Home site here.<br />');
   break;
case 'INDEX_DIRECTORY_help':
   $title=i18n::translate('Index file directory');
   $text=i18n::translate('~Index file directory~<br /><br />The path to a readable and writable directory where PhpGedView should store index files (include the trailing "/").  PhpGedView does not require this directory\'s name to be "index".  You can choose any name you like.<br /><br />For security, this directory should be placed somewhere in the server\'s file space that is not accessible from the Internet. An example of such a structure follows:<br /><b>PhpGedView:</b> dir1/dir2/dir3/PhpGedView<br /><b>Index:</b> dir1/dir4/dir5/dir6/index<br /><br />For the example shown, you would enter <b>../../dir4/dir5/dir6/index/</b> in this field.<br />');
   break;
case 'INDI_FACTS_ADD_help':
   $title=i18n::translate('Individual Add Facts');
   $text=i18n::translate('~Individual Add Facts~<br /><br />This is the list of GEDCOM facts that your users can add to individuals.  You can modify this list by removing or adding fact names, even custom ones, as necessary.  Fact names that appear in this list must not also appear in the <i>Unique Individual Facts</i> list.<br />');
   break;
case 'INDI_FACTS_QUICK_help':
   $title=i18n::translate('Quick Individual Facts');
   $text=i18n::translate('~Quick Individual Facts~<br /><br />This is the short list of GEDCOM individual facts that appears next to the full list and can be added with a single click.<br />');
   break;
case 'INDI_FACTS_UNIQUE_help':
   $title=i18n::translate('Unique Individual Facts');
   $text=i18n::translate('~Unique Individual Facts~<br /><br />This is the list of GEDCOM facts that your users can only add <u>once</u> to individuals.  For example, if BIRT is in this list, users will not be able to add more than one BIRT record to an individual.  Fact names that appear in this list must not also appear in the <i>Individual Add Facts</i> list.<br />');
   break;
case 'JEWISH_ASHKENAZ_PRONUNCIATION_help':
   $title=i18n::translate('Jewish Ashkenaz pronunciation');
   $text=i18n::translate('~Jewish Ashkenaz pronunciation~<br /><br />Use Jewish Ashkenazi pronunciations.<br /><br />When set to <b>Yes</b> the months Cheshvan and Teves will be spelled with Ashkenazi pronunciation.  Setting it to <b>No</b> will change the months to Hesvan and Tevet.  This only affects the Jewish setting.  The Hebrew setting will always use the Hebrew alphabet.<br />');
   break;
case 'LANGUAGE_help':
   $title=i18n::translate('Language');
   $text=i18n::translate('~Language~<br /><br />Assign the default language for the site.<br /><br />When the <b>Allow user to change language</b> option is set, users can override this setting through their browser\'s preferred language configuration, configuration options on their Account page, or through links or buttons on most PhpGedView pages.<br />');
   break;
case 'LANG_SELECTION_help':
   $title=i18n::translate('Supported languages');
   $text=i18n::translate('~Supported languages~<br /><br />You can change the list of languages supported by your PhpGedView site by adding or removing checkmarks as appropriate.  This changes the language choices available to your users.<br /><br />You can achieve the same thing through the <b>Configure supported languages</b> link on the Admin menu, where you can also change things such as the language\'s flag icon, the date format, or whether the surname should always be printed first.<br />');
   break;
case 'LINK_ICONS_help':
   $title=i18n::translate('PopUp links on charts');
   $text=i18n::translate('~PopUp links on charts~<br /><br />Allows the user to select links to other charts and close relatives of the person.<br /><br />Set to <b>Disabled</b> to disable this feature.  Set to <b>On Mouse Over</b> to popup the links when the user mouses over the icon in the box.  Set to <b>On Mouse Click</b> to popup the links when the user clicks on the icon in the box.<br />');
   break;
case 'LOGFILE_CREATE_help':
   $title=i18n::translate('Archive log files');
   $text=i18n::translate('~Archive log files~<br /><br />How often should the program archive log files.<br />');
   break;
case 'LOGIN_URL_help':
   $title=i18n::translate('Login URL');
   $text=i18n::translate('~Login URL~<br /><br />You only need to enter a Login URL if you want to redirect to a different site or location when your users login.  This is very useful if you need to switch from http to https when your users login.  Include the full URL to <i>login.php</i>.  For example, https://www.yourserver.com/phpgedview/login.php .<br />');
   break;
case 'MAX_ALIVE_AGE_help':
   $title=i18n::translate('Age at which to assume a person is dead');
   $text=i18n::translate('~Age at which to assume a person is dead~<br /><br />If this person has any events other than Death, Burial, or Cremation more recent than this number of years, he is considered to be "alive".  Children\'s birth dates are considered to be such events for this purpose.<br />');
   break;
case 'MAX_DESCENDANCY_GENERATIONS_help':
   $title=i18n::translate('Maximum Descendancy generations');
   $text=i18n::translate('~Maximum Descendancy generations~<br /><br />Set the maximum number of generations to display on Descendancy charts.<br />');
   break;
case 'MAX_PEDIGREE_GENERATIONS_help':
   $title=i18n::translate('Maximum Pedigree generations');
   $text=i18n::translate('~Maximum Pedigree generations~<br /><br />Set the maximum number of generations to display on Pedigree charts.<br />');
   break;
case 'MAX_RELATION_PATH_LENGTH_help':
   $title=i18n::translate('Max. relation path length');
   $text=i18n::translate('~Max. relation path length~<br /><br />If the <i>Use relationship privacy</i> option is enabled, logged-in users will only be able to see or edit individuals within this number of relationship steps.<br /><br />This option sets the default for all users who have access to this genealogical database.  The Administrator can override this option for individual users by editing the user\'s account details.<br />');
   break;
case 'MAX_VIEW_RATE_help':
   $title=i18n::translate('Maximum page view rate');
   $text=i18n::translate('~Maximum page view rate~<br /><br />This option limits the rate at which a user can view pages.<br /><br />If that rate is exceeded, PhpGedView treats the session as a hacking attempt;  the session will be terminated with a suitable message.  These two values should place a reasonable limit on the amount of bandwith and downloaded bytes from the server.  This feature can be switched off by setting the time interval to 0.<br />');
   break;
case 'MEDIA_DIRECTORY_LEVELS_help':
   $title=i18n::translate('Multi-Media directory levels to keep');
   $text=i18n::translate('~Multi-Media directory levels to keep~<br /><br />A value of 0 will ignore all directories in the file path for the media object.  A value of 1 will retain the first directory containing this image.  Increasing the numbers increases number of parent directories to retain in the path.<br /><br />For example, if you link an image in your GEDCOM with a path like <b>C:\Documents&nbsp;and&nbsp;Settings\User\My&nbsp;Documents\My&nbsp;Pictures\Genealogy\Surname&nbsp;Line\grandpa.jpg</b>, a value of 0 will translate this path to <b>./media/grandpa.jpg</b>.  A value of 1 will translate this to <b>./media/Surname&nbsp;Line/grandpa.jpg</b>, etc.  Most people will only need to use a 0.  However, it is possible that some media objects kept in different directories have identical names and would overwrite each other when this option is set to 0.  Non-zero settings allow you to keep some organization in your media thereby preventing name collisions.<br />');
   break;
case 'MEDIA_DIRECTORY_help':
   $title=i18n::translate('MultiMedia directory');
   $text=i18n::translate('~MultiMedia directory~<br /><br />The path to a readable and writable directory where PhpGedView should store media files (include the trailing "/").  PhpGedView does not require this directory\'s name to be "media".  You can choose any name you like.<br /><br />Even though the Media Firewall feature lets you store media files in an area of the server\'s file space that is not accessible from the Internet, the directory named here must still exist and must be readable from the Internet and writable by PhpGedView.  For more information, please refer to the Media Firewall configuration options in the Multimedia section of the GEDCOM configuration page.<br />');
   break;
case 'MEDIA_EXTERNAL_help':
   $title=i18n::translate('Keep links');
   $text=i18n::translate('~Keep links~<br /><br />When a multimedia link is found starting with for example http://, ftp://, mms:// it will not be altered when set to <b>Yes</b>. For example, http://www.myfamily.com/photo/dad.jpg will stay http://www.myfamily.com/photo/dad.jpg.  When set to <b>No</b>, the link will be handled as a standard reference and the media depth will be used.  For example: http://www.myfamily.com/photo/dad.jpg will be changed to ./media/dad.jpg<br />');
   break;
case 'MEDIA_FIREWALL_ROOTDIR_help':
   $title=i18n::translate('Media Firewall Root Directory');
   $text=i18n::translate('~Media Firewall Root Directory~<br /><br />Directory in which the protected Media directory can be created.  When this field is empty, the <b>#GLOBALS[INDEX_DIRECTORY]#</b> directory will be used.<br />');
   break;
case 'MEDIA_FIREWALL_THUMBS_help':
   $title=i18n::translate('Protect Thumbnails of Protected Images');
   $text=i18n::translate('~Protect Thumbnails of Protected Images~<br /><br />When an image is in the protected Media directory, should its thumbnail be protected as well?<br />');
   break;
case 'MEDIA_ID_PREFIX_help':
   $title=i18n::translate('Media ID prefix');
   $text=i18n::translate('~Media ID prefix~<br /><br />When a new media record is added online in PhpGedView, a new ID for that media will be generated automatically. The media ID will have this prefix.<br />');
   break;
case 'META_AUDIENCE_help':
   $title=i18n::translate('Audience META tag');
   $text=i18n::translate('~Audience META tag~<br /><br />The value to place in the Audience meta tag in the HTML page header.<br />');
   break;
case 'META_AUTHOR_help':
   $title=i18n::translate('Author META tag');
   $text=i18n::translate('~Author META tag~<br /><br />The value to place in the Author meta tag in the HTML page header.  Leave this field empty to use the full name of the Genealogy contact.<br />');
   break;
case 'META_COPYRIGHT_help':
   $title=i18n::translate('Copyright META tag');
   $text=i18n::translate('~Copyright META tag~<br /><br />The value to place in the Copyright meta tag in the HTML page header.  Leave this field empty to use the full name of the Genealogy contact.<br />');
   break;
case 'META_DESCRIPTION_help':
   $title=i18n::translate('Description META tag');
   $text=i18n::translate('~Description META tag~<br /><br />The value to place in the Description meta tag in the HTML page header.  Leave this field empty to use the title of the currently active database.<br />');
   break;
case 'META_KEYWORDS_help':
   $title=i18n::translate('Keywords META tag');
   $text=i18n::translate('~Keywords META tag~<br /><br />The value to place in the Keywords meta tag in the HTML page header.  Some search engines will use the Keywords meta tag to help index your page.<br /><br />The Most Common Surnames list that appears in the GEDCOM Statistics block on your Welcome page can also be added to anything you enter here.<br />');
   break;
case 'META_PAGE_TOPIC_help':
   $title=i18n::translate('Page-topic META tag');
   $text=i18n::translate('~Page-topic META tag~<br /><br />The value to place in the Page-topic meta tag in the HTML page header.  Leave this field empty to use the title of the currently active database.<br />');
   break;
case 'META_PAGE_TYPE_help':
   $title=i18n::translate('Page-type META tag');
   $text=i18n::translate('~Page-type META tag~<br /><br />The value to place in the Page-type meta tag in the HTML page header.<br />');
   break;
case 'META_PUBLISHER_help':
   $title=i18n::translate('Publisher META tag');
   $text=i18n::translate('~Publisher META tag~<br /><br />The value to place in the Publisher meta tag in the HTML page header.  Leave this field empty to use the full name of the Genealogy contact.<br />');
   break;
case 'META_REVISIT_help':
   $title=i18n::translate('How often should crawlers revisit META tag');
   $text=i18n::translate('~How often should crawlers revisit META tag~<br /><br />The value to place in the Revisit meta tag in the HTML page header.  Some web crawlers ignore this value.<br />');
   break;
case 'META_ROBOTS_help':
   $title=i18n::translate('Robots META tag');
   $text=i18n::translate('~Robots META tag~<br /><br />The value to place in the Robots meta tag in the HTML page header.  Some robots or web crawlers ignore this value.<br />');
   break;
case 'META_TITLE_help':
   $title=i18n::translate('Add to TITLE header tag');
   $text=i18n::translate('~Add to TITLE header tag~<br /><br />Anything on this line will be added to the TITLE tag in the HTML page header after the regular page title and before the PhpGedView credit.<br />');
   break;
case 'MULTI_MEDIA_help':
   $title=i18n::translate('Enable multimedia features');
   $text=i18n::translate('~Enable multimedia features~<br /><br />GEDCOM 5.5.1 allows you to link pictures, videos, and other multimedia objects into your GEDCOM.  If you do not include multimedia objects in your GEDCOM, you can disable the multimedia features by setting this value to <b>No</b>.<br /><br />See the Multimedia section in the <a href="readme.txt">readme.txt</a> file for more information about including media in your site.<br />');
   break;
case 'PAGE_AFTER_LOGIN_help':
   $title=i18n::translate('Page to show after Login');
   $text=i18n::translate('~Page to show after Login~<br /><br />Which page should users see after they have logged in?<br /><br />The choice made here determines whether a successful Login causes the Welcome or the MyGedView page to appear when the login is done from the Welcome page.<br /><br />A Login done from the link at the top of every other page will return the user to that page.<br />');
   break;
case 'PEDIGREE_FULL_DETAILS_help':
   $title=i18n::translate('Show Birth and Death details on charts');
   $text=i18n::translate('~Show Birth and Death details on charts~<br /><br />This option controls whether or not to show the Birth and Death details of an individual on charts.<br />');
   break;
case 'PEDIGREE_GENERATIONS_help':
   $title=i18n::translate('PEDIGREE_GENERATIONS_help');
   ...
   break;
case 'PEDIGREE_LAYOUT_help':
   $title=i18n::translate('Default Pedigree chart layout');
   $text=i18n::translate('~Default Pedigree chart layout~<br /><br />This option indicates whether the Pedigree chart should be generated in landscape or portrait mode.<br />');
   break;
case 'PEDIGREE_ROOT_ID_help':
   $title=i18n::translate('Default person for Pedigree and Descendancy charts');
   $text=i18n::translate('~Default person for Pedigree and Descendancy charts~<br /><br />Set the ID of the default person to display on Pedigree and Descendancy charts.<br />');
   break;
case 'PEDIGREE_SHOW_GENDER_help':
   $title=i18n::translate('Show gender icon on charts');
   $text=i18n::translate('~Show gender icon on charts~<br /><br />This option controls whether or not to show the individual\'s gender icon on charts.<br /><br />Since the gender is also indicated by the color of the box, this option doesn\'t conceal the gender. The option simply removes some duplicate information from the box.<br />');
   break;
case 'PGV_MEMORY_LIMIT_help':
   $title=i18n::translate('Memory limit');
   $text=i18n::translate('~Memory limit~<br /><br />The maximum amount of memory that can be consumed by PhpGedView scripts.  The default is 32 Mb.  Many hosts disable this option in their PHP configuration; changing this value may not actually affect the current maximum memory setting.<br />');
   break;
case 'PGV_SESSION_SAVE_PATH_help':
   $title=i18n::translate('Session save path');
   $text=i18n::translate('~Session save path~<br /><br />The path to store PhpGedView session files.<br /><br />Some hosts do not have PHP configured properly and sessions are not maintained between page requests.  This option lets site administrators overcome that problem by saving files in one of their local directories.  The ./index/ directory is a good choice if you need to change this.  The default is to leave the field empty, which will use the Save path as configured in <i>php.ini</i>.<br />');
   break;
case 'PGV_SESSION_TIME_help':
   $title=i18n::translate('Session timeout');
   $text=i18n::translate('~Session timeout~<br /><br />The time in seconds that a PhpGedView session remains active before requiring a login.  The default is 7200, which is 2 hours.<br />');
   break;
case 'PGV_SIMPLE_MAIL_help':
   $title=i18n::translate('Use simple mail headers in external mails');
   $text=i18n::translate('~Use simple mail headers in external mails~<br /><br />In normal mail headers for external mails, the email address as well as the name are used. Some mail systems will not accept this. When set to <b>Yes</b>, only the email address will be used.<br />');
   break;
case 'PGV_SMTP_ACTIVE_help':
   $title=i18n::translate('Use SMTP to send external mails');
   $text=i18n::translate('~Use SMTP to send external mails~<br /><br />Use SMTP to send e-mails from PhpGedView.<br /><br />This option requires access to an SMTP mail server.  When set to <b>No</b> PhpGedView will use the e-mail system built into PHP on this server.<br />');
   break;
case 'PGV_SMTP_AUTH_PASS_help':
   $title=i18n::translate('Password');
   $text=i18n::translate('~Password~<br /><br />The password required for authentication with the SMTP server.<br />');
   break;
case 'PGV_SMTP_AUTH_USER_help':
   $title=i18n::translate('User name');
   $text=i18n::translate('~User name~<br /><br />The user name required for authentication with the SMTP server.<br />');
   break;
case 'PGV_SMTP_AUTH_help':
   $title=i18n::translate('Use name and password');
   $text=i18n::translate('~Use name and password~<br /><br />Use name and password authentication to connect to the SMTP server.<br /><br />Some SMTP servers require all connections to be authenticated before they will accept outbound e-mails.<br />');
   break;
case 'PGV_SMTP_FROM_NAME_help':
   $title=i18n::translate('Sender name');
   $text=i18n::translate('~Sender name~<br /><br />Enter the name to be used in the &laquo;From:&raquo; field of e-mails originating at this site.<br /><br />For example, if your name is <b>John Smith</b> and you are the site administrator for a site that is  known as <b>Jones Genealogy</b>, you could enter something like <b>John Smith</b> or <b>Jones Genealogy</b> or even <b>John Smith, Administrator: Jones Genealogy</b>.  You may enter whatever you wish, but HTML is not permitted.<br />');
   break;
case 'PGV_SMTP_HELO_help':
   $title=i18n::translate('Sending domain name');
   $text=i18n::translate('~Sending domain name~<br /><br />This is the domain part of a valid e-mail address on the SMTP server.<br /><br />For example, if you have an e-mail account such as <b>yourname@abc.xyz.com</b>, you would enter <b>abc.xyz.com</b> here.<br />');
   break;
case 'PGV_SMTP_HOST_help':
   $title=i18n::translate('Outgoing server (SMTP) name');
   $text=i18n::translate('~Outgoing server (SMTP) name~<br /><br />This is the name of the SMTP mail server.  Example: <b>smtp.foo.bar.com</b>.<br /><br />Configuration values for some e-mail providers:<br /><br /><b>Gmail<br /></b><br /><b>Outgoing server (SMTP) name:</b> smtp.gmail.com<br /><b>SMTP Port:</b> 465 or 587<br /><b>Secure connection:</b> SSL<br /><br /><b>Hotmail<br /></b><br /><b>Outgoing server (SMTP) name:</b> smtp.live.com<br /><b>SMTP Port:</b> 25 or 587<br /><b>Secure connection:</b> TLS<br /><br /><b>Yahoo Mail Plus (currently a paid service)<br /></b><br /><b>Outgoing server (SMTP) name:</b> smtp.mail.yahoo.com<br /><b>SMTP Port:</b> 25<br />');
   break;
case 'PGV_SMTP_PORT_help':
   $title=i18n::translate('SMTP Port');
   $text=i18n::translate('~SMTP Port~<br /><br />The port number to be used for connections to the SMTP server.  Generally, this is port <b>25</b>.<br />');
   break;
case 'PGV_SMTP_SSL_help':
   $title=i18n::translate('Secure connection');
   $text=i18n::translate('~Secure connection~<br /><br />Transport Layer Security (TLS) and Secure Sockets Layer (SSL) are Internet data encryption protocols.<br /><br />TLS 1.0, 1.1 and 1.2 are standardized developments of SSL 3.0. TLS 1.0 and SSL 3.1 are equivalent. Further work on SSL is now done under the new name, TLS.<br /><br />If your SMTP Server requires the SSL protocol during login, you should select the <b>SSL</b> option. If your SMTP Server requires the TLS protocol during login, you should select the <b>TLS</b> option.<br />');
   break;
case 'PGV_STORE_MESSAGES_help':
   $title=i18n::translate('Allow messages to be stored online');
   $text=i18n::translate('~Allow messages to be stored online~<br /><br />Specifies whether messages sent through PhpGedView can be stored in the database.  If set to <b>Yes</b> users will be able to retrieve their messages when they login to PhpGedView.  If set to <b>No</b> messages will only be emailed.<br />');
   break;
case 'PHPGEDVIEW_EMAIL_help':
   $title=i18n::translate('PhpGedView reply address');
   $text=i18n::translate('~PhpGedView reply address~<br /><br />E-mail address to be used in the &laquo;From:&raquo; field of e-mails that PhpGedView creates automatically.<br /><br />PhpGedView can automatically create e-mails to notify administrators of changes that need to be reviewed.  PhpGedView also sends notification e-mails to users who have requested an account.<br /><br />Usually, the &laquo;From:&raquo; field of these automatically created e-mails is something like <i>From: phpgedview-noreply@yoursite</i> to show that no response to the e-mail is required.  To guard against spam or other e-mail abuse, some e-mail systems require each message\'s &laquo;From:&raquo; field to reflect a valid e-mail account and will not accept messages that are apparently from account <i>phpgedview-noreply</i>.<br />');
   break;
case 'POSTAL_CODE_help':
   $title=i18n::translate('Postal Code position');
   $text=i18n::translate('~Postal Code position~<br /><br />Different countries use different ways to write the address. This option will enable you to place the postal code either before or after the city name.<br />');
   break;
case 'PREFER_LEVEL2_SOURCES_help':
   $title=i18n::translate('Source type');
   $text=i18n::translate('~Source type~<br /><br />When adding new close relatives, you can add source citations to the records (e.g. INDI, FAM) or the facts (BIRT, MARR, DEAT).  This option controls which checkboxes are ticked by default.<br />');
   break;
case 'PRIVACY_BY_RESN_help':
   $title=i18n::translate('Use GEDCOM (RESN) Privacy restriction');
   $text=i18n::translate('~Use GEDCOM (RESN) Privacy restriction~<br /><br />The GEDCOM 5.5.1 specification includes the option of using RESN tags to set Privacy options for people and facts in the GEDCOM file.  Enabling this option will tell the program to look for level 1 RESN tags in GEDCOM records.  Level 2+ RESN tags are automatically applied and will not be affected by this setting.  Note that this might slow down some of the functions of PhpGedView such as the Individual list.<br />');
   break;
case 'PRIVACY_BY_YEAR_help':
   $title=i18n::translate('Limit Privacy by age of event');
   $text=i18n::translate('~Limit Privacy by age of event~<br /><br />The <b>Limit Privacy by age of event</b> setting will hide the details of people based on how old they were at specific events regardless of whether they are dead or alive.<br /><br />Use this setting along with the <b>Age at which to assume a person is dead</b> setting.  For example, if you made the Age setting 100 and set this option to <b>Yes</b>, all persons, alive or dead, born less than 100 years ago would be set to private.  People who were married less than 85 years ago and people who died less than 75 years ago would also be marked as private.  Please note that using this option will slow down your performance somewhat.<br />');
   break;
case 'QUICK_REQUIRED_FACTS_help':
   $title=i18n::translate('Facts to always show on Quick Update');
   $text=i18n::translate('~Facts to always show on Quick Update~<br /><br />This is a comma separated list of GEDCOM fact tags that will always be shown on the Quick Update form whether or not they already exist in the individual\'s record.  For example, if BIRT is in the list, fields for birth date and birth place will always be shown on the form.<br />');
   break;
case 'QUICK_REQUIRED_FAMFACTS_help':
   $title=i18n::translate('Facts for families to always show on Quick Update');
   $text=i18n::translate('~Facts for families to always show on Quick Update~<br /><br />This is a comma separated list of GEDCOM fact tags that will always be shown on the Family tabs of the Quick Update form whether or not they already exist in the family\'s record.  For example, if MARR is in the list, then fields for marriage date and marriage place will always be shown on the form.<br />');
   break;
case 'REPO_FACTS_ADD_help':
   $title=i18n::translate('Repository Add Facts');
   $text=i18n::translate('~Repository Add Facts~<br /><br />This is the list of GEDCOM facts that your users can add to repositories.  You can modify this list by removing or adding fact names, even custom ones, as necessary.  Fact names that appear in this list must not also appear in the <i>Unique Repository Facts</i> list.<br />');
   break;
case 'REPO_FACTS_QUICK_help':
   $title=i18n::translate('Quick Repository Facts');
   $text=i18n::translate('~Quick Repository Facts~<br /><br />This is the short list of GEDCOM repository facts that appears next to the full list and can be added with a single click.<br />');
   break;
case 'REPO_FACTS_UNIQUE_help':
   $title=i18n::translate('Unique Repository Facts');
   $text=i18n::translate('~Unique Repository Facts~<br /><br />This is the list of GEDCOM facts that your users can only add <u>once</u> to repositories.  For example, if NAME is in this list, users will not be able to add more than one NAME record to a repository.  Fact names that appear in this list must not also appear in the <i>Repository Add Facts</i> list.<br />');
   break;
case 'REPO_ID_PREFIX_help':
   $title=i18n::translate('Repository ID prefix');
   $text=i18n::translate('~Repository ID prefix~<br /><br />When a new repository record is added online in PhpGedView, a new ID for that repository will be generated automatically. The repository ID will have this prefix.<br />');
   break;
case 'REQUIRE_ADMIN_AUTH_REGISTRATION_help':
   $title=i18n::translate('Require an administrator to approve new user registrations');
   $text=i18n::translate('~Require an administrator to approve new user registrations~<br /><br />If the option <b>Allow visitors to request account registration</b> is enabled this setting controls whether the admin must approve the registration.<br /><br />Setting this to <b>Yes</b> will require that all new users first verify themselves and then be approved by an admin before they can login.  With this setting on <b>No</b>, the <b>User approved by Admin</b> checkbox will be checked automatically when users verify their account, thus allowing an immediate login afterwards without admin intervention.<br />');
   break;
case 'REQUIRE_AUTHENTICATION_help':
   $title=i18n::translate('Require visitor authentication');
   $text=i18n::translate('~Require visitor authentication~<br /><br />Enabling this option will force all visitors to login before they can view any data on the site.<br />');
   break;
case 'RESN_help':
   $title=i18n::translate('RESN_help');
   ...
   break;
case 'RSS_FORMAT_help':
   $title=i18n::translate('RSS Format');
   $text=i18n::translate('~RSS Format~<br /><br />The format to be used as the default feed format for the site. The numeric suffixes <u>do not</u> indicate version: they identify formats.  For example, RSS 2.0 is not newer than RSS 1.0, but a different format. Feed readers should be able to read any format.<br /><br />This <a href=\'http://en.wikipedia.org/wiki/RSS\' target=\'_blank\'title=\'Wikipedia article\'><b>Wikipedia article</b></a> contains comprehensive information and links about RSS and the various RSS formats.<br />');
   break;
case 'SAVE_WATERMARK_IMAGE_help':
   $title=i18n::translate('Store watermarked full size images on server?');
   $text=i18n::translate('~Store watermarked full size images on server?~<br /><br />If the Media Firewall is enabled, should copies of watermarked full size images be stored on the server in addition to the same images without watermarks?<br /><br />When set to <b>Yes</b>, full-sized watermarked images will be produced more quickly at the expense of higher server disk space requirements.<br />');
   break;
case 'SAVE_WATERMARK_THUMB_help':
   $title=i18n::translate('Store watermarked thumbnails on server?');
   $text=i18n::translate('~Store watermarked thumbnails on server?~<br /><br />If the Media Firewall is enabled, should copies of watermarked thumbnails be stored on the server in addition to the same thumbnails without watermarks?<br /><br />When set to <b>Yes</b>, media lists containing watermarked thumbnails will be produced more quickly at the expense of higher server disk space requirements.<br />');
   break;
case 'SEARCHLOG_CREATE_help':
   $title=i18n::translate('Archive SearchLog files');
   $text=i18n::translate('~Archive SearchLog files~<br /><br />How often should the program archive Searchlog files.<br />');
   break;
case 'SECURITY_CHECK_GEDCOM_DOWNLOADABLE_help':
   $title=i18n::translate('Check if GEDCOM files are downloadable');
   $text=i18n::translate('~Check if GEDCOM files are downloadable~<br /><br />For security reasons, GEDCOM files should not be in a location where they can be directly downloaded, thus bypassing privacy checks. Clicking this link will check if your GEDCOM files can be downloaded over the network.<br /><br />On some systems this check has been known to take a really long time or not even complete.  If that is the case for you, then you should try to point your browser directly at your GEDCOM to see if it can be downloaded.<br />');
   break;
case 'SERVER_URL_help':
   $title=i18n::translate('PhpGedView URL');
   $text=i18n::translate('~PhpGedView URL~<br /><br />If you use https or a port other than the default, you will need to enter the URL to access your server here.<br />');
   break;
case 'SHOW_AGE_DIFF_help':
   $title=i18n::translate('Show Date Differences');
   $text=i18n::translate('~Show Date Differences~<br /><br />This option controls whether or not the Close Relatives tab should show differences between birth dates of spouses, between marriage date and birth date of first child, and between birth dates of children.<br />');
   break;
case 'SHOW_CONTEXT_HELP_help':
   $title=i18n::translate('Show contextual <b>?</b> Help links');
   $text=i18n::translate('~Show contextual <b>?</b> Help links~<br /><br />This option will enable links, identified by question marks, next to items on many pages.  These links allow users to get information or help about those items.<br />');
   break;
case 'SHOW_COUNTER_help':
   $title=i18n::translate('Show hit counters');
   $text=i18n::translate('~Show hit counters~<br /><br />Show hit counters on Portal and Individual pages.<br />');
   break;
case 'SHOW_DEAD_PEOPLE_help':
   $title=i18n::translate('Show dead people');
   $text=i18n::translate('~Show dead people~<br /><br />Set the privacy access level for all dead people.<br />');
   break;
case 'SHOW_EMPTY_BOXES_help':
   $title=i18n::translate('Show empty boxes on Pedigree charts');
   $text=i18n::translate('~Show empty boxes on Pedigree charts~<br /><br />This option controls whether or not to show empty boxes on Pedigree charts.<br />');
   break;
case 'SHOW_EST_LIST_DATES_help':
   $title=i18n::translate('Show estimated dates for birth and death');
   $text=i18n::translate('~Show estimated dates for birth and death~<br /><br />This option controls whether or not to show estimated dates for birth and death instead of leaving blanks on individual lists and charts for individuals whose dates are not known.<br />');
   break;
case 'SHOW_FACT_ICONS_help':
   $title=i18n::translate('Show Fact icons');
   $text=i18n::translate('~Show Fact icons~<br /><br />Set this to <b>Yes</b> to display icons near Fact names on the Personal Facts and Details page.  Fact icons will be displayed only if they exist in the <i>images/facts</i> directory of the current theme.<br />');
   break;
case 'SHOW_GEDCOM_RECORD_help':
   $title=i18n::translate('Allow users to see raw GEDCOM records');
   $text=i18n::translate('~Allow users to see raw GEDCOM records~<br /><br />Setting this to <b>Yes</b> will place links on individuals, sources, and families to let users bring up another window containing the raw data taken right out of the GEDCOM file.<br />');
   break;
case 'SHOW_HIGHLIGHT_IMAGES_help':
   $title=i18n::translate('Show highlight images in people boxes');
   $text=i18n::translate('~Show highlight images in people boxes~<br /><br />If you have enabled multimedia in your site, you can have PhpGedView display a thumbnail image next to the person\'s name in charts and boxes.<br /><br />Currently, PhpGedView uses the first multimedia object listed in the GEDCOM record as the highlight image.  For people with multiple images, you should arrange the multimedia objects such that the one you wish to be highlighted appears first, before any others.<br /><br />See the Multimedia section in the <a href="readme.txt">readme.txt</a> file for more information about including media in your site.<br />');
   break;
case 'SHOW_ID_NUMBERS_help':
   $title=i18n::translate('Show ID numbers next to names');
   $text=i18n::translate('~Show ID numbers next to names~<br /><br />This option controls whether or not to show ID numbers in parentheses after names on charts and lists.<br />');
   break;
case 'SHOW_LAST_CHANGE_help':
   $title=i18n::translate('Show GEDCOM record last change date on lists');
   $text=i18n::translate('~Show GEDCOM record last change date on lists~<br /><br />This option controls whether or not to show GEDCOM record last change date on lists.<br />');
   break;
case 'SHOW_LDS_AT_GLANCE_help':
   $title=i18n::translate('Show LDS ordinance codes in chart boxes');
   $text=i18n::translate('~Show LDS ordinance codes in chart boxes~<br /><br />Setting this option to <b>Yes</b> will show status codes for LDS ordinances in chart boxes.<ul><li><b>B</b> - Baptism</li><li><b>E</b> - Endowed</li><li><b>S</b> - Sealed to spouse</li><li><b>P</b> - Sealed to parents</li></ul>A person who has all of the ordinances done will have <b>BESP</b> printed after their name.  Missing ordinances are indicated by <b>_</b> in place of the corresponding letter code.  For example, <b>BE__</b> indicates missing <b>S</b> and <b>P</b> ordinances.<br />');
   break;
case 'SHOW_LEVEL2_NOTES_help':
   $title=i18n::translate('Show all Notes and Source references on Notes and Sources tabs');
   $text=i18n::translate('~Show all Notes and Source references on Notes and Sources tabs~<br /><br />This option controls whether Notes and Source references that are attached to Facts should be shown on the Notes and Sources tabs of the Individual page.<br /><br />Ordinarily, the Notes and Sources tabs show only Notes and Source references that are attached directly to the individual\'s database record.  These are <i>level 1</i> Notes and Source references.<br /><br />The <b>Yes</b> option causes these tabs to also show Notes and Source references that are part of the various Facts in the individual\'s database record.  These are <i>level 2</i> Notes and Source references because the various Facts are at level 1.<br />');
   break;
case 'SHOW_LIST_PLACES_help':
   $title=i18n::translate('Place levels to show on lists');
   $text=i18n::translate('~Place levels to show on lists~<br /><br />This determines how much of the Place information is shown in the Place fields on lists.<br /><br />Setting the value to <b>9</b> will ensure that all Place information will be shown.  Setting the value to <b>0</b> (zero) will hide places completely.  Setting the value to <b>1</b> will show the topmost level, which is normally the country.  Setting it to <b>2</b> will show the topmost two levels.  The second topmost level, below the country, is often the state, province, or territory. Etc.<br />');
   break;
case 'SHOW_LIVING_NAMES_help':
   $title=i18n::translate('Show living names');
   $text=i18n::translate('~Show living names~<br /><br />Should the names of living people be shown to the public?<br />');
   break;
case 'SHOW_MARRIED_NAMES_help':
   $title=i18n::translate('Show married names on Individual list');
   $text=i18n::translate('~Show married names on Individual list~<br /><br />This option will show the married names of females on the Individual list.  This option requires that you calculate the married names when you import the GEDCOM file.<br />');
   break;
case 'SHOW_MEDIA_DOWNLOAD_help':
   $title=i18n::translate('Show download link in Media Viewer');
   $text=i18n::translate('~Show download link in Media Viewer~<br /><br />The Media Viewer can show a link which, when clicked, will download the Media file to the local PC.<br /><br />You may want to hide the download link for security reasons.<br />');
   break;
case 'SHOW_MEDIA_FILENAME_help':
   $title=i18n::translate('Show file name in Media Viewer');
   $text=i18n::translate('~Show file name in Media Viewer~<br /><br />The Media Viewer can show the name of the Media file being viewed.  This option determines whether that file name is shown to users or not.<br /><br />You may want to hide the file name for security reasons.<br />');
   break;
case 'SHOW_MULTISITE_SEARCH_help':
   $title=i18n::translate('Show Multi-Site Search');
   $text=i18n::translate('~Show Multi-Site Search~<br /><br />Multi-site search allows users to search across multiple PhpGedView websites which you have setup in the Manage Sites administration area or remotely linked to.  This option controls whether the Multi-site Search feature is available to everyone or only to authenticated users.<br />');
   break;
case 'SHOW_NO_WATERMARK_help':
   $title=i18n::translate('Who can view non-watermarked images?');
   $text=i18n::translate('~Who can view non-watermarked images?~<br /><br />If the Media Firewall is enabled, users will see watermarks if they do not have the privilege level specified here.<br />');
   break;
case 'SHOW_PARENTS_AGE_help':
   $title=i18n::translate('Show age of parents next to child\'s birthdate');
   $text=i18n::translate('~Show age of parents next to child\'s birthdate~<br /><br />This option controls whether or not to show age of father and mother next to child\'s birthdate on charts.<br />');
   break;
case 'SHOW_PEDIGREE_PLACES_help':
   $title=i18n::translate('Place levels to show in person boxes');
   $text=i18n::translate('~Place levels to show in person boxes~<br /><br />This sets how much of the place information is shown in the person boxes on charts.<br /><br />Setting the value to 9 will guarantee to show all place levels.  Setting the value to 0 will hide places completely.  Setting the value to 1 will show the first level, setting it to 2 will show the first two levels, etc.<br />');
   break;
case 'SHOW_PRIVATE_RELATIONSHIPS_help':
   $title=i18n::translate('Show private relationships');
   $text=i18n::translate('~Show private relationships~<br /><br />This option will retain family links in privatized records.  This means that you will see empty "private" boxes on the pedigree chart and on other charts with private people.<br /><br />This is similar to the behavior of PhpGedView versions prior to v4.0.<br /><br />This setting is off by default.  It is recommended instead of turning this on, to point your pedigree root person in your GEDCOM configuration to a person who is not private.<br />');
   break;
case 'SHOW_REGISTER_CAUTION_help':
   $title=i18n::translate('Show Acceptable Use agreement on &laquo;Request new user account&raquo; page');
   $text=i18n::translate('When set to <b>Yes</b>, the following message will appear above the input fields on the &laquo;Request new user account&raquo; page:<div class="list_value_wrap"><div class="largeError">Notice:</div><div class="error">By completing and submitting this form, you agree:<ul><li>to protect the privacy of living people listed on our site;</li><li>and in the text box below, to explain to whom you are related, or to provide us with information on someone who should be listed on our site.</li></ul></div></div>');
   break;
case 'SHOW_RELATIVES_EVENTS_help':
   $title=i18n::translate('Show events of close relatives on Individual page');
   $text=i18n::translate('~Show events of close relatives on Individual page~<br /><br />Births, marriages, and deaths of relatives are important events in one\'s life. This option controls whether or not to show these events on the <i>Personal facts and details</i> tab on the Individual page.<br /><br />The events affected by this option are:<ul><li>Death of spouse</li><li>Birth and death of children</li><li>Death of parents</li><li>Birth and death of siblings</li><li>Death of grand-parents</li><li>Birth and death of parents\' siblings</li></ul><br />');
   break;
case 'SHOW_RESEARCH_ASSISTANT_help':
   $title=i18n::translate('Show Research Assistant');
   $text=i18n::translate('~Show Research Assistant~<br /><br />What type of user can view the Research Assistant module if it is installed?<br />');
   break;
case 'SHOW_SOURCES_help':
   $title=i18n::translate('Show sources');
   $text=i18n::translate('~Show sources~<br /><br />Set the privacy access level for all Sources.  If the user does not have access to Sources, the Source list will be removed from the Lists menu and the Sources tab will not be shown on the Individual Details page.<br />');
   break;
case 'SHOW_SPIDER_TAGLINE_help':
   $title=i18n::translate('Show spider tagline');
   $text=i18n::translate('~Show spider tagline~<br /><br />On pages generated for search engines, display as the last line the particular search engine the page detected.  If this option is on, it can bias Google&reg; AdSense towards search engine optimization tools.<br />');
   break;
case 'SHOW_STATS_help':
   $title=i18n::translate('Show execution statistics');
   $text=i18n::translate('~Show execution statistics~<br /><br />Show runtime statistics and database queries at the bottom of every page.<br />');
   break;
case 'SOURCE_ID_PREFIX_help':
   $title=i18n::translate('Source ID prefix');
   $text=i18n::translate('~Source ID prefix~<br /><br />When a new source record is added online in PhpGedView, a new ID for that source will be generated automatically.  The source ID will have this prefix.<br />');
   break;
case 'SOUR_FACTS_ADD_help':
   $title=i18n::translate('Source Add Facts');
   $text=i18n::translate('~Source Add Facts~<br /><br />This is the list of GEDCOM facts that your users can add to sources.  You can modify this list by removing or adding fact names, even custom ones, as necessary.  Fact names that appear in this list must not also appear in the <i>Unique Source Facts</i> list.<br />');
   break;
case 'SOUR_FACTS_QUICK_help':
   $title=i18n::translate('Quick Source Facts');
   $text=i18n::translate('~Quick Source Facts~<br /><br />This is the short list of GEDCOM source facts that appears next to the full list and can be added with a single click.<br />');
   break;
case 'SOUR_FACTS_UNIQUE_help':
   $title=i18n::translate('Unique Source Facts');
   $text=i18n::translate('~Unique Source Facts~<br /><br />This is the list of GEDCOM facts that your users can only add <u>once</u> to sources.  For example, if TITL is in this list, users will not be able to add more than one TITL record to a source.  Fact names that appear in this list must not also appear in the <i>Source Add Facts</i> list.<br />');
   break;
case 'SPLIT_PLACES_help':
   $title=i18n::translate('Split places in Edit mode');
   $text=i18n::translate('~Split places in Edit mode~<br /><br />Set this to <b>Yes</b> to split each place name by commas into subfields for easier editing.  Example :<br /><ol><li>Default mode<br /><u>Place</u>: Half Moon Bay, San Mateo, California, USA<br /><br /></li><li>Split mode<br /><u>Country</u>: USA<br /><u>State</u>: California<br/><u>County</u>: San Mateo<br/><u>City</u>: Half Moon Bay</li></ol>');
   break;
case 'SUBLIST_TRIGGER_F_help':
   $title=i18n::translate('Maximum number of family names');
   $text=i18n::translate('~Maximum number of family names~<br /><br />Long lists of families with the same name can be broken into smaller sub-lists according to the first letter of the given name.<br /><br />This option determines when sub-listing of family names will occur.  To disable sub-listing completely, set this option to zero.<br />');
   break;
case 'SUBLIST_TRIGGER_I_help':
   $title=i18n::translate('Maximum number of surnames');
   $text=i18n::translate('~Maximum number of surnames~<br /><br />Long lists of persons with the same surname can be broken into smaller sub-lists according to the first letter of the individual\'s given name.<br /><br />This option determines when sub-listing of surnames will occur.  To disable sub-listing completely, set this option to zero.<br />');
   break;
case 'SUPPORT_METHOD_help':
   $title=i18n::translate('Support method');
   $text=i18n::translate('~Support method~<br /><br />The method to be used to contact the Support contact about technical questions.<ul><li>The <b>Mailto link</b> option will create a "mailto" link that can be clicked to send an email using the mail client on the user\'s PC.</li><li>The <b>PhpGedView internal messaging</b> option will use a messaging system internal to PhpGedView, and no emails will be sent.</li><li>The <b>Internal messaging with emails</b> option is the default.  It will use the PhpGedView messaging system and will also send copies of the messages via email.</li><li>The <b>PhpGedView sends emails with no storage</b> option allows PhpGedView to handle the messaging and will send the messages as emails, but will not store the messages internally.  This option is similar to the <b>Mailto link</b> option, except that the message will be sent by PhpGedView instead of the user\'s workstation.</li><li>The <b>No contact method</b> option results in your users having no way of contacting you.</li></ul>');
   break;
case 'SURNAME_LIST_STYLE_help':
   $title=i18n::translate('Surname list style');
   $text=i18n::translate('~Surname list style~<br /><br />Lists of surnames, as they appear in the Top 10 Surnames block, the Individuals, and the Families, can be shown in different styles.<ul><li><b>Table</b>&nbsp;&nbsp;&nbsp;In this style, the surnames are shown in a table that can be sorted either by surname or by count.</li><li><b>Tagcloud</b>&nbsp;&nbsp;&nbsp;In this style, the surnames are shown in a list, and the font size used for each name depends on the number of occurrences of that name in the database.  The list is not sortable.</li></ul><br />');
   break;
case 'SURNAME_TRADITION_help':
   $title=i18n::translate('Surname tradition');
   $text=i18n::translate('~Surname tradition~<br /><br />When you add new members to a family, PhpGedView can supply default values for surnames according to regional custom.<br /><br /><ul><li>In the <b>Paternal</b> tradition, all family members share the father\'s surname.</li><li>In the <b>Spanish</b> and <b>Portuguese</b> tradition, children receive a surname from each parent.</li><li>In the <b>Icelandic</b> tradition, children receive their male parent\'s given name as a surname, with a suffix that denotes gender.</li><li>In the <b>Polish</b> tradition, all family members share the father\'s surname. For some surnames, the suffix indicates gender.  The suffixes <i>ski</i>, <i>cki</i>, and <i>dzki</i> indicate male, while the corresponding suffixes <i>ska</i>, <i>cka</i>, and <i>dzka</i> indicate female.</li></ul><br />');
   break;
case 'SYNC_GEDCOM_FILE_help':
   $title=i18n::translate('Synchronize edits into GEDCOM file');
   $text=i18n::translate('~Synchronize edits into GEDCOM file~<br /><br />In past versions of PGV the pending edits were stored in the GEDCOM file and the changed records were then "accepted" into the database.  Starting with v4.1 pending changes are no longer stored in the GEDCOM file but in the changes file.  <br /><br />Setting this value to true will update the GEDCOM file when changes are accepted into the database.  This will keep the GEDCOM file synchronized with the database.  For greater compatibility with previous versions the default value of this field is on.<br /><br />You may want to turn it off to conserve memory when accepting changes.<br />');
   break;
case 'TBLPREFIX_help':
   $title=i18n::translate('Database Table Prefix');
   $text=i18n::translate('~Database Table Prefix~<br /><br />A prefix to prepend to the tables created by PhpGedView.  By changing this value you can set up multiple PhpGedView sites to use the same physical database but different tables.  For example, the same site could host a "test" as well as a "production" installation of PhpGedView with completely independent data tables.<br />');
   break;
case 'THEME_DIR_help':
   $title=i18n::translate('Theme directory');
   $text=i18n::translate('~Theme directory~<br /><br />The directory where your PhpGedView theme files are kept.<br /><br />You may customize any of the standard themes that come with PhpGedView to give your site a unique look and feel.  See the Theme Customization section of the <a href="readme.txt">readme.txt</a> file for more information.<br />');
   break;
case 'THUMBNAIL_WIDTH_help':
   $title=i18n::translate('Width of generated thumbnails');
   $text=i18n::translate('~Width of generated thumbnails~<br /><br />This is the width (in pixels) that the program will use when automatically generating thumbnails.  The default setting is 100.<br />');
   break;
case 'TIME_LIMIT_help':
   $title=i18n::translate('PHP time limit');
   $text=i18n::translate('~PHP time limit~<br /><br />The maximum time in seconds that PhpGedView should be allowed to run.<br /><br />The default is 1 minute.  Depending on the size of your GEDCOM file, you may need to increase this time limit when you need to build the indexes.  Set this value to 0 to allow PHP to run forever.<br /><br />CAUTION: Setting this to 0 or setting it too high could cause your site to hang on certain operating systems until the script finishes.  Setting it to 0 means it may never finish until a server administrator kills the process or restarts the server.  A large Pedigree chart can take a very long time to run; leaving this value as low as possible ensures that someone cannot crash your server by requesting an excessively large chart.<br />');
   break;
case 'UNDERLINE_NAME_QUOTES_help':
   $title=i18n::translate('Underline names in quotes');
   $text=i18n::translate('~Underline names in quotes~<br /><br />Many programs will place the preferred given name in "quotes" in the GEDCOM.  The usual convention for this is to underline the preferred given name.  Enabling this option will convert any names surrounded by quotes to &lt;span&gt; with a CSS class of "starredname".<br /><br />For example, if the name in the GEDCOM were 1&nbsp;NAME&nbsp;Gustave&nbsp;"Jean&nbsp;Paul"&nbsp;Charles&nbsp;/Wilson/ enabling this option would change the part of the name enclosed in quotes to &lt;span&nbsp;class="starredname"&gt;Jean&nbsp;Paul&lt;/span&gt; for printing purposes.  Depending on other settings, the browser would then display that name as <b>Gustave&nbsp;<u>Jean&nbsp;Paul</u>&nbsp;Charles&nbsp;Wilson</b> or <b>Wilson,&nbsp;Gustave&nbsp;<u>Jean&nbsp;Paul</u> Charles</b><br />');
   break;
case 'USE_GEONAMES_help':
   $title=i18n::translate('Use GeoNames database');
   $text=i18n::translate('~Use GeoNames database~<br /><br />Should the GeoNames database be used to provide more suggestions for place names?<br /><br />When this option is set to <b>Yes</b>, the GeoNames database will be queried to supply suggestions for the place name being entered.  When set to <b>No</b>, only the current genealogical database will be searched.  As you enter more of the place name, the suggestion will become more precise.  This option can slow down data entry, particularly if your Internet connection is slow.<br /><br />The GeoNames geographical database is accessible free of charge. It currently contains over 8,000,000 geographical names.<br />');
   break;
case 'USE_MEDIA_FIREWALL_help':
   $title=i18n::translate('Use Media Firewall');
   $text=i18n::translate('~Use Media Firewall~<br /><br />See the Wiki for a description of how to use the Media Firewall. <a href="#PGV_PHPGEDVIEW_WIKI#/en/index.php?title=Media_Firewall" target="_blank">#PGV_PHPGEDVIEW_WIKI#</a><br />');
   break;
case 'USE_MEDIA_VIEWER_help':
   $title=i18n::translate('Use Media Viewer');
   $text=i18n::translate('~Use Media Viewer~<br /><br />When this option is <b>Yes</b>, clicking on images will produce the Media Viewer page.  This page shows the details of the image.  If you have sufficient rights, you can also edit these details.<br /><br />When this option is <b>No</b>, clicking on images will produce a full-size image in a new window.<br />');
   break;
case 'USE_REGISTRATION_MODULE_help':
   $title=i18n::translate('Allow visitors to request account registration');
   $text=i18n::translate('~Allow visitors to request account registration~<br /><br />Gives visitors the option of registering themselves for an account on the site.<br /><br />The visitor will receive an email message with a code to verify his application for an account.  After verification, the Administrator will have to approve the registration before it becomes active.<br />');
   break;
case 'USE_RELATIONSHIP_PRIVACY_help':
   $title=i18n::translate('Use relationship privacy');
   $text=i18n::translate('~Use relationship privacy~<br /><br /><b>No</b> means that authenticated users can see the details of all living people.  <b>Yes</b> means that users can only see the private information of living people they are related to.<br /><br />This option sets the default for all users who have access to this genealogical database.  The Administrator can override this option for individual users by editing the user\'s account details.<br />');
   break;
case 'USE_RIN_help':
   $title=i18n::translate('Use RIN number instead of GEDCOM ID');
   $text=i18n::translate('~Use RIN number instead of GEDCOM ID~<br /><br />Set to <b>Yes</b> to use the RIN number instead of the GEDCOM ID when asked for Individual IDs in configuration files, user settings, and charts.  This is useful for genealogy programs that do not consistently export GEDCOMs with the same ID assigned to each individual but always use the same RIN.<br />');
   break;
case 'USE_SILHOUETTE_help':
   $title=i18n::translate('Use silhouettes');
   $text=i18n::translate('~Use silhouettes~<br /><br />Use silhouette images when no highlighted image for that person has been specified.  The images used are specific to the gender of the person in question.<br /><br /><table><tr><td wrap valign="middle">This image might be used when the gender of the person is unknown: </td><td><img src="images/silhouette_unknown.gif" width="40" alt="Silhouette image" title="Silhouette image" /></td></tr></table><br />');
   break;
case 'USE_THUMBS_MAIN_help':
   $title=i18n::translate('Use thumbnail');
   $text=i18n::translate('~Use thumbnail~<br /><br />This option determines whether PhpGedView should send the large or the small image to the browser whenever a chart or the Personal Details page requires a thumbnail.<br /><br />The <b>No</b> choice will cause PhpGedView to send the large image, while the <b>Yes</b> choice will cause the small image to be sent.  Each individual image also has the &laquo;Always use main image?&raquo; option which, when set to <b>Yes</b>, will cause the large image to be sent regardless of the setting of the &laquo;Use thumbnail&raquo; option in the GEDCOM configuration.  You cannot force PhpGedView to send small images when the GEDCOM configuration specifies that large images should always be used.<br /><br />PhpGedView does not re-size the image being sent; the browser does this according to the page specifications it has also received.  This can have undesirable consequences when the image being sent is not truly a thumbnail where PhpGedView is expecting to send a small image.  This is not an error:  There are occasions where it may be desirable to display a large image in places where one would normally expect to see a thumbnail-sized picture.<br /><br />You should avoid setting the &laquo;Use thumbnail&raquo; option to <b>No</b>.  This choice will cause excessive amounts of image-related data to be sent to the browser, only to have the browser discard the excess.  Page loads, particularly of charts with many images, can be seriously slowed.<br />');
   break;
case 'WATERMARK_THUMB_help':
   $title=i18n::translate('Add watermarks to thumbnails?');
   $text=i18n::translate('~Add watermarks to thumbnails?~<br /><br />If the Media Firewall is enabled, should thumbnails be watermarked? Your media lists will load faster if you don\'t watermark the thumbnails.<br />');
   break;
case 'WEBMASTER_EMAIL_help':
   $title=i18n::translate('Support contact');
   $text=i18n::translate('~Support contact~<br /><br />The person to be contacted about technical questions or errors encountered on your site.<br />');
   break;
case 'WELCOME_TEXT_AUTH_MODE_CUST_HEAD_help':
   $title=i18n::translate('Standard header for custom Welcome text');
   $text=i18n::translate('~Standard header for custom Welcome text~<br /><br />Choose to display a standard header for your custom Welcome text.  When your users change language, this header will appear in the new language.<br /><br />If set to <b>Yes</b>, the header will look look this:<div class="list_value_wrap"><center><b>Welcome to this Genealogy website</b></center><br />Access is permitted to users who have an account and a password for this website.<br /></div>');
   break;
case 'WELCOME_TEXT_AUTH_MODE_CUST_help':
   $title=i18n::translate('Custom Welcome text');
   $text=i18n::translate('~Custom Welcome text~<br /><br />If you have opted for custom Welcome text, you can type that text here.  The text will NOT be translated into the language of the visitor, but will be shown exactly as you typed it.  However, if your custom text contains references to language variables that you can define in the various <i>languages/extra.xx.php</i> files, your site can show translated text.<br /><br />You can insert HTML tags into your custom Welcome text.<br /><br />The following description, taken from the Help text for the FAQ list, is equally applicable to the custom Welcome text.<br /><br />HTML entities are a very easy way to add special characters to your FAQ titles and text.  You can use symbolic names, decimal numbers, or hexadecimal numbers.  A complete list of HTML entities, their coding, and their representation by your browser can be found here:  <a href="http://htmlhelp.com/reference/html40/entities/" target="_blank">HTML entity lists</a><br /><br />On occasion, you may need to show a Tilde character&nbsp;&nbsp;<b>&#x7E;</b>&nbsp;&nbsp;or a Number Sign&nbsp;&nbsp;<b>&#x23;</b>&nbsp;&nbsp;in your URLs or text.  These characters have a special meaning to the PhpGedView Help system and can only be entered in their hexadecimal or decimal form.  Similarly, the&nbsp;&nbsp;<b>&lt;</b>&nbsp;&nbsp;and&nbsp;&nbsp;<b>&gt;</b>&nbsp;&nbsp;characters that usually enclose HTML tags must be entered in their hexadecimal or decimal forms if they are to be treated as normal text instead of signalling an HTML tag.<ul><li><b>&amp;&#x23;35;</b>&nbsp;&nbsp;or&nbsp;&nbsp;<b>&amp;&#x23;x23;</b>&nbsp;&nbsp;will result in&nbsp;&nbsp;<b>&#x23;</b></li><li><b>&amp;&#x23;60;</b>&nbsp;&nbsp;or&nbsp;&nbsp;<b>&amp;&#x23;x3C;</b>&nbsp;&nbsp;will result in&nbsp;&nbsp;<b>&#x3C;</b></li><li><b>&amp;&#x23;62;</b>&nbsp;&nbsp;or&nbsp;&nbsp;<b>&amp;&#x23;x3E;</b>&nbsp;&nbsp;will result in&nbsp;&nbsp;<b>&#x3E;</b></li><li><b>&amp;&#x23;126;</b>&nbsp;&nbsp;or&nbsp;&nbsp;<b>&amp;&#x23;x7E;</b>&nbsp;&nbsp;will result in&nbsp;&nbsp;<b>&#x7E;</b></li></ul>There is a&nbsp;&nbsp;<b>&amp;tilde;</b>&nbsp;&nbsp;HTML entity, but this symbol is not interpreted as a Tilde when coded in URLs.<br /><br />You can insert references to entries in the language files or to values of global variables.  Examples: <ul><li><b>&#x23;pgv_lang[add_to_cart]&#x23;</b>&nbsp;&nbsp;&nbsp;is a reference to the language variable $pgv_lang["add_to_cart"], and if it were to appear in this field, would show as <b>Add to Clippings Cart</b> when the FAQ list is viewed in the current language.</li><li><b>&#x23;factarray[AFN]&#x23;</b>&nbsp;&nbsp;&nbsp;is a reference to the Fact name $factarray["AFN"], and if it were to appear in this field, would show as <b>Ancestral File Number (AFN)</b> when the FAQ list is viewed in the current language. </li><li><b>&#x23;PGV_VERSION&#x23;&nbsp;&#x23;PGV_VERSION_RELEASE&#x23;</b>&nbsp;&nbsp;&nbsp;is a reference to the constant PGV_VERSION, a space, and a reference to the constant PGV_VERSION_RELEASE, and if they were to appear in this field, would show as <b>#PGV_VERSION#&nbsp;#PGV_VERSION_RELEASE#</b> when the FAQ list is viewed in the current language.</li><li><b>&#x23;GLOBALS[GEDCOM]&#x23;</b>&nbsp;&nbsp;&nbsp;is a reference to the global variable $GEDCOM, which is the name of the current GEDCOM file.  If it were to appear in this field, it would show as <b>#GLOBALS[GEDCOM]#</b>.</li><li><b>&#x23;GLOBALS[GEDCOM_TITLE]&#x23;</b>&nbsp;&nbsp;&nbsp;is a reference to the global variable $GEDCOM_TITLE, which is the title of the current GEDCOM file.  If it were to appear in this field, it would show as <b>#GLOBALS[GEDCOM_TITLE]#</b>.</li></ul><br />This feature is useful when you wish to create FAQ lists that are different for each language your site supports.  You should put your customized FAQ list titles and entries into the <i>languages/extra.xx.php</i> files (<i>xx</i> is the code for each language), using the following format:<br />$pgv_lang["faq_title1"] = "This is a sample FAQ title";<br />$pgv_lang["faq_body1"] = "This is a sample FAQ body.";<br /><br />');
   break;
case 'WELCOME_TEXT_AUTH_MODE_help':
   $title=i18n::translate('Welcome text on Login page');
   $text=i18n::translate('~Welcome text on Login page~<br /><br />Here you can choose text to appear on the login screen. You must determine which predefined text is most appropriate.<br /><br />You can also choose to enter your own custom Welcome text, but the text you enter will not be translated when your users change language.  However, if your custom text contains references to language variables that you can define in the various <i>languages/extra.xx.php</i> files, your site can show translated text.  Please refer to the Help text associated with the <b>Custom Welcome text</b> field for more information.<br /><br />The predefined texts are:<ul><li><b>Predefined text that states all users can request a user account:</b><div class="list_value_wrap"><center><b>Welcome to this Genealogy website</b></center><br />Access to this site is permitted to every visitor who has a user account.<br /><br />If you have a user account, you can login on this page.  If you don\'t have a user account, you can apply for one by clicking on the appropriate link below.<br /><br />After verifying your application, the site administrator will activate your account.  You will receive an email when your application has been approved.</div><br/></li><li><b>Predefined text that states admin will decide on each request for a user account:</b><div class="list_value_wrap"><center><b>Welcome to this Genealogy website</b></center><br />Access to this site is permitted to <u>authorized</u> users only.<br /><br />If you have a user account you can login on this page.  If you don\'t have a user account, you can apply for one by clicking on the appropriate link below.<br /><br />After verifying your information, the administrator will either approve or decline your account application.  You will receive an email message when your application has been approved.</div><br/></li><li><b>Predefined text that states only family members can request a user account:</b><div class="list_value_wrap"><center><b>Welcome to this Genealogy website</b></center><br />Access to this site is permitted to <u>family members only</u>.<br /><br />If you have a user account you can login on this page.  If you don\'t have a user account, you can apply for one by clicking on the appropriate link below.<br /><br />After verifying the information you provide, the administrator will either approve or decline your request for an account.  You will receive an email when your request is approved.</div></li></ul>');
   break;
case 'WORD_WRAPPED_NOTES_help':
   $title=i18n::translate('Add spaces where notes were wrapped');
   $text=i18n::translate('~Add spaces where notes were wrapped~<br /><br />Some genealogy programs wrap notes at word boundaries while others wrap notes anywhere.  This can cause PhpGedView to run words together.  Setting this to <b>Yes</b> will add a space between words where they are wrapped in the original GEDCOM.<br />');
   break;
case 'ZOOM_BOXES_help':
   $title=i18n::translate('Zoom boxes on charts');
   $text=i18n::translate('~Zoom boxes on charts~<br /><br />Allows a user to zoom boxes on charts to get more information.<br /><br />Set to <b>Disabled</b> to disable this feature.  Set to <b>On Mouse Over</b> to zoom boxes when the user mouses over the icon in the box.  Set to <b>On Mouse Click</b> to zoom boxes when the user clicks on the icon in the box.<br />');
   break;
case 'accesskey_viewing_advice_help':
...
case 'active_help':
   ...
   $text=i18n::translate('~Active~<br /><br />Allow users to select this language if the option <b>Allow user to change language</b> is enabled.<br />');
   break;
case 'add_by_id_help':
   $title=i18n::translate('add_by_id_help');
...
case 'add_child_help':
   ...
   break;
case 'add_custom_facts_help':
   $title=i18n::translate('add_custom_facts_help');
   ...
   break;
case 'add_facts_general_help':
   $title=i18n::translate('add_facts_general_help');
   ...
   break;
case 'add_facts_help':
   $title=i18n::translate('add_facts_help');
   ...
   break;
case 'add_fam_clip_help':
   $title=i18n::translate('add_fam_clip_help');
...
case 'add_gedcom_help':
   ...
   break;
case 'add_husband_help':
   $title=i18n::translate('add_husband_help');
...
case 'add_opf_child_help':
   ...
   break;
case 'add_person_help':
   $title=i18n::translate('add_person_help');
   ...
   break;
case 'add_repository_clip_help':
   $title=i18n::translate('add_repository_clip_help');
...
case 'add_son_daughter_help':
   ...
   break;
case 'add_source_clip_help':
   $title=i18n::translate('add_source_clip_help');
...
case 'alpha_help':
   ...
   break;
case 'alphabet_lower_help':
   $title=i18n::translate('Alphabet lower case');
   $text=i18n::translate('~Alphabet lower case~<br /><br />Lower case alphabet letters in this language.  This alphabet is used while sorting lists of names.<br />');
   break;
case 'alphabet_upper_help':
   $title=i18n::translate('Alphabet upper case');
   $text=i18n::translate('~Alphabet upper case~<br /><br />Upper case alphabet letters in this language.  This alphabet is used while sorting lists of names.<br />');
   break;
case 'annivers_date_select_help':
   $title=i18n::translate('annivers_date_select_help');
   ...
   break;
case 'annivers_event_help':
   $title=i18n::translate('annivers_event_help');
   ...
   break;
case 'annivers_month_select_help':
   $title=i18n::translate('annivers_month_select_help');
   ...
   break;
case 'annivers_sex_help':
   $title=i18n::translate('annivers_sex_help');
   ...
   break;
case 'annivers_show_help':
   $title=i18n::translate('annivers_show_help');
   ...
   break;
case 'annivers_tip_help':
   $title=i18n::translate('annivers_tip_help');
   ...
   break;
case 'annivers_year_select_help':
   $title=i18n::translate('annivers_year_select_help');
...
case 'apply_privacy_help':
   ...
   break;
case 'autoContinue_help':
   $title=i18n::translate('Automatically press &laquo;Continue&raquo; button');
...
case 'basic_or_all_help':
   ...
   break;
case 'best_display_help':
   $title=i18n::translate('best_display_help');
   ...
   break;
case 'block_move_right_help':
   $title=i18n::translate('block_move_right_help');
   ...
   break;
case 'block_move_up_help':
   $title=i18n::translate('block_move_up_help');
...
case 'bom_check_help':
   ...
   $text=i18n::translate('~Byte Order Mark (BOM) check~<br /><br />This check will analyze all the language files for the BOM (Byte Order Mark). If found, it will remove the BOM from the affected file. These special codes can cause malfunctions in some parts of PhpGedView.<br />');
   break;
case 'box_width_help':
...
case 'cache_life_help':
   ...
   break;
case 'cal_dowload_help':
   $title=i18n::translate('cal_dowload_help');
   ...
   break;
case 'change_indi2id_help':
   $title=i18n::translate('change_indi2id_help');
   ...
   break;
case 'chart_area_help':
   $title=i18n::translate('chart_area_help');
...
case 'clip_cart_help':
   ...
   break;
case 'clip_download_help':
   $title=i18n::translate('clip_download_help');
...
case 'collation_help':
   ...
   $text=i18n::translate('~Database collation sequence~<br /><br />If you are using the database\'s built-in collation rules, this option specifies the collation sequence to use for this language.  You should ensure that your database supports all the collation sequences you intend to use.<br /><br />The use of database collation is controlled in the site configuration settings.<br />');
   break;
case 'commit_google_help':
   $title=i18n::translate('Commit Google&reg; translated changes');
   $text=i18n::translate('~Commit Google&reg; translated changes~<br /><br />When you click this link, all accumulated translations performed through the Google&reg; Translation system that have not already been saved will be saved.<br /><br />The indicator shows the progress of the Save operation.<br /><br />');
   break;
case 'compare_lang_utility_help':
   $title=i18n::translate('Language File Comparison Utility');
   $text=i18n::translate('~Language File Comparison Utility~<br /><br />This utility will compare two sets of language files to produce a list of the additions and subtractions between them.<br /><br />You should also check the various CHANGELOG files for changes to the English versions.  The English files should be used as the reference from which all others are produced.<br />');
   break;
case 'config_help':
   $title=i18n::translate('config_help');
   $text=i18n::translate('Configuration help');
   break;
case 'config_help_help':
   $title=i18n::translate('Configuration help');
   $text=i18n::translate('~Configuration help~<br /><br />This page collects all of the major topics of Configuration Help into one place.  You can view the information on your screen, or you can print it for later use.<br />');
   break;
case 'config_lang_utility_help':
   $title=i18n::translate('Configuration of supported languages');
   $text=i18n::translate('~Configuration of supported languages~<br /><br />This page is used to control what language choices are available to your users.  For example, you can set things up so that only German and French are available.  This might be useful if, for example, you are not able to communicate with your users in Hungarian.<br /><br />You also use this page to alter certain aspects of PhpGedView that depend on the selected language.  For example, here is where you tell PhpGedView how to format date and time fields.<br /><br />The languages that are active and greyed out cannot be disabled because they are in use. Look at the bottom table to see where the language is used. When a language is no longer used by the GEDCOM or user you will be able to disable it.<br /><br />All of your changes will be recorded in a new file called <b>lang_settings.php</b> created in the <b>#INDEX_DIRECTORY#</b> directory.  All of your further changes will be made to this new file and PhpGedView will use only <u>this</u> file.  You can revert to the original default language settings by deleting this file.<br /><br />If you must report problems with your language settings, please tell the PhpGedView support team whether this new file is present or not.<br />');
   break;
case 'context_help':
   $title=i18n::translate('context_help');
   $text=i18n::translate('More help is available by clicking the <b>?</b> next to items on the page.');
   break;
case 'convertPath_help':
...
case 'convertSlashes_help':
   ...
   break;
case 'convert_ansi2utf_help':
   $title=i18n::translate('convert_ansi2utf_help');
   ...
   break;
case 'cookie_help':
   $title=i18n::translate('cookie_help');
   ...
   break;
case 'cookie_login_help':
   $title=i18n::translate('cookie_login_help');
...
case 'days_to_show_help':
   ...
   break;
case 'def_gedcom_date_help':
   $title=i18n::translate('def_gedcom_date_help');
   ...
   break;
case 'def_gedcom_help':
   $title=i18n::translate('def_gedcom_help');
   ...
   break;
case 'def_gramps_help':
   $title=i18n::translate('def_gramps_help');
...
case 'def_help':
   ...
   break;
case 'def_pdf_format_help':
   $title=i18n::translate('def_pdf_format_help');
   ...
   break;
case 'def_pgv_help':
   $title=i18n::translate('def_pgv_help');
   ...
   break;
case 'def_portal_help':
   $title=i18n::translate('def_portal_help');
   ...
   break;
case 'def_theme_help':
   $title=i18n::translate('def_theme_help');
   ...
   break;
case 'default_gedcom_help':
   $title=i18n::translate('default_gedcom_help');
   ...
   break;
case 'delete_faq_item_help':
   $title=i18n::translate('Delete FAQ item');
   $text=i18n::translate('~Delete FAQ item~<br />This option will let you delete an item from the FAQ page<br />');
   break;
case 'delete_gedcom_help':
   $title=i18n::translate('delete_gedcom_help');
...
case 'delete_source_help':
   ...
   break;
case 'desc_generations_help':
   $title=i18n::translate('desc_generations_help');
   $text=i18n::translate('Here you can set the number of generations to display on this page.<br /><br />The right number for you depends of the size of your screen and whether you show details or not.  Processing time will increase as you increase the number of generations.');
   break;
case 'desc_rootid_help':
   $title=i18n::translate('desc_rootid_help');
   ...
   break;
case 'detected_ansi2utf_help':
   $title=i18n::translate('detected_ansi2utf_help');
   ...
   break;
case 'detected_date_help':
   $title=i18n::translate('detected_date_help');
...
case 'download_gedcom_help':
   ...
   break;
case 'download_zipped_help':
   $title=i18n::translate('download_zipped_help');
   $text=i18n::translate('When you check this option, a copy of the GEDCOM file will be compressed into ZIP format before the download begins. This will reduce its size considerably, but you will need to use a compatible Unzip program (WinZIP, for example) to decompress the transmitted GEDCOM file before you can use it.<br /><br />This is a useful option for downloading large GEDCOM files.  There is a risk that the download time for the uncompressed file may exceed the maximum allowed execution time, resulting in incompletely downloaded files.  The ZIP option should reduce the download time by 75%.');
   break;
case 'edit_ABBR_help':
   $title=i18n::translate('edit_ABBR_help');
   ...
   break;
case 'edit_ADDR_help':
   $title=i18n::translate('edit_ADDR_help');
   ...
   break;
case 'edit_AGNC_help':
   $title=i18n::translate('edit_AGNC_help');
...
case 'edit_EMAIL_help':
   ...
   break;
case 'edit_FAX_help':
   $title=i18n::translate('edit_FAX_help');
   ...
   break;
case 'edit_FILE_help':
   $title=i18n::translate('edit_FILE_help');
   ...
   break;
case 'edit_FORM_help':
   $title=i18n::translate('edit_FORM_help');
   ...
   break;
case 'edit_GIVN_help':
   $title=i18n::translate('edit_GIVN_help');
   ...
   break;
case 'edit_NAME_help':
   $title=i18n::translate('edit_NAME_help');
...
case 'edit_NSFX_help':
   ...
   break;
case 'edit_PAGE_help':
   $title=i18n::translate('edit_PAGE_help');
   ...
   break;
case 'edit_PEDI_help':
   $title=i18n::translate('edit_PEDI_help');
   ...
   break;
case 'edit_PHON_help':
   $title=i18n::translate('edit_PHON_help');
   ...
   break;
case 'edit_PLAC_help':
   $title=i18n::translate('edit_PLAC_help');
   ...
   break;
case 'edit_QUAY_help':
   $title=i18n::translate('edit_QUAY_help');
   ...
   break;
case 'edit_RELA_help':
   $title=i18n::translate('edit_RELA_help');
   ...
   break;
case 'edit_ROMN_GIVN_help':
   $title=i18n::translate('edit_ROMN_GIVN_help');
   $text=i18n::translate('In many cultures it is customary to have a traditional name spelled in the traditional characters and also a romanized version of the name as it would be spelled or pronounced in languages based on the Latin alphabet, such as English.<br /><br />If you prefer to use a non-Latin alphabet such as Hebrew, Greek, Russian, Chinese, or Arabic to enter the name in the standard name fields, then you can use this field to enter the same name using the Latin alphabet.  Both versions of the name will appear in lists and charts.<br /><br />Although this field is labelled "Romanized", it is not restricted to containing only characters based on the Latin alphabet.  This might be of use with Japanese names, where three different alphabets may occur.<br /><br />In this field you should enter the given names for the person.  As an example, in the name "John Robert Finlay", the given names that should be entered here are "John Robert"');
   break;
case 'edit_ROMN_SURN_help':
   $title=i18n::translate('edit_ROMN_SURN_help');
   ...
   break;
case 'edit_ROMN_help':
   $title=i18n::translate('edit_ROMN_help');
   $text=i18n::translate('In many cultures it is customary to have a traditional name spelled in the traditional characters and also a romanized version of the name as it would be spelled or pronounced in languages based on the Latin alphabet, such as English.<br /><br />If you prefer to use a non-Latin alphabet such as Hebrew, Greek, Russian, Chinese, or Arabic to enter the name in the standard name fields, then you can use this field to enter the same name using the Latin alphabet.  Both versions of the name will appear in lists and charts.<br /><br />Although this field is labelled "Romanized", it is not restricted to containing only characters based on the Latin alphabet.  This might be of use with Japanese names, where three different alphabets may occur.');
   break;
case 'edit_SEX_help':
   $title=i18n::translate('edit_SEX_help');
   ...
   break;
case 'edit_SHARED_NOTE_help':
   $title=i18n::translate('edit_SHARED_NOTE_help');
   ...
   break;
case 'edit_SOUR_EVEN_help':
   $title=i18n::translate('edit_SOUR_EVEN_help');
   ...
   break;
case 'edit_SOUR_help':
   $title=i18n::translate('edit_SOUR_help');
   ...
   break;
case 'edit_SPFX_help':
   $title=i18n::translate('edit_SPFX_help');
   ...
   break;
case 'edit_STAT_help':
   $title=i18n::translate('edit_STAT_help');
...
case 'edit_TEXT_help':
   ...
   break;
case 'edit_TIME_help':
   $title=i18n::translate('edit_TIME_help');
   ...
   break;
case 'edit_TITL_help':
   $title=i18n::translate('edit_TITL_help');
   ...
   break;
case 'edit_TYPE_help':
   $title=i18n::translate('edit_TYPE_help');
   ...
   break;
case 'edit_URL_help':
   $title=i18n::translate('edit_URL_help');
   ...
   break;
case 'edit__HEB_GIVN_help':
   $title=i18n::translate('edit__HEB_GIVN_help');
   ...
   break;
case 'edit__HEB_SURN_help':
   $title=i18n::translate('edit__HEB_SURN_help');
   $text=i18n::translate('In many cultures it is customary to have a traditional name spelled in the traditional characters and also a romanized version of the name as it would be spelled or pronounced in languages based on the Latin alphabet, such as English.<br /><br />If you prefer to use the Latin alphabet to enter the name in the standard name fields, then you can use this field to enter the same name in the non-Latin alphabet such as Greek, Hebrew, Russian, Arabic, or Chinese.  Both versions of the name will appear in lists and charts.<br /><br />Although this field is labelled "Hebrew", it is not restricted to containing only Hebrew characters.<br /><br />In this field you should enter the surname for the person.  As an example, in the name "John Robert Finlay", the surname that should be entered here is "Finlay"<br /><br />Individuals with multiple surnames, common in Spain and Portugal, should separate the surnames with a comma.  This indicates that the person is to be listed under each of the names.  For example, the surname "Cortes,Vega" will be listed under both <b>C</b> and <b>V</b>, whereas the surname "Cortes Vega" will only be listed under <b>C</b>.');
   break;
case 'edit__HEB_help':
   $title=i18n::translate('edit__HEB_help');
   $text=i18n::translate('In many cultures it is customary to have a traditional name spelled in the traditional characters and also a romanized version of the name as it would be spelled or pronounced in languages based on the Latin alphabet, such as English.<br /><br />If you prefer to use the Latin alphabet to enter the name in the standard name fields, then you can use this field to enter the same name in the non-Latin alphabet such as Greek, Hebrew, Russian, Arabic, or Chinese.  Both versions of the name will appear in lists and charts.<br /><br />Although this field is labelled "Hebrew", it is not restricted to containing only Hebrew characters.');
   break;
case 'edit__MARNM_help':
   $title=i18n::translate('edit__MARNM_help');
   ...
   break;
case 'edit__PRIM_help':
   $title=i18n::translate('edit__PRIM_help');
   ...
   break;
case 'edit__THUM_help':
   $title=i18n::translate('edit__THUM_help');
   ...
   break;
case 'edit_add_ASSO_help':
   $title=i18n::translate('edit_add_ASSO_help');
   ...
   break;
case 'edit_add_GEDFact_ASSISTED_help':
   $title=i18n::translate('edit_add_GEDFact_ASSISTED_help');
   ...
   break;
case 'edit_add_NOTE_help':
   $title=i18n::translate('edit_add_NOTE_help');
   ...
   break;
case 'edit_add_SHARED_NOTE_help':
   $title=i18n::translate('edit_add_SHARED_NOTE_help');
   ...
   break;
case 'edit_add_SOUR_help':
   $title=i18n::translate('edit_add_SOUR_help');
   ...
   break;
case 'edit_add_child_help':
   $title=i18n::translate('edit_add_child_help');
   ...
   break;
case 'edit_add_parent_help':
   $title=i18n::translate('edit_add_parent_help');
   ...
   break;
case 'edit_add_spouse_help':
   $title=i18n::translate('edit_add_spouse_help');
   ...
   break;
case 'edit_add_unlinked_note_help':
   $title=i18n::translate('edit_add_unlinked_note_help');
   ...
   break;
case 'edit_add_unlinked_person_help':
   $title=i18n::translate('edit_add_unlinked_person_help');
   ...
   break;
case 'edit_add_unlinked_source_help':
   $title=i18n::translate('edit_add_unlinked_source_help');
   ...
   break;
case 'edit_birth_help':
   $title=i18n::translate('edit_birth_help');
   ...
   break;
case 'edit_config_gedcom_help':
   $title=i18n::translate('edit_config_gedcom_help');
   ...
   break;
case 'edit_death_help':
   $title=i18n::translate('edit_death_help');
   ...
   break;
case 'edit_edit_raw_help':
   $title=i18n::translate('edit_edit_raw_help');
   ...
   break;
case 'edit_faq_item_help':
   $title=i18n::translate('Edit FAQ item');
   $text=i18n::translate('~Edit FAQ item~<br />This option will let you edit an item on the FAQ page.<br />');
   break;
case 'edit_gedcoms_help':
   $title=i18n::translate('edit_gedcoms_help');
   ...
   break;
case 'edit_given_name_help':
   $title=i18n::translate('edit_given_name_help');
   $text=i18n::translate('In this field you should enter the given names for the person.  As an example, in the name "John Robert Finlay", the given names that should be entered here are "John Robert"');
   break;
case 'edit_lang_utility_help':
   $title=i18n::translate('Language File Edit Utility');
   $text=i18n::translate('~Language File Edit Utility~<br /><br />You can use this utility to edit the contents of a language file by using the contents of the English one.<br /><br />You will see the contents of the original English language file and the contents of the same file type (there are nine of these) in your chosen language.  You click on the message text shown below the English version.  This opens a new window where you can modify the text.  You can save the changes or abandon them.<br />');
   break;
case 'edit_name_help':
   $title=i18n::translate('Edit Name');
   $text=i18n::translate('This is the most important field in a person\'s Name record.<br /><br />This field should be filled automatically as the other fields are filled in, but it is provided so that you can edit the information according to your personal preference.<br /><br />The name in this field should be entered according to the GEDCOM 5.5.1 standards with the surname surrounded by forward slashes "/".  As an example, the name "John Robert Finlay Jr." should be entered like this: "John Robert /Finlay/ Jr.".');
   break;
case 'edit_privacy_help':
   ...
   break;
case 'edit_raw_gedcom_help':
   $title=i18n::translate('edit_raw_gedcom_help');
...
case 'edit_sex_help':
   ...
   $text=i18n::translate('Choose the appropriate gender from the drop-down list.  The <b>unknown</b> option indicates that the gender is unknown.');
   break;
case 'edit_suffix_help':
   $title=i18n::translate('edit_suffix_help');
   $text=i18n::translate('In this optional field you should enter the name suffix for the person.  Examples of name suffixes are "Sr.", "Jr.", and "III".');
   break;
case 'edit_surname_help':
   $title=i18n::translate('edit_surname_help');
   $text=i18n::translate('In this field you should enter the surname for the person.  As an example, in the name "John Robert Finlay", the surname that should be entered here is "Finlay"<br /><br />Individuals with multiple surnames, common in Spain and Portugal, should separate the surnames with a comma.  This indicates that the person is to be listed under each of the names.  For example, the surname "Cortes,Vega" will be listed under both <b>C</b> and <b>V</b>, whereas the surname "Cortes Vega" will only be listed under <b>C</b>.');
   break;
case 'editlang_help':
   $title=i18n::translate('Edit');
   $text=i18n::translate('~Edit~<br /><br />Edit message from language file.<br />');
   break;
case 'edituser_change_lang_help':
   $title=i18n::translate('edituser_change_lang_help');
   ...
   break;
case 'edituser_conf_password_help':
   $title=i18n::translate('edituser_conf_password_help');
   ...
   break;
case 'edituser_contact_meth_help':
   $title=i18n::translate('edituser_contact_meth_help');
   ...
   break;
case 'edituser_email_help':
   $title=i18n::translate('edituser_email_help');
   ...
   break;
case 'edituser_firstname_help':
   $title=i18n::translate('edituser_firstname_help');
   ...
   break;
case 'edituser_gedcomid_help':
   $title=i18n::translate('edituser_gedcomid_help');
   ...
   break;
case 'edituser_lastname_help':
   $title=i18n::translate('edituser_lastname_help');
   ...
   break;
case 'edituser_my_account_help':
   $title=i18n::translate('edituser_my_account_help');
   ...
   break;
case 'edituser_password_help':
   $title=i18n::translate('edituser_password_help');
   ...
   break;
case 'edituser_rootid_help':
   $title=i18n::translate('edituser_rootid_help');
   ...
   break;
case 'edituser_user_default_tab_help':
   $title=i18n::translate('edituser_user_default_tab_help');
   ...
   break;
case 'edituser_user_theme_help':
   $title=i18n::translate('edituser_user_theme_help');
   ...
   break;
case 'edituser_username_help':
   $title=i18n::translate('edituser_username_help');
...
case 'empty_cart_help':
   ...
   break;
case 'empty_lines_detected_help':
   ...
   break;
case 'end_admin_help':
   $title=i18n::translate('end_admin_help');
   $text=i18n::translate('--- End extra Admin Info ---');
   break;
case 'export_lang_utility_help':
   $title=i18n::translate('Language File Export Utility');
   $text=i18n::translate('~Language File Export Utility~<br /><br />You can create documentation for administrators.<br /><br />This utility will produce an HTML version of the Configuration Help file in the selected language.  You can use your browser to look at this file, which is formatted for printing.<br />');
   break;
case 'fambook_descent_help':
   $title=i18n::translate('fambook_descent_help');
   ...
   break;
case 'fan_style_help':
   $title=i18n::translate('fan_style_help');
...
case 'find_media_help':
   ...
   break;
case 'firstname_f_help':
   $title=i18n::translate('firstname_f_help');
   ...
   break;
case 'firstname_i_help':
   $title=i18n::translate('firstname_i_help');
...
case 'follow_spouse_help':
   ...
   break;
case 'ged_filter_description_help':
   $title=i18n::translate('Search option text');
   $text=i18n::translate('~Search option text~<br />This option lets you search the text associated with configuration options.<br /><br />As you type letters, the search will find all configuration options that contain that letter sequence.  The search becomes more precise as you type more letters.<br />');
   break;
case 'gedcom_configfile_help':
   $title=i18n::translate('gedcom_configfile_help');
...
case 'gen_missing_thumbs_help':
   ...
   break;
case 'general_privacy_help':
   $title=i18n::translate('General Privacy settings');
   $text=i18n::translate('~General Privacy settings~<br /><br />You can have different Privacy settings for each GEDCOM on your PhpGedView web site.  Check under the page title whether you are editing the correct GEDCOM.<br /><br />You can override these general settings by using the other Privacy forms on the Edit GEDCOM privacy settings page.<br /><br /><b>More help</b><br />More help is available by clicking the <b>?</b> next to items on the page.<br />');
   break;
case 'generate_thumb_help':
   $title=i18n::translate('generate_thumb_help');
...
case 'header_favorites_help':
   ...
   break;
case 'header_general_help':
   $title=i18n::translate('header_general_help');
...
case 'header_help':
   ...
   break;
case 'header_lang_select_help':
   $title=i18n::translate('header_lang_select_help');
   ...
   break;
case 'header_search_help':
   $title=i18n::translate('header_search_help');
   ...
   break;
case 'header_theme_help':
   $title=i18n::translate('header_theme_help');
   ...
   break;
case 'header_user_links_help':
   $title=i18n::translate('header_user_links_help');
   ...
   break;
case 'help_HS_help':
   $title=i18n::translate('help_HS_help');
   ...
   break;
case 'help_content_help':
   $title=i18n::translate('help_content_help');
   ...
   break;
case 'help_contents_head_help':
   $title=i18n::translate('help_contents_head_help');
   $text=i18n::translate('<b>HELP CONTENTS</b>');
   break;
case 'help_faq_help':
   $title=i18n::translate('help_faq_help');
   ...
   break;
case 'help_help':
   $title=i18n::translate('help_help');
   ...
   break;
case 'help_page_help':
   $title=i18n::translate('help_page_help');
   ...
   break;
case 'help_qm_help':
   $title=i18n::translate('help_qm_help');
   ...
   break;
case 'hide_context_help':
   $title=i18n::translate('hide_context_help');
   $text=i18n::translate('Hide Contextual Help');
   break;
case 'hide_translated_help':
   $title=i18n::translate('Hide translated');
   $text=i18n::translate('~Hide translated~<br /><br />If set to <b>Yes</b> you will only see those messages of your selected language file which have not been translated.  This means the new message does <u>not</u> appear in the target language file.<br /><br />Some language files contain English text for various untranslated messages.  This routine cannot identify these untranslated items, since they already are present in the target file.  The assumption is, "If the message is present in the target file, it must have been translated."<br />');
   break;
case 'hs_inallhelp':
...
case 'hs_title_help':
   ...
   break;
case 'import_gedcom_help':
   $title=i18n::translate('import_gedcom_help');
...
case 'include_media_help':
   ...
   break;
case 'index_add_favorites_help':
   $title=i18n::translate('index_add_favorites_help');
   ...
   break;
case 'index_charts_help':
   $title=i18n::translate('index_charts_help');
   ...
   break;
case 'index_common_given_names_help':
   $title=i18n::translate('index_common_given_names_help');
   ...
   break;
case 'index_common_names_help':
   $title=i18n::translate('index_common_names_help');
   ...
   break;
case 'index_events_help':
   $title=i18n::translate('index_events_help');
   ...
   break;
case 'index_favorites_help':
   $title=i18n::translate('index_favorites_help');
   ...
   break;
case 'index_gedcom_news_adm_help':
   $title=i18n::translate('index_gedcom_news_adm_help');
   ...
   break;
case 'index_gedcom_news_help':
   $title=i18n::translate('index_gedcom_news_help');
   ...
   break;
case 'index_help':
   $title=i18n::translate('index_help');
   ...
   break;
case 'index_htmlplus_compat_help':
   $title=i18n::translate('index_htmlplus_compat_help');
   ...
   break;
case 'index_htmlplus_content_help':
   $title=i18n::translate('index_htmlplus_content_help');
   ...
   break;
case 'index_htmlplus_gedcom_help':
   $title=i18n::translate('index_htmlplus_gedcom_help');
   ...
   break;
case 'index_htmlplus_help':
   $title=i18n::translate('index_htmlplus_help');
   ...
   break;
case 'index_htmlplus_template_help':
   $title=i18n::translate('index_htmlplus_template_help');
   ...
   break;
case 'index_htmlplus_title_help':
   $title=i18n::translate('index_htmlplus_title_help');
   ...
   break;
case 'index_loggedin_help':
   $title=i18n::translate('index_loggedin_help');
   ...
   break;
case 'index_login_help':
   $title=i18n::translate('index_login_help');
   ...
   break;
case 'index_media_help':
   $title=i18n::translate('index_media_help');
   ...
   break;
case 'index_onthisday_help':
   $title=i18n::translate('index_onthisday_help');
   $text=i18n::translate('This block is similar to the "Upcoming Events" block, except that it displays today\'s events.');
   break;
case 'index_portal_head_help':
   $title=i18n::translate('index_portal_head_help');
   $text=i18n::translate('<div class="name_head"><center><b>THE WELCOME PAGE</b></center></div>');
   break;
case 'index_portal_help':
   $title=i18n::translate('index_portal_help');
   ...
   break;
case 'index_stats_help':
   $title=i18n::translate('index_stats_help');
   ...
   break;
case 'index_top10_pageviews_help':
   $title=i18n::translate('index_top10_pageviews_help');
   ...
   break;
case 'index_welcome_help':
   $title=i18n::translate('index_welcome_help');
...
case 'invalid_header_help':
   ...
   break;
case 'is_user_help':
   $title=i18n::translate('is_user_help');
...
case 'lang_langcode_help':
   ...
   break;
case 'lang_shortcut_help':
   $title=i18n::translate('Abbreviation for language files');
   $text=i18n::translate('~Abbreviation for language files~<br /><br />This code defines an abbreviation for the language name.  This abbreviation forms part of the name of each of the language files used by PhpGedView.  For example, the abbreviation used for French is <b>fr</b>, and consequently the file names for French are <i>configure_help.<b>fr</b>.php</i>, <i>countries.<b>fr</b>.php</i>, <i>facts.<b>fr</b>.php</i>, <i>help_text.<b>fr</b>.php</i>, and <i>lang.<b>fr</b>.php</i><br />');
   break;
case 'language_to_edit_help':
   $title=i18n::translate('Language to edit');
   $text=i18n::translate('~Language to edit~<br /><br />In this list box you select the language whose messages you want to edit.<br />');
   break;
case 'language_to_export_help':
   $title=i18n::translate('Language to export');
   $text=i18n::translate('~Language to export~<br /><br />From this list box you can select the language whose messages you want to export.<br /><br />The routine currently only exports the contents of the <i>configure_help.xx.php</i>, <i>help_text.xx.php</i>, and <i>lang.xx.php</i> files.  The output is an HTML file that you can print from your browser.<br />');
   break;
case 'lifespan_add_person_help':
   $title=i18n::translate('lifespan_add_person_help');
...
case 'line_up_generations_help':
   ...
   break;
case 'link_child_help':
   $title=i18n::translate('link_child_help');
   ...
   break;
case 'link_gedcom_id_help':
   $title=i18n::translate('link_gedcom_id_help');
   ...
   break;
case 'link_husband_help':
   $title=i18n::translate('link_husband_help');
...
case 'link_remote_help':
   ...
   break;
case 'link_remote_location_help':
   $title=i18n::translate('link_remote_location_help');
   ...
   break;
case 'link_remote_rel_help':
   $title=i18n::translate('link_remote_rel_help');
   ...
   break;
case 'link_remote_site_help':
   $title=i18n::translate('link_remote_site_help');
   ...
   break;
case 'link_wife_help':
   $title=i18n::translate('link_wife_help');
   ...
   break;
case 'login_buttons_aut_help':
   $title=i18n::translate('login_buttons_aut_help');
   ...
   break;
case 'login_buttons_help':
   $title=i18n::translate('login_buttons_help');
...
case 'macfile_detected_help':
   ...
   break;
case 'mail_option1_help':
   $title=i18n::translate('mail_option1_help');
   ...
   break;
case 'mail_option2_help':
   $title=i18n::translate('mail_option2_help');
   ...
   break;
case 'mail_option3_help':
   $title=i18n::translate('mail_option3_help');
   ...
   break;
case 'mail_option4_help':
   $title=i18n::translate('mail_option4_help');
...
case 'medialist_recursive_help':
   ...
   break;
case 'menu_annical_help':
   $title=i18n::translate('menu_annical_help');
   ...
   break;
case 'menu_charts_help':
   $title=i18n::translate('menu_charts_help');
   ...
   break;
case 'menu_clip_help':
   $title=i18n::translate('menu_clip_help');
   ...
   break;
case 'menu_famtree_help':
   $title=i18n::translate('menu_famtree_help');
...
case 'menu_help_help':
   ...
   break;
case 'menu_lists_help':
   $title=i18n::translate('menu_lists_help');
   ...
   break;
case 'menu_myged_help':
   $title=i18n::translate('menu_myged_help');
...
case 'mygedview_customize_help':
   ...
   break;
case 'mygedview_favorites_help':
   $title=i18n::translate('mygedview_favorites_help');
...
case 'mygedview_login_help':
   $title=i18n::translate('mygedview_login_help');
   ...
   break;
case 'mygedview_message_help':
   $title=i18n::translate('mygedview_message_help');
   ...
   break;
case 'mygedview_myjournal_help':
   $title=i18n::translate('mygedview_myjournal_help');
   ...
   break;
case 'mygedview_portal_help':
   $title=i18n::translate('mygedview_portal_help');
   ...
   break;
case 'mygedview_welcome_help':
   $title=i18n::translate('mygedview_welcome_help');
...
case 'name_list_help':
   ...
   break;
case 'name_reverse_help':
   $title=i18n::translate('Surname first');
   $text=i18n::translate('~Surname first~<br /><br />In some languages the surname should be displayed first instead of the default to display it last.  Enabling this option will display the surname first.  Hungarian, Chinese, and Japanese are examples where the surname (the family name) is usually given first.<br />');
   break;
case 'new_dir_help':
   $title=i18n::translate('new_dir_help');
...
case 'new_password_help':
   ...
   break;
case 'new_user_firstname_help':
   $title=i18n::translate('new_user_firstname_help');
   ...
   break;
case 'new_user_help':
   $title=i18n::translate('new_user_help');
   ...
   break;
case 'new_user_lastname_help':
   $title=i18n::translate('new_user_lastname_help');
...
case 'oldest_top_help':
   ...
   break;
case 'original_lang_name_help':
   $title=i18n::translate('Original name of language in #D_LANGNAME#');
   $text=i18n::translate('~Original name of language~<br /><br />How is this language named in this language?<br /><br />English calls itself <b>English</b>;  German calls itself <b>Deutsch</b>;  Dutch calls itself <b>Nederlands</b>;  Czech calls itself <b>Cestina</b>, etc.<br />');
   break;
case 'page_help':
...
case 'ppp_default_form_help':
   ...
   break;
case 'ppp_levels_help':
   $title=i18n::translate('ppp_levels_help');
   ...
   break;
case 'ppp_match_one_help':
   $title=i18n::translate('ppp_match_one_help');
   ...
   break;
case 'ppp_name_list_help':
   $title=i18n::translate('ppp_name_list_help');
   ...
   break;
case 'ppp_numfound_help':
   $title=i18n::translate('ppp_numfound_help');
   ...
   break;
case 'ppp_placelist_help':
   $title=i18n::translate('ppp_placelist_help');
   ...
   break;
case 'ppp_view_records_help':
   $title=i18n::translate('ppp_view_records_help');
   ...
   break;
case 'preview_faq_item_help':
   $title=i18n::translate('Preview all FAQ items');
   $text=i18n::translate('~Preview all FAQ items~<br />This option lets an admin user view the FAQ page without all the editing options and links.<br /><br />Except for a single <b>Edit</b> link above the first FAQ item, the appearance of the FAQ page will be identical to what an ordinary user would see. This special <b>Edit</b> link will restore full Edit functionality to the FAQ page.<br />');
   break;
case 'preview_help':
...
case 'privacy_error_help':
   ...
   break;
case 'random_media_ajax_controls_help':
   ...
   break;
case 'random_media_filter_help':
   $title=i18n::translate('random_media_filter_help');
   ...
   break;
case 'random_media_persons_or_all_help':
   ...
   break;
case 'random_media_start_slide_help':
...
case 'recent_changes_help':
   ...
   break;
case 'register_comments_help':
   $title=i18n::translate('register_comments_help');
   ...
   break;
case 'register_gedcomid_help':
   $title=i18n::translate('register_gedcomid_help');
   ...
   break;
case 'relationship_id_help':
   $title=i18n::translate('relationship_id_help');
...
case 'reorder_families_help':
   ...
   break;
case 'repolist_listbox_help':
   $title=i18n::translate('repolist_listbox_help');
   ...
   break;
case 'repos_listbox_help':
   $title=i18n::translate('repos_listbox_help');
   ...
   break;
case 'restore_faq_edits_help':
   $title=i18n::translate('Restore FAQ edit functionality');
   $text=i18n::translate('~Restore FAQ edit functionality~<br />This option restores the FAQ page to what an admin user normally sees, so that individual FAQ items may be edited.<br />');
   break;
case 'review_changes_help':
...
case 'rootid_help':
   ...
   break;
case 'rss_feed_help':
   $title=i18n::translate('rss_feed_help');
...
case 'savelang_help':
   ...
   $text=i18n::translate('~Save~<br /><br />Save edited message to language file.<br />');
   break;
case 'search_enter_terms_help':
   $title=i18n::translate('search_enter_terms_help');
   ...
   break;
case 'search_exclude_tags_help':
   $title=i18n::translate('search_exclude_tags_help');
   ...
   break;
case 'search_include_ASSO_help':
   $title=i18n::translate('search_include_ASSO_help');
...
case 'showUnknown_help':
   ...
   break;
case 'show_age_marker_help':
   $title=i18n::translate('show_age_marker_help');
...
case 'show_context_help':
   $title=i18n::translate('show_context_help');
   $text=i18n::translate('Show Contextual Help');
   break;
case 'show_fact_sources_help':
   ...
   break;
case 'show_fam_gedcom_help':
   $title=i18n::translate('show_fam_gedcom_help');
   ...
   break;
case 'show_fam_timeline_help':
   $title=i18n::translate('show_fam_timeline_help');
   ...
   break;
case 'show_full_help':
   $title=i18n::translate('show_full_help');
...
case 'show_marnms_help':
   ...
   break;
case 'show_repo_gedcom_help':
   $title=i18n::translate('show_repo_gedcom_help');
   ...
   break;
case 'show_source_gedcom_help':
   $title=i18n::translate('show_source_gedcom_help');
   $text=i18n::translate('When you click this link, the source\'s records will be displayed in raw database format.');
   break;
case 'show_spouse_help':
   $title=i18n::translate('show_spouse_help');
   ...
   break;
case 'show_thumb_help':
   $title=i18n::translate('show_thumb_help');
   $text=i18n::translate('Thumbnails will be shown if you check this box.');
   break;
case 'simple_filter_help':
   $title=i18n::translate('simple_filter_help');
   $text=i18n::translate('Simple search filter based on the characters entered, no wildcards are accepted.');
   break;
case 'skip_sublist_help':
   $title=i18n::translate('skip_sublist_help');
...
case 'soundex_search_help':
   ...
   break;
case 'sourcelist_listbox_help':
   $title=i18n::translate('sourcelist_listbox_help');
   ...
   break;
case 'sources_listbox_help':
   $title=i18n::translate('sources_listbox_help');
   ...
   break;
case 'start_admin_help':
   $title=i18n::translate('start_admin_help');
   $text=i18n::translate('+++ Begin extra Admin Info +++');
   break;
case 'stat_help':
   $title=i18n::translate('stat_help');
...
case 'style_help':
   ...
   break;
case 'talloffset_help':
   $title=i18n::translate('talloffset_help');
   ...
   break;
case 'text_direction_help':
   $title=i18n::translate('Text direction');
   $text=i18n::translate('~Text direction~<br /><br />Identifies which direction is used to write text in the chosen language.  Most languages are written from left to right.  Arabic and Hebrew are examples of languages that are written in the opposite direction (right to left).<br />');
   break;
case 'text_faq_help':
   $title=i18n::translate('text_faq_help');
...
case 'timeline_control_help':
   ...
   break;
case 'todo_help':
   $title=i18n::translate('todo_help');
...
case 'todo_show_future_help':
   ...
   break;
case 'todo_show_other_help':
   $title=i18n::translate('Show other users\' tasks');
   $text=i18n::translate('Show &quot;To Do&quot; tasks assigned to other users');
   break;
case 'todo_show_unassigned_help':
   $title=i18n::translate('Show unassigned tasks');
   $text=i18n::translate('Show &quot;To Do&quot; tasks that are not assigned to any user');
   break;
case 'translation_forum_help':
   $title=i18n::translate('PhpGedView Translations forum on SourceForge');
   $text=i18n::translate('~PhpGedView Translations forum on SourceForge~<br /><br />This <a href="http://sourceforge.net/forum/forum.php?forum_id=294245" target="_blank"><b>link</b></a> opens a new browser window.  You will be redirected to the Translations forum of PhpGedView, where you can discuss translation topics.<br />');
   break;
case 'um_bu_help':
   $title=i18n::translate('um_bu_help');
   $text=i18n::translate('~Backup~<br /><br />This tool can make a backup of several kinds of data in PhpGedView.<br /><br />The data you choose to back up will be gathered into a ZIP file, which you can download by clicking the link at the bottom of the page, after the backup has been successfully made.<br /><br />The ZIP file will remain in your Index directory until you remove it manually.<br />');
   break;
case 'um_index_sql_help':
   $title=i18n::translate('This tool will import <i>authenticate.php</i> and other <i>.dat</i> files from your index directory into your database.<br />');
   $text=i18n::translate('~Migrate users from Index to SQL mode~<br /><br />This tool will import <i>authenticate.php</i> and other <i>.dat</i> files from your index directory into your database.<br />');
   break;
case 'um_sql_index_help':
...
case 'upload_gedcom_help':
   ...
   break;
case 'upload_media_file_help':
   $title=i18n::translate('upload_media_file_help');
   ...
   break;
case 'upload_media_folder_help':
   $title=i18n::translate('upload_media_folder_help');
...
case 'upload_media_help':
   ...
   break;
case 'upload_path_help':
   $title=i18n::translate('Upload path');
   $text=i18n::translate('~Upload path~<br /><br />This is the path where the GEDCOM file you wish to upload can be found. To select the path, click on <b>Browse</b> and navigate to your GEDCOM file and then click <b>Open</b>.');
   break;
case 'upload_server_file_help':
   $title=i18n::translate('upload_server_file_help');
   ...
   break;
case 'upload_server_folder_help':
   $title=i18n::translate('upload_server_folder_help');
   ...
   break;
case 'upload_thumbnail_file_help':
   $title=i18n::translate('upload_thumbnail_file_help');
...
case 'useradmin_auto_accept_help':
   ...
   break;
case 'useradmin_can_admin_help':
   $title=i18n::translate('useradmin_can_admin_help');
   ...
   break;
case 'useradmin_can_edit_help':
   $title=i18n::translate('useradmin_can_edit_help');
   ...
   break;
case 'useradmin_edit_user_help':
   $title=i18n::translate('useradmin_edit_user_help');
   ...
   break;
case 'useradmin_editaccount_help':
   $title=i18n::translate('useradmin_editaccount_help');
   ...
   break;
case 'useradmin_gedcomid_help':
   $title=i18n::translate('useradmin_gedcomid_help');
   ...
   break;
case 'useradmin_help':
   $title=i18n::translate('useradmin_help');
   ...
   break;
case 'useradmin_path_length_help':
   $title=i18n::translate('useradmin_path_length_help');
   ...
   break;
case 'useradmin_relation_priv_help':
   $title=i18n::translate('useradmin_relation_priv_help');
   ...
   break;
case 'useradmin_rootid_help':
   $title=i18n::translate('useradmin_rootid_help');
   ...
   break;
case 'useradmin_user_default_tab_help':
   $title=i18n::translate('useradmin_user_default_tab_help');
   ...
   break;
case 'useradmin_verbyadmin_help':
   $title=i18n::translate('useradmin_verbyadmin_help');
   ...
   break;
case 'useradmin_verified_help':
   $title=i18n::translate('useradmin_verified_help');
   ...
   break;
case 'useradmin_visibleonline_help':
   $title=i18n::translate('useradmin_visibleonline_help');
...
case 'username_help':
   ...
   break;
case 'utf8_ansi_help':
   $title=i18n::translate('utf8_ansi_help');
...
case 'verify_gedcom_help':
   ...
   break;
case 'view_server_folder_help':
   $title=i18n::translate('view_server_folder_help');

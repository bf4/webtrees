	...
	*/
	function &getOtherMenu() {
		...
		else
		{
			...
			$menu->addLink(encode_url("module.php?mod=clippings&action=add&id={$this->nid}&type=note"));
		}
		if ($SHOW_GEDCOM_RECORD)
		{
				// other / view_gedcom
		...
		{
				// other / add_to_cart
				$submenu = new Menu($pgv_lang['add_to_cart'], encode_url("module.php?mod=clippings&action=add&id={$this->nid}&type=note"));
				if (!empty($PGV_IMAGES["clippings"]["small"]))

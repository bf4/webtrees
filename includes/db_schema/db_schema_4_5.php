...
define('PGV_SCHEMA_4_5', '');

try {
	// These columns may have been created in an earlier versions of PGV.  Update them to the preferred type.
	self::exec("ALTER TABLE {$TBLPREFIX}individuals MODIFY i_file ".self::$COL_FILE." NOT NULL");
	self::exec("ALTER TABLE {$TBLPREFIX}individuals MODIFY i_id   ".self::$COL_XREF." NOT NULL");
	self::exec("ALTER TABLE {$TBLPREFIX}individuals MODIFY i_rin  ".self::$COL_XREF." NOT NULL");

...
$ascii_langs = array('english', 'danish', 'dutch', 'french', 'hungarian', 'german', 'norwegian', 'spanish', 'spanish-ar');
...
//	var $rauthor = '';
	...
	*/
	function setup() {
		...
		// Generated By...text
		$this->generatedby = ("$pgv_lang[generated_by] ".PGV_PHPGEDVIEW." ".(PGV_USER_IS_ADMIN? PGV_VERSION_TEXT: ""));
...
class PGVRTextBox extends PGVRElement {
	...
	*/
	function PGVRTextBox($width, $height, $border, $bgcolor, $newline, $left, $top, $pagecheck, $style, $fill, $padding) {
		$this->border = $border;
		$this->bgcolor = $bgcolor;
		$this->fill= $fill;
		$this->height = $height;
...
//	if (!empty($attrs['style'])) $style = $attrs['style'];
	...
	array_push($pgvreportStack, $pgvreport);
	$pgvreport = $PGVReportRoot->createTextBox($width, $height, $border, $bgcolor, $newline, $left, $top, $pagecheck, $style, $fill, $padding);
}

	...
	*/
	...
	<?php }
	  ...
	  <div id="pagetab3" class="<?php echo $TEXT_DIRECTION; ?>">
		...
		?>
			<tr>
				<td class="descriptionbox" colspan="4"><?php print_help_link("stat", "qm", "statistiek_list"); ?> <?php echo $pgv_lang["statvars"]; ?></td>
			</tr>
			<tr>
			<td class="descriptionbox width25 wrap"><?php print_help_link("stat_x", "qm", "statistiek_list"); ?> <?php echo $pgv_lang["statlxa"]; ?> </td>
			<td class="optionbox">
		...
		//	echo "\" /><label for=\"stat_16\">", $pgv_lang["stat_16_mmb"], "</label><br />";
			...
			<td class="descriptionbox width20 wrap" id="axes"><?php print_help_link("stat_z", "qm", "statistiek_list"); ?> <?php echo $pgv_lang["statlza"]; ?>  </td>
	  ...
	  <div id="tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
		<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
			<li class="ui-state-default ui-corner-top">
				<a name="pagetab0" title="<?php echo $pgv_lang["individuals"];?>" href="statistics.php?ged=<?php echo $GEDCOM; ?>&content=1&tab=0"><span>
					<?php echo $pgv_lang["individuals"];?></span></a>
			</li>
			<li class="ui-state-default ui-corner-top">
				<a name="pagetab1" title="<?php echo $pgv_lang["families"];?>" href="statistics.php?ged=<?php echo $GEDCOM; ?>&content=1&tab=1"><span>
					<?php echo $pgv_lang["families"];?></span></a>
			</li>
			<li class="ui-state-default ui-corner-top">
				<a name="pagetab2" title="<?php echo $pgv_lang["others"];?>" href="statistics.php?ged=<?php echo $GEDCOM; ?>&content=1&tab=2"><span>
					<?php echo $pgv_lang["others"];?></span>	</a>
			</li>
			<li class="ui-state-default ui-corner-top">
				<a name="pagetab3" title="<?php echo $pgv_lang["stat_own_charts"];?>" href="statistics.php?ged=<?php echo $GEDCOM; ?>&content=1&tab=3"><span>
					<?php echo $pgv_lang["stat_own_charts"];?></span></a>
			</li>
		</ul>
	  </div> <!-- tabs -->
	</div> <!--  end -->

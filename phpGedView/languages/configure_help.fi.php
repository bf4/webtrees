...
$pgv_lang["THUMBNAIL_WIDTH_help"]	= "~Kehitettyjen pikkukuvien leveys~<br /><br />Kun ohjelma kehittää automaattisesti pikkukuvan, niin se käyttää tätä leveyttä (pikseleinä). Vakiona asetus on 100.";
...
$pgv_lang["SHOW_MARRIED_NAMES_help"]= "~Näytä avionimet henkilöluettelossa~<br /><br />Tämä valinta näyttää naisten avionimet henkilöluettelossa. Tämä valinta vaatii, että avionimet lasketaan, kun GEDCOM-tiedosto tuodaan.<br />";
$pgv_lang["SEARCHLOG_CREATE"]	= "Arkistoi HakuLoki-tiedostot";
$pgv_lang["SEARCHLOG_CREATE_help"]	= "~Arkistoi HakuLoki-tiedostot~<br /><br />Kuinka usein ohjelma arkistoi HakuLoki-tiedostot.<br />";
...
$pgv_lang["upload_path_help"]		= "~Lähetyspolku~<br /><br />Tästä polusta löytyy GEDCOM-tiedosto jonka haluat lähettää. Asettaaksesi polun paina <b>Selaa</b> ja valitse sinun GEDCOM-tiedosto ja paina <b>Avaa</b>.";
...
$pgv_lang["language_to_edit_help"]		= "~Muokattava kieli~<br /><br />Tästä pudotusvalikosta voit valita minkä kielisiä viestejä haluat muokata.<br />";
...
$pgv_lang["active_help"]			= "~Aktiivinen~<br /><br />Sallii käyttäjän valita kielen jos <b>Salli käyttäjän vaihtaa kieli</b> -valinta on päällä.<br />";
...
$pgv_lang["alphabet_upper_help"]		= "~Aakkoset isoin kirjaimin~<br /><br />Tämän kielen isot kirjaimet. Näitä kirjaimia käytetään kun lajitellaan nimilistoja.<br />";
$pgv_lang["alphabet_lower"]			= "Aakkoset pienin kirjaimin";
$pgv_lang["alphabet_lower_help"]		= "~Aakkoset pienin kirjaimin~<br /><br />Tämän kielen pienet kirjaimet. Näitä kirjaimia käytetään kun lajitellaan nimilistoja.<br />";
...
$pgv_lang["hide_translated_help"]		= "~Piilota käännetyt~<br /><br />Mikäli vastaat kyllä, näkyvät vain ne valitsemasi kielen viestit joita ei ole käännetty eli joita ei vielä ole valitsemassasi kielitiedostossa.<br />Kun viesti on kielitiedostossa (vaikka vielä kääntämättä) tätä ei enää näytetä luettelossa.<br />";
...
$pgv_lang["um_tool_help"] 		= "~Käyttäjätietojen integrointityökalu~<br /><br />#pgv_lang[um_explain]#";
...
$pgv_lang["um_bu_help"] 		= "~Varmuuskopio~<br /><br />Tällä työkalulla voi tehdä muutamista erilaisista tiedoista varmuuskopioita phpGedView:ssä.<br /><br />Valitsemasi varmuuskopioitavat tiedot kerätään ZIP-tiedostoon, jonka voit ladata sivun lopussa olevasta linkistä kun varmuuskopiointi on tehty.<br /><br />ZIP-tiedosto jää sinun index-kansioon kunnes sen manuaalisesti poistat.";
...
$pgv_lang["edit_faq_item_help"] 	= "~Muokkaa kysymystä~<br />Tämä valinta sallii sinun muokata kysymystä tai sen vastausta.<br />";
$pgv_lang["restore_faq_edits"] 	= "Palauta kysymysten muokkaustoiminta";
$pgv_lang["restore_faq_edits_help"] 	= "~Palauta kysymysten muokkaustoiminta~<br />Tämä valinta palauttaa UKK-sivun ylläpidon näkemään tilaan, jotta yksittäistä kysymystä voi muokata.<br />";
$pgv_lang["add_faq_item"] 		= "Lisää kysymys";
$pgv_lang["add_faq_item_help"] 	= "~Lisää kysymys~<br />Tämä valinta sallii sinun lisätä kysymyksen UKK-sivulle.<br />";
$pgv_lang["delete_faq_item"] 		= "Poista kysymys";
$pgv_lang["delete_faq_item_help"] 	= "~Poista kysymys~<br />Tämä valinta sallii sinun poistaa kysymyksen UKK-sivulta.<br />";
$pgv_lang["moveup_faq_item"] 	= "Siirrä kysymys ylös";
$pgv_lang["movedown_faq_item"] 	= "Siirrä kysymys alas";
$pgv_lang["time_limit_help"]		= "~Aikaraja~<br /><br />Tuonnille sallittu maksimiaika käsitellessä GEDCOM-tiedostoa.";
...
$pgv_lang["ged_filter_description_help"] = "~Hae asetuksen kuvauksesta~<br />Tämä kenttä antaa sinun hakea asetuksia joiden kuvaus sisältää kirjoittamasi tekstin.<br /><br />Kun kirjoitat kirjaimia, haku etsii kaikki asetukset jotka sisältävät antamasi kirjainsarjan.  Haku tulee tarkemmaksi kirjoittaessasi lisää kirjaimia.<br />";
...
$pgv_lang["WATERMARK_THUMB_help"]		= "~Lisää vesileimat pikkukuviin?~<br /><br />Jos Media Firewall on päällä, tuleeko pikkukuviin lisätä vesileima? Medialistasi latautuvat nopeammin jos et vesileimaa pikkukuvia.<br />";
...
$pgv_lang["INDI_FACTS_QUICK_help"]	= "~Henkilöön nopeasti lisättävät tiedot~<br /><br />Tämä lista GEDCOM tietoja näkyy täydellisen listan vieressä ja niistä voi lisätä tietoja yhdellä klikkauksella.<br />";
...
$pgv_lang["FAM_FACTS_QUICK_help"]	= "~Perheeseen nopeasti lisättävät tiedot~<br /><br />Tämä lista perhetietoja näkyy täyden listan vieressä ja siitä voi lisätä tiedon yhdellä klikkauksella.<br />";
$pgv_lang["editlang_help"]		= "~Muokkaa~<br /><br />Muokkaa viestiä kielitiedostosta.<br />";
$pgv_lang["savelang_help"]		= "~Talleta~<br /><br />Tallenna muokattu viesti kielitiedostoon.<br />";

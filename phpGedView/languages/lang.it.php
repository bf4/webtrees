...
$pgv_lang["search_indis"]			= "Individui";
$pgv_lang["search_notes"]			= "Shared Note";
...
$pgv_lang["cookie_help"]			= "Questo sito utilizza i cookies per tenere traccia dei tuoi dati di accesso stato. &lt;br /&gt; &lt;br /&gt; I cookie non sembrano essere abilitati nel tuo browser. È necessario abilitare i cookie di questo sito prima di poter effettuare il login. Potete consultare il vostro browser l'aiuto di documentazione per le informazioni su come abilitare i cookie.";
$pgv_lang["cookie_help"]			= "";
...
$pgv_lang["var_not_exist"]			= "<span style=\"font-weight: bold\">La variabile lingua non esiste. Per favore, segnalo come errore a un amministratore.</span>";
...
$pgv_lang["week1"]					= "settimane";
$pgv_lang["timeline_beginYear"] = "Inizio anno";
$pgv_lang["timeline_endYear"] = "Fine anno";
...
$pgv_lang["all_saints"] = "Tutti i Santi";
...
$pgv_lang["rela_husb"]				= "Relazionato al marito";
$pgv_lang["rela_wife"]				= "Relazionato alla moglie";
...
$pgv_lang["message_instructions"]	= "<b>NB:</b> Informazioni private di persune viventi saranno dati solo a parenti e amici stressi. Ti verrà richiesto di verificare la tua relazione prima di ricevere qualsiasi dato privato. A volte informazioni di persone decedute possono anch'esse essere private. Ciò in quanto non vi sono sufficient iinformazioni per determinare se sono viventi o meno e probabilmente non abbiamo ulteriori informazioni su questa persona.<br /><br />Prima di porre domande, per favore verifica che stai chiedendo della persona corretta controllando date, località e parenti stretti. Se stai inserendo modifiche ai dati genealogici, per favore includi la fonte da cui hai ottenuto i dati.<br /><br />";
...
$pgv_lang["with"]					= "con";
$pgv_lang["on"]						= "su";			// for precise dates
...
$pgv_lang["bridesmaid"] = "Damigella della sposa";

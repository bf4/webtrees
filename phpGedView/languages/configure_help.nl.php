...
$pgv_lang["bom_check_help"]		= "~BOM-controle taalbestanden~<br /><br />Middels deze controle worden BOM's (Byte Order Mark) in de taalbestanden opgespoord en verwijderd.<br /><br /><br /><br />";
...
$pgv_lang["lang_debug_help"]	= "~Helptekst foutzoeken~<br /><br />Als u deze optie aanzet, worden de namen van de taalvariabelen die in de helptekst worden gebruikt, in het popup-venster getoond. Dit helpt vertalers om de naam van de variabele te bepalen, als de tekst moet worden aangepast.<br /><br />Deze optie blijft alleen gedurende uw huidige PhpGedView-sessie aanstaan.<br /><br />";
...
$pgv_lang["um_sql_index_help"] = "~Migreren gebruikers van SQL- naar Index modus~<br /><br />Dit programma maakt het bestand \"authenticate.php\" en diverse <b>.dat</b> bestanden aan in uw indexmap.<br />Nadat de bestanden succesvol zijn aangemaakt, kunt u overschakelen naar index-modus met beoud van alle gebruikersinstellingen, berichten, favorieten, nieuwsberichten en opmaak van de genealogie-startpagina en MGedView-pagina's.<br /><br />Let op: Na het overschakelen naar index-modus moet u uw GEDCOM-bestand(en) opnieuw importeren.<br /><br />|";
$pgv_lang["um_index_sql_help"] = "~Migreren gebruikersgegevens van Index naar SQL-modus~<br /><br />Dit programma importeert de gegevens uit het \"authenticate.php\" bestand en uit de .dat bestanden in uw indexmap, in uw database.<br />";
...
$pgv_lang["um_bu_help"] = "~Backup~<br /><br />Dit programma maakt een backup van verschillende soorten gegevens in PhpGedView.<br /><br />De gegevens die u hieronder voor de backup selecteert worden verzameld en in een ZIP-bestand opgeslagen.<br />Dit kunt u downloaden met de koppeling die dan onderaan de pagina verschijnt.<br />Het ZIP-bestand blijft aanwezig in uw index-map totdat u dit handmatig verwijdert.";

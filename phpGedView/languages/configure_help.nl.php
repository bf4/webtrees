...
$pgv_lang["DBTYPE_help"]			= "Het type PEAR ondersteunende database om verbinding mee te maken. De mogelijkheden zijn: MySQL, PostgreSQL en SQLite. De eerste twee hebben extra bibliotheken van PHP nodig. SQLite wordt standaard met PHP5 meegeleverd.<br />Als u SQLite gebruikt, hoeven database machine, database gebruikersnaam en database wachtwoord niet ingevuld te worden. In plaats daarvan vult u in het vak \"Databasenaam\" het pad en de naam van de database in.";
$pgv_lang["DBHOST"] 				= "Database-machine";
$pgv_lang["DBHOST_help"] 			= "De DNS-naam of het IP-adres van the computer waar de database staat.<br />Als zowel PHP als de database op dezelfde machine staan, volstaat localhost.  Deze instelling wordt niet gebruikt als u een SQLite database heeft ingesteld.";
$pgv_lang["DBUSER"] 				= "Database-gebruikersnaam";
$pgv_lang["DBUSER_help"] 			= "De database gebruikersnaam die nodig is om in te loggen op de database. Deze instelling wordt niet gebruikt als u een SQLite database heeft ingesteld.";
$pgv_lang["DBPASS"] 				= "Database-wachtwoord";
$pgv_lang["DBPASS_help"] 			= "Het database wachtwoord van de gebruiker. Deze instelling wordt niet gebruikt als u een SQLite database heeft ingesteld.";
$pgv_lang["DBNAME"] 				= "Databasenaam";
$pgv_lang["DBNAME_help"] 			= "De database in de machine die PhpGedView moet gebruiken. De gebruikersnaam in het gebruikersveld moet create, insert, update, delete, en select privilege op deze database hebben.<br />Voor SQLite dient u een bestandsnaam aan te geven in een map die schrijfbaar is voor PhpGedView. Voorbeeld: index/phpgedview.db.";
$pgv_lang["TBLPREFIX"]				= "Voorvoegsel databasetabellen";
$pgv_lang["TBLPREFIX_help"]			= "Een voorvoegsel voor de SQL tabellen die gemaakt zijn door PhpGedView. Door het veranderen van deze waarde kunt u meerdere PhpGedView sites gebruik laten maken van dezelfde database maar met verschillende tabellen.";
...
$pgv_lang["ALLOW_CHANGE_GEDCOM_help"]	= "Als u deze optie op \"Ja\" zet, kunnen gebruikers wisselen van GEDCOM-bestand. Dit is alleen mogelijk als op uw site meerdere GEDCOM-bestanden aanwezig zijn.";
$pgv_lang["gedcom_path"]			= "Map en naam GEDCOM-bestand";
$pgv_lang["gedcom_path_help"]		= "Upload eerst uw GEDCOM-bestand naar een locatie op de server die door PHP bereikt kan worden. Voer dan het pad naar dat bestand en de bestandsnaam hier in.<br /><br />Voorbeeld: ./index/myged.ged<br /><br />Zie het <a href=\"readme.txt\">readme.txt</a> bestand voor meer uitleg.";
$pgv_lang["CHARACTER_SET"]			= "Karakterset codering";
$pgv_lang["CHARACTER_SET_help"]		= "Dit is de karakterset van uw GEDCOM-bestand. UTF-8 is de standaard en moet voor bijna alle sites werken. Als het GEDCOM-bestand de IBM-Windowscodering gebruikt dan moet u hier WINDOWS neerzetten.<br /><br />N.B.: PHP ondersteunt geen UNICODE (UTF-16); zet dat er dus niet en om vervolgens te gaan klagen bij de PHP ondersteuners :-)";
$pgv_lang["LANGUAGE"]				= "Taal";
$pgv_lang["LANGUAGE_help"]			= "Stelt de standaardtaal in voor de website. Gebruikers hebben de mogelijkheid om deze instelling aan te passen via de browserinstellingen of via het keuzeveld op het scherm, indien ENABLE_MULTI_LANGUAGE = true.";
$pgv_lang["ENABLE_MULTI_LANGUAGE"]	= "Laat de gebruiker de taal wijzigen";
$pgv_lang["ENABLE_MULTI_LANGUAGE_help"] = "Zet dit op \"Ja\" om de gebruikers de mogelijkheid te geven een andere taal te kiezen via het keuzevak op het scherm. De standaard is de taalinstelling van de browser.";
...
$pgv_lang["CALENDAR_FORMAT_help"]	= "Hiermee specificeert u het type kalender, dat u wilt gebruiken met dit GEDCOM-bestand.<br />Hebreeuws is hetzelfde als de Joodse kalender, maar dan met Hebreeuwse karakters. Let op: de Joods/Hebreeuwse datums worden berekend met behulp van Gregoriaanse/Juliaanse datums. Omdat de Joodse kalender bij zonsondergang start, wordt bij gebeurtenissen die plaatsvinden tussen zonsondergang en middernacht een datum weergegeven die een dag eerder ligt dan de juiste Joodse datum. Verder kan weergave van Hebreeuws een probleem zijn voor oude Internet Verkenners. Ze tonen het Hebreeuws achterstevoren of geheel niet.";
$pgv_lang["DISPLAY_JEWISH_THOUSANDS"]		= "Geef Hebreeuwse duizendtallen weer";
$pgv_lang["DISPLAY_JEWISH_THOUSANDS_help"]	= "Toon Alafim in Hebreeuwse kalenders. \"JA\" geeft het jaar 1969 weer als <span lang=\"he-IL\" dir='rtl'>&#1492;'&#160;&#1514;&#1513;&#1499;&quot;&#1496;</span>&lrm; , \"NEE\" als <span lang=\"he-IL\" dir='rtl'>&#1514;&#1513;&#1499;&quot;&#1496;</span>&lrm;. Dit beïnvloedt de waarde van het Joodse jaar niet, deze blijft ongewijzigd 5729 ongeacht deze instelling.";
...
$pgv_lang["DEFAULT_PEDIGREE_GENERATIONS_help"]	= "Stelt het aantal generaties dat standaard afgebeeld moet worden in de kwartierstaat.";
$pgv_lang["MAX_PEDIGREE_GENERATIONS"]		= "Max. aantal generaties kwartierstaat";
$pgv_lang["MAX_PEDIGREE_GENERATIONS_help"]	= "Stelt het maximum aantal generaties in, dat in de kwartierstaat wordt getoond.";
$pgv_lang["MAX_DESCENDANCY_GENERATIONS"]		= "Max. aantal generaties nakomelingen";
$pgv_lang["MAX_DESCENDANCY_GENERATIONS_help"]	= "Stelt het maximum aantal generaties in, dat in de grafiek nakomelingen wordt getoond.";
$pgv_lang["USE_RIN"]				= "Gebruik RIN in plaats van GEDCOM-ID";
$pgv_lang["USE_RIN_help"]			= "Kies \"Ja\" om RIN-nrs. te gebruiken in plaats van GEDCOM-ID's. Deze worden gebruikt in configuratiebestanden, gebruikersinstellingen en overzichten. Dit is nuttig voor genealogieprogramma's, die geen bijbehorende ID's exporteren maar altijd dezelfde RIN gebruiken.";
$pgv_lang["PEDIGREE_ROOT_ID"]		= "Beginpersoon kwartierstaat en nakomelingen";
$pgv_lang["PEDIGREE_ROOT_ID_help"]	= "Stelt het ID van de beginpersoon in voor kwartierstaat en nakomelingenoverzicht.";
$pgv_lang["GEDCOM_ID_PREFIX"]		= "Voorvoegsel GEDCOM-ID";
$pgv_lang["GEDCOM_ID_PREFIX_help"]	= "Bij weergave van de kwartierstaat, nakomelingen, verwantschap en andere weergaven wordt gebruikers gevraagd een ID in te voeren. Als hierbij geen voorvoegsel wordt ingevoerd, wordt deze toegevoegd.";
$pgv_lang["SOURCE_ID_PREFIX"]		= "Voorvoegsel bron-ID";
$pgv_lang["SOURCE_ID_PREFIX_help"]	= "Als met behulp van PhpGedView een nieuwe bron wordt aangemaakt, wordt hiervoor automatisch een ID aangemaakt. Het bron-ID heeft het hier opgegeven voorvoegsel, gevolgd door een volgnummer.";
$pgv_lang["REPO_ID_PREFIX"]			= "Voorvoegsel bewaarplaats-ID";
$pgv_lang["REPO_ID_PREFIX_help"]	= "Als met behulp van PhpGedView een nieuwe bewaarplaats wordt aangemaakt, wordt hiervoor automatisch een ID aangemaakt. Het bewaarplaats-ID heeft het hier opgegeven voorvoegsel, gevolgd door een volgnummer.";
$pgv_lang["PEDIGREE_FULL_DETAILS"]		= "Laat geboorte- en overlijdensgegevens zien in kwartierstaat en nakomelingenoverzicht";
$pgv_lang["PEDIGREE_FULL_DETAILS_help"] = "Geeft aan of de geboorte- en overlijdensgegevens van een persoon zichtbaar worden.";
$pgv_lang["PEDIGREE_LAYOUT"] 		= "Standaard opmaak kwartierstaat";
$pgv_lang["PEDIGREE_LAYOUT_help"] 	= "Geeft aan of de kwartierstaat staand of liggend moet worden weergegeven.";
$pgv_lang["SHOW_EMPTY_BOXES"]		= "Toon lege vakken in de kwartierstaat";
$pgv_lang["SHOW_EMPTY_BOXES_help"]	= "Kies hier, of lege vakken worden getoond in de kwartierstaat.";
$pgv_lang["ZOOM_BOXES"]				= "Inzoomen op vakken in de weergave";
$pgv_lang["ZOOM_BOXES_help"]		= "Geeft een gebruiker de mogelijkheid om in te zoomen op de vakken en zodoende meer informatie te tonen. \"Uitschakelen\" zet deze functie uit, \"Door muisaanwijzer erover\" activeert de functie wanneer de muisaanwijzer op het scherm op het icoon komt, \"Door muisknop ingedrukt\" activeert de zoomfunctie, zolang de knop blijft ingedrukt, \"Door muisklik\" wordt de functie afwisselend aan en uit geschakeld.";
$pgv_lang["LINK_ICONS"]				= "Popup met koppelingen in weergaven";
$pgv_lang["LINK_ICONS_help"]		= "Geeft een gebruiker de mogelijkheid om door te springen naar andere weergaven en verwanten van de persoon. \"Uitschakelen\" zet deze functie uit, \"Door muisaanwijzer erover\" activeert de functie wanneer het pijltje op het scherm op het icoon komt, \"Door muisknop ingedrukt\" activeert de functie, zolang de knop blijft ingedrukt, \"Door muisklik\" wordt de functie afwisselend aan en uit geschakeld.";
$pgv_lang["ABBREVIATE_CHART_LABELS"]		= "Afgekorte veldtitels";
$pgv_lang["ABBREVIATE_CHART_LABELS_help"]	= "Geeft aan of titels bij gegevens worden afgekort: \"G\" in plaats van \"Geboren\".";
$pgv_lang["SHOW_PARENTS_AGE"]		= "Toon leeftijd ouders bij geboortedatum kind";
$pgv_lang["SHOW_PARENTS_AGE_help"]	= "Hiermee wordt het tonen van de leeftijd van de ouders bij de geboorte van het kind al dan niet ingeschakeld.";
$pgv_lang["HIDE_LIVE_PEOPLE"]		= "Gebruik privacyinstellingen";
$pgv_lang["HIDE_LIVE_PEOPLE_help"]	= "Met deze optie kunt u de privacymodule inschakelen en de details van levende personen verbergen. Levende personen hebben geen gebeurtenis die meer dan het aantal jaren, zoals gedefinieerd in de variabele \$MAX_ALIVE_AGE geleden gebeurd zijn en geen kinderen geboren zijn.<br />In de privacymodule kunt u de privacyinstellingen verder bewerken.";
$pgv_lang["REQUIRE_AUTHENTICATION"]			= "Vereis bezoekersauthenticatie";
$pgv_lang["REQUIRE_AUTHENTICATION_help"]	= "Door deze optie in te schakelen worden alle bezoekers in te loggen, voordat ze gegevens op de site kunnen bekijken.";
$pgv_lang["WELCOME_TEXT_AUTH_MODE"]			= "Welkomsttekst op de aanmeldpagina bij aanmelden vereist";
$pgv_lang["WELCOME_TEXT_AUTH_MODE_help"]	= "Kies hier de tekst, die op het aanmeldscherm verschijnt in geval bezoekers zich moeten aanmelden bij deze site (authenticatie vereist).<br />U kunt uitproberen welke standaard tekst op uw situatie van toepassing is.<br />U kunt er ook voor kiezen, om zelf een tekst in te voeren in het onderstaande vak.<br /><br />Let op: deze tekst wordt niet vertaald in de taal van uw gebruikers.";
...
$pgv_lang["WELCOME_TEXT_AUTH_MODE_CUST_help"]	= "Als u heeft gekozen om een zelf gedefinieerde tekst te tonen op het aanmeldscherm, dan kunt u hier de desbetreffende tekst intypen.<br />Let op: de tekst wordt weergegeven zoals u die intypt en wordt dus NIET vertaald in de taal van de bezoekers.<br />Als u wilt, kunt u in de tekst HTML-tekens gebruiken voor opmaak.";
$pgv_lang["WELCOME_TEXT_AUTH_MODE_CUST_HEAD"] = "Standaard koptekst voor zelf gedefinieerde welkomsttekst";
$pgv_lang["WELCOME_TEXT_AUTH_MODE_CUST_HEAD_help"] = "Kies deze optie om, aan uw eigen welkomsttekst bij \"aanmelden vereist\", een standaard koptekst vanuit PhpGedView toe te voegen.<br />Deze koptekst is beschikbaar in alle talen van PhpGedView.";
$pgv_lang["CHECK_CHILD_DATES"]		= "Controleer datums van de kinderen";
$pgv_lang["CHECK_CHILD_DATES_help"]	= "Controleer de datums van de kinderen om te bepalen of een persoon overleden is. Op oudere systemen en bij grote GEDCOM-bestanden verlaagt dit de response tijd van uw website.";
$pgv_lang["MAX_ALIVE_AGE"]			= "Leeftijd waarboven iemand geacht wordt overleden te zijn";
$pgv_lang["MAX_ALIVE_AGE_help"]		= "De maximum leeftijd die een persoon kan hebben of de maximum leeftijd van hun kinderen om te bepalen waarneer iemand overleden is of niet.";
$pgv_lang["SHOW_GEDCOM_RECORD"]			= "Sta toe dat gebruikers de GEDCOM-regels zien";
$pgv_lang["SHOW_GEDCOM_RECORD_help"]	= "Door deze optie op 'ja' te zetten worden er, bij personen, gezinnen en bronnen, koppelingen geplaatst die gebruikers een nieuw venster geven met de gegevens uit het GEDCOM-bestand.";
$pgv_lang["ALLOW_EDIT_GEDCOM"]		= "Sta wijzigen toe";
$pgv_lang["ALLOW_EDIT_GEDCOM_help"]	= "Stelt functionaliteit ter beschikking om in de toepassing gegevens te wijzigen. De desbetreffende gebruikers moeten hier dan nog expliciet voor worden geautoriseerd.";
$pgv_lang["POSTAL_CODE"]  = "Positie postcode";
$pgv_lang["INDEX_DIRECTORY"]		= "Map voor indexbestanden";
$pgv_lang["INDEX_DIRECTORY_help"]	= "Het pad naar een lees- en schrijfbare map waar PhpGedView de indexbestanden moet opslaan (inclusief de \"/\" aan het eind).";
$pgv_lang["SHOW_ID_NUMBERS_help"]	= "Toon ID-nummers tussen haakjes achter de persoonsnaam in de vakken.";
$pgv_lang["SHOW_PEDIGREE_PLACES"]		= "Toon plaatsen in persoonsvakken";
$pgv_lang["SHOW_PEDIGREE_PLACES_help"]	= "Stelt in, hoeveel niveaus van plaatsinformatie worden weergegeven bij geboorte- en overlijdensdata in de kwartierstaat- en nakomelingengrafieken. De waarde 9 laat alle niveaus zien, de waarde 0 geen enkele. De waarde 1 toont alleen het eerste niveau, 2 ook het tweede, etc.";
$pgv_lang["MULTI_MEDIA"]			= "Multimedia mogelijkheden aanzetten";
$pgv_lang["MULTI_MEDIA_help"]		= "GEDCOM 5.5 bevat de mogelijkheid om afbeeldingen, video's en andere multimedia-objecten op te nemen in het GEDCOM-bestand. Als u geen multimedia-objecten in uw GEDCOM-bestand heeft dan kunt u deze optie op 'Nee' zetten om de multimediamogelijkheden uit te zetten.<br />Zie de multimediaparagraaf het <a href=\"readme.txt\">readme.txt</a> bestand voor meer informatie over het opnemen van media in uw website.";
$pgv_lang["MEDIA_EXTERNAL"]			= "Behoudt koppelingen";
$pgv_lang["MEDIA_EXTERNAL_help"]	= "Als een multimedia-item wordt gevonden waarvan de naam start met bijvoorbeeld http://, ftp:// of mms://, wordt de naam ongewijzigd gelaten als deze optie aan staat. Bijvoorbeeld: http://www.mijnfamilie.nl/foto/vader.jpg blijft http://www.mijnfamilie.nl/foto/vader.jpg. Als de optie uit staat, wordt de naam behandeld als standaardverwijzing en wordt het aantal niveaus van de multimediamappen toegepast. Bijvoorbeeld: http://www.mijnfamilie.nl/foto/vader.jpg wordt ./media/vader.jpg.";
$pgv_lang["MEDIA_DIRECTORY"]		= "Multimediamappen";
$pgv_lang["MEDIA_DIRECTORY_help"]	= "Het pad naar de map waar PhpGedView de lokale mediagegevens ophaalt (met de laatste \"/\" achter de padnaam).<br />Het pad moet een relatief pad zijn binnen de PGV website, bijvoorbeeld: ./media/<br />Ook een URL naar een website kan als pad NIET worden gebruikt, aangezien dit niet in alle gevallen werkt.";
$pgv_lang["MEDIA_DIRECTORY_LEVELS"]			= "Aantal niveaus van de Multimediamappen";
$pgv_lang["MEDIA_DIRECTORY_LEVELS_help"]	= "Een waarde van 0 zal alle mappen overslaan in het pad van het media object. Een waarde van 1 zal ook de eerste map van het object gebruiken. Door het verhogen van het getal wordt het aantal niveaus van mappen verhoogd dat gebruikt wordt.<br />Bijvoorbeeld: als er een koppeling naar het object staat met het pad C:\\Documents and Settings\\User\\My Documents\\My Pictures\\Genealogy\\Surname Line\\grandpa.jpg dan zal een waarde van 0 vertaald worden in het pad ./media/grandpa.jpg. Een waarde van 1 zal vertaald worden naar ./media/Surname Line/grandpa.jpg, enz. De meeste mensen zullen met een 0 kunnen volstaan. Let op: het is mogelijk dat sommige media objecten met dezelfde naam elkaar overschrijven. Dit maakt het mogelijk om enige structuur aan te brengen in de media map en voorkomt het voorkomen van dubbele namen.";
...
$pgv_lang["USE_THUMBS_MAIN_help"]	= "Afhankelijk van de omvang van de afbeeldingen kan het beter zijn om in plaats van de afbeeldingen de miniatuurweergaven te gebruiken naast de naam van de persoon. Als de afbeeldingen erg groot zijn, kan de tijd die nodig is voor het opbouwen van de pagina erg lang worden. Let er wel op dat uw miniatuurweergaven van voldoende kwaliteit zijn.<br /><br />Zet deze waarde op \"Ja\" om miniatuurweergaven te gebruiken en \"Nee\" om de oorspronkelijke afbeeldingen te gebruiken.";
$pgv_lang["ENABLE_CLIPPINGS_CART"]		= "Knipselbak aanzetten";
$pgv_lang["ENABLE_CLIPPINGS_CART_help"] = "De knipselbak maakt het voor bezoekers mogelijk om informatie toe te voegen aan een GEDCOM-knipselbestand.<br />De bezoeker kan dit bestand downloaden als een GEDCOM-bestand en in zijn of haar genealogiesoftware inlezen.";
$pgv_lang["HIDE_GEDCOM_ERRORS"]			= "Verberg GEDCOM-fouten";
$pgv_lang["HIDE_GEDCOM_ERRORS_help"]	= "Door deze optie op 'Ja' te zetten worden fouten niet getoond als PhpGedView een GEDCOM-code tegenkomt die het niet herkent. PhpGedView voldoet aan de GEDCOM 5.5 standaard, maar veel genealogieprogramma's bevatten aangepaste of eigen codes. Zie het <a href=\"readme.txt\">readme.txt</a> bestand voor meer informatie.";
$pgv_lang["WORD_WRAPPED_NOTES"]			= "Toevoegen spaties als notities zijn afgebroken";
$pgv_lang["WORD_WRAPPED_NOTES_help"]	= "Sommige genealogie programma's breken opmerkingen af op woorden terwijl andere de opmerkingen op een willekeurige plek afbreken. Hierdoor is het mogelijk dat PhpGedView woorden aan elkaar plakt. Door dit op 'Ja' te zetten wordt er een spatie tussen woorden gezet.";
$pgv_lang["SHOW_CONTEXT_HELP_help"]	= "Door middel van deze optie kunt op de pagina's vraagtekens weergeven naast de verschillende koppelingen en velden. Bezoekers kunnen hierop klikken en krijgen dan informatie over het desbetreffende item.";
$pgv_lang["COMMON_NAMES_THRESHOLD"]			= "Minimum aantal voor \"Meest voorkomende achternamen\"";
$pgv_lang["COMMON_NAMES_THRESHOLD_help"]	= "Dit is het aantal malen dat een achternaam moet voorkomen in de genealogie, voordat hij verschijnt in de \"Meest voorkomende achternamen\" op de Welkomstpagina.";
$pgv_lang["COMMON_NAMES_ADD"]		= "Namen om toe te voegen aan \"Meest voorkomende achternamen\"";
$pgv_lang["COMMON_NAMES_ADD_help"]	= "Als het aantal malen dat een achternaam in de genealogie voorkomt lager is dan de drempelwaarde, zal de naam niet in de lijst met Meest voorkomende achternamen verschijnen. De achternaam kan dan hier handmatig worden toegevoegd. Als er meer namen worden opgegeven, moeten ze met een komma worden gescheiden.<br />Let op: de opgegeven namen zijn hoofdlettergevoelig!";
$pgv_lang["COMMON_NAMES_REMOVE"]		= "Namen om te verwijderen uit Meest voorkomende achternamen (komma gescheiden)";
$pgv_lang["COMMON_NAMES_REMOVE_help"]	= "Als u een achternaam wilt verwijderen uit de Meest voorkomende achternamen, zonder de drempelwaarde daarvoor te verhogen, kunt u de naam hier invoeren. Als er meer namen worden opgegeven, moeten ze met een komma worden gescheiden.<br />Let op: de opgegeven namen zijn hoofdlettergevoelig!";
$pgv_lang["SHOW_CONTEXT_HELP"]		= "Toon \"?\" helpkoppelingen op de pagina's";
$pgv_lang["HOME_SITE_URL"]			= "Website-URL";
$pgv_lang["HOME_SITE_URL_help"]		= "Het adres dat in de standaard themabestanden zorgt voor een koppeling naar uw website.";
$pgv_lang["HOME_SITE_TEXT"]			= "Website-tekst";
$pgv_lang["HOME_SITE_TEXT_help"]	= "De tekst die gebruikt wordt voor de koppeling naar uw website.";
$pgv_lang["CONTACT_EMAIL"]			= "E-mail genealogische vragen";
$pgv_lang["CONTACT_EMAIL_help"]		= "Het e-mailadres dat gebruikt moet worden als er vragen zijn over de genealogische gegevens op deze website.";
...
$pgv_lang["WEBMASTER_EMAIL_help"]	= "Het e-mail adres dat gebruikt moet worden als er vragen zijn over de techniek of als er fouten worden gevonden op de website.";
...
$pgv_lang["FAVICON_help"]			= "Wijzig dit in het icoon dat getoond moet worden in de favorieten als mensen de website markeren.";
$pgv_lang["THEME_DIR"]				= "Themamap";
$pgv_lang["THEME_DIR_help"]			= "De map waar de PhpGedView thema bestanden staan. U kunt elk standaard thema aanpassen die met PhpGedView worden meegeleverd om uw website op een unieke manier te tonen.<br /> Zie de paragraaf over thema-aanpassing in het <a href=\"readme.txt\">readme.txt</a> bestand voor meer informatie.";
$pgv_lang["TIME_LIMIT"]				= "PHP tijdslimiet";
$pgv_lang["TIME_LIMIT_help"]		= "De maximale tijd in seconden dat PhpGedView mag draaien. De standaard tijd is één minuut. Afhankelijk van de omvang van het GEDCOM-bestand is het mogelijk dat deze waarde verhoogt moet worden tijdens het opbouwen van de indexen. Met de waarde 0 mag PHP altijd blijven draaien.<br />OPGELET: door deze waarde op 0 te zetten of een andere hoge waarde is het mogelijk dat de website blijft hangen op bepaalde bewerkingen zolang het script draait. Door de waarde op 0 te zetten is het mogelijk dat het script nooit gestopt wordt behalve als het door de server beheerder wordt gestopt of de machine herstart. Een grote genealogietabel kan zeer lang draaien; door deze waarde zo laag mogelijk te houden wordt voorkomen dat iemand de webserver kan laten stoppen door een 1000 generatie lijst op te vragen.";
...
$pgv_lang["SERVER_URL_help"] 		= "Type hier de URL van uw server, als u https of een andere dan de standaardpoort gebruikt.";
$pgv_lang["LOGIN_URL"]				= "URL voor aanmelden";
$pgv_lang["LOGIN_URL_help"]			= "De URL voor aanmelden vult u alleen in, als u een andere site of locatie wilt opgeven waar uw gebruikers zich moeten aanmelden. Dit is bijvoorbeeld nuttig voor het geval u om wilt schakelen naar https voor aanmelden. De volledige URL naar het login.php-bestand dient hier ingevoerd te worden, bijv. https://www.mijnserver.nl/phpgedview/login.php.";
$pgv_lang["PGV_SESSION_TIME"]		= "Sessie verlopen";
$pgv_lang["PGV_SESSION_TIME_help"]	= "De tijd in seconden, dat een PhpGedView sessie actief blijft, voordat opnieuw aanmelden noodzakelijk is. Standaard is 120 minuten.";
$pgv_lang["SHOW_STATS"]				= "Toon verwerkingsgegevens";
$pgv_lang["SHOW_STATS_help"]		= "Toont verwerkingsgegevens en database bevragingen onder aan ieder scherm.";
$pgv_lang["SHOW_COUNTER"]			= "Toon bezoekteller";
$pgv_lang["SHOW_COUNTER_help"]		= "Toont de bezoekteller op de MyGedView-pagina, de Genealogie-infopagina en op de personen-pagina.";
$pgv_lang["USE_REGISTRATION_MODULE"]		= "Gebruikers toestaan om gebruikersnamen te registreren";
$pgv_lang["USE_REGISTRATION_MODULE_help"]	= "Geeft gebruikers de mogelijkheid zich op de site te registreren.<br />De gebruiker ontvangt daarna een e-mail met verificatiegegevens.<br />Beheerders moeten de registratie na verificatie goedkeuren opdat die actief wordt.";
$pgv_lang["ALLOW_USER_THEMES"] 		= "Gebruikers toestaan om hun eigen site-opmaak te kiezen";
$pgv_lang["ALLOW_USER_THEMES_help"] = "Geeft gebruikers de mogelijkheid hun eigen opmaakthema te kiezen.";
$pgv_lang["PGV_SIMPLE_MAIL"]		= "Gebruik alleen e-mailadres voor externe berichten";
$pgv_lang["PGV_SIMPLE_MAIL_help"]	= "Normaliter worden in externe mailberichten zowel het e-mailadres als de naam van de geadresseerde en de afzender gebruikt. Sommige mailsystemen accepteren dit niet. Bij de waarde \"Ja\" wordt alleen het e-mailadres gebruikt.";
$pgv_lang["gedcom_title_help"] 		= "Voer een titel in, welke de inhoud van dit GEDCOM-bestand beschrijft.";
$pgv_lang["LOGFILE_CREATE"] 		= "Archiveer Logbestanden";
$pgv_lang["PGV_STORE_MESSAGES"]		= "Sta toe dat berichten worden opgeslagen";
$pgv_lang["PGV_STORE_MESSAGES_help"]	= "Hiermee wordt aangegeven, of berichten, die door PhpGedView worden verzonden, opgeslagen worden. Bij de waarde \"Ja\" kunnen gebruikers, bij aanmelden, hun ontvangen berichten lezen. Bij de waarde \"Nee\" worden de berichten alleen via externe e-mail verzonden.";
$pgv_lang["ALLOW_THEME_DROPDOWN"]		= "Toon keuzelijst voor wijziging thema";
$pgv_lang["ALLOW_THEME_DROPDOWN_help"]	= "Deze optie geeft gebruikers de mogelijkheid om hun eigen site-opmaak te kiezen uit een keuzelijst.<br />de optie \"#ALLOW_USER_THEMES#\" moet eveneens ingeschakeld staan.";
$pgv_lang["META_AUTHOR"]			= "META-tag auteur";
$pgv_lang["META_AUTHOR_help"]		= "Deze waarde wordt geplaatst in de META-tag voor de auteur in de kop van de HTML-pagina. Als deze leeg wordt gelaten, wordt de volledige naam van de contactpersoon opgenomen.";
...
$pgv_lang["META_PUBLISHER_help"]	= "Deze waarde wordt geplaatst in de META-tag voor de uitgever in de kop van de HTML-pagina. Als deze leeg wordt gelaten, wordt de volledige naam van de contactpersoon voor de desbetreffende genealogie opgenomen.";
...
$pgv_lang["META_COPYRIGHT_help"]	= "Deze waarde wordt geplaatst in de META-tag voor copyright in de kop van de HTML-pagina. Als deze leeg wordt gelaten, wordt de volledige naam van de contactpersoon voor de desbetreffende genealogie opgenomen.";
...
$pgv_lang["META_DESCRIPTION_help"]	= "Deze waarde wordt geplaatst in de META-tag voor de omschrijving van de pagina, in de kop van de HTML-pagina. Als deze leeg wordt gelaten, wordt de naam van de actieve genealogie opgenomen.";
...
$pgv_lang["META_PAGE_TOPIC_help"]	= "Deze waarde wordt geplaatst in de META-tag voor het onderwerp van de pagina, in de kop van de HTML-pagina. Als deze leeg wordt gelaten, wordt de naam van de actieve genealogie opgenomen.";
...
$pgv_lang["META_AUDIENCE_help"]		= "Deze waarde wordt geplaatst in de META-tag voor de doelgroep van de pagina, in de kop van de HTML-pagina.";
$pgv_lang["META_PAGE_TYPE"]			= "META-tag paginatype";
$pgv_lang["META_PAGE_TYPE_help"]	= "Deze waarde wordt geplaatst in de META-tag voor paginatype, in de kop van de HTML-pagina.";
$pgv_lang["META_ROBOTS"]			= "META-tag robots";
$pgv_lang["META_ROBOTS_help"]		= "Deze waarde wordt geplaatst in de META-tag voor robots, in de kop van de HTML-pagina. Let op: veel zoek-robots negeren deze waarde.<";
$pgv_lang["META_REVISIT"]			= "META-tag herbezoek";
$pgv_lang["META_REVISIT_help"]		= "Deze waarde wordt geplaatst in de META-tag voor herbezoek door zoekrobots, in de kop van de HTML-pagina.";
$pgv_lang["META_KEYWORDS"]			= "META-tag sleutelwoorden";
$pgv_lang["RSS_FORMAT"]				= "RSS-indeling";
$pgv_lang["META_KEYWORDS_help"]		= "Deze waarde wordt geplaatst in de META-tag voor sleutelwoorden, in de kop van de HTML-pagina. Veel zoekmachines gebruiken de sleutelwoorden om de pagina te ontsluiten. Aan wat hier wordt opgegeven, worden automatisch de lijst met veel voorkomende achternamen en de statistieken voor de genealogie toegevoegd.";
$pgv_lang["META_TITLE"]				= "META-tag toevoegen aan titel";
$pgv_lang["META_TITLE_help"]		=	"Alles wat hier wordt opgegeven, wordt toegevoegd aan de titel-metatag, achter de paginatitel en voor de PhpGedView informatie.";
$pgv_lang["PGV_MEMORY_LIMIT"]		= "Geheugenlimiet";
$pgv_lang["PGV_MEMORY_LIMIT_help"]	= "Het maximum geheugen dat PHP-scripts kunnen gebruiken. De standaardwaarde is 16 Mb. Op veel machines is de optie om deze waarde voor PHP in te stellen uitgeschakeld. Het instellen van deze waarde heeft daarom niet altijd invloed op de werkelijke maximumwaarde.";
$pgv_lang["LOGFILE_CREATE_help"] 	= "Geef aan hoe vaak het programma de log bestanden moet archiveren.";
$pgv_lang["welcome_new"] 			= "Welkom bij uw nieuwe PhpGedView website. U ziet deze pagina omdat u PhpGedView met succes op uw webserver heeft geïnstalleerd en kunt nu beginnen met het instellen volgens uw wensen.";
$pgv_lang["welcome_new_help"]		= "Dit Help-venster zal u behulpzaam zijn bij het configuratieproces.  Omdat u diverse velden moet invullen, kan dit venster u van aanvullende informatie voorzien, over het veld waarin u bent. U kunt dit venster sluiten, om het weer te openen klik op een van de \"?\" vraagtekens naast het label van het veld.";
$pgv_lang["review_readme"] 			= "Leest u eerst het <a href=\"readme.txt\" target=\"_blank\">readme.txt</a> bestand voordat u verder gaat met het instellen van PhpGedView.";
$pgv_lang["return_editconfig"]		= "U kunt ten allen tijde terugkeren naar deze pagina, door te klikken op de koppeling <b>Instellingen</b> op de Pagina <b>Beheer</b>, of met uw internet verkenner het bestand editconfig.php op te roepen.";
$pgv_lang["return_editconfig_gedcom"]	= "U kunt ten allen tijde terugkeren naar deze pagina, door te klikken op de koppeling <b>Wijzig</b> in de tabel <b>Huidige GEDCOM-bestanden</b> op de Pagina <b>Beheer GEDCOM-bestanden en privacy instellingen</b>, of met uw internet verkenner het bestand editconfig_gedcom.php op te roepen.";
...
$pgv_lang["general_privacy_help"]	= "De <b>Algemene privacy-instellingen.</b><br />Hier maakt u de basisinstellingen voor deze genealogie. Let erop, dat u de instellingen van de juiste genealogie aanpast, want als u meer genealogieën in PhpGedView beschikbaar heeft, gelden voor iedere genealogie eigen privacy-instellingen.<br />Afwijkingen van de basisinstellingen zijn mogelijk, door de andere instellingen op deze pagina te gebruiken.<br /><br /><b>Meer Help</b><br />Op deze pagina is meer helpinformatie beschikbaar. Klik daarvoor op de <b>?</b> achter de vakken en teksten.";
...
$pgv_lang["bom_check_help"]		= "Middels deze controle worden BOM's (Byte Order Mark) in de taalbestanden opgespoord en verwijderd.";
$pgv_lang["bom_check_desc"]			= "Middels deze controle worden BOM's (Byte Order Mark) in de taalbestanden opgespoord en verwijderd.";
...
$pgv_lang["export_lang_utility_desc"]	= "Kies een taal om de helpinformatie uit het gekozen configuration_help taalbestand te exporteren naar een documentatiebestand.";
...
$pgv_lang["original_lang_name_help"]	= "Hiermee geeft u aan, hoe deze taal in die taal zelf wordt genoemd.<br />Voorbeelden: Engels: English, Duits: Deutsch, Nederlands: Nederlands.";
$pgv_lang["lang_shortcut"]			= "Afkorting van de taal";
$pgv_lang["lang_shortcut_help"]		= "Met deze optie stelt u in, hoe de taal in twee letters wordt afgekort.<br />Meestal is dit de eerste code, die in de taaldetectiecodes is opgenomen.<br />De afkorting wordt gebruikt voor de naamgeving van de taalbestanden. ";
$pgv_lang["lang_langcode_help"]		= "Met behulp van deze codes kan PhpGedView detecteren welke taalinstelling de Internetverkenner van de gebruiker gebruikt voor het bekijken van de PhpGedView pagina's. De codes moeten worden gescheiden door een puntkomma \";\". ";
...
$pgv_lang["translation_forum_desc"]	= "Deze koppeling opent een nieuw venster in uw Internet Verkenner, naar het vertalerforum van PhpGedView (http://sourceforge.net/forum/forum.php?forum_id=294245). Hier kunt u vragen stellen over vertalingen, problemen voorleggen en (als u wilt) u aanmelden voor het leveren van een bijdrage aan de vertalingen.<br />Als u moeite heeft met de Engelse taal, dan kunt u uw bericht in het Nederlands stellen.";
...
$pgv_lang["um_proceed"]				= "Doorgaan met importeren/exporteren van gebruikersinformatie?";
$pgv_lang["um_creating"]			= "Aanmaken";
$pgv_lang["um_sql_index"]			= "Dit programma maakt het bestand \"authenticate.php\" en diverse <b>.dat</b> bestanden aan in uw indexmap.<br />Nadat de bestanden succesvol zijn aangemaakt, kunt u overschakelen naar index-modus met beoud van alle gebruikersinstellingen, berichten, favorieten, nieuwsberichten en opmaak van de genealogie-startpagina en MGedView-pagina's.<br /><br />Let op: Na het overschakelen naar index-modus moet u uw GEDCOM-bestand(en) opnieuw importeren.";
...
$pgv_lang["um_bu_help"] = "Dit programma maakt een backup van verschillende soorten gegevens in PhpGedView.<br /><br />De gegevens die u hieronder voor de backup selecteert worden verzameld en in een ZIP-bestand opgeslagen.<br />Dit kunt u downloaden met de koppeling die dan onderaan de pagina verschijnt.<br />Het ZIP-bestand blijft aanwezig in uw index-map totdat u dit handmatig verwijdert.";

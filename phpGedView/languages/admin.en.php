...
$pgv_lang["cannot_change_timelimit_instr"]		= "You may not be able to run all functions on large GEDCOMs with more than 3000 individuals.";
...
$pgv_lang["cannot_change_memlimit_instr"]		= "You may not be able to run all functions on large GEDCOMs with more than 3000 individuals.";
...
$pgv_lang["cannot_use_sax"]		= "You do not have the SAX XML library.  You will not be able to run PDF reports or some other auxillary functions.";

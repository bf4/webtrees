...
$pgv_lang["reorder_media_title"]			= "Drag and drop thumbnails to reorder media items";
$pgv_lang["reorder_media_window"]			= "Re-order media (window)";
$pgv_lang["reorder_media_window_title"]		= "Click a row, then \"Drag and drop\" to reorder media ";
$pgv_lang["reorder_media_save"]				= "Saves the sorted media to the Individual Gedcom";
$pgv_lang["reorder_media_reset"]			= "Removes the sorted media from the Individual Gedcom";

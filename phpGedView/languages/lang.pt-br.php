...
$pgv_lang["descendancy_header"]		= "Relatório de Descendentes para";
...
$pgv_lang["lbl_type_server"]="Informe um novo site.";
...
$pgv_lang["error_view_connections"]="Selecione o site que deseja Ver.";
...
$pgv_lang["label_ban_view_links"]="Ver ligações com este site banido";
...
$pgv_lang["title_view_conns"]="Ver Conexões";
$pgv_lang["label_server_info"]="Todas as pessoas ligadas remotamente pelo site:";
$pgv_lang["label_view_local"]="Ver dados locais da pessoa";
$pgv_lang["label_view_remote"]="Ver dados remotos da pessoa";
...
$pgv_lang["july_1st"]="Jul";
$pgv_lang["june_1st"]="Jun";
$pgv_lang["may_1st"]="Maio";
$pgv_lang["april_1st"]="Abr";
...
$pgv_lang["error_server_exists"]="O site adicionado já existe; selecione o site da lista «Use an existing site».";
...
$pgv_lang["remember_me"]="Você deseja que este site reconheça-o automaticamente de uma próxima vez?";
$pgv_lang["add_unlinked_person"]="Adicionar pessoa sem parentes na árvore";
$pgv_lang["add_unlinked_source"]="Adicionar uma fonte sem qualquer ligação";
...
$pgv_lang["top10_pageviews"]="Itens mais Vistos";
$pgv_lang["top10_pageviews_block"]="Pessoas mais visitadas";
...
$pgv_lang["fams_charts"]="Opções da Família";
...
$pgv_lang["indis_charts"]="Opções do Indivíduo";
...
$pgv_lang["individual_list"]="Lista de Pessoas";
$pgv_lang["family_list"]="Lista de Famílias";
$pgv_lang["source_list"]="Lista de Fontes";
$pgv_lang["place_list"]="Hierarquia de Locais";
$pgv_lang["place_list_aft"]="Locais abaixo de";
$pgv_lang["media_list"]="Lista de Mídias";
...
$pgv_lang["external_file"]			= "Este objeto de mídia nao existe como arquivo no servidor. Deve ter sido apagado, movido ou renomeado.";
...
$pgv_lang["replace_with"]			= "Substituir com";
...
$pgv_lang["repo_list"]="Lista de Reposição";
...
$pgv_lang["timeline_endYear"] = "Ano do término";
$pgv_lang["timeline_beginYear"] = "Ano do início";
...
$pgv_lang["no_auth_needed"]			= "Sem Autenticação";
...
$pgv_lang["comment_exp"]="Aviso do administrador";
...
$pgv_lang["utf8_to_ansi"]="Quer converter este arquivo GEDCOM do formato UTF-8 para ANSI (ISO-8859-1)?";
...
$pgv_lang["aunt"]="Tia";
$pgv_lang["uncle"]="Tio";
$pgv_lang["bosa_6"] 				= "Neto";
$pgv_lang["bosa_7"] 				= "Neta";
$pgv_lang["firstcousin"]="Primo";
$pgv_lang["bosa_13"]				= "Bisneta";
$pgv_lang["bosa_10"]				= "Bisneto";
$pgv_lang["bosa_5"] 				= "Neta";
$pgv_lang["bosa_4"] 				= "Neto";
$pgv_lang["bosa_3"] 				= "Filha";
$pgv_lang["bosa_2"] 				= "Filho";
...
$pgv_lang["add_son_daughter"]="Adicionar filho ou uma filha";
$pgv_lang["must_provide"]="Informe um ";
$pgv_lang["delete_person"]="Excluir esta Pessoa";
$pgv_lang["confirm_delete_person"]="Confirmar exclusão desta pessoa do arquivo GEDCOM?";
...
$pgv_lang["add_new_wife"]="Adicionar nova esposa";
$pgv_lang["add_new_husb"]="Adicionar novo marido";
...
$pgv_lang["add_father"]="Adicionar novo pai";
$pgv_lang["add_mother"]="Adicionar nova mãe";
...
$pgv_lang["welcome_text_auth_mode_1"]="<b>BEM-VINDO A ESTE SITE GENEALÓGICO</b><br /><br />O acesso a este site é permitido a qualquer visitante, desde que tenha uma conta.<br />Se já tem uma conta, basta identificar-se, Se ainda não tem uma, clique no link apropriado nesta página e solicite a sua conta.<br />Sua solicitação será enviada ao Administrador do site que após ativar sua conta, lhe enviará um email instruindo-o de como acessar o site.";
$pgv_lang["welcome_text_auth_mode_2"]="<b>BEM-VINDO A ESTE SITE GENEALÓGICO</b><br /><br />O acesso a este site é permitido a todos que tenham uma conta.<br />Se já tem uma conta, basta identificar-se, Se ainda não tem uma, clique no link apropriado nesta página e solicite a sua conta.<br />Sua solicitação será enviada ao Administrador do site para ser aceita ou não.<br />Um email será enviado informando-o da decisão do Administrador.";
$pgv_lang["welcome_text_auth_mode_3"]="<b>BEM-VINDO A ESTE SITE GENEALÓGICO</b><br /><br />O acesso a este site é permitido <b>somente para pessoas da família</b>.<br />Se já tem uma conta, basta identificar-se, Se ainda não tem uma e você é da família, clique no link apropriado nesta página e solicite a sua conta.<br />Sua solicitação será enviada ao Administrador do site para ser aceita ou não.<br />Um email será enviado informando-o da decisão do Administrador.";
...
$pgv_lang["no_favorites"]="Não há favoritos. Para adicionar uma pessoa ao <b>Meus Favoritos</b>, procure os detalhes da Pessoa que você deseja adicionar e clique em \"Adicione aos Meus Favoritos\" ou use a caixa abaixo para adicioná-lo pelo sua ID (ex: I21), ou informe uma URL e um título.";
...
$pgv_lang["gedcom_news_archive"]="Ver arquivo";
...
$pgv_lang["inc_researchlog"]="Log de Pesquisa";
...
$pgv_lang["not_configured"]="Configure o PhpGedView.";
$pgv_lang["location_upgrade"]="Por favor, informe a localizaçào dos arquivos de atualização.";
$pgv_lang["new_variable"]="Nova variável encontrada: ";
$pgv_lang["file_open_error"]="Houve um erro ao abrir o arquivo [#pgv_lang[global_str1]#].";
$pgv_lang["file_write_error"]="Erro!!! Não foi possível gravar no arquivo [#pgv_lang[global_str1]#].";
$pgv_lang["config_open_error"]="Ocorreu um erro na abertura do arquivo de configuração.";
$pgv_lang["gedcom_config_write_error"]="Erro!!! Não foi possível gravar o arquivo de configuração da Árvore (GEDCOM).";
...
$pgv_lang["heading_researchlog"]="Arquivos de log de Pesquisas:";
$pgv_lang["heading_researchloglang"]="Arquivos de Log de Idiomas e Pesquisa";
...
$pgv_lang["process_error"]="Houve um problema ao processar a página. Uma nova versão não pode ser determinada.";
$pgv_lang["upgrade_completed"]="Atualização finalizada com sucesso";
$pgv_lang["start_using_upgrad"]="Clique aqui para utilizar a versão";
...
$pgv_lang["patriarch_list"]="Lista dos Patriarcas";
...
$pgv_lang["stat_18_ard"]="idade em relação a ano do falecimento.";
...
$pgv_lang["stplmarrbirth"]		 = "Meses entre o casamento e o nascimento do primeiro filho";
...
$pgv_lang["total_places"]="Lugares econtrados";

...
$pgv_lang["privacy_error"]		= "Podrobnosti o tejto osobe sú neverejné.";
...
$pgv_lang["mail04_line05"]		= "Po prihlásení vyberte link «Môj účet» v menu «Vstupná brána MyGedView» a vyplňte pole heslo, pre zmenu vášho hesla.";
...
$pgv_lang["welcome_text_cust_head"]	=	"<center><b>VITAJTE NA TÝCHTO RODOPISNÝCH STRÁNKACH</b></center><br />Prístup na tieto stránky je umožnený iba užívateľom, ktorý tu majú zriadený svoj uživateľský účet z heslom.";
...
$pgv_lang["recent_changes_none"]	= "<b>Nie sú žiadne zmeny za posledných #pgv_lang[global_num1]# dní.</b>";
$pgv_lang["recent_changes_some"]	= "<b>Zmeny urobené za posledných #pgv_lang[global_num1]# dní.</b>";
...
$pgv_lang["click_here_help"]		= "Kliknite na toto tlačítko na uloženie zmien, ktoré ste urobili.<br /><br />Vrátite sa na  stránku Vitajte alebo Vstupná brána MyGedView, ale zmeny nebudú zobrazené. Na zobrazenie uložených zmien môžete použiť funkciu vašeho prehliadača Aktualizovať.";
$pgv_lang["block_summaries"]		= "Tu je krátký popis každého z blokov, ktorý môžete umiestniť na stránku Vitajte alebo Vstupná brána MyGedView.<br /><table border='1' align='center'><tr><td class='list_value'><b>Meno</b></td><td class='list_value'><b>Popis</b></td></tr>&nbsp;</table>";
...
$pgv_lang["add_fav_or_enter_url"]	= "Alebo<br />Vložte URL a názov";

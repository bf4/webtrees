...
if (preg_match("/lang\...\.php$/", $_SERVER["SCRIPT_NAME"])>0) {
	print "אין לך גישה לתיקית קובצי השפות.";
	exit;
}
...
$pgv_lang["record_not_found"]		= "רשומת ה-GEDCOM המבוקשת לא נימצאה. הסיבה יכולה להיות קישור לאדם לא תקין או קובץ GEDCOM פגום.";
...
$pgv_lang["error_server_exists"]    	= "האתר שאתה מנסה להוסיף כבר קיים;\nאנא בחר אותו מרשימהה נגללת ששמה\n<b>השתמש באתר קיים</b>.";
...
$pgv_lang["cancel"]			= "בטל";
$pgv_lang["cookie_help"]		= "עוגיות (Cookies) דרושות כדי להתחבר לאתר זה. ניראה שהדפרדן שלך אינו מאפשר עוגיות.<br /><br />נא אפשר עוגיות עבור אתר זה לפני המשכת תהליך החיבור. ניתן לעיין בתעוד העזרה של הדפדפן שלך איך מאפשרים עוגיות.";
//new stuff
//Individual
...
$pgv_lang["error_remote"]           	= "בחרת אתר מרוחק.";
$pgv_lang["error_same"]             	= "בחרת את אותו האתר.";
$pgv_lang["error_server_exists"]    	= "האתר שאותו אתה מנסה להוסיף כבר\nקיים. בחר אותו מהתיבה הנגללת ששמה\n<b>השתמש באתר קיים</b>.";
$pgv_lang["lbl_server_list"]        	= "השתמש באתר קיים.";
$pgv_lang["lbl_type_server"]         	= "הקלד אתר חדש.";
...
$pgv_lang["filter_address"]		= "הראה כתובות לות:";
...
$pgv_lang["htmlplus_block_narrative"] 	= "סגנון תאורי";
//$pgv_lang["htmlplus_block_narrative"] 	= "סגנון ספורי (רק באנגלית)";
...
$pgv_lang["top10_pageviews_descr"]	= "אזור זה מציג את עשרת הרשומות הכי נצפות. מונה הפגיעות בהגדרת התצורה של ה-GEDCOM חיב לפעול כדי שהאזור יהיה פעיל.";
...
$pgv_lang["relatives_events"]		= "ארועים של קרובי משפחה";
...
$pgv_lang["view_records_in_place"]	= "התבונן בכל הרשומות הנימצאות במקום הזה";
...
$pgv_lang["delete_dir_success"]	= "תיקייות המדיה והתמונות המזעריות הוסרו בהצלחה.";
$pgv_lang["current_dir"]		= "התיקייה הנוכחית";
$pgv_lang["add_directory"]		= "הוסף תיקיה";
...
$pgv_lang["no_thumb_dir"]		= " תיקית התמונות המזעריות לא קיימת ולא ניתן ליצור אותה עבורך";
...
$pgv_lang["media_folder_corrupt"]	= "תיקית המדיה מקולקלת.";
...
$pgv_lang["unable_to_create_index"]	= "לא ניתן ליצור קובץ אינדקסים. וודא שקיימות הרשאות לתיקיה PhpGedView. את ההרשאות ניתן לשנות אחרי שקבצי האינדקס יכתבו.";
...
$pgv_lang["alpha_index"]		= "אנדקס אלף בית";
...
$pgv_lang["basic_auth_failure"]	= "עליך להכניס קוד משתמש וסיסמא תקפים כדי להכנס למשאב זה";
...
//$pgv_lang["upload_help"]		= "בחר קבצים מהמחשב המקומי שלך והעלה אותם לשרת. כל הקבצים יועלו לתיקיה <b>#MEDIA_DIRECTORY#</b> או לאחת מהתיקיות מתחתיו.<br /><br />שמות החוצצים שתציין יתווספו ל-#MEDIA_DIRECTORY#. למשל, #MEDIA_DIRECTORY#myfamily. אם תיקית התמונות המזעריות אינה קיימת, היא תווצר בצורה אוטומטית.<br /><br />";
$pgv_lang["upload_media_help"]	= "~#pgv_lang[upload_media]#~<br /><br />בחר קבצים מהמחשב המקומי שלך להעלאה לשרת שלך. כל הקבצים מועלים לתיקיית <b>#MEDIA_DIRECTORY#</b> או לאחת מהתיקיות מתחתיה.<br /><br />שמות החוצצים שאתה מציין יתווספו ל-#MEDIA_DIRECTORY#. למשל, #MEDIA_DIRECTORY#myfamily. אם תיקית התמונות המזעריות אינה קיימת, היא תווצר בצורה אוטומטית.";
...
$pgv_lang["add_gedcom_instructions"]	= "הכנס שם קובץ עבור ה-GEDCOM החדש הזה.  קובץ ה-GEDCOM החדש יווצר בתיקיית האינדקס: #INDEX_DIRECTORY#";
...
$pgv_lang["verify_upload_instructions"]	= "נימצא קובץ GEDCOM בעל שם זהה. אם תבחר להמשיך, קובץ ה-GEDCOM הישן יוחלף בקובץ שהעלת ותהליך היבוא יתחיל שוב. אם תבחר לבטל, קובץ ה-GEDCOM הישן ישאר כפי שהיה.";
...
$pgv_lang["my_messages"]		= "הודאות שלי";
...
$pgv_lang["upcoming_events_descr"]	="אזור ארועים קרובים מראה רשימה של אירועים שיתרחשו בקרוב. תוכל לקבוע את כמות הנתונים שתראה, והמנהלן יכול לקבוע את תחום הזמן הקובע לאזור.";
$pgv_lang["todays_events_block"]	="ביום הזה";
$pgv_lang["todays_events_descr"]	="אזור ביום הזה - בהיסטוריה שלך ... מראה רשימה של ארועים שהתרחשו היום. אם אין אירועים, תוכל לקבוע את כמות הנתונים שתראה.";
...
$pgv_lang["block_top10_descr"]    	= "האזור מציג טבלה של 10 שמות המשפחה השכיחים במאגר הנתונים. ניתן לשנות את המספר של שמות המשפחה. ניתן לקבוע הגדרות בתצורת ה-GEDCOM כך ששמות מסויימים לא יופיעו ברשימה.";
...
$pgv_lang["gedcom_news_limit"]	= "הגבל את הצוגה לפי:";
...
//$pgv_lang["optional_tools"] 		= "ניתן להריץ את הכלים האופציונליים הבאים לפני הייבוא.";
...
$pgv_lang["ahnentafel_christened_m"] 	= "הותבל";		// male
$pgv_lang["ahnentafel_christened_f"] 	= "הותבלה";	// female
...
$pgv_lang["gd_library"]		= "בעית קונפיגורציה של שרת ה-PHP: תיקית GD 2.x דרושה כדי להשתמש בפונקציות התמונה.";
$pgv_lang["gd_freetype"]		= "בעית קונפיגורציה של שרת ה-PHP: תיקית Freetype דרושה כדי להשתמש בפונטי TrueType.";
...
$pgv_lang["stpl"]			= "...";
$pgv_lang["stplGDno"]		= "תיקית Graphics Display אינה קיימת ב-PHP 4. פנה למינהלן המערכת";
...
$pgv_lang["hs_results"] 		= "נימצאו תוצאות:";

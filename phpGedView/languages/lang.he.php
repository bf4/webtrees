...
$pgv_lang["mail01_line02"]		= "קיבלנו בקשה ב- #SERVER_NAME#  ליצור קוד משתמש של PhpGedView עם הכתובת האלקטרונית שלך  #user_email# .";
...
$pgv_lang["mail02_line02"]		= "משתמש פוטנציאלי נרשם ב-PhpGedView של #SERVER_NAME#";
...
$pgv_lang["pls_note06"]		= "נשלח לך דואר של אישור לכתובת האלקטרונית <b>#user_email#</b>. עליך לאשר את בקשת קוד המשתמש שלך לפי ההוראות המופיעות בדואר של האישור. אם לא תאשר את בקשת קוד המשתמש תוך שבעה ימים,  הבקשה לקוד משתמש תדחה באופן אוטומטי ואז יהיה עליך להירשם שנית.<br /><br />אחרי שתנהג לפי ההוראות המופיעות בדואר של האישור, על המנהלן עדיין לאשר את המשתמש שלך לפני שיהיה ניתן להשתמש בקוד המשתמש שלך.<br /><br />כדי להתחבר לאתר זה, עליך לדעת קוד משתמש וסיסמא.<br /><br />";
$pgv_lang["pls_note06a"]		= "נשלח לך דואר של אישור לכתובת האלקטרונית <b>#user_email#</b>. עליך לאשר את בקשת קוד המשתמש שלך לפי ההוראות המופיעות בדואר של האישור. אם לא תאשר את בקשת קוד המשתמש תוך שבעה ימים,  הבקשה לקוד משתמש תדחה באופן אוטומטי ואז יהיה עליך להירשם שנית.<br /><br />אחרי שתנהג לפי ההוראות המופיעות בדואר של האישור תוכל להתחבר לאתר. כדי להתחבר לאתר זה, יש לדעת קוד משתמש וסיסמא.<br /><br />";
...
$pgv_lang["pls_note08"]		= "הנתונים על המשתמש <b>#user_name#</b> נבדקו.";
$pgv_lang["mail03_line01"]		= "שלום המנהלן ...";
$pgv_lang["mail03_line02"]		= "המשתמש #newuser[username]# (#newuser[fullname]#) אישר את נתוני הרישום שלו.";
...
$pgv_lang["pwreqinfo"]		= "שלום...<br /><br />דואר הכולל סיסמא חדשה נישלח לכתובת אלקטרונית <b>#user[email]#</b>.<br /><br />בדוק את תיבת הדואר שלך מכיוון שהדואר יתקבל תוך מספר דקות.<br /><br />המלצה:<br />אחרי שתקבל את הדואר התחבר לאתר זה עם סיסמתך החדשה ושנה את הסיסמא כדי לשמור על אבטחת הנתונים.";

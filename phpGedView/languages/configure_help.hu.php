...
$pgv_lang["enter_db_pass"]		= "Biztonsági okokból meg kell adnia a Az adatbázis felhasználóneve és a Az adatbázis jelszava mielőtt változtatna a konfigurációs adatokban.";
...
$pgv_lang["DBTYPE_help"]                = "~Az adatbázis típusa~<br /><br />Az Ön adatbázisa, mely támogatja a PEAR-t.<br /><br />A PhpGedView támogatja a MySQL, PostgreSQL és a SQLite adatbázisokat.<br /><br />";
$pgv_lang["DBHOST"] 			= "Adatbázis szerver";
$pgv_lang["DBHOST_help"] 		= "~Adatbázis szerver~<br /><br />Az Ön adatbázisát működtető számítógép DNS-e vagy IP-címe. Ez a beállítás nem lesz használva ha SQLite adatbázist használ.<br /><br />";
$pgv_lang["DBUSER"] 			= "Az adatbázis felhasználóneve";
$pgv_lang["DBUSER_help"] 		= "~Az adatbázis felhasználóneve~<br /><br />Az adatbázis felhasználóneve, mely az adatbázisba való bejelentkezéshez szükséges. Ez a beállítás nem lesz használva ha SQLite adatbázist használ.<br /><br />";
$pgv_lang["DBPASS"] 			= "Az adatbázis jelszava";
$pgv_lang["DBPASS_help"] 		= "~Az adatbázis jelszava~<br /><br />Az adatbázis jelszava, mely Az adatbázis felhasználóneve mezőben megadott felhasználóhoz tartozik. Ez a beállítás nem lesz használva ha SQLite adatbázist használ.<br /><br />";
$pgv_lang["DBNAME"] 			= "Az adatbázis neve";
$pgv_lang["DBNAME_help"] 		= "~Az adatbázis neve~<br /><br />Az Ön által a PhpGedView-hoz használni kívánt adatbázis a szerveren.<br /><br />A Az adatbázis felhasználóneve mezőben megadott felhasználónak a következő jogosultságokkal kell rendelkeznie: létrehoz, beszúr, frissít, töröl és kijelöl. Az SQLite-nak egy állomány nevet kell megadni egy olyan mappába ahol a PHP-nek írási joga van mint az index mappa (index/phpgedview.db).<br /><br />";
$pgv_lang["TBLPREFIX_help"] 		= "~Adatbázis tábla előtag~<br /><br />Az előtag, melyet a PhpGedView az adattáblák nevéhez fűz. A mező tartalmának megváltoztatásával Ön több PhpGedView-oldalt üzemeltethet azonos adatbázissal, de eltérő adattáblákkal.<br /><br />";
$pgv_lang["ALLOW_CHANGE_GEDCOM_help"] 	= "~GEDCOM váltás engedélyezése~<br /><br />Ezen változó beállításával engedélyezheti, hogy a látogatók választhassanak  a GEDCOM-állományok között, amennyiben Ön beállította a többszörös GEDCOM-adattáblák környezetét.<br /><br />Ha Ön a <b>Nem</b>-et választja, sem a látogatók sem a bejelentkezett felhasználók nem válthatnak a rendelkezésre álló GEDCOM-állományok között.<br /><br />";
$pgv_lang["upload_path"]		= "Feltöltési útvonal";
$pgv_lang["upload_path_help"]		= "~Feltöltési útvonal~<br /><br />Ez az útvonal ahol a feltöltendő GEDCOM állomány található.";
$pgv_lang["gedcom_path"]		= "GEDCOM útvonala és neve a szerveren";
$pgv_lang["gedcom_path_help"] 		= "~GEDCOM útvonala és neve a szerveren~<br /><br />Két lehetőség van hogy egy GEDCOM állományt importáljon a PhpGedView-ba. Ezek a:<ol><li>FTP használata</li><li>PhpGedView -n való feltöltés</li></ol>Amikor már az állomány a szerveren van, használja a <i>Új GEDCOM-állomány hozzáadása</i> Adja meg az állomány nevét és eléréséi útját a szerveren. Ha az elérési utját nem adja meg akkor a <i>Index fájl könyvtár</i> utvonal lesz használva ami a PhpGedView konfigurációban van beállitva.<br /><br />Amikor a <i>GEDCOM-állomány feltöltése</i> funkciót használja akkor keresse meg a kívánt állományt a számítógépén. Ez lehet egy általános GEDCOM állomány vagy egy ZIP állomány amiben a GEDCOM állomány található. A PhpGedView automatikusan kiszedi a ZIP állományból a GEDCOM állományt.<br /><br />Amikor egy állományt feltölt, a nevét és a spórolási helyét megváltoztathatja a szerveren.<br /><br />Bővebb információt a <a href=\"readme.txt\">Readme.txt</a> állományban találhat.<br />";
$pgv_lang["CHARACTER_SET"] 		= "Karakterkészlet-kódolás";
$pgv_lang["CHARACTER_SET_help"] 	= "~Karakterkészlet-kódolás~<br /><br />Az Ön GEDCOM-állományának karakterkészlete. Az alapértelmezett kódolás az UTF-8, mely az oldalak döntő többsége képes kezelni. Amennyiben Ön ibm windows kódolással exportálta GEDCOM-állományát, írjon ide WINDOWS-t.<br /><br />FONTOS: A PHP nem támogatja az UNICODE (UTF-16) kódolást, tehát kérjük, ne állítsa azt be.<br />";
$pgv_lang["LANGUAGE"] 			= "Nyelv";
$pgv_lang["LANGUAGE_help"] 		= "~Nyelv~<br /><br />Kijelöli az oldal alapértelmezett nyelvét.<br /><br />A felhasználók természetesen megváltoztathatják ezt a böngészőjük beállításain keresztül, vagy a lap alján található vezérlőpanel segítségével (ha az <b>A látogatók nyelvet válthatnak</b> értéke <b>true</b>).<br />";
$pgv_lang["ENABLE_MULTI_LANGUAGE"] 	= "A látogatók nyelvet válthatnak";
$pgv_lang["ENABLE_MULTI_LANGUAGE_help"] = "~A látogatók nyelvet válthatnak~<br /><br />Állítsa <b>igen</b>-re, hogy a felhasználók kiválaszthassák a használni kívánt nyelvet a lap alján lévő lenyíló-ablakból és a böngészőjükben beállított alapértelmezett nyelvet használhassák.<br />";
$pgv_lang["CALENDAR_FORMAT"] 		= "Dátumformátum";
$pgv_lang["CALENDAR_FORMAT_help"] 	= "~Dátumformátum~<br /><br />Lehetővé teszi, hogy Ön beállítsa azt a naptárformátumot, melyet ehhez a GEDCOM-állományhoz szeretne használni.<br /><br />A héber naptár megegyezik a zsidó naptárral, csak héber karaktereket használ.<br /><br />Megjegyzés: A zsidó/héber naptárban használt értékek a gregorián/juliánusz dátumokból számítjuk. Mivel a zsidó naptári nap alkonyatkor kezdődik, ezért minden olyan esemény, mely alkonyattól éjfélig zajlik, egy nappal korábban kerül feltüntetésre. A héber karakterek megjelenítése egyes régebbi böngészőkön problémás lehet, melyek fordítva vagy sehogy sem jelenítik meg azokat.<br />";
$pgv_lang["DISPLAY_JEWISH_THOUSANDS"] 		= "Megjeleníti a héber ezreseket";
$pgv_lang["DISPLAY_JEWISH_THOUSANDS_help"] 	= "~Megjeleníti a héber ezreseket~<br /><br />Mutatja az Alafim-ot a héber naptárban.<br /><br />Ha ezt igen-re állítjuk, akkor az 1969-es év így jelenik meg: <span lang=\"he-IL\" dir='rtl'>&#1492;'&#160;&#1514;&#1513;&#1499;&quot;&#1496;</span>&lrm; , nem-re állítva pedig így jelennek meg az évek <span lang=\"he-IL\" dir='rtl'>&#1514;&#1513;&#1499;&quot;&#1496;</span>&lrm;. Ez nincs befolyással a zsidó évek beállítására. Az év 5729-ként jelenik meg, függetlenül ettől a beállítástól.<br /><br />Figyelem: Ez a beállítás hasonló a PHP 5.0 Calendar constant CAL_JEWISH_ADD_ALAFIM.<br />";
$pgv_lang["DISPLAY_JEWISH_GERESHAYIM"]		= "A héber gershayim megjelenítése";
$pgv_lang["DISPLAY_JEWISH_GERESHAYIM_help"]	= "~A héber gershayim megjelenítése~<br /><br />Az aposztróf és az idézőjelek használata a héber dátumok megjelenítésénél.<br /><br />Ha ezt igen-re állítjuk, akkor az 1969 február 8. így jelenik meg <span lang='he-IL' dir='rtl'>&#1499;'&#160;&#1513;&#1489;&#1496;&#160;&#1514;&#1513;&#1499;&quot;&#1496;</span>&lrm; , míg ezt nem-re állítva így jelenik meg <span lang='he-IL' dir='rtl'>&#1499;&#160;&#1513;&#1489;&#1496;&#160;&#1514;&#1513;&#1499;&#1496;</span>&lrm;. Ez a beállítás nincs hatással a zsidó évek megjelenítésére, mivel a zsidó dátumokban megjelenő idézőjelek nem jelennek meg a Latin karakterek használatával.<br /><br />Megjegyzés: Ez a beállítás hasonló a PHP 5.0 CAL_JEWISH_ADD_ALAFIM_GERESH és CAL_JEWISH_ADD_GERESHAYIM naptár konstansához. Ez a beállítás mindkét változóra hatással van.<br />";
$pgv_lang["JEWISH_ASHKENAZ_PRONUNCIATION"] 	= "Zsidó Ashkenazi kiejtés";
$pgv_lang["JEWISH_ASHKENAZ_PRONUNCIATION_help"] = "~Zsidó Ashkenazi kiejtés~<br /><br />Használja a zsidó Ashkenazi kiejtéseket.<br /><br />Ha ezt igen-re állítjuk, a Cheshvan és Teves hónapok az Ashkenazi kiejtéssel jelennek meg. Ha ezt nem-re állítjuk, nem változik ezeknek a hónapoknak a megjelenése. Ez csak a zsidó beállításokra van hatással. A héber beállítást használva, a héber ábécét használjuk.<br /><br />";
$pgv_lang["DEFAULT_PEDIGREE_GENERATIONS"] 	= "Az ősfa generációinak száma";
$pgv_lang["DEFAULT_PEDIGREE_GENERATIONS_help"] 	= "~Az ősfa generációinak száma~<br /><br />Megadja a generációk alapértelmezett számát, melyek az ősfán megjelenítésre kerülnek.<br />";
$pgv_lang["MAX_PEDIGREE_GENERATIONS"] 		= "Az ősfa generációinak maximális száma";
$pgv_lang["MAX_PEDIGREE_GENERATIONS_help"] 	= "~Az ősfa generációinak maximális száma~<br /><br />";
$pgv_lang["MAX_DESCENDANCY_GENERATIONS"] 	= "Leszármazott generációk maximális száma";
$pgv_lang["MAX_DESCENDANCY_GENERATIONS_help"] 	= "~Leszármazott generációk maximális száma~<br /><br />Megszabja a leszármazottak grafikonján feltüntethető generációk maximális számát.<br />";
$pgv_lang["USE_RIN"] 				= "RIN# azonosító használata a GEDCOM ID helyett";
$pgv_lang["USE_RIN_help"] 			= "~RIN# azonosító használata a GEDCOM ID helyett~<br /><br />Állítsa <b>Igen</b>-re, ha a RIN-azonosítót kívánja használni a GEDCOM-azonosító helyett, mikor egyéni azonosítót kell megadnia a beállításokhoz, keresésekhez vagy diagrammokhoz. Hasznos beállítás olyan genealógiai programok esetében, melyek nem exportálják a GEDCOM-állományokat külön személyi azonosítóval, hanem állandó RIN-azonosítót használnak.<br />";
$pgv_lang["PEDIGREE_ROOT_ID"] 			= "Az ősfa és a leszármazottak grafikonja esetében alapértelmezett személy";
$pgv_lang["PEDIGREE_ROOT_ID_help"] 		= "~Az ősfa és a leszármazottak grafikonja esetében alapértelmezett személy~<br /><br />Megszabja az ősfa illetve a leszármazottak fája esetében alapértelmezett személy azonosítóját.<br />";
$pgv_lang["GEDCOM_ID_PREFIX"]			= "Személy azonosító előtag";
$pgv_lang["GEDCOM_ID_PREFIX_help"]		= "~Személy azonosító előtag~<br /><br />Amikor egy új személy kerül felvételre a PhpGedView -ba, akkor egy új azonosító generálódik hozzá. A személy azonosító előtagja ez lesz.<br />";
...
$pgv_lang["PEDIGREE_FULL_DETAILS_help"]	 	= "~A születési és halálozási adatok mutatása az ősfán és a leszármazottak fáján~<br /><br />Megszabja, hogy a születési és halálozási adatok alapértelmezetten feltüntetésre kerülejenek-e.<br />";
$pgv_lang["PEDIGREE_LAYOUT"]			= "Az ősfa alapértelmezett nézete:";
$pgv_lang["PEDIGREE_LAYOUT_help"]		= "~Az ősfa alapértelmezett nézete:~<br /><br />Ebben a mezőben adható meg, hogy az ősfa álló vagy fekvő nézetben jöjjön létre.<br />";
$pgv_lang["SHOW_EMPTY_BOXES"] 			= "Üres szövegdobozok feltüntetése az ősfán";
$pgv_lang["SHOW_EMPTY_BOXES_help"]		= "~Üres szövegdobozok feltüntetése az ősfán~<br /><br />Megszabja, hogy üres cellák feltüntetésre kerüljenek-e az ősfán.<br />";
$pgv_lang["ZOOM_BOXES"]				= "Ráközelítés a cellákra";
$pgv_lang["ZOOM_BOXES_help"]			= "~Ráközelítés a cellákra~<br /><br />Lehetővé teszi, hogy a felhasználók ráközelíthessenek a cellákra, hogy így több információt kaphassanak az adott személyről.<br /><br />Állítsa be a <b>Tiltva</b> opciót, ha nem kívánja ezt engedélyezni. Válassza az <b>Az egér áthúzására</b> opciót, ha az egér áthaladására, illetve a <b>Egérkattintásra</b> opciót ha az egér kattintására kívánja aktiválni ezt a funkciót.<br />";
$pgv_lang["LINK_ICONS"]				= "Felugró hivatkozások a diagrammokon";
$pgv_lang["LINK_ICONS_help"]			= "~Felugró hivatkozások a diagrammokon~<br /><br />Lehetővé teszi, hogy a felhasználók közvetlenül kiválaszthassanak más diagrammokat, vagy a személy közeli rokonait.<br /><br />Állítsa be a <b>Tiltva</b> opciót, ha nem kívánja ezt engedélyezni. Válassza az <b>Az egér áthúzására</b> opciót, ha az egér áthaladására, illetve a <b>Egérkattintásra</b> opciót ha az egér kattintására kívánja aktiválni ezt a funkciót.<br />";
$pgv_lang["ABBREVIATE_CHART_LABELS"]		= "Feliratok rövidítése";
$pgv_lang["ABBREVIATE_CHART_LABELS_help"] 	= "~Feliratok rövidítése~<br /><br />Itt adható meg, hogy a program rövidítse-e a grafikonokon az olyan feliratokat, mint pl. <b>Született</b>, csak az kezdőbetűt tüntetve fel.<br />";
...
$pgv_lang["HIDE_LIVE_PEOPLE_help"] 		= "~Diszkrét adatkezelés engedélyezése~<br /><br />Ez az opció engedélyezi a diszkrét adatkezelésre vonatkozó beállításokat és elrejti az életben lévő személyek adatait.<br /><br />Élő személynek tekintjük azt, akivel kapcsolatban nincs rögzített esemény \$MAX_ALIVE_AGE évnél korábban, illetve akinek nem született gyermeke \$MAX_ALIVE_AGE évnél régebben.<br />";
$pgv_lang["REQUIRE_AUTHENTICATION"]		= "Felhasználói azonosítás megkövetelése";
$pgv_lang["REQUIRE_AUTHENTICATION_help"] 	= "~Felhasználói azonosítás megkövetelése~<br /><br />Ennek az opciónak az engedélyezésével, a látogatók csak azután tekinthetnek meg bármilyen adatot az oldalon, miután bejelentkeztek.<br />";
$pgv_lang["WELCOME_TEXT_AUTH_MODE"]     	= "A bejelentkező oldal üdvözlő szövege \"Hitelesített módban\"";
$pgv_lang["WELCOME_TEXT_AUTH_MODE_help"]        = "~A bejelentkező oldal üdvözlő szövege \"Hitelesített módban\"~<br /><br />Itt választhatja ki azt a szöveget, mely a bejelentkező oldalon jelenik meg akkor, ha a <b>Hitelesített mód</b> aktiválva van. Kérjük, próbálja ki, melyik előre definiált szövegváltozat a leginkább megfelelő Önnek. Természetesen megadhat egyéni üdvözlő szöveget is, de ez nem lesz lefordítva más nyelvekre.<br /><br />Az előre definiált változatok a következők:<ul><li><b>Szövegváltozat, mely szerint minden felhasználó igényelhet hozzáférést:</b><div class=\"list_value_wrap\"><center><b>Üdvözöljük ezen a Családfakutató-Honlapon!</b></center><br />A honlapot minden olyan felhasználó látogathatja, akinek van hozzáférési jogosultsága.<br /><br />Amennyiben Önnek már rendelkezik felhasználói jogosultsággal, bejelentkezhet az oldalra. Ha még nem, a megfelelő hivatkozásra kattintva kezdeményezheti annak megszerzését.<br /><br />Miután megerősítette jelentkezését, a honlap adminisztrátora fogadja el, vagy utasítja el az Ön igényét.A pozitív döntésről email-ben kap értesítést.</div><br /></li><li><b>Szövegváltozat, mely szerint az adminisztrátor dönti el, hogy elfogadja-e a hozzáféréshez benyújtott igényeket:</b><div class=\"list_value_wrap\"><center><b>Üdvözöljük ezen a Családfakutató-Honlapon</b><center><br />A honlaphoz kizárólag a <u>bejelentkezett</u> felhasználók férhetnek hozzá.<br /><br />Amennyiben Önnek már rendelkezik felhasználói jogosultsággal, bejelentkezhet az oldalra. Ha még nem, a megfelelő hivatkozásra kattintva kezdeményezheti annak megszerzését.<br /><br />Miután megerősítette jelentkezését, a honlap adminisztrátora fogadja el, vagy utasítja el az Ön igényét. A pozitív döntésről email-ben kap értesítést.</div><br /></li><li><b>Szövegváltozat, mely szerint kizárólag családtagok igényelhetnek hozzáférést:</b><div class=\"list_value_wrap\"><center><b>Üdvözöljük ezen a Családfakutató-Honlapon</b></center><br />A honlaphoz <u>kizárólag családtagok</u> férhetnek hozzá.<br /><br />Amennyiben Önnek már rendelkezik felhasználói jogosultsággal, bejelentkezhet az oldlara. Ha még nem, a megfelelő hivatkozásra kattintva kezdeményezheti annak megszerzését.<br /><br />Miután megerősítette jelentkezését, a honlap adminisztrátora fogadja el, vagy utasítja el az Ön igényét. A pozitív döntésről email-ben kap értesítést.</div></li></ul>";
...
$pgv_lang["WELCOME_TEXT_AUTH_MODE_CUST_help"]   = "~Egyéni üdvözlő szöveg~<br /><br />Ha Ön az egyéni üdvözlő szöveg lehetőségét választotta, itt adhatja meg a szöveget. A szöveg azonban NEM kerül lefordításara a  látogatók nyelvére, éppen úgy fejelnik meg, ahogy Ön begépelte.<br /><br />Ha szüksége, HTML-kódot is illeszthet a szövegbe.<br />";
$pgv_lang["WELCOME_TEXT_AUTH_MODE_CUST_HEAD"] 	= "Egyéni üdvözlő szöveg alapértelmezett fejléce";
$pgv_lang["WELCOME_TEXT_AUTH_MODE_CUST_HEAD_help"] = "~Egyéni üdvözlő szöveg alapértelmezett fejléce~<br /><br />Válassa az általános fejlécmegjelenítésére az üdvözlő szöveghez. Amikor a felhasználók nyelvet változtatnak akkor a fejléc az új nyelven jelenik meg.<br /><br />Ha Ön az igen-t jejöli meg, a fejléc így fog megjelenni:<div class=\"list_value_wrap\"><center><b>Üdvözöljük ezen a Családfakutató-Honlapon</b></center><br />A honlapot érvényes felhasználói névvel és jelszóval rendelkező felhasználók látogathatják.<br /></div>";
$pgv_lang["CHECK_CHILD_DATES"] 			= "Gyermekekkel kapcsolatos dátumok ellenőrzése";
$pgv_lang["CHECK_CHILD_DATES_help"] 		= "~Gyermekekkel kapcsolatos dátumok ellenőrzése~<br /><br />Leellenőrzi egy gyermek dátumait, amikor meghatározzuk hogy egy személy elhunyt-e. Régebbi rendszereken és nagyobb GEDCOMoknál ez lelassíthatja az oldal működését.<br />";
$pgv_lang["MAX_ALIVE_AGE"] 			= "Az életkor, mely után az adott személy feltehetően már nem él";
$pgv_lang["MAX_ALIVE_AGE_help"] 		= "~Az életkor, mely után az adott személy feltehetően már nem él~<br /><br />Az évek maximális száma, amit egy személyhez kapcsolódó esemény, vagy gyermekeinek életkora alapján használunk ahhoz hogy meghatározzuk hogy életben van-e.<br />";
$pgv_lang["SHOW_GEDCOM_RECORD"] 		= "A felhasználók láthatják a nyers GEDCOM-rekordot";
$pgv_lang["SHOW_GEDCOM_RECORD_help"] 		= "~A felhasználók láthatják a nyers GEDCOM-rekordot~<br /><br />Ha Ön ezt az opciót <b>Igen</b>-re állítja, akkor a személyek, források és családok mellett megjelenik egy hivatkozás, mellyel a felhasználók egy felugró ablakban megjeleníthetik a nyers GEDCOM-rekordot.<br />";
$pgv_lang["ALLOW_EDIT_GEDCOM"] 			= "Online szerkesztés engedélyezése";
$pgv_lang["ALLOW_EDIT_GEDCOM_help"] 		= "~Online szerkesztés engedélyezése~<br /><br />Az aktuális GEDCOM-állományban engedélyezi az online szerkesztés lehetőségét, tehát a szerkesztési jogosultsággal rendelkező felhasználók módosíthatják a GEDCOM-ot.<br />";
$pgv_lang["INDEX_DIRECTORY_help"] 		= "~Index fájl könyvtár~<br /><br />Annak az olvasható és írható könyvtárnak az útvonala, ahol a PhpGedView tárolja az indexfájlokat (a végén a \"/\" jellel).<br /><br />";
$pgv_lang["POSTAL_CODE"]  			= "Postai irányítószám pozíciója";
$pgv_lang["POSTAL_CODE_help"] =		 "~Postai irányítószám pozíciója~<br /><br />Különbözö országok kölönbözöen írják a címeket. Itt be tudja állítani hogy az irántítószám a városnév elött vagy utána legyen.<br />";
$pgv_lang["SHOW_ID_NUMBERS_help"] 		= "~Mutassuk az azonosítószámot a nevek mellett~<br /><br />Mutatja az ID számokat zárójelben a név mögött a táblázatokban.<br />";
$pgv_lang["SHOW_PEDIGREE_PLACES"] 		= "Megmutatja a helységeket a személynél";
$pgv_lang["SHOW_PEDIGREE_PLACES_help"] 		= "~Megmutatja a helységeket a személynél~<br /><br />Mutatja a helységeket a születés és az elhalálozás mellett a családi a és leszármazási táblázatokban.<br />";
$pgv_lang["MULTI_MEDIA"] 			= "Multimédiás megoldások engedélyezése";
$pgv_lang["MULTI_MEDIA_help"] 			= "~Multimédiás megoldások engedélyezése~<br /><br />A GEDCOM 5.5.1 formátum lehetővé teszi képek, filmek és egyéb multimédiás elemek  behivatkozását a GEDCOM-ba. Ha Ön nem illeszt multimédia elemeket a GEDCOM-állományába, lehetősége van a szolgáltatás kiiktatására, ha <b>Nem</b>-re állítja ezt a mezőt. <br /><br />További információt kaphat a multimédia elemek beillesztéséről a <a href=\"readme.txt\">readme.txt</a> Multimédia fejezetéből.<br />";
$pgv_lang["MEDIA_EXTERNAL"]			= "Hivatkozások megtartása";
$pgv_lang["MEDIA_EXTERNAL_help"]        	= "~Hivatkozások megtartása~<br /><br />Ha egy multimédiás hivatkozás kezdete pl. http://, ftp://, mms://, akkor azt nem változtatjuk meg, ha ezt az opciót <b>igen</b>-re állítja. Például a http://www.myfamily.com/photo/dad.jpg továbbra is  http://www.myfamily.com/photo/dad.jpg marad. Ha viszont <b>nem</b>-re állítja, általános hivatkozásként kezeljük és a médiakönyvtárhoz képest adjuk meg az elérését. Például a http://www.myfamily.com/photo/dad.jpg hivatkozást így alakítjuk át: ./media/dad.jpg.<br />";
...
$pgv_lang["MEDIA_DIRECTORY_LEVELS_help"] 	= "~Multimédia könyvtárak szintjeinek kezelése~<br /><br />Ha ez az érték 0-ra van állítva, akkor nem veszünk figyelembe egy könyvtárat sem az állomány útvonalában a médiaobjektumhoz. Ha az érték 1, akkor az első könyvtárat használjuk ahol ez a kép van. Ha növeljük ezt a számot, akkor több szülőkönyvtár kerül a keresési útvonalba.  <br />Például: ha egy kép a GEDCOM-ban ezzel a könyvtárral szerepel C:/Documents and Settings/User/My Documents/My Pictures/Genealogy/Surname Line/grandpa.jpg, akkor a 0 értéket megadva ez a könyvtár átalakul erre: ./media/grandpa.jpg.  Az 1-es értékre ez lesz az útvonal ./media/Surname Line/grandpa.jpg, stb. A legtöbb esetben a 0 a megfelelő érték, de lehetséges az hogy több médiaelemnek is ugyan az a neve, és ekkor lehet ezzel a változóval jobban rendszerezni a médiaelemeket, és elkerülni a névütközéseket.<br />";
$pgv_lang["SHOW_HIGHLIGHT_IMAGES_help"] 	= "~Mutassunk képrészletet a személyek dobozában~<br /><br />Ha engedélyezve van a multimédia az oldalon, akkor a PhpGedView megmutathat kisképeket egy személy neve mellett a táblázatokban és a szövegdobozokban.<br /><br />A PhpGedView jelenleg az első multimédia objektumot használja erre a célra. Ahol több kép van megadva, ott azt a képet kell az első helyre rendezni, amelyiket erre a célra szeretnénk használni.<br /><br />Lásd a multimédia részt a <a href=\"readme.txt\">readme.txt</a> fájlban, a multimédia elemek beillesztéséről.<br />";
$pgv_lang["USE_THUMBS_MAIN"]    		= "Kisképek használat a személyes oldalakon";
$pgv_lang["USE_THUMBS_MAIN_help"]       	= "~Kisképek használat a személyes oldalakon~<br /><br />Attól függően, hogy Ön hogyan tárolja a képeit, bizonyos esetekben jobb, ha a személyes oldalakon a kisképek jelennek meg a személyek neve mellett.<br /><br />Ha az eredeti képek túl nagyok, letöltésük hosszú időt vehet igénybe, így a kisképek jól helyettesíthetik őket (ha minőségük megfelelő). Állítsa ezt az elemet <b>igen</b>-re, ha a kisképeket akarja használni, illetve hagyja meg <b>nem</b> beállítást, ha az eredeti felbontású képeket választja.<br />";
$pgv_lang["ENABLE_CLIPPINGS_CART"] 		= "A családfa ágak kosarának engedélyezése";
$pgv_lang["ENABLE_CLIPPINGS_CART_help"] 	= "~A családfa ágak kosarának engedélyezése~<br /><br />A családfa ágak kosara lehetővé teszi, hogy külön személyeket válasszunk ki, akiknek az adatai ezután egy fájlban letölthetőek, és más családfa programba beimportálhatóak.<br />";
$pgv_lang["HIDE_GEDCOM_ERRORS"] 		= "GEDCOM-hibák elrejtése";
$pgv_lang["HIDE_GEDCOM_ERRORS_help"] 		= "~GEDCOM-hibák elrejtése~<br /><br />Ha ezt beállítjuk <b>igen</b>-re, akkor nem jelennek meg a GEDCOM állomány feldolgozása közben előforduló hibák. A PhpGedView törekszik a GEDCOM 5.5.1-es szabványt betartására, de sok egyéb családfa program tárolhat saját bejegyzéseket az állományban. Lásd a <a href=\"readme.txt\">readme.txt</a> állományt további információért.<br />";
$pgv_lang["WORD_WRAPPED_NOTES"] 		= "Szóközök beillesztése a sortöréseknél";
$pgv_lang["WORD_WRAPPED_NOTES_help"] 		= "~Szóközök beillesztése a sortöréseknél~<br /><br />Néhány családfa-program a megjegyzések sorait több sorba töri a szavak végén, néhány pedig máshol. Ebből kifolyólag a PhpGedView összekapcsolhat szavakat. A mezőt <b>igen</b>-re állítva, a hosszú sorok töréséhez szóközök kerülnek a GEDCOMban.<br />";
$pgv_lang["SHOW_CONTEXT_HELP"]			= "A Környezetérzékeny segítség mutatása alapértelmezettként";
$pgv_lang["SHOW_CONTEXT_HELP_help"]		= "~A Környezetérzékeny segítség mutatása alapértelmezettként~<br /><br />Ezzel a beállítással, azokon az oldalakon ahol van környezetérzékeny segítség, ott kérdőjelekkel jelezzük ezt.<br />";
$pgv_lang["COMMON_NAMES_THRESHOLD"]     	= "Küszöbérték a Gyakori vezetéknévhez";
$pgv_lang["COMMON_NAMES_THRESHOLD_help"] 	= "~Küszöbérték a Gyakori vezetéknévhez~<br /><br />A vezetéknév előfordulásainak száma ahhoz, hogy Gyakori vezetéknevek között jelenjen meg a Nyitóoldalon.<br />";
$pgv_lang["COMMON_NAMES_ADD"]   		= "Nevek hozzáadása a Gyakori vezetéknevekhez (vesszővel elválasztva)";
$pgv_lang["COMMON_NAMES_ADD_help"]      	= "~Nevek hozzáadása a Gyakori vezetéknevekhez (vesszővel elválasztva)~<br /><br />Ha egy vezetéknév előfordulása nem éri el a küszöbértéket, nem fog megjelenni a listában. Ugyanakkor hozzáadhatja őket manuálisan. Ha több nevet kíván felvenni a listára, vesszővel válassza el őket egymástól. <b>A vezetéknevek érzékenyek a kis- és nagybetűk közötti különbségre.</b><br />";
$pgv_lang["COMMON_NAMES_REMOVE"]        	= "Nevek eltávolítása a Gyakori vezetéknevek közül (vesszővel elválasztva)";
$pgv_lang["COMMON_NAMES_REMOVE_help"]   	= "~Nevek eltávolítása a Gyakori vezetéknevek közül (vesszővel elválasztva)~<br /><br />Ha Ön bizonyos vezetékneveket el kíván távolítani a listáról anélkül, hogy csökkentenie kelljen a küszöbértéket, akkor itt kell azokat megadnia. Ha több nevet kíván felvenni a listára, vesszővel válassza el őket egymástól. <b>A vezetéknevek érzékenyek a kis- és nagybetűk közötti különbségre.</b><br />";
$pgv_lang["HOME_SITE_URL"] 			= "A fő weboldal URL-je";
$pgv_lang["HOME_SITE_URL_help"] 		= "~A fő weboldal URL-je~<br /><br />Egy webcím, ami az oldal fejlécében szerepel. Itt általában a fő weboldal címét érdemes megadni.<br />";
$pgv_lang["HOME_SITE_TEXT"] 			= "A fő weboldal szövege";
$pgv_lang["HOME_SITE_TEXT_help"] 		= "~A fő weboldal szövege~<br /><br />Az a szöveg, amire kattintva juthatunk a fő weboldalhoz.<br />";
$pgv_lang["CONTACT_EMAIL"] 			= "E-mail cím genealógiai kérdésekhez";
$pgv_lang["CONTACT_EMAIL_help"] 		= "~E-mail cím genealógiai kérdésekhez~<br /><br />Az az email cím, amire a látogatók írhatnak az oldalon levő családfa adatokkal kapcsolatban.<br />";
$pgv_lang["CONTACT_METHOD"]			= "Kapcsolattartási forma";
$pgv_lang["CONTACT_METHOD_help"]		= "~Kapcsolattartási forma~<br /><br />Az a kapcsolattartási forma, amit a látogatók használhatnak a 'kapcsolattartó személlyel' való kommunikációhoz, családfa adatokkal kapcsolatban. Erre a címre kattintva megnyílik a felhasználó email kliense, és rögtön írhat levelet. Az 'üzenés' opcióval a PhpGedView beépített üzenetküldését használhatjuk, email küldése nélkül. Az 'üzenet email-el' opció az alapértelmezett, és itt az üzenet másolatát email-ban is elküldjük. Az 'email-ek tárolás nélkül' opciónál a PhpGedView kezeli az üzenetküldést, és email-ként küldi az üzeneteket, de nem tárolja el azokat. Ha nem jelöljük be az üzenetek küldésének lehetőségét, akkor a látogatók nem tudnak üzenni nekünk.<br />";
$pgv_lang["WEBMASTER_EMAIL"] 			= "E-mail cím a Webmesterhez";
$pgv_lang["WEBMASTER_EMAIL_help"] 		= "~E-mail cím a Webmesterhez~<br /><br />Az az e-mail cím, amire a látogatók a technikai jellegű kérdésekkel fordulhatnak, esetleg hibákat jelezheznek.<br />";
$pgv_lang["SUPPORT_METHOD"]			= "A támogatás formája";
$pgv_lang["SUPPORT_METHOD_help"]		= "~A támogatás formája~<br /><br />Az a mód, ahogy a látogatók a 'támogató személlyel' felveszik a kapcsolatot a családfával kapcsolatos kérdésekben. Erre a címre kattintva megnyílik a felhasználó e-mail kliense, és rögtön írhat levelet. Az 'PhpGedView belső üzenet' opcióval a PhpGedView beépített üzenetküldését használhatjuk, e-mail küldése nélkül. Az 'Belső üzenet e-maillel megerősítve' opció az alapértelmezett, és itt az üzenet másolatát e-mailban is elküldjük. Az 'E-mailek tárolás nélkül' opciónál a PhpGedView kezeli az üzenetküldést, és e-mailként küldi az üzeneteket, de nem tárolja el azokat. Ha a 'Nincs kapcsolattartás' opciót jelöljük be, akkor a látogatók nem tudnak üzenni nekünk.<br />";
$pgv_lang["FAVICON"] 				= "Kedvencek ikon";
$pgv_lang["FAVICON_help"] 			= "~Kedvencek ikon~<br /><br />Állítsa be azt az ikon-állományt, melyet meg kíván mutatni, amikor az Ön oldalát felveszik a Kedvencek közé.<br />";
$pgv_lang["THEME_DIR"] 				= "Témák könyvtára";
$pgv_lang["THEME_DIR_help"] 			= "~Témák könyvtára~<br /><br />Az a könyvtár, ahol a PhpGedView a megjelenés témáinak fájljait tárolja.<br /><br />A témákkal egyedi kinézetet adhatunk oldalunknak. Lásd a 'saját témák' részt a <a href=\"readme.txt\">readme.txt</a> fájlban több információért.<br />";
$pgv_lang["TIME_LIMIT"] 			= "PHP időkorlát";
$pgv_lang["TIME_LIMIT_help"] 			= "~PHP időkorlát~<br /><br />Az a maximum hossz, amíg a PhpGedView fithat.<br /><br />Az alap érték 1 perc. A GEDCOM fájl méretétől függően, indexek készítéséhez növelheti ezt a számot. Ha 0-ra álítja akkornincs időkorlát.<br /><br />FIGYELEM: 0-ra állítva, vagy túl nagy értékre állítva ezt, a művelet befejezéséig az oldal lefagyhat. Ha 0-át állítunk be, lehetséges hogy soha nem fejeződik be a program futása, amíg a rendszergazda le nem állítja, vagy újra nem indítja a programot a szerveren. Nagy családfákat sok ideig tarthat feldolgozni, így ezt a számot alacsony értéken tartva megakadályozhatjuk hogy valaki leállítsa a webszervert 1000 diagramm készítésével.<br />";
$pgv_lang["PGV_SESSION_SAVE_PATH_help"] 	= "~Munkamenet állományainak elérési útja~<br /><br />Az elérési út, ahol a PhpGedView-munkamenetek állományait kívánja tárolni.<br /><br />Egyes szolgáltatóknál a PHP-beállítások hiányosak, és a munkamenetekre vonatkozó adatokat nem tartják karban az egyes laphívások között. Ez a mező lehetőséget ad az adminisztrátornak, hogy az eredeti beállításokat felülírva lokálisan tárolja a munkamenetekre vonatkozó adatokat (melyhez az ./index/ könyvtár jó választás lehet). Alapértelmezett az üres mező, vagyis a <i>php.ini</i>-ben megadott érték változatlanul hagyása.<br /><br />";
$pgv_lang["SERVER_URL_help"]			= "~A PhpGedView URL-je~<br /><br />Amennyiben Ön https-kapcsolatot, vagy az alapértelmezettől eltérő portot használ, meg kell adnia a szerver URL-jét.<br /><br />";
$pgv_lang["LOGIN_URL"]                  	= "Bejelentkező URL";
$pgv_lang["LOGIN_URL_help"]             	= "~Bejelentkező URL~<br /><br />Csak abban az esetben adjon meg bejelentkező URL-t, ha a bejelentkezés után át kívánja irányítani a felhasználókat egy másik oldalra. Ez a lehetőség igen hasznos például akkor, ha Ön http-ről https-re szeretne váltani a beléptetés után. A <i>login.php</i> teljes elérési útját adja meg it (pl. https://www.yourserver.com/phpgedview/login.php).<br />";
$pgv_lang["PGV_SESSION_TIME_help"] 	= "~Munkamenet lejárata~<br /><br />Az időtartam másodpercben megadva, mely alatt egy PhpGedView-munkamenet aktív, és a felhasználónak nem kell újra bejelentkezni.  Az alapértelmezett érték 2 óra (7200 másodperc).<br /><br />";
$pgv_lang["SHOW_STATS"] 		= "Futtatási statisztika megjelenítése";
$pgv_lang["SHOW_STATS_help"] 		= "~Futtatási statisztika megjelenítése~<br /><br />Minden lap alján feltünteti a futtatási és adatbázis-lekérdezési statisztikát.<br />";
$pgv_lang["SHOW_COUNTER"]		= "Számláló megjelenítése";
$pgv_lang["SHOW_COUNTER_help"]		= "~Számláló megjelenítése~<br /><br />Látogató-számláló feltüntetése a portál- és a személyhez kötődő oldalon.<br />";
$pgv_lang["USE_REGISTRATION_MODULE_help"]	= "~A látogatók kérhetnek regisztrációt~<br /><br />Lehetővé teszi, hogy a látogatók regisztrálják magukat az oldalon.<br /><br />A látogató kapni fog egy e-mailt melyen keresztül megerősíti regisztrációs szándékát. Az aktiváció előtt ezt szándékot az adminisztrátornak is jóvá kell hagyni. <br /><br />";
$pgv_lang["ALLOW_USER_THEMES_help"]	= "~Engedjük a felhasználóknak hogy témát váltsanak~<br /><br />A felhasználók kiválaszthatják a nekik tetsző, egyedi asztal-témát.<br /><br />";
$pgv_lang["PGV_SIMPLE_MAIL_help"] 	= "~Egyszerű levélfejléc a külső e-mailekben~<br /><br />A külső e-mailek fejléceiben egyaránt megtalálható az e-mail cím és a levél küldőjének a neve. Ugyanakkor egyes levelezőrendszerek nem fogadják el ezt a megoldást. Állítsa <b>igen</b>-re, hogy csak az e-mail cím kerüljön elküldésre.<br /><br />";
$pgv_lang["gedcom_title"]			= "GEDCOM-állomány címe";
$pgv_lang["gedcom_title_help"]		= "~GEDCOM-állomány címe~<br /><br />Adjon meg egy, a GEDCOM-állományra jellemző nevet, melyet az egyes állományok közötti választáskor látnak a felhasználók.<br />";
$pgv_lang["LOGFILE_CREATE"]		= "Napló-állományok archiválása";
$pgv_lang["LOGFILE_CREATE_help"]	= "~Napló-állományok archiválása~<br /><br />A napló-állományok archiválási gyakorisága.<br /><br />";
$pgv_lang["PGV_MEMORY_LIMIT_help"]	= "~Memóriahatár~<br /><br />A PhpGedView által maximálisan felhasználható memória mérete, melynek  alapértelmezett értéke 32MB. Sok szolgáltató tiltja ezt a beállítási lehetőséget a PHP-beállításaiban, így a végrehajtott változtatások nem gyakorolnak minden esetben hatást a felhasznált memória méretére.<br /><br />";
$pgv_lang["PGV_STORE_MESSAGES_help"]	= "~Az üzenetek online tárolhatók~<br /><br />Megszabja, hogy a PhpGedView-n keresztül küldött üzenetek tárolásra kerüljenek-e az adatbázisban. Ha az <b>Igen</b>-t választja, a felhasználók láthatják az üzeneteiket, mikor bejelentkeznek a PhpGedView-be, a <b>Nem</b> esetén az üzeneteket csak e-mailben kapják meg.<br /><br />";
$pgv_lang["ALLOW_THEME_DROPDOWN"]       = "Megjelenítit az asztaltémák közötti választást biztosító legördülő menüt.";
$pgv_lang["ALLOW_THEME_DROPDOWN_help"]  = "~Megjelenítit az asztaltémák közötti választást biztosító legördülő menüt.~<br /><br />Biztosítja a felhasználóknak azt a lehetőséget, hogy kiválasszák saját asztaltémájukat egy legördülő menüből (ha ez a lehetőség létezik az adott asztaltémában).<br /><br />Ehhez a lehetőséghez az <b>Engedjük a felhasználóknak hogy témát váltsanak</b> mezőt szintén jóvá kell hagyni.<br /><br />";
$pgv_lang["META_AUTHOR"]                = "\"Szerző\" META tag";
$pgv_lang["META_AUTHOR_help"]   	= "~\"Szerző\" META tag~<br /><br />A HTML oldal fejlécében lévő <b>szerző</b> META tag-nek ad értéket. Kérjük, hagyja üresen ezt a mezőt, ha GEDCOM-állományhoz megadott kapcsolattartó nevét szeretné itt használni.<br /><br />";
...
$pgv_lang["META_PUBLISHER_help"]        = "~\"Kiadó\" META tag~<br /><br />A HTML oldal fejlécében lévő <b>kiadó</b> META tag-nek ad értéket. Kérjük, hagyja üresen ezt a mezőt, ha GEDCOM-állományhoz megadott kapcsolattartó nevét szeretné itt használni.<br /><br />";
...
$pgv_lang["META_COPYRIGHT_help"]        = "~\"Copyright\" META tag~<br /><br />A HTML oldal fejlécében lévő <b>copyright</b> META tag-nek ad értéket. Kérjük, hagyja üresen ezt a mezőt, ha GEDCOM-állományhoz megadott kapcsolattartó nevét szeretné itt használni. <br />";
...
$pgv_lang["META_DESCRIPTION_help"]      = "~\"Leírás\" META tag~<br /><br />A HTML oldal fejlécében lévő <b>leírás</b> META tag-nek ad értéket. Kérjük, hagyja üresen ezt a mezőt, ha az aktuális GEDCOM-állomány címét szeretné itt használni.<br /><br />";
...
$pgv_lang["META_PAGE_TOPIC_help"]       = "~\"Az oldal tárgya\" META tag~<br /><br />A HTML oldal fejlécében lévő \"az oldal tárgya\" META tag-nek ad értéket. Kérjük, hagyja üresen ezt a mezőt, ha az aktuális GEDCOM-állomány címét szeretné itt használni.<br /><br />";
...
$pgv_lang["META_AUDIENCE_help"] 	= "~\"Célközönség\" META tag~<br /><br />A HTML oldal fejlécében lévő <b>célközönség</b> META tag-nek ad értéket.<br /><br />";
$pgv_lang["META_PAGE_TYPE"]             = "\"Az oldal típusa\" META tag";
$pgv_lang["META_PAGE_TYPE_help"]        = "~\"Az oldal típusa\" META tag~<br /><br />A HTML oldal fejlécében lévő <b>az oldal típusa</b> META tag-nek ad értéket.<br /><br />";
$pgv_lang["META_ROBOTS"]                = "\"Robotok\" META tag";
$pgv_lang["META_ROBOTS_help"]   	= "~\"Robotok\" META tag~<br /><br />A HTML oldal fejlécében lévő <b>robotok</b> META tag-nek ad értéket. Számos keresőrobot nem veszi figyelembe ezt az értéket.<br /><br />";
$pgv_lang["META_REVISIT"]               = "\"Keresőrobotok látogatási gyakorisága\" META tag";
$pgv_lang["META_REVISIT_help"]  	= "~\"Keresőrobotok látogatási gyakorisága\" META tag~<br /><br />A HTML oldal fejlécében lévő <b>látogatási gyakoriság</b> META tag-nek ad értéket. Számos keresőrobot nem veszi figyelembe ezt az értéket.<br /><br />";
$pgv_lang["META_KEYWORDS"]              = "\"Kulcsszavak\" META tag";
$pgv_lang["META_KEYWORDS_help"] 	= "~\"Kulcsszavak\" META tag~<br /><br />A HTML oldal fejlécében lévő <b>kulcsszavak</b> META tag-nek ad értéket. Számos keresőmotor fogja használni az oldal indexelésében az itt megadott kulcsszavakat. A GEDCOM-statisztika blokkban található leggyakoribb vezetékneveket a program hozzáfűzi azon kifejezésekhez, melyeket Ön itt megad.<br /><br />";
$pgv_lang["META_TITLE"]         	= "A fejléc \"TITLE\" elemének hozzáadása";
$pgv_lang["META_TITLE_help"]    	= "~A fejléc \"TITLE\" elemének hozzáadása~<br /><br />A HTML oldal fejlécében lévő <b>TITLE</b> elemnek ad értéket úgy, hogy az ide írt szöveget az általános cím és a PhpGedView-ra való utalás közé fűzi.<br /><br />";
$pgv_lang["RSS_FORMAT"]				= "RSS formátum";
$pgv_lang["welcome_new_help"]		= "~Üdvözöljük az Ön új PhpGedView honlapján.~#pgv_lang[welcome_new2]#Ez az ablak segítséget nyújt Önnek a konfigurációs folyamat során. Ahogyan belép az egyes mezőkbe, az ablakban mindig az aktuális elemről kap tájékoztatást. Bármikor becsukhatja ezt az ablakot, újbóli megnyitásához kattintson a cellák melletti bármelyik <b>?</b> jelre.<br />";
...
$pgv_lang["SHOW_LIVING_NAMES_help"]		= "~Élő személyek nevéhez hozzáférhet~<br /><br />Élő személyek nevének megmutatása.<br /><br />Lehetőséget biztosít arra, hogy az élő személyek nevét bárki láthassa.<br /><br />";
$pgv_lang["SHOW_RESEARCH_ASSISTANT"]			= "Kutatási segéd mutatása";
$pgv_lang["SHOW_RESEARCH_ASSISTANT"]			= "Kutatási segéd mutatása";
$pgv_lang["USE_RELATIONSHIP_PRIVACY_help"]	= "~Diszkréció rokonság alapján~<br /><br /><Rokoni kapcsolatok diszkrét kezelése.<br /><br />A <b>Nem</b> azt jelenti, hogy az élő személyek adatait az összes a regisztrált felhasználó láthatja.<br />Az <b>Igen</b> azt jelenti, hogy a felhasználók csak azoknak az élő személyeknek a privát adatait láthatják, akikkel rokonságban állnak.<br /><br />";
$pgv_lang["MAX_RELATION_PATH_LENGTH_help"]	= "~Rokonsági fok maximális nagysága~<br /><br />A rokonsági fok maximális nagysága.<br /><br />A másodfokú unokatestvérek kezelése.<br /><br />";
$pgv_lang["CHECK_MARRIAGE_RELATIONS_help"]	= "~Házastársi kapcsolatok ellenőrzése~<br /><br />Házastársi kapcsolatok ellenőrzése.<br /><br />A rokonság ellenőrzése a házastársi kapcsolatok alapján.<br /><br />";
$pgv_lang["SHOW_DEAD_PEOPLE_help"]		= "~Elhunyt személyekhez hozzáférhet~<br /><br />Elhunyt személyek megmutatása.<br /><br />";
...
$pgv_lang["PRIVACY_BY_YEAR_help"]       	= "~Egy esemény diszkréciós szabályozása életkor alapján.~<br /><br /><b>Az esemény diszkréciós szabályozása életkor alapján</b> lehetőséget ad arra, hogy Ön a személyekt adatait életkoruk alapján rejtse el - függetlenül attól, hogy élnek-e vagy már meghaltak. Hazsnálja ezt a lehetőséget a \"AAz életkor, mely után az adott személy feltehetően már nem él\" beállítással. Például ha az utóbbi opciót 100-ra, az előbbit \"igen\"-re állítja, akkor a kevesebb mint 100 éve született személyek adatai bizalmasak lesznek. Így egyben a kevesebb mint 85 éve házasodott és a kevesebb mint 75 éve elhunyt személyek adatai szintén bizalmasnak fognak számítani. Kérjük tartsa szem előtt, hogy ezen beállítás használata csökkenteni fogja a program teljesítményét.<br /><br />";
...
$pgv_lang["bom_check_help"]             = "~BOM-ellenőrzés a nyelvi állományokban~<br /><br />#pgv_lang[bom_check_desc]#<br />";
...
$pgv_lang["edit_lang_utility_help"]	= "~Nyelvi állományok szerkesztése~<br /><br />#pgv_lang[edit_lang_utility_desc]#<br />";
$pgv_lang["edit_lang_utility_warning"]	= "FIGYELEM!<br /><br />Ha Ön úgy dönt, hogy a \"<b>Az ablak frissítése nélkül bezár</b>\" gombot használja, a tartalmi változásokat addig nem fogja látni, amíg nem frissíti a lapot. Ezenkívül egyes esetekben így a nyelvi állomány is megsérülhet, ha Ön egy olyan üzenetet szerkeszt, amely eddig nem szerepelt az Ön változatában, vagy amelyet közvetlenül ezelőtt szerkesztett.<br /><br />Tehát ha nem biztos a dolgában, kérjük, hogy ne használja a \"<b>Az ablak frissítése nélkül bezár</b>\" gombot.";
...
$pgv_lang["editlang_help"]		= "~Szerkeszt~<br /><br />Üzenet szerkesztése a következő nyelvi állományban:<br />";
$pgv_lang["savelang"]			= "Mentés";
$pgv_lang["savelang_help"]		= "~Mentés~<br /><br />Szerkesztett szöveg mentése.<br />";
...
$pgv_lang["export_lang_utility_help"]	= "~Nyelvi állományok exportálása~<br /><br />#pgv_lang[export_lang_utility_desc]#<br />";
...
$pgv_lang["compare_lang_utility_help"]	= "~Nyelvi állományokat összehasonlítása~<br /><br />#pgv_lang[compare_lang_utility_desc]#<br />";
...
$pgv_lang["lang_shortcut_help"]		= "~Nyelv-specifikus rövidítés~<br /><br />Ez a kód megadja a PhpGedView nyelvi állományaiban használatos nyelv-specifikus rövidítést. Ez rendszerint az első a 'Nyelvi beállítások' kódjai közül (melyek a támogatott nyelvek konfigurálása ablakának következő mezőjében adhatók meg).<br />";
$pgv_lang["lang_langcode"]		= "Nyelvi beállítások kódjai";
$pgv_lang["lang_langcode_help"]		= "~Nyelvi beállítások kódjai~<br /><br />Ezen kódok lehetővé teszik, hogy a PhpGedView a böngésző beállításai alapján felismerje az aktuális nyelvet. A kódokat pontosvesszővel kell egymástól elválasztani.<br />";
...
$pgv_lang["alphabet_upper_help"]	= "~Nagybetűs ábécé~<br /><br />Az adott nyelv nagybetűs ábécéje, mely a nagybetűs nevek sorbarendezését segíti a PhpGedView-listákon.<br />";
$pgv_lang["alphabet_lower"]		= "Kisbetűs ábécé";
$pgv_lang["alphabet_lower_help"]	= "~Kisbetűs ábécé~<br /><br />Az adott nyelv kisbetűs ábécéje, mely a kisbetűs nevek sorbarendezését segíti a PhpGedView-listákon.<br />";
...
$pgv_lang["translation_forum_help"]	= "~Ugrás a PhpGedView fordítói fórumához (a SourceForge.net-en)~<br /><br />#pgv_lang[translation_forum_desc]#<br />";
$pgv_lang["lang_set_file_read_error"]	= "HIBA!!! A <b>language_settings.php</b> nem olvasható!";
$pgv_lang["add_new_language_help"]	= "~Új nyelvi állományok és beállítások hozzáadása~<br /><br />#pgv_lang[add_new_language_desc]#";
...
$pgv_lang["um_bu_help"] 		= "~Biztonsági mentés~<br /><br />#pgv_lang[um_bu_explain]#";
...
$pgv_lang["um_tool_help"] 		= "~Felhasználói adat migrációs eszköz~<br /><br />#pgv_lang[um_explain]#";
...
$pgv_lang["INDI_FACTS_ADD_help"]		= "~Személyhez tények hozzáadása~<br /><br />Ez a GEDCOM tények listája amit a felhasználók hozzáadhatnak a személyekhez. A Listát meg lehet változtatni ugy hogy elvesz vagy hozzáad egy tény nevet, még egyedülálló tényeket is, ha szükséges. A tény nevek amik ebben a listában láthatók, nem muszáj a <i>Személy egyedülálló tényei</i> listában is lennie.<br />";
$pgv_lang["INDI_FACTS_UNIQUE"] 			= "Személy egyedülálló tényei";
$pgv_lang["INDI_FACTS_UNIQUE_help"]		= "~Személy egyedülálló tényei~<br /><br />Ez a GEDCOM tények listája amit a felhasználók <u>csak egyszer</u> adhatnak hozzá egy személyhez. Például, ha a születés (BIRT) a listában van, a felhasználók nem tudják a listához megint hozzáadni a születés (BIRT) adatot a személyhez. Tények neve ami a listában szerepel nem muszáj a <i>Személyhez tények hozzáadása</i> listában is szerepelnie.<br />";
$pgv_lang["FAM_FACTS_ADD"] 			= "Családhoz tények hozzáadása";
$pgv_lang["FAM_FACTS_ADD_help"]			= "~Családhoz tények hozzáadása~<br /><br />Ez a GEDCOM tények listája amit a felhasználók hozzáadhatnak egy családhoz. A Listát meg lehet változtatni ugy hogy elvesz vagy hozzáad egy tény nevet, még egyedülálló tényeket is, ha szükséges. A tény nevek amik ebben a listában láthatók, nem muszáj a  <i>Család egyedülálló tényei</i> listában is lennie.<br />";
$pgv_lang["FAM_FACTS_UNIQUE"] 			= "Család egyedülálló tényei";
$pgv_lang["FAM_FACTS_UNIQUE_help"]		= "~Család egyedülálló tényei~<br /><br />Ez a GEDCOM tények listája amit a felhasználók <u>csak egyszer</u> adhatnak hozzá egy családhoz. Például, ha a házasság (MARR) a listában van, a felhasználók nem tudják a listához megint hozzáadni a házasság (MARR) adatot a családhoz. Tények neve ami a listában szerepel nem muszáj a <i>Családhoz tények hozzáadása</i> listában is szerepelnie.<br />";
$pgv_lang["SOUR_FACTS_ADD"] 			= "Forráshoz tények hozzáadása";
$pgv_lang["SOUR_FACTS_ADD_help"]		= "~Forráshoz tények hozzáadása~<br /><br />Ez a GEDCOM tények listája amit a felhasználók hozzáadhatnak egy forráshoz. A Listát meg lehet változtatni ugy hogy elvesz vagy hozzáad egy tény nevet, még egyedülálló tényeket is, ha szükséges. A tény nevek amik ebben a listában láthatók, nem muszáj a <i>Forrás egyedülálló tényei</i> listában is lennie.<br />";
$pgv_lang["SOUR_FACTS_UNIQUE"] 			= "Forrás egyedülálló tényei";
$pgv_lang["SOUR_FACTS_UNIQUE_help"]		= "~Forrás egyedülálló tényei~<br /><br />Ez a GEDCOM tények listája amit a felhasználók <u>csak egyszer</u> adhatnak hozzá egy forráshoz. Például, ha a cím (TITL) a listában van, a felhasználók nem tudják a listához megint hozzáadni a cím (TITL) adatot a forráshoz. Tények neve ami a listában szerepel nem muszáj a <i>Forráshoz tények hozzáadása</i> listában is szerepelnie.<br />";
$pgv_lang["REPO_FACTS_ADD"] 			= "Szervezethez tények hozzáadása";
$pgv_lang["REPO_FACTS_ADD_help"]		= "~Szervezethez tények hozzáadása~<br /><br />Ez a GEDCOM tények listája amit a felhasználók hozzáadhatnak egy szervezethez. A Listát meg lehet változtatni ugy hogy elvesz vagy hozzáad egy tény nevet, még egyedülálló tényeket is, ha szükséges. A tény nevek amik ebben a listában láthatók, nem muszáj a <i>Szervezet egyedülálló tényei</i> listában is lennie.<br />";
$pgv_lang["REPO_FACTS_UNIQUE"] 			= "Szervezet egyedülálló tényei";
$pgv_lang["REPO_FACTS_UNIQUE_help"]		= "~Szervezet egyedülálló tényei~<br /><br />Ez a GEDCOM tények listája amit a felhasználók <u>csak egyszer</u> adhatnak hozzá egy szervezethez. Például, ha a név (NAME) a listában van, a felhasználók nem tudják a listához megint hozzáadni a név (NAME) adatot a szervezethez. Tények neve ami a listában szerepel nem muszáj a <i>Szervezethez tények hozzáadása</i> listában is szerepelnie.<br />";
$pgv_lang["LANG_SELECTION_help"]		= "~Támogatott nyelvek~<br /><br />Meg tudja változtatni a támogatott nyelveket a PhpGedView -ban, úgy hogy ki- vagy bepipálja a jelölőnégyzeteket. Ez megengedi a felhasználóknak hogy a megadott nyelvekből választhassanak.<br /><br />Ezt ugyan itt el tudja érni: <b>Támogatott nyelvek beállítása</b> a Adminisztráció menüböl, ahol megváltoztatható pl.: nyelvek zászlója, dátum formátum, vagy hogy a vezetéknév mindig elsőként látszódjon.<br />";
$pgv_lang["MEDIA_ID_PREFIX"]		= "Média-elem azonosító előtag";
$pgv_lang["MEDIA_ID_PREFIX_help"]	= "~Média-elem azonosító előtag~<br /><br />Amikor a PhpGedView weboldalán egy új média elemet regisztrálnak akkor egy új azonosítószám generálódik automatikusan. Ez lesz a média azonosító előtagja.<br />";
$pgv_lang["FAM_ID_PREFIX"]		= "Család azonosító előtag";
$pgv_lang["FAM_ID_PREFIX_help"]	= "~Család azonosító előtag~<br /><br />Amikor a PhpGedView weboldalán egy új családot regisztrálnak akkor egy új azonosítószám generálódik automatikusan. Ez lesz a család azonosító előtagja.<br />";
$pgv_lang["QUICK_REQUIRED_FAMFACTS"]			= "Családok tényei ami mindig szerepeljen a Gyors Frissítés-en";
$pgv_lang["QUICK_REQUIRED_FAMFACTS_help"]		= "~Családok tényei ami mindig szerepeljen a Gyors Frissítés-en~<br /><br />Ez egy vesszőkkel elválasztott lista a GEDCOM tényeinek ami mindig fel lesz tüntetve a Gyors Frissítése a családnak oldalán, nem tekintve arra hogy már létezik vagy még nem létezik a személy adataiban. Például, ha a házasság (MARR) a listában van, akkor a házasság dátuma és házasság helyszíne mindig a formulában lesz.<br />";
$pgv_lang["QUICK_REQUIRED_FACTS"]			= "Tények ami mindig szerepeljen a Gyors Frissítés-en";
$pgv_lang["QUICK_REQUIRED_FACTS_help"]		= "~Tények ami mindig szerepeljen a Gyors Frissítés-en~<br /><br />Ez egy vesszökkel elválasztott lista a GEDCOM tényeiből amik mindig szerepelnek a Gyors Frissítés oldalon, eltekintve hogy már létezik vagy még nem a személy adataiban. Például, ha a születés (BIRT) a listában van, akkor a mező a születési dátum és a helyszíne mindig látszani fog az oldalon.<br />";
$pgv_lang["AUTO_GENERATE_THUMBS"]			= "Automatikusan generált előnézet képek";
$pgv_lang["AUTO_GENERATE_THUMBS_help"]		= "~Automatikusan generált előnézet képek~<br /><br />A rendszer automatikus generáljon előnézet képeket amelyik fényképnek még nincs. Az ön PHP telepítése lehet hogy nem támogatja ezt a funkciót.<br />";
$pgv_lang["phpinfo_help"]				= "~PHP információ~<br /><br />Ez az oldal részletes információkat mutat a szerverről ahova a PhpGedView telepítve lett. Konfiguráció részletek a szerver szoftverjéről, ahogy a PHP-hez és a PhpGedView -hoz kapcsolódik, itt tekinthető meg.<br />";
$pgv_lang["config_help_help"]			= "~Konfigurációs segítség~<br /><br />Ez az oldal összefoglalja nagyobb vonalakban a Konfiguráció Segitség -hez tartozó információkat. Az információ megtekinthető a képernyőn vagy elmenthető későbbi használathoz is.<br />";
...
$pgv_lang["THUMBNAIL_WIDTH_help"]		= "~Generált előnézeti képek szélessége~<br /><br />Ez a szélesség (pixelben) amit a program használni fog amikor automatikusan elönézeti képeket generál. Az alap beállítás 100.<br />";
$pgv_lang["SHOW_SOURCES"]			= "Források mutatása";
$pgv_lang["SHOW_SOURCES_help"]		= "~Források mutatása~<br /><br />Beállítása a bizalmas hozzáférési jogosultságnak az összes Forrásnak. Ha a felhasználónak nincs jogosultsága a Forrásokhoz akkor a Listák menüjéből a Források Listája és a személyek adatainál a Források oldala nem láthatók.<br />";
$pgv_lang["GEDCOM_DEFAULT_TAB"]			= "Alapoldal mutatása a személyek oldalán";
$pgv_lang["GEDCOM_DEFAULT_TAB_help"]	= "~Alapoldal mutatása a személyek oldalán~<br /><br />Ez az opció beállítja hogy melyik oldalt mutassa automatikusan amikor a személyek adatai oldalát látogatják.";
...
$pgv_lang["file_to_edit_help"]			= "~Szerkesztendő állomány~<br /><br />#pgv_lang[lang_file_descriptions]#";
$pgv_lang["lang_filenames_help"]		= "~Nyelvi állományok~<br /><br />#pgv_lang[lang_file_descriptions]#";
?>

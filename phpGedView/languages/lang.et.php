...
$pgv_lang["add_fav_or_enter_url"]		= "VÕI<br />sisesta URL ja pealkiri";
...
$pgv_lang["privacy_error"]			= "Selle isiku detailisem info on privaatne.";
...
$pgv_lang["recent_changes_none"]	= "<b>Viimase #pgv_lang[global_num1]# päeva jooksul pole muudatusi tehtud.</b>";
$pgv_lang["recent_changes_some"]	= "<b>Viimase #pgv_lang[global_num1]# päeva jooksul tehtud muudatused</b>";
...
$pgv_lang["click_here_help"]		= "Muudatuste salvestamiseks vajuta siia.<br /><br />Satud tagasi leheküljele Tere,  või leheküljele Minu GedView portaal, Kuid muudatused võivad sealt puududa.  Muudatuste nägemiseks pead kasutama brauseri värskendamise funktsiooni (refresh).";
$pgv_lang["block_summaries"]		= "Lühidalt on kirjeldatud iga blokki, mida saad paigutada lehtedele Tere,  või Minu GedView portaal.<br /><table border='1' align='center'><tr><td class='list_value'><b>Nimi</b></td><td class='list_value'><b>Kirjeldus</b></td></tr>&nbsp;</table>";

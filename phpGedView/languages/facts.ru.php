...
$factarray["AFN"]  = "Номер прародителя (положение в генеалогическом древе)";
//$factarray["AFN";
...
$factarray["RIN"]  = "Идентификационный номер";
$factarray["ROLE"] = "Роль";
$factarray["SEX"]  = "Пол";
...
$factarray["_ADPF"]	= "Усыновлён/удочерена отцом";
$factarray["_ADPM"] 	= "Усыновлён/удочерена матерью";

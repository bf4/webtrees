...
$pgv_lang["click_here_help"]="~Clique aqui para continuar~<br /><br />Clique neste botão para salvar as alterações.<br /><br />Ao retornar para a página Bem-Vindo ou para Meu Portal, caso não veja suas alterações, clique no botão Atualizar de seu Navegador (Browser).";
$pgv_lang["block_summaries"]="~Descrição dos Blocos~<br /><br />Descrição sucinta de cada bloco que você pode colocar em Bem-Vindo ou na página Meu Portal.<br /><table border='1' align='center'><tr><td class='list_value'><b>Nome</b></td><td class='list_value'><b>Descrição</b></td></tr>&nbsp;</table><br /><br />";

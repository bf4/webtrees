...
$pgv_lang["upload_media_help"]		= "~Medya dosyaları yükle~<br /><br />Serverinize yüklemek için yerel bilgisayarınızdan dosyaları seçin. Dızın <b>#MEDIA_DIRECTORY#</b> ya da onun alt dizininin birisine tüm dosya yüklenecek..<br /><br />Sizin belirttiğiniz dosya adlar #MEDIA_DIRECTORY# ilave edilecekler. örneğin #MEDIA_DIRECTORY#benimailem.Tırnak önizleme dızın var olmazsa otomatik olarak oluşturulacak.";

...
$pgv_lang["unsync_warning"] 	= "קובץ ה-GEDCOM <em>אינו</em> מסונכרן עם מסד הנתונים.  יתכן שהוא אינו כולל את הורסיה האחרונה של הנתונים שלך.  כדי לייבא מחדש ממסד הנתונים ולא מהקובץ, עליך לייצא ולהעלות מחדש.";

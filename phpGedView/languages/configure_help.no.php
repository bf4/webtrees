...
$pgv_lang["MEDIA_FIREWALL_THUMBS_help"]	= "Når et bilde er i den beskyttede mediakatalogen, skal det tilhørende miniatyrbildet beskyttes også?";
$pgv_lang["SHOW_SPIDER_TAGLINE"]		= "Vis spider-tagline";
$pgv_lang["SHOW_SPIDER_TAGLINE_help"]		= "På sider som genereres for søkemotorer, kan denne setningen vises som den siste linjen på siden denne søkemotorene oppdager.  Hvis dette alternativet er slått på, kan det påvirke Google&reg; AdSense i retning av søkemotorens optimatiseringsverktøy.";
$pgv_lang["SHOW_PRIVATE_RELATIONSHIPS_help"] = "Dette alternativet vil beholde familjebånd i private poster.  Dette betyr at du vil se tomme \"privat\"bokser i anetrediagrammet og på  andre diagrammer med private personer.<br /><br />Dette er samme adferd fra PhpGedView versjoner tidligere enn v4.0.<br /><br />Dette alternativet er AV som standard.  Det er anbefalt å istedenfor å slå alternativet på, å peke rotpersonen i GEDCOM-konfigurasjonen på en person som ikke er privat.";
$pgv_lang["SHOW_PRIVATE_RELATIONSHIPS"]	= "Vis private slektskap";
$pgv_lang["SYNC_GEDCOM_FILE_help"] 			= "I tidligere versjoner av PGV ble listene av ventende endringer lagret i GEDCOM-filen og de endrede postene ble \"akseptert\" inn i databasen.  Fra og med v4.1 vil ventende endringer ikke lenger lagres i GEDCOM-filen, men i en endringsfil.  <br /><br />Hvis du setter dette alternativet til ja vil du oppdatere GEDCOM-filen når endringene er akseptert i databasen. Dette vil holde GEDCOM-filen synkronisert med databasen.  For bedre kompatibilitet med tidligere versjoner vil standardverdien på dette feltet være ja.<br /><br />Du kan slå det av for å spare minne når du aksepterer endringer.";
$pgv_lang["SYNC_GEDCOM_FILE"]			= "Synkroniser endringer til GEDCOM-filen";
$pgv_lang["COMMIT_COMMAND_help"] 			= "Hvis du ønsker å bruke et versjonskontrollsystem slik soms CVS for å arkivere endringer til din GEDCOM-fil, konfigurasjonen din eller personverninnstillinger, kan du skrive kommandoen her.  La boksen være blank hvis du ikke ønsker å bruke et versjonskontrollsystem.  Gyldige valg er <b>cvs</b> og <b>svn</b>.";
$pgv_lang["COMMIT_COMMAND"] 			= "Kommando for Versjonskontroll-commit ";
$pgv_lang["SHOW_MULTISITE_SEARCH_help"]	= "Vis Multi-site søk tillater brukere å søke i flere websteder som du har definert i adminmenyen Oppsett for nettsteder.  Dette valget kontrollererom Multi-site søk-funksjonaliteten er tilgjengelig for alle eller bare godkjente brukere.";
$pgv_lang["SHOW_MULTISITE_SEARCH"]		= "Vis Multi-Site søk";
$pgv_lang["SHOW_NO_WATERMARK"]			= "Hvem kan se ikke-vannmerkede bilder?";
$pgv_lang["SHOW_NO_WATERMARK_help"]		= "Hvis Mediabrannmuren er aktivert, vil brukerne se vannmerker hvis de ikke har tilgangsnivået som er spesifisert her.";
$pgv_lang["WATERMARK_THUMB"]			= "Legge til vannmerke på miniatyrbilder?";
$pgv_lang["WATERMARK_THUMB_help"]		= "Hvis Mediabrannmuren er aktivert, skal miniatyrbildene vannmerkes? Medialistene vill lastes hurtigere dersom du ikke vannmerker miniatyrbildene.";
$pgv_lang["SAVE_WATERMARK_THUMB"]		= "Lagre vanmerkede miniatyrbilder på tjeneren?";
$pgv_lang["SAVE_WATERMARK_THUMB_help"]	= "Hvis Mediabrannmuren er aktivert, skal kopier av vannmerkede miniatyrbilder lagres på tjeneren i tillegg til de samme miniatyrbildene uten vannmerke?<br /><br />Hvis alternativet er satt til <b>Ja</b>,  vil medialister som inneholder vannmerkede miniatyrbilder bli genererert raskere på bekostning av større krav til diskplass på tjeneren.";
$pgv_lang["SAVE_WATERMARK_IMAGE"]		= "Lagre vannmerkede bilder i full størrelse på tjener?";
$pgv_lang["SAVE_WATERMARK_IMAGE_help"]	= "Dersom Mediabrannmuren er aktivert, skal kopier av vannmerkede bilder i full størrelse lagres på tjeneren i tillegg til de samme bildene uten vannmerke?<br /><br />Hvis alternativet er satt til <b>Ja</b>, vil vannmerkede bilder i fullskala størrelse bli vist raskere på bekostning av større krav til diskplass.";
$pgv_lang["DB_UTF8_COLLATION"]			= "Bruk databasen til å skaffe UTF-8 kollasjoner";
$pgv_lang["DB_UTF8_COLLATION_help"]		= "Bestemmer om PhpGedView skal bruke databasens innebyggede funskjoner for sortering og sammenligning.  Som regel er det hurtigere å bruke databasen til å sortere og sammenligne data i forhold til å benytte PHP, men ikke alle databaser/versjoner har denne muligheten.  Rekkefølgen for sammenligning for hvert språk bestemmes for språket i siden for å konfigurere støttede språk.<br /><br /><span class=\"warning\">VIKTIG: Du må bare sette denne verdien til ja hvis du gjør det FØR databasetabellene er opprettet første gang. Velger du det på en eksisterende database kan datene bli ødelagt.</span><br /><br />MySQL tilbyr god støtte for UTF-8, selv om ikke alle sammenligningssekvenser er tilgjengelige i tidligere versjoner.  Andre databasemotorer tilbyr lite eller ingen støtte for UTF-8. Hvis du er usikker på din databases støtte for UTF-8, skal du sette denne verdien til <b>Nei</b>.<br /><br />Denne <a href='http://en.wikipedia.org/wiki/UTF-8' target='_blank' title='Wikipedia-artikkelen'><b>Wikipedia-artikkelen</b></a> inneholder fyldig informasjon og lenker om UTF-8.";
$pgv_lang["INDI_FACTS_ADD"] 			= "Fakta å legge til for personer";
$pgv_lang["INDI_FACTS_ADD_help"]		= "Dette er de GEDCOM-faktaene som dine brukere kan knytte til personer.  Du kan endre denne listen ved å fjerne eller legge til faktanavn, også egendefinerte om nødvendig.  Faktanavn i denne listen kan ikke samtidig være i <i>Unike fakta for personer</i> -listen.";
$pgv_lang["INDI_FACTS_UNIQUE"] 			= "Unike fakta for personer";
$pgv_lang["INDI_FACTS_UNIQUE_help"]		= "Dette er rekken med GEDCOM fakta som dine brukere kan legge til <u>en gang</u> for en person.  For eksempel, hvis BIRT er på denne listen, vil brukerne ikke kunne legge til mer enn en BIRT-post til en person.  Faktanavn som er på denne listen kan ikke være på listen <i>Fakta å legge til for personer</i>.";
$pgv_lang["INDI_FACTS_QUICK"] 			= "Hurtiglinker for personfakta";
$pgv_lang["INDI_FACTS_QUICK_help"]	= "Dette er et utvalg av GEDCOM-fakta for personer som vises ved siden av den komplette listen  og som kan legges til med et enkelt klikk.";
$pgv_lang["FAM_FACTS_ADD"] 			= "Fakta å legge til for familier";
$pgv_lang["FAM_FACTS_ADD_help"]		= "Dette er rekken av GEDCOM-fakta som dine brukere kan legge til familier.  Du kan endre denne listen ved å fjerne eller legge til faktanavn, også egendefinerte om nødvendig.  Faktanavn som er på denne listen kan ikke være på listen <i>Unike fakta for familier</i>.";
$pgv_lang["FAM_FACTS_UNIQUE"] 			= "Unike fakta for familier";
$pgv_lang["FAM_FACTS_UNIQUE_help"]		= "Dette er rekken med GEDCOM fakta som dine brukere kan legge til <u>en gang</u> for en familie.  For eksempel, hvis MARR er på denne listen, vil brukerne ikke kunne legge til mer enn en MARR-hendelse til en familie.  Faktanavn som er på denne listen kan ikke samtidig være på <i>Fakta å legge til for familier</i>-listen.";
$pgv_lang["FAM_FACTS_QUICK"] 			= "Hurtiglinker for familiefakta";
$pgv_lang["FAM_FACTS_QUICK_help"]	= "Dette er et utvalg av GEDCOM-fakta for personer som vises ved siden av den komplette listen og som kan legges til med et enkelt klikk.";
$pgv_lang["SOUR_FACTS_ADD"] 			= "Fakta å legge til for kilder";
$pgv_lang["SOUR_FACTS_ADD_help"]		= "Dette er rekken av GEDCOM-fakta som dine brukere kan legge til kilder.  Du kan endre denne listen ved å fjerne eller legge til faktanavn, også egendefinerte om nødvendig.  Faktanavn som er på denne listen kan ikke samtidig være på <i>Unike fakta for kilder</i>-listen.";
$pgv_lang["SOUR_FACTS_UNIQUE"] 			= "Unike fakta for kilder";
$pgv_lang["SOUR_FACTS_UNIQUE_help"]		= "Dette er rekken med GEDCOM fakta som dine brukere kan legge til <u>en gang</u> for en kilde.  For eksempel, hvis TITL er på denne listen, vil brukerne ikke kunne legge til mer enn en TITL-fakta til en kilde.  Faktanavn på denne listen kan ikke samtidig være på <i>Fakta å legge til for kilder</i>-listen.";
$pgv_lang["SOUR_FACTS_QUICK"] 			= "Hurtiglinker for kildefakta";
$pgv_lang["SOUR_FACTS_QUICK_help"]	= "Dette er et utvalg av GEDCOM-fakta for personer som vises ved siden av den komplette listen og som kan legges til med et enkelt klikk.";
$pgv_lang["REPO_FACTS_ADD"] 			= "Fakta å legge til for oppbevaringssteder";
$pgv_lang["REPO_FACTS_ADD_help"]		= "Dette er rekken av GEDCOM-fakta som dine brukere kan legge til oppbevaringssteder.  Du kan endre denne listen ved å fjerne eller legge til faktanavn, også egendefinerte om nødvendig.  Faktanavn på denne listen kan ikke samtidig være   på <i>Unike fakta for oppbevaringssteder</i>-listen.";
$pgv_lang["REPO_FACTS_UNIQUE"] 			= "Unike fakta for oppbevaringssteder";
$pgv_lang["REPO_FACTS_UNIQUE_help"]		= "Dette er rekken av GEDCOM-fakta som dine brukere kan legge til oppbevaringssteder.  Du kan endre denne listen ved å fjerne eller legge til faktanavn, også egendefinerte om nødvendig.  Faktanavn som er på denne listen kan ikke samtidig være på <i>Fakta å legge til for oppbevaringssteder</i>-listen.";
$pgv_lang["REPO_FACTS_QUICK"] 			= "Hurtiglinker for oppbevaringsstedfakta";
$pgv_lang["REPO_FACTS_QUICK_help"]	= "Dette er et utvalg av GEDCOM-fakta for personer som vises ved siden av den komplette listen og som kan legges til med et enkelt klikk.";
$pgv_lang["LANG_SELECTION_help"]		= "Du kan endre endre hvilke språk som skal støttes av ditt PhpGedView-nettsted ved å legge til eller fjerne hakene som du ønsker.  Dette endrer utvalget av språk som er tilgjengelig for dine brukere.<br /><br />Du kan oppnå det samme ved  <b>Konfigurere støttede språk</b> lenken på Adminmenyen, hvor du også kan endre ting som språkets flagg-ikon, datoformater, eller om etternavn alltids skal skrives først.";
$pgv_lang["MEDIA_ID_PREFIX"]		= "Prefiks til Media-ID";
$pgv_lang["MEDIA_ID_PREFIX_help"]	= "Når et mediaobjekt legges til online i PhpGedView, vil en ID for det mediaobjektet bli generert automatsk. Media ID-en vil få dette prefikset.";
$pgv_lang["FAM_ID_PREFIX"]		= "Prefiks til Familie-ID";
$pgv_lang["FAM_ID_PREFIX_help"]	= "Når en ny familie blir registert online i PhpGedView, vil en ny ID automatisk bli lagd for denne familien. Familie-IDen får da dette prefikset (standard er F).";
$pgv_lang["QUICK_REQUIRED_FAMFACTS"]			= "Vis alltid faktaopplysninger for familier ved Hurtig-oppdatering";
$pgv_lang["QUICK_REQUIRED_FAMFACTS_help"]		= "Dette er en komma-oppdelt list for faktamerker (GEDCOM-fakta) som alltid vil bli vist for familier i vinduet for Hurtig-oppdatering selv om disse allerede finnes for enkelte av personene i familien.<br />For eksempel, hvis MARR er i listen, så vil alltid feltene for bryllupsdato og -sted bli vist.";
$pgv_lang["QUICK_REQUIRED_FACTS"]			= "Fakta som alltid vises ved Hurtig-oppdatering";
$pgv_lang["QUICK_REQUIRED_FACTS_help"]		= "Dette er en komma-oppdelt list for faktamerker (GEDCOM-fakta) som alltid vil bli vist i vinduet for Hurtig-oppdatering selv om disse allerede finnes fra før for personen.<br />For eksempel, hvis BIRT er i listen, så vil alltid feltene for fødselsdato og -sted bli vist.";
$pgv_lang["SURNAME_TRADITION_help"] = "Når du legger ny medlemmer til en familie kan PhpGedView foreslå standardverdier for etternavn i henhold til regionale tradisjoner og skikker.<br /><br /><ul><li>Ved tr<b>Paternalistisk</b>tradisjon, vil alle familiemedlemmene ha farens etternavn.</li><li>I  <b>Spansk</b> and <b>Portugisisk</b> tradisjon, vil barna få et etternavn fra hver av foreldrene.</li><li>I  <b>Islandsk</b> tradisjon, vil barna få farens fornavn som etternavn, med en endelse som viser kjønnet.</li><li>I  <b>Polsk</b> tradisjon, vil alle familiemedlemmene ha farens etternavn. For noen etternavn vil endelsen indikere personens kjønn. Endelsene <i>ski</i>, <i>cki</i>, og <i>dzki</i> indikerer hankjønn, men de korresponderende <i>ska</i>, <i>cka</i>, and <i>dzka</i> indikerer hunkjønn.</li></ul>";
$pgv_lang["ADVANCED_NAME_FACTS_help"] = "Dette er en kommaseparert liste med GEDCOM-fakta som blir vist på skjermbildet for å legge til eller å endre navn.  Hvis du bruker ikke-latinsk alfabet slik som hebraisk, gresk, kyrillisk eller arabisk, vi du kanskje legge til fakta slik som _HEB, ROMN, FONE, etc. for å tillate lagring av navn i ulike alfabet.";
$pgv_lang["ADVANCED_PLAC_FACTS_help"] = "Dette er en kommaseparert liste med GEDCOM-fakta som blir vist på skjermbildet for å legge til eller å stednavn.  Hvis du bruker ikke-latinsk alfabet slik som hebraisk, gresk, kyrillisk eller arabisk, vi du kanskje legge til fakta slik som _HEB, ROMN, FONE, etc. for å tillate lagring av navn i ulike alfabet.";
$pgv_lang["USE_GEONAMES"]				= "Bruk GeoNames-database";
$pgv_lang["USE_GEONAMES_help"]			= "Skal GeoNames-database brukes til å finne flere forslag for stednavn?<br /><br />Når dette valget er satt til <b>Ja</b>, vil GeoNames-database bli søkt i for å finne forslag til stednavn som blir skrevet.  Når det er satt til <b>Nei</b>, vil kun den gjeldende stedtabellen bli søkt i.  Etterhvert som du legger inn flere stednavn, vil forslagene bli mer nøyaktige.  Dette valget kan forsinke inntastingen av data, hvis din internettforbindelse er treg.<br /><br />GeoNames geografisk database er gratis tilgjengelig. Den inneholder over 8,000,000 geografiske navn.";
$pgv_lang["AUTO_GENERATE_THUMBS"]			= "Lage automatisk miniatyrbilder";
$pgv_lang["AUTO_GENERATE_THUMBS_help"]		= "Skal systemet automatisk lage miniatyrbilder for bilder som ikke har det fra før.<br />PS. Det kan hende at PHP-versjonen din ikke støtter denne funksjonen.";
$pgv_lang["phpinfo_help"]				= "Denne siden gir deg omfattende informasjon om nettjeneren din der PhpGedView er plassert.  Mange detaljer om konfigurasjonen blir vist om programvaren til tjeneren som er relatert til PHP og PhpGedView.";
$pgv_lang["config_help_help"]			= "Denne siden viser alle de viktigste emnene om hjelp for konfigurasjon på et sted.  Du kan se på eller skrive ut informasjonen for senere bruk.";
$pgv_lang["more_help_advice"]			= "<br /><b>Mer hjelp</b><br />Mer hjelp er tilgjengelig ved å klikke på <b>?</b> ved siden av hvert punkt på siden.";
$pgv_lang["THUMBNAIL_WIDTH"]			= "Bredde for laging av miniatyrbilder";
$pgv_lang["THUMBNAIL_WIDTH_help"]		= "Dette er bredden (i punkter) som programmet vil bruke ved automatisk generering av miniatyrbilder.<br />Standardverdi er 100.";
...
$pgv_lang["CHANGELOG_CREATE_help"]	= "Hvor ofte skal programmet arkivere filene for endringslogg?.";
...
$pgv_lang["FULL_SOURCES_help"]		= "Kildehenvisninger kan inkludere felter for å lagre informasjon om kvaliteten på dataene (primærkilde, sekundærkilde, osv.) og datoen hendelsen ble inntatt i kilden.  Hvis du ikke bruker disse feltene kan du deaktivere dem når du oppretter ny kilder.";
$pgv_lang["PREFER_LEVEL2_SOURCES"]		= "Foretrekk kilder til fakta";
$pgv_lang["PREFER_LEVEL2_SOURCES_help"]		= "Når du legger til nye fakta for nære slektninger, kan du legge til kildehenvisninger til postene (dvs INDI, FAM) eller faktaene (BIRT, MARR, DEAT).  Dette alternativet kontrollerer hvilke avkrysningsbokser som skal kukes av som default.";
...
$pgv_lang["DBPORT_help"]		= "TCP-porten som skal benyttes ved tilkobling til databasetjeneren.  La den være blank for å benytte defaultverdien for din databasetype.  Valget har ingen betydning dersom du bruker en SQLite database.";
...
$pgv_lang["upload_path_help"]		= "Dette er banen hvor GEDCOM-filen du ønsker å laste opp befinner seg. For å velge bane, klikk på <b>Bla gjennom</b> og naviger til GEDCOM-filen og klikk <b>Åpne</b>.";
...
$pgv_lang["PEDIGREE_SHOW_GENDER_help"]	= "Dette alternativet kontrollerer om du skal vise en persons kjønn med et ikon på diagrammer eller ikke.<br /><br />Siden kjønn også er vist med farge på boksene, vil ikke dette valget skjule en persons kjønn. Valget bare fjerner noe duplisert informasjon fra boksene.";
...
$pgv_lang["ZOOM_BOXES_help"] 			= "Gjør det mulig for en bruker å endre størrelsen på bokser i diagram og for å få mer informasjon.<dl><dt>Du kan velge mellom:</dt><dd><b>Ikke valgt</b> for å sperre dette valget.</dd><dd><b>Ved å føre musen over</b> for at boksen skal bli større må man bevege musen over ikonet i boksen.</dd><dd><b>Ved å holde museknappen inne</b> for at boksen skal bli større når man holde museneknappe inne når man er over ikonet i boksen.</dd><dd><b>#$pgv_lang[click]#</b> for at boksen skal bli større må man klikke på ikonet i boksen.</dd></dl>";
$pgv_lang["LINK_ICONS"] 				= "Ikon for \"undermeny\" i diagrambokser";
$pgv_lang["LINK_ICONS_help"] 			= "Gjør det mulig for brukere å velge linker til andre diagram og nære slektninger til personen i boksen.<dl><dt>Du kan velge mellom:</dt><dd><b>Ikke valgt</b> for å sperre dette valget.</dd><dd><b>Ved å føre musen over</b> for å vise en \"undermeny\" må man bevege musen over ikonet i boksen.</dd><dd><b>Ved å klikke med musen</b> for å vise en \"undermeny\" må man klikke på ikonet i boksen.</dd></dl>";
...
$pgv_lang["SHOW_AGE_DIFF_help"]		= "Dette valget bestemmer hvorvidt fanen Nære slektninger skal vise forskjellen mellom fødselsdatoer for ektefeller, mellom vielsesdato og fødselsdato for første barn og mellom barnas fødselsdatoer.";
...
$pgv_lang["SHOW_RELATIVES_EVENTS_help"] = "Opplysninger om fødsel og død til slektninger er viktige hendelser. Dette valget gir deg mulighet til å vise disse hendelsene på arkfanen <i>Fakta og detaljer om personen</i> på faktasiden til personer.<br /><br />Hendelser som vises ved aktivering av dette valget, er:<ul><li>Dødsfall til ektefeller</li><li>Fødsel/dødfall til barn</li><li>Dødsfall til foreldre</li><li>Fødsel/dødsfall til søsken</li><li>Dødsfall til besteforeldre</li><li>Fødsel/dødsfall til søsken til foreldre</li></ul>";
$pgv_lang["EXPAND_RELATIVES_EVENTS"]      = "Vis automatisk listen av hendelser for nære slektninger";
$pgv_lang["EXPAND_RELATIVES_EVENTS_help"] = "Dette valget bestemmer om du ønsker automatisk visning av <i>Hendelser til nære slektninger</i>.";
$pgv_lang["EXPAND_SOURCES"]      = "Vis utvidede kilder automatisk";
$pgv_lang["EXPAND_SOURCES_help"] = "Dette valget kontrollerer om du ønsker å automatisk vise innholdet i <i>Kilder</i> på siden for personer.";
$pgv_lang["EXPAND_NOTES"]      = "Vis utvidede merknader automatisk";
$pgv_lang["EXPAND_NOTES_help"] = "Dette valget kontrollerer om du ønsker å automatisk vise innholdet i <i>Noter</i> på siden for personer.";
$pgv_lang["SHOW_LEVEL2_NOTES"]      = "Vis alle merknader og kildereferanser på fanene for Merknader og Kilder";
$pgv_lang["SHOW_LEVEL2_NOTES_help"] = "Dette valget kontrollerer om hvorvidt noter og kildereferanser som er knyttet til fakta skal vises på fanene for noter og faktapå personsiden.<br /><br />Normalt viser noter- og kildefanene bare noter og kilder som er knyttet direkte til personens post.  Disse kalles <i>nivå 1</i> noter- og kildereferanser.<br /><br />Valget <b>Ja</b> vil få disse fanene til også å vise noter og kildereferanser som er en del av heldelser og fakta knyttet til persones post i databasen.  Dette er <i>nivå 2</i>-noter og kilder fordi de ulike faktaene er nivå 1.";
...
$pgv_lang["WELCOME_TEXT_AUTH_MODE_CUST_HEAD_help"]	= "Du kan velge å vise en (flerspråklig) standardtekst som start for den egenkomponerte velkomstteksten din.<br /><br />Dersom du velger \"Ja\", vil teksten start med følgende setninger:<br /><br /><center><h3><b>Velkommen til disse slektssidene !</b></h3>PS! - <i>Sidene er <b>bare</b> tilgjengelig for brukere som har <b>gyldig</b> brukernavn og passord.</i></center>";
$pgv_lang["SHOW_REGISTER_CAUTION"]			= "Vis 'Avtale om akseptabel bruk' på «Be om ny brukerkonto» siden";
$pgv_lang["SHOW_REGISTER_CAUTION_help"]		= "Når dette valget er satt til <b>Ja</b>, vil følgende melding vises over inputfeletene på «Søke om brukerkonto» siden:<div class=\"list_value_wrap\"><div class=\"largeError\">Viktig:</div><div class=\"error\">Ved å fylle ut og sende inn dette skjemaet, bekrefter du at du:<ul><li>beskytte privatlivets fred og pesonvernet til de levende personer som er nevnt på dette nettstedet;</li><li>og i tekstfeltet nedenfor, forklar hvem du har slektskap til,eller bidra med informasjon om hvem som skal eller bør være nevnt.</li></ul></div></div>";
...
$pgv_lang["EDIT_AUTOCLOSE_help"]	= "Dette valget angir om vindu for redigering skal lukkes automatisk etter at oppdatering er utført uten feil.";
...
$pgv_lang["POSTAL_CODE_help"] = "Ulike land bruker forskjellig måte å skrive postadresser. Du kan her velge om postnummert skal komme før eller etter navnet på poststedet.";
$pgv_lang["SUBLIST_TRIGGER_I"]		= "Maks antall etternavn";
$pgv_lang["SUBLIST_TRIGGER_I_help"]	= "Lange lister med personer med samme etternavn kan brytes opp i mindre underlister i henhold til den første bokstaven i personenes fornavn.<br /><br />Dette valget bestemmer når underlister av etternavn skal benyttes.  For å deaktivere oppdeling i underlister fullstendig, sett dette valget til null.";
$pgv_lang["SUBLIST_TRIGGER_F"]		= "Maks antall familienavn";
$pgv_lang["SUBLIST_TRIGGER_F_help"]	= "Lange lister med familier med samme etternavn kan brytes opp i mindre underlister i henhold til den første bokstaven i personenes fornavn.<br /><br />Dette valget bestemmer når underlister av etternavn skal benyttes.  For å deaktivere oppdeling i underlister fullstendig, sett dette valget til null.";
$pgv_lang["SURNAME_LIST_STYLE"]		= "Type etternavnliste";
$pgv_lang["SURNAME_LIST_STYLE_help"]	= "Lister med etternavn, slik som de fremkommer i Rammen Topp 10 etternavn blokken, Personer, og Familier, kan vises i ulike stiler.<ul><li><b>Tabell</b>&nbsp;&nbsp;&nbsp;I denne stilen vil etternavn vises i en tabell som kan sorteres enten etter etternavn eller antall.</li><li><b>Tagcloud</b>&nbsp;&nbsp;&nbsp;I denne stilen vil etternavn vises i en liste og størrelsen på skrifttypen for hvert navn er avhengig av frekvensen av dette etternavnet i databasen. Denne listen kan du ikke sortere.</li></ul>";
...
$pgv_lang["SHOW_LAST_CHANGE_help"]	= "Dette valget kontroller om du skal vise GEDCOM-postens siste endringsdato eller ikke på lister.";
$pgv_lang["SHOW_EST_LIST_DATES"]		= "Vis beregnet dato for fødsler og dødsfall";
$pgv_lang["SHOW_EST_LIST_DATES_help"]	= "Dette valget kontrollerer om du skal vise beregnede datoer for fødsel og død istedenfor blank i personlister og diagrammer fpr personer der disse datoene ikke er kjent.";
...
$pgv_lang["SHOW_MEDIA_FILENAME_help"]	= "Mediaviseren kan vise navn på mediafilen som blir vist.  Dette valget bestemmer om du skal vise filnavnet eller ikke.<br /><br />Du vil kanskje skjule filnavnet av sikkerhetshensyn.";
$pgv_lang["SHOW_MEDIA_DOWNLOAD"]		= "Vis lenke for nedlasting i mediaviseren";
$pgv_lang["SHOW_MEDIA_DOWNLOAD_help"]	= "Mediaviseren kan vise en lenke, som hvis man klikker på den vil laste mediafilen ned til lokal PC.<br /><br />Du vil kanskje skjule nedlastningslinken av sikkerhetshensyn.";
...
$pgv_lang["CONTACT_METHOD_help"] 		= "Her velger du den måten besøkende kan få formidlet spørsmål til <b>Kontaktperson for slektsspørsmål</b>.  Linken for kontakt vil bli vist nederst på hver side.<dl><dt>Du har følgende valg:</dt><dd><b>Besøkende sitt eget e-post-program</b>. Besøkende må ha et e-post-program tilgjengelig på sin egen maskin.</dd><dd><b>PhpGedView interne beskjeder</b>. Dette bruker beskjedsystemet som er innebygd i PhpGedView, og det sender ingen ekstern e-post.</dd><dd><b>PhpGedView interne beskjeder med e-post-kopi</b>. Dette valget er standard og bruker beskjedsystemet som er innebygd i PhpGedView, men sender også kopi av beskjedene med e-post.</dd><dd><b>PhpGedView ekstern e-post</b>. Dette valget bruker beskjedsystemet som er innebygd i PhpGedView, men sender beskjedene med e-post uten å ta en kopi til det interne systemet.</dd><dd><b>Ingen kontaktlink</b>. Dette gjør at besøkende ikke kan kontakte deg.</dd></dl>";
$pgv_lang["PHPGEDVIEW_EMAIL"]		= "PhpGedView svaradresse";
$pgv_lang["PHPGEDVIEW_EMAIL_help"]	= "Dette er epostadressen som brukes i &laquo;Fra:&raquo;-feltet i eposter som PhpGedView lager automatisk.<br /><br />PhpGedView kan automatisk generere eposter for å informere administrator om endringer som må gjennomgås og godkjennes.  PhpGedView sender også disse informasjonsepostene ttil brukere som har bedt om konto.<br /><br />Normal vil &laquo;Fra:&raquo;-feltet i disse automatisk genererte epostene vær noe slikt som <i>Fra: phpgedview-noreply@dittnettsted</i> for å vise at svar på eposten ikke er forventet eller nødvendig.  For å verne mot spam eller annen misbruk av epost, vil noen epostsystemer kreve at hver melddings &laquo;Fra:&raquo;-felt faktisk er en gyldig epostkonto og vil ikke godta meldinger som kommer fra <i>phpgedview-noreply</i>.";
...
$pgv_lang["SUPPORT_METHOD_help"] 		= "Her velger du den måten besøkende kan få formidlet spørsmål til <b>Kontaktperson for teknisk hjelp</b> om nettstedet.  Linken for kontakt vil bli vist nederst på hver side.<dl><dt>Du har følgende valg:</dt><dd><b>Besøkende sitt eget e-post-program</b>. Besøkende må ha et e-post-program tilgjengelig på sin egen maskin.</dd><dd><b>PhpGedView interne beskjeder</b>. Dette bruker beskjedsystemet som er innebygd i PhpGedView, og det sender ingen ekstern e-post.</dd><dd><b>PhpGedView interne beskjeder med e-post-kopi</b>. Dette valget er standard og bruker beskjedsystemet som er innebygd i PhpGedView, men sender også kopi av beskjedene med e-post.</dd><dd><b>PhpGedView ekstern e-post</b>. Dette valget bruker beskjedsystemet som er innebygd i PhpGedView, men sender beskjedene med e-post uten å ta en kopi til det interne systemet.</dd><dd><b>Ingen kontaktlink</b>. Dette gjør at besøkende ikke kan kontakte deg.</dd></dl>";
$pgv_lang["SHOW_FACT_ICONS"] 		= "Vis faktaikoner";
$pgv_lang["SHOW_FACT_ICONS_help"]	= "Sett til <b>Ja</b> for å vise ikoner ved siden av faktanavn på Fakta og detaljer om personen siden.  Faktaikoner vil kun vises hvi de eksisterer i <i>images/facts</i>-katalogen som tilhører stilen som er i bruk.";
...
$pgv_lang["PGV_SMTP_ACTIVE_help"] = "Bruk SMTP for å sende epost fra PhpGedView.<br /><br />Dette valget krever tilgang til en SMTP eposttjener.  Når den er satt til <b>Nei</b> vil PhpGedView bruke epostsystemet som er innebygget i PHP på denne tjeneren.";
$pgv_lang["PGV_SMTP_HOST_help"] = "Dette er navnet på SMTP eposttjeneren.  Eksempel: <b>smtp.online.no</b>.";
$pgv_lang["PGV_SMTP_HELO_help"] = "Dette er domenedelen av en gyldig epostadresse på SMTP-tjeneren.<br /><br />For eksempel, hvis du har en epostkonto som <b>yourname@abc.xyz.com</b>, skal du skrive inn <b>abc.xyz.com</b> her.";
$pgv_lang["PGV_SMTP_PORT_help"] = "Portnummeret som skal benyttes for oppkoblinger til SMTP-tjeneren.  Normalt er dette port <b>25</b>.";
$pgv_lang["PGV_SMTP_AUTH_help"] = "Bruk navn og passord for å autentisere oppkobling til SMTP-tjener.<br /><br />De fleste SMTP-tjenere  krever at alle oppkoblinger blir autentisert før de vil godta utgående eposter.";
$pgv_lang["PGV_SMTP_AUTH_USER_help"] = "Brukernavnet som kreves for autentisering på SMTP-tjeneren.";
$pgv_lang["PGV_SMTP_AUTH_PASS_help"] = "Passordet for autentisering på SMTP-tjeneren.";
$pgv_lang["PGV_SMTP_FROM_NAME_help"] = "Skriv navnet som skal brukes i &laquo;Fra:&raquo;-feltet i eposter fra dette nettstedet.<br /><br />For eksempel, hvis du heter <b>Svere Hansen</b> og du er administrator for nettstedet kjent som <b>Sverres slektstre</b>, kan du skrive inn <b>Sverre Hansen</b> eller <b>Sverres slektstre</b> eller til og med <b>Sverre Hansen, Administrator for Sverres slektstre</b>.  Du kan skrive inn hva du vil, men HTML er ikke tillatt.";
$pgv_lang["gedcom_title"]				= "Tittel til Slektsbasen";
...
$pgv_lang["SHOW_LIVING_NAMES_help"]		= "Skal navn til nålevende personer vises til alle?";
...
$pgv_lang["USE_RELATIONSHIP_PRIVACY_help"]	= "'<b>Nei</b>' betyr at godkjente brukere kan se alle opplysninger til nålevende personer.<br />'<b>Ja</b>' betyr at brukere kan kun se privat informasjon om nålevende personer de er i slekt med.";
$pgv_lang["MAX_RELATION_PATH_LENGTH"]	= "Maks steglengde for slektskap";
$pgv_lang["MAX_RELATION_PATH_LENGTH_help"]	= "Dersom <b>Bruk personvern på slektskap</b> er aktiv, vil brukere som er logget inn bare kunne se og endre personer innenfor disse stegene for grad av slektskap.";
$pgv_lang["CHECK_MARRIAGE_RELATIONS"]	= "Sjekk ekteskapsbånd";
$pgv_lang["CHECK_MARRIAGE_RELATIONS_help"]	= "Sjekk slektninger gjennom ekteskapsrelasjoner.";
$pgv_lang["SHOW_DEAD_PEOPLE"]			= "Vis døde personer";
$pgv_lang["SHOW_DEAD_PEOPLE_help"]		= "Setter nivået for personvern for alle døde personer.";
$pgv_lang["select_privacyfile_button"]	= "Velg personvern-fil";
$pgv_lang["PRIVACY_BY_YEAR"]			= "Begrens personvern utfra dato i hendelse";
$pgv_lang["PRIVACY_BY_YEAR_help"]		= "Innstillingen for <i>Begrens personvern utfra dato i hendelse</i> vil skjule faktaopplysninger til personer basert på hvor gammel de var da hendelsen skjedde uavhengig av om de lever eller er døde.  Bruk denne  sammen med innstillingen \"Antatt maks levetid for en person\".<br /><br />Eksempel: Dersom du setter alderen til å være 100 og aktiverer denne innstilling ved å angi \"Ja\", så vil alle personer, levende eller døde, som er født mindre enn for 100 år siden, bli vist som Privat.<br />Personer som ble gift mindre enn for 85 år siden, og personer som døde for mindre enn 75 år siden, vil også bli vist som Privat.<br /><br /><b>NB!</b>  <i>Vær oppmerksom på at dersom du aktiviserer denne innstillingen, så vil tiden det tar å vise en side øke noe.</i>";
...
$pgv_lang["commit_google_help"]	= "Når du klikker på denne lenken, vil alle akkumulerte oversettelser som er gjennomført med Google&reg; Oversetter-systemer som ikke allerede er lagret bli lagret.<br /><br />Indikatoren viser framdriften på lagreprosessen.";
$pgv_lang["google_translate_help"]	= "Dette verktøyet bruker Google&reg; Oversetter som en hjelp for oversetteren.  Den er <b>ikke</b> ment å erstatte oversetelser gjort av en person som fult ut forstår kilden and mål-språket.    Vær også oppmerksom på at Google&reg; oversetterverktøy verken er til å stole på eller alltid i stand til å utføre en oversettelse.<br /><br />Når en språktekst ellere er oversatt, vil det ikke være noen lenke til Google&reg; Oversetter.<br /><br />For hver tekst du ønsker å bruke Google&reg; Oversetter på, må du klikke <b>Google&reg; Oversetter</b> lenken.  Etter at siden er lastet på nytt, bør du korrigere feiloversettelser for hånd. <b>Det er ingen garanti for at Google&reg; Oversetter er korrekt.</b> Du må korrigere spesialtegn som #, <, >, / og HTML-tagger og likeledes referanser til andre språk- eller globale variable i den oversatte teksten så resultatet matcher den originale uoversatte teksten.  Merk at Google&reg; Oversetter vil legge til et mellomrom etter hver HTML-tag.  Du må absolutt fjerne disse ekstra mellomrommene.<br /><br />Når du er fornøyd med resultatet, klikk <b>Bruk</b> for å lagre resultatet.  Hvis du ikke klikker <b>Bruk</b>, vil endringen blir akkumulert til du kilkker <b>Bruk Google&reg; oversatte endringer</b> lenken på bunnen av siden for å effektuere alle lagrede tekster på en gang.";

//-- language edit utility
$pgv_lang["lang_edit_help"]			= "Denne siden er først og fremst for oversettere.  Her kan du oversette, sammenligne og eksportere språkfiler.  Det er også et valg for å hjelpe oversettere for å sjekke tekst som PhpGedView lager.";
$pgv_lang["edit_langdiff"]				= "Språk / oversettelser";
$pgv_lang["bom_check"]					= "Sjekk av språkfilene (BOM)";
$pgv_lang["bom_check_help"]		= "Dette valget vil sjekke alle språkfilene om koden BOM (Byte Order Mark) finnes i filene. Disse tegnene som noen tekstbehandlere legger skjult i begynnelsen av filen, vil gjøre at PHP vise en feilmelding på toppen av hver side...<br />Dersom koden blir funnet, vil den bli fjernet.";
...
$pgv_lang["lang_debug_help"]	= "Når du aktivert dette valget, vil navnene til språk-variablene brukt i hjelpeteksten vises sammen med teksten i hjelpeviduet.<br />Dette kan hjelpe oversettere å finne det rette variabel-navnet som skal endres.<br /><br />Denne innstillingen vil ikke være aktivert neste gang du logger deg inn i PhpGedView.";
...
$pgv_lang["language_to_export_help"]		= "Her kan du velge det språket som skal brukes for å lage en dokumentasjon fra.<br /><br />Det er bare innholdet i filen <i>configure_help_xx.php</i> som eksporteres.  Det lages en fil (i HTML-format) som du kan se på og/eller skrive ut i nettleseren din.";
$pgv_lang["export_lang_utility"]		= "Eksport av språk-fil";
$pgv_lang["export"]						= "Eksporter";
$pgv_lang["export_lang_utility_help"]	= "Her kan du velge et språk og eksportere innholdet i hjelpe-tekst for konfigurasjon av PhpGedView<br />for å lage en dokumentasjon (i HTML-format) for programmet på det valgte språket.";
...
$pgv_lang["um_tool_help"] = "Dette verktøyet vil enten eksportere brukerdata fra SQL til Index-modus eller importere brukerdata fra Index-filer inn i SQL-tabeller.<br /><br />Brukerdata, favoritter, ramme-definisjoner, beskjeder og nyheter vil bli gjort tilgjengelig igjen etter at du har byttet modus.<br /><br /><b>ADVARSEL</b><br />Du kan ikke bruke dette verktøyet til å overføre brukerdata mellom ulike versjoner av PhpGedView.  Forsikre deg om at dataene stammer fra, eller er importert inn i den samme PhpGedView-versjonen.<br /><br /><b>IMPORTERE</b><br />Dersom du velger å importere brukerdata-filene fra Index-modus, vil eventuelle brukerdata som finnes fra før, bli <u>overskrevet</u>. Med andre ord så fletter <u>ikke</u> dette verktøyet informasjonen, men legger inn informasjonen på nytt. Når du er ferdig med importen, så er det ikke mulig å hente den gamle informasjonen igjen.<br /><br /><b>EKSPORTERE</b><br />Dersom du eksporterer brukerinformasjonen fra SQL-databasen din til Index-modu-filer, vil verktøyet lagre filen <i>authenticate.php</i> og flere <i>.dat</i> filer i index-mappen din. Dersom det finnes filer med samme navn fra før, vil du bli spurt om de skal overskrives. Etter at du har byttet til Index-modus, vil all informasjon være tilgjengelig direkte.<br /><br /><b>NB!</b> Etter at du har byttet til Index-modus, MÅ du importere GEDCOM-fil(ene) dine på nytt.";
$pgv_lang["um_sql_index_help"] = "Dette verktøyet vil lage filen <i>authenticate.php</i> og flere andre <i>.dat</i> filer i index-mappen din.<br /><br />Etter at filene er opprettet, kan du bytte til Index-database med alle registrerte brukere og bekjeden deres, favoritter, nyheter og MyGedview layout inntakt.<br /><br />NB! Etter at du har byttet til Index-database, må du importere GEDCOM-fil(ene) på nytt.";
$pgv_lang["um_index_sql_help"] = "Dette verktøyet vil importere filen <i>authenticate.php</i> og andre <i>.dat</i> filer fra index-mappen din inn i databasen din.";
...
$pgv_lang["um_bu_help"] 				= "Her kan du lage en sikkerhetskopi av forskjellige data i PhpGedView.<br /><br />Dataene som du velger å ta sikkerhetskopi av, vil bli samlet i en ZIP-fil,<br />som det også er mulig å laste ned (download) ved å klikke på valget nederst på siden, etter at sikkerhetskopieringen er utført.<br /><br />ZIP-filen vil forbli i Index-mappen din til du fjerner den manuellt.";
...
$pgv_lang["ged_filter_description_help"] = "Dette valget lar deg søke i teksten som er forbundet med konfigureringsvalgene.<br /><br />Når du skriver inn bokstaver, vil søket finne alle konfigurasjonsvalg som inneholder den rekkefølgen av bokstaver.  Søket blir mer presist ettehvert som du skriver flere bokstaver.";

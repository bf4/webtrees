...
$pgv_lang["pls_note07"]						= "~Felhasználó ellenőrzése~<br /><br />Kérem írja be a felhasználónevét, a jelszavát és az email-ben az ellenőrzéshez kapott aktiváló kódot.";
...
$pgv_lang["click_here_help"]					= "~Kattintson ide hogy folytassa~<br /><br />Kattintson erre a gombra hogy elmentse a változtatásokat.<br /><br />Vissza fog kerülni a Üdvözöljük vagy a MyGedView Portál oldalra, de a változtatásai lehet hogy még nem fognaklátsztani. Lehet hogy az oldalt frissítenie kell a változások megjelenítéséhez.";
$pgv_lang["block_summaries"]		= "~Leírás Blokk~<br /><br />Egy rövid leírás minden egyes blokkról amit a Üdvözöljük vagy a MyGedView Portál oldalra tud tenni.<br /><table border='1' align='center'><tr><td class='list_value'><b>Név</b></td><td class='list_value'><b>Leírás</b></td></tr>&nbsp;</table><br /><br />";

...
$pgv_lang["WELCOME_TEXT_AUTH_MODE_help"]		= "Here you can choose a text which will appear on the login screen when authentication mode is set to yes. Please try which predefined text is most appropriate.<br />You can also choose to enter your own custom welcome text, but this will not be translated in the language of your users.<br /><br />The predefined texts are:<br /><br /><b>Predefined text that states all users can apply for a user account :</b><br /><br /><center><b>Καλώς ήλθατε σε αυτό τον γενεαλογικό ιστοτόπο</b></center><br />Η πρόσβαση σε αυτή την τοποθεσία επιτρέπεται σε κάθε επισκέπτη που διαθέτει ένα λογαριασμό χρήστη.<br /><br />Εάν έχετε ένα λογαριασμό χρήστη, μπορείτε να συνδεθείτε σε αυτή τη σελίδα. Εάν δεν έχετε λογαριασμό χρήστη, μπορείτε να υποβάλετε αίτημα για έναν, επιλέγοντας το κατάλληλο σύνδεσμο παρακάτω.<br /><br />Μετά την επιβεβαίωση του αιτήματος σας, ο διαχειριστής της τοποθεσίας θα ενεργοποιήσει τον λογαριασμό σας. Θα λάβετε ένα email μόλις το αίτημα σας εγκριθεί.<br /><br /><b>Predefined text that states admin will decide if applied for a user account :</b><br /><br /><center><b>Καλώς ήλθατε σε αυτό τον γενεαλογικό ιστοτόπο</b></center><br />Η πρόσβαση σε αυτή την τοποθεσία επιτρέπεται μόνο σε <u>εγκεκριμένους</u> χρήστες.<br /><br />Εάν έχετε ένα λογαριασμό χρήστη, μπορείτε να συνδεθείτε σε αυτή τη σελίδα. Εάν δεν έχετε λογαριασμό χρήστη, μπορείτε να υποβάλετε αίτημα για έναν, επιλέγοντας το κατάλληλο σύνδεσμο παρακάτω.<br /><br />Μετά την επιβεβαίωση του αιτήματος σας, ο διαχειριστής της τοποθεσίας είτε θα εγκρίνει τον λογαριασμό σας είτε θα απορρίψει το αίτημα σας. Θα λάβετε ένα email μόλις το αίτημα σας εγκριθεί.<br /><br /><b>Predefined text that states only family members can apply for a user account :</b><br /><br /><center><b>Καλώς ήλθατε σε αυτό τον γενεαλογικό ιστοτόπο</b></center><br />Η πρόσβαση σε αυτή την τοποθεσία επιτρέπεται <u>μόνο σε μέλη της οικογένειας</u>.<br /><br />Εάν έχετε ένα λογαριασμό χρήστη, μπορείτε να συνδεθείτε σε αυτή τη σελίδα. Εάν δεν έχετε λογαριασμό χρήστη, μπορείτε να υποβάλετε αίτημα για έναν, επιλέγοντας το κατάλληλο σύνδεσμο παρακάτω.<br /><br />Μετά την επιβεβαίωση του αιτήματος σας, ο διαχειριστής της τοποθεσίας είτε θα εγκρίνει τον λογαριασμό σας είτε θα απορρίψει το αίτημα σας. Θα λάβετε ένα email μόλις το αίτημα σας εγκριθεί.";
...
$pgv_lang["WELCOME_TEXT_AUTH_MODE_CUST_HEAD_help"]	= "Choose to display a (multilingual) header for your custom welcome text.<br /><br />If set to yes, the header will look look this:<br /><br /><center><b>Καλώς ήλθατε σε αυτό τον γενεαλογικό ιστοτόπο</b></center><br />Η πρόσβαση επιτρέπεται σε χρήστες που έχουν λογαριασμό και κωδικό για αυτή την τοποθεσία.<br />";

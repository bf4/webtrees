...
$pgv_lang["DBTYPE_help"]		= "Typ podporované PEAR databáze, k níž se má připojit. Možnosti jsou: MySQL, PostgreSQL, Oracle a SQLite.";
$pgv_lang["DBHOST"]			= "Host databáze";
$pgv_lang["DBHOST_help"]		= "DNS nebo IP adresa počítače, na němž je nainstalován váš databázový server.";
$pgv_lang["DBUSER"]			= "Uživatelské jméno k databázi";
$pgv_lang["DBUSER_help"]		= "Ke vstupu do vaší databáze je vyžadováno uživatelské jméno databáze.";
$pgv_lang["DBPASS"]			= "Heslo k databázi";
$pgv_lang["DBPASS_help"]		= "Heslo k databázi pro uživatele, jehož uživatelské jméno jste zadali do políčka Uživatelské jméno.";
$pgv_lang["DBNAME"]			= "Jméno databáze";
$pgv_lang["DBNAME_help"]		= "Databáze na vašem serveru, kterou má PhpGedView použít. Uživatel, jehož uživatelské jméno jste zadali do políčka, musí mít práva vytvořit, vložit, obnovit, smazat a vybrat z databáze.";
$pgv_lang["TBLPREFIX"]			= "Prefix před názvy tabulek v databázi";
$pgv_lang["TBLPREFIX_help"]		= "Prefix připisovaný do názvů tabulek vytvořených aplikací PhpGedView.  Změnou této hodnoty můžete zajistit užívání jedné databáze více aplikacemi PhpGedView, ale každá bude používat vlastní tabulky.";
...
$pgv_lang["JEWISH_ASHKENAZ_PRONUNCIATION_help"]	= "Použít židovskou výslovnost \"Ashkenazi\".<br />Jestliže je tato hodnota nastavena na \"ano\", pro měsíce Cheshvan a Teves bude použita výslovnost \"Ashkenazi\". Nastavíte-li hodnotu na \"ne\", budou měsíce změněny na Hesvan and Tevet. <br />Toto má vliv jen na židovské nastavení. Zvolíte-li hebrejské nastavení, bude použita hebrejská abeceda.";
...
$pgv_lang["WELCOME_TEXT_AUTH_MODE_help"]	= "Zde můžete zvolit text, který se objeví na přihlašovací stránce, je-li autentifikační mód nastaven na ano. Prosím, vyberte nejvhodnější přednastavený text.<br />Můžete zadat i svůj vlastní text, ale ten nebude mít překlad do jiných jazyků.<br /><br />Přednastavené texty jsou:<br /><br /><b>Přednastavený text, jenž říká, že všichni uživatelé mohou zažádat o zřízení uživatelského účtu :</b><br /><br /><b>VÍTEJTE NA TĚCHTO RODOPISNÝCH STRÁNKÁCH</b><br /><br />Přístup na tyto stránky je povolen všem návštěvníkům, kteří zde mají zřízený účet.<br />Jestliže zde již máte svůj účet, můžete se na této stránce přihlásit.<br /><br />Pokud ještě účet nemáte, můžete o něj požádat kliknutím na příslušný odkaz na této stránce.<br />Po ověření zadaných údajů vám administrátor účet zpřístupní.<br />Oznámení o zpřístupnění obdržíte e-mailem.<br /><br /><b>Přednastavený text, jenž říká, že admin rozhodne v případě žádosti o účet :</b><br /><br /><b>VÍTEJTE NA TĚCHTO RODOPISNÝCH STRÁNKÁCH</b><br /><br />Přístup na tyto stránky je umožněn pouze <b>přihlášeným</b> uživatelům.<br />Jestliže zde již máte svůj účet, můžete se na této stránce přihlásit.<br /><br />Pokud ještě účet nemáte, můžete o něj požádat kliknutím na příslušný odkaz na této stránce.<br />Po ověření zadaných údajů administrátor vaši žádost buď přijme, nebo odmítne.<br />Oznámení o přijetí své žádosti obdržíte e-mailem.<br /><br /><b>Přednastavený text, jenž říká, že o zřízení uživatelského účtu mohou žádat pouze členové rodiny :</b><br /><br /><b>VÍTEJTE NA TĚCHTO RODOPISNÝCH STRÁNKÁCH</b><br /><br />Přístup na tyto stránky je povolen pouze <b>členům rodiny</b>.<br />Jestliže zde již máte svůj účet, můžete se na této stránce přihlásit.<br /><br />Pokud ještě účet nemáte, můžete o něj požádat kliknutím na příslušný odkaz na této stránce.<br />Po ověření zadaných údajů administrátor vaši žádost buď přijme, nebo odmítne.<br />Oznámení o přijetí své žádosti obdržíte e-mailem.";
...
$pgv_lang["WELCOME_TEXT_AUTH_MODE_CUST_HEAD_help"] = "Zvolte tuto možnost, chcete-li mít před svým vlastním úvodním textem vícejazyčnou hlavičku.<br /><br />Je-li nastaveno na ano, hlavička bude vypadat takto:<br /><br /><b>VÍTEJTE NA TĚCHTO RODOPISNÝCH STRÁNKÁCH</b><br /><br />Přístup na tyto stránky je umožněn pouze uživatelům, kteří zde mají zřízený svůj uživatelský účet s heslem.";
...
$pgv_lang["INDEX_DIRECTORY_help"]	= "Cesta k čitelné a zapisovatelné složce, do níž by mělo PhpGedView ukládat \"Index soubory\" (včetně lomítka \"/\")";
...
$pgv_lang["SERVER_URL_help"]		= "Jestliže používáte https nebo jiný port než implicitní, budete sem muset vložit URL pro přístup sem na váš server.";
...
$pgv_lang["PGV_SESSION_TIME_help"]	= "Čas, udaný v sekundách, po který zůstávají sessions PhpGedView aktivní před vyžádáním přihlášení.  Implicitní je 30 minut.";
...
$pgv_lang["ALLOW_USER_THEMES_help"]	= "Umožnit uživatelům vybrat si vlastní motiv.";
$pgv_lang["PGV_SIMPLE_MAIL"] = "V externích e-mailech používat jednoduché e-mailové hlavičky";
$pgv_lang["PGV_SIMPLE_MAIL_help"] = "V normálních e-mailových hlavičkách v externích e-mailech je použita jak e-mailová adresa, tak jméno. Některé e-mailové systémy tuto formu nepřijímají. Zvolíte-li ano, použije se pouze e-mailová adresa.";
...
$pgv_lang["LOGFILE_CREATE_help"]	= "Jak dlouho by měl program archivovat log soubory.";
$pgv_lang["PGV_MEMORY_LIMIT"]		= "Maximální velikost paměti";
$pgv_lang["PGV_MEMORY_LIMIT_help"]	= "Maximální velikost paměti, kterou mohou zaplnit skripty PhpGedView.  Implicitní hodnota je 16M.  Mnoho hostingů tuto volbu vypíná ve svém nastavení PHP, takže změna této hodnoty nemusí ve skutečnosti ovlivnit nastavení velikosti paměti.";
$pgv_lang["PGV_STORE_MESSAGES"]		= "Umožnit online ukládání zpráv:";
$pgv_lang["PGV_STORE_MESSAGES_help"]	= "Určuje, jestli mohou být zprávy poslané přes PhpGedView ukládány do databáze.  Jestliže je nastaveno 'Ano', pak budou moci uživatelé dostávat zprávy, když se přihlásí do PhpGedView.  Jestliže je nastaveno 'Ne', pak se budou zprávy odesílat pouze e-mailem.";
$pgv_lang["ALLOW_THEME_DROPDOWN"]		= "Zobrazit rolovací menu pro změnu motivu";
$pgv_lang["ALLOW_THEME_DROPDOWN_help"]	= "Umožňuje uživateli zvolit si vlastní motiv.<br />z rolovacího menu (je-li zabudováno v aktuálním motivu)<br />ALLOW_USER_THEMES musí být taktéž nastaveno na ano.";
$pgv_lang["META_AUTHOR"]		= "META tag o autorovi";
$pgv_lang["META_AUTHOR_help"]	= "Hodnota, která má být v hlavičce HTML stránky zapsána do meta tagu o autorovi. Ponechte prázdné, chcete-li zde použít celé jméno kontaktního uživatele.";
...
$pgv_lang["META_PUBLISHER_help"]	= "Hodnota, jež se má zapsat do meta tagu o vydavateli v hlavičce HTML stránky. Ponechte toto políčko prázdné, chcete-li, aby bylo použito celé jméno kontaktního uživatele.";
...
$pgv_lang["META_COPYRIGHT_help"]	= "Hodnota, která se zapsat do meta tagu o copyrightu v hlavičce HTML stránky. Ponechte toto políčko prázdné, chcete-li, aby bylo použito celé jméno kontaktního uživatele.";
...
$pgv_lang["META_DESCRIPTION_help"]	= "Hodnota, která se má v hlavičce HTML stránky zapsat do meta tagu s popisem. Ponechte políčko prázdné, chcete-li, aby byl použit nynější nadpis tohoto GEDCOMu.";
...
$pgv_lang["META_PAGE_TOPIC_help"]	= "Hodnota, která se má v hlavičce HTML stránky zapsat do meta tagu popisující tematické zaměření stránky. Ponechte políčko prázdné, chcete-li, aby byl použit nynější nadpis tohoto GEDCOMu.";
...
$pgv_lang["META_AUDIENCE_help"]	= "Hodnota, která se má v hlavičce HTML stránky zapsat do meta tagu popisující skupinu lidi, pro niž jsou stránky určeny.";
$pgv_lang["META_PAGE_TYPE"]		= "META tag typu stránky";
$pgv_lang["META_PAGE_TYPE_help"]	= "Hodnota, která se má v hlavičce HTML stránky zapsat do meta tagu popisující typ stránky.";
$pgv_lang["META_ROBOTS"]		= "META tag robotů";
$pgv_lang["META_ROBOTS_help"]	= "Hodnota, která se má v hlavičce HTML stránky zapsat do meta tagu pro roboty. Mnoho roborů toto nastavení ignoruje.";
$pgv_lang["META_REVISIT"]		= "Jak často by měl webový pavouk kontrolovat META tag";
$pgv_lang["META_REVISIT_help"]	= "Hodnota, jež se má zapsat do hlavičky HTML stránky do meta tagu revize. Mnoho webových pavouků tuto hodnotu ignorují.";
...
$pgv_lang["META_TITLE_help"]	=	"Cokoliv vepíšete do tohoto řádku, bude přidáno do nadpisu HTML stránky mezi řádný nadpis a slovo PhpGedView.";
$pgv_lang["welcome_new"]			= "Vítejte na svých nových stránkách v PhpGedView. Úspěšně jste nainstalovali PhpGedView (jinak byste neviděli tuto stránku), a tak se můžete pustit do nastavování systému podle vašich potřeb.";
...
$pgv_lang["review_readme"]	= "Dříve, než budete pokračovat v konfiguraci PhpGedView, měli byste si pročíst soubor <a href=\"readme.txt\" target=\"_blank\">readme.txt</a>.";
...
$pgv_lang["general_privacy_help"]		= "<b>Obecné nastavení privátnosti.</b><br />Toto nastavení bude vašim implicitním nastavením pro konkrétní GEDCOM.<br />Podívejte se pod titulek stránky, abyste si ověřili, že upravujete správný GEDCOM.<br /><br />To zároveň znamená, že pro každý GEDCOM (máte-li více než jeden) ve vašem PhpGedView můžete mít zvláštní nastavení.<br /><br />Toto obecné nastavení můžete \"přebít\" použitím dalších formulářů privátnosti na stránce Upravit nastavení privátnosti v GEDCOMu.<br /><br /><b>Další nápověda</b><br />Další nápověda je k dispozici z formuláře.<br />Klikněte prosím na <b>?</b> za popisky.";
...
$pgv_lang["SHOW_LIVING_NAMES_help"]		= "Zobrazit jména žijících osob<br /><br />Jména žijících osob by měla být zobrazována veřejně.";
$pgv_lang["USE_RELATIONSHIP_PRIVACY_help"]	= "Použít příbuzenskou privátnost<br /><br />Hodnota 'Ne' znamená, že autentifikovaní uživatelé uvidí data všech žijících osob.<br />Hodnota 'Ano' znamená, že uživatelé si budou moci prohlížet soukromá data pouze svých příbuzných.";
$pgv_lang["MAX_RELATION_PATH_LENGTH_help"]	= "Max. příbuzenská vzdálenost.<br /><br />Je-li volba #pgv_lang[USE_RELATIONSHIP_PRIVACY] zapnuta, přihlášení uživatelé si budou moci prohlížet a upravovat údaje u osob maximálně do této příbuzenské vzdálenosti.";
$pgv_lang["CHECK_MARRIAGE_RELATIONS_help"]	= "Zkontrolovat sňatkové vztahy<br /><br />Zkontrolovat příbuznost sňatkem.";
$pgv_lang["SHOW_DEAD_PEOPLE_help"]		= "Zobrazit jména mrtvých osob<br /><br />Nastavit soukromý přístup ke všem mrtvým lidem";
$pgv_lang["person_privacy_help"]		= "<b>Položka privátního nastavení.</b><br />Toto nastavení umožňuje administrátorům přepsat implicitní nastavení konkrétní osoby v GEDCOMu. Předpokládejme například, že jste měli dítě, které zemřelo v útlém věku. Normálně, poněvadž je to dítě mrtvé, by byly údaje o něm přístupné všem uživatelům. Ale informace o vás a všech ostatních z vaší rodiny jsou ještě soukromé. Nechcete odstranit záznam o úmrtí dítěte; chcete tyto údaje zařadit mezi soukromé. Jestliže mělo ID tohoto dítěte bylo I100, měli byste zadat následující privátní nastavení: <br /><br />ID: I100<br />Komu ukázat: \"Ukázat jen autentifikovaným uživatelům\"<br /><br />Obdobný postup můžeme použít v jiném případě. Kdybychom chtěli zveřejnit údaje o někom (ID 101), o kom bychom věděli, že již nežije, ale neměli bychom datum jeho úmrtí, mohli bychom to udělat následovně:<br /><br />ID: I101<br />Komu ukázat: \"Ukázat veřejně\"";

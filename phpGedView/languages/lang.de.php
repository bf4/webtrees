...
$pgv_lang["review_changes_descr"]	= "Der &laquo;Offene Änderungen&raquo; Block zeigt Benutzern mit Editierrechten eine Liste der Datensätze die online geändert wurden und die noch kontrolliert und übernommen bzw. verworfen werden müssen.<br /><br />Wenn dieser Block aktiviert ist, erhalten alle Benutzer mit Editierrechten täglich eine Mail, die auf offene Änderungen hinweist.";
...
$pgv_lang["gedcom_downloadable"] 	= "Diese GEDCOM Datei könnte über das Internet heruntergeladen werden!<br />Bitte lesen Sie im Bereich &laquo;SECURITY&raquo; der Datei <a href=\"readme.txt\"><b>readme.txt</b></a> nach, wie Sie dieses Problem lösen können.";
...
$pgv_lang["updating_is_dead"]                        = "Der &laquo;Verstorben&raquo; Status aller Personen wird aktualisiert";
...
$pgv_lang["tools_readme"]                        = "Bitte lesen Sie in der Datei README.TXT das Kapitel &laquo;Tools&raquo; für weitere Informationen.";
$pgv_lang["sec"]                                = "s";
...
$pgv_lang["accept_gedcom"]              = "Entscheiden Sie für jede Änderung, ob Sie sie übernehmen oder verwerfen möchten.<br /><br />Um alle Änderungen auf einmal zu übernehmen, klicken Sie <b>&laquo;Alle Änderungen übernehmen&raquo;</b> in der Box unten.<br />Weitere Informationen über eine Änderung erhalten Sie über den Link <b>&laquo;Änderungen ansehen&raquo;</b> oder klicken Sie <b>&laquo;GEDCOM Datensatz ansehen&raquo;</b>, um die veränderte GEDCOM Datei anzusehen.";
...
$pgv_lang["mail04_line05"]			= "Um Ihr Passwort, nachdem Sie sich angemeldet haben zu ändern, wählen Sie die &laquo;#pgv_lang[myuserdata]#&raquo; Verbindung innerhalb des &laquo;#pgv_lang[mygedview]#&raquo; Menüs und tragen Sie dann in beiden Passwort Feldern das neue Passwort ein.";
...
$pgv_lang["upcoming_events_descr"]        = "Der &laquo;Bevorstehende Ereignisse&raquo; Block zeigt eine Liste von Daten aus der Datenbank an, die sich in den kommenden Tagen jähren.<br /><br />Sie können für Ihre Portal Seite den Umfang dieses Blocks kontrollieren.  Der Verwalter tut das Gleiche für die Begrüßungs Seite.";
$pgv_lang["todays_events_block"]        = "An diesem Tag";
$pgv_lang["todays_events_descr"]        = "Der &laquo;An diesem Tag&raquo; Block zeigt eine Liste von Daten aus der Datenbank an, die sich heute jähren.<br /><br />Sie können für Ihre Portal Seite den Umfang dieses Blocks kontrollieren.  Der Verwalter tut das Gleiche für die Begrüßungs Seite.";
$pgv_lang["logged_in_users_block"]        = "Angemeldete Benutzer";
$pgv_lang["logged_in_users_descr"]        = "Der &laquo;Angemeldete Benutzer&raquo; Block zeigt eine Liste der Personen, die derzeit auf dieser Webseite angemeldet sind.";
$pgv_lang["user_messages_block"]        = "Benutzer Nachrichten";
$pgv_lang["user_messages_descr"]        = "Der &laquo;Benutzer Nachrichten&raquo; Block zeigt eine Liste von Nachrichten an, die der aktuelle Benutzer erhalten hat.";
$pgv_lang["user_favorites_block"]        = "Benutzer Lesezeichen";
$pgv_lang["user_favorites_descr"]        = "Der &laquo;Lesezeichen&raquo; Block zeigt dem Benutzer eine Liste der von ihm als wichtig angesehenen Personen in der Datenbank an, deren Daten er so schneller wieder auffinden kann.";
$pgv_lang["welcome_block"]                = "Willkommen";
$pgv_lang["welcome_descr"]                = "Der &laquo;Willkommen&raquo; Block zeigt dem Benutzer das aktuelle Datum und die Uhrzeit, Links zur Änderung der Benutzereinstellung und zu seiner eigenen Stammbaumansicht und auch einen Link zur Anpassung seiner Mein GedView Seite.";
$pgv_lang["random_media_block"]                = "Zufälliges Bild";
$pgv_lang["random_media_descr"]                = "Der &laquo;Zufälliges Bild&raquo; Block wählt bei jedem Aufruf zufällig ein Bild aus der Datenbank aus und zeigt es an.<br /><br />Der Verwalter kontrolliert die Art der Medien Objekte die hier angezeigt werden können.";
...
$pgv_lang["gedcom_descr"]                = "Der &laquo;GEDCOM Willkommen&raquo; Block ist equivalent zum &laquo;Willkommen&raquo; Block indem er dem Benutzer den Titel der aktuellen Datei, sowie Datum und Uhrzeit anzeigt.";
$pgv_lang["gedcom_favorites_block"]        = "GEDCOM Lesezeichen";
$pgv_lang["gedcom_favorites_descr"]        = "Der &laquo;GEDCOM Lesezeichen&raquo; Block gibt dem Verwalter die Möglichkeit, wichtige Personen der Datenbank als Lesezeichen einzutragen, so dass die Besucher sie leichter finden können.";
$pgv_lang["gedcom_stats_block"]                = "GEDCOM Statistiken";
$pgv_lang["gedcom_stats_descr"]                = "Der &laquo;GEDCOM Statistiken&raquo; Block zeigt dem Besucher einige Informationen über die GEDCOM Datei, z.B. wann sie erstellt wurde und wie viele Personen sie umfasst.<br /><br />Es kann auch eine Liste der am häufigsten vorkommenden Namen angezeigt werden. Zu dieser Liste können Namen hinzugefügt oder daraus Namen unterdrückt werden. Der Häufigkeitswert, ab wann ein Name in dieser Liste auftaucht, kann in der GEDCOM Konfiguration eingestellt werden.";
...
$pgv_lang["login_descr"]                = "Der &laquo;Login&raquo; Block ermöglicht Benutzern das Anmelden auf dieser Seite.";
$pgv_lang["theme_select_block"]         = "Theme Auswahl";
$pgv_lang["theme_select_descr"]         = "Der &laquo;Theme Auswahl&raquo; Block zeigt die Themenauswahl Liste an - auch dann, wenn der Wechsel des Themes eigentlich deaktiviert ist.";
...
$pgv_lang["user_news_descr"]                = "Der &laquo;Benutzer Journal&raquo; Block ermöglicht dem Benutzer Notizen oder ein Journal online zu verwalten.";
...
$pgv_lang["recent_changes_descr"]        = "Der &laquo;Neueste Änderungen&raquo; Block listet alle Änderungen, die an der GEDCOM Datei in der letzten Zeit vorgenommen wurden. Dieser Block kann Ihnen helfen, diese jüngsten Veränderungen zu verfolgen. Die Änderungen werden automatisch anhand des &laquo;CHAN&raquo; tags erkannt.";
...
$pgv_lang["stpl"]			 	= "...";
$pgv_lang["stplGDno"]			 = "Die &laquo;Graphics Display Library&raquo; ist in PHP4 nicht verfügbar. Bitte wenden Sie sich an Ihren System Verwalter.";
$pgv_lang["stpljpgraphno"]		= "Die &laquo;JPgraph&raquo; Module befinden sich nicht im Verzeichnis <i>phpgedview/jpgraph/</i>. Bitte laden Sie diese von http://www.aditus.nu/jpgraph/jpdownload.php herunter<br /> <h3>Danach müssen Sie die heruntergeladenen JPgraph Module ins Verzeichnis <i>phpgedview/jpgraph/</i> kopieren</h3>.<br />";
...
$pgv_lang["error_server_exists"]    = "Die Internetseite die Sie einfügen möchten, existiert bereits; bitte wählen Sie diese in der Rubrik &laquo;Existierende Seite benutzen&raquo;.";

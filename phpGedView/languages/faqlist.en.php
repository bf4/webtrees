...
$faqlist["FAQ_030_HEBNAME"] = "<u>HEBREW NAME</u> is a Hebrew translation of the person's name in Latin letters. No person can have more than one Hebrew name. PhpGedView expects you to enclose the surname in slashes. The name ???? ??? would be entered as ???? /???/.";
...
$faqlist["FAQ_030_NAMES2"] = "The <i>Edit Name</i> option, found below the person's name on the Personal Details page, allows you to edit any aspect of the individual's name. The <i>Delete Name</i> option, also found below the person's name, lets you remove the name from the person's information in the database without removing or changing anything else.  You can add more names to the person's information in the database by clicking the <i>Add new Name</i> option in the <i>Edit</i> sub-menu of the <i>Options for individual</i> menu.  More information can be obtained by clicking the Help icon associated with these options."; 

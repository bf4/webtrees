...
$faqlist["FAQ_017_body"] = "With the PhpGedView you can:<ul><li>Keep privacy of living people; the webmaster determines whom you can see.</li><li>Enjoy many possibilities to view the tree: as different charts, reports, or lists.</li><li>It's a collaborative tree; with the Webmaster's permission, everyone can take part in updating the tree.</li></ul>";
...
$faqlist["FAQ_027_body"] = "In order to see details (only of your close branches), you must be a part of the tree, and you must inform the Webmaster/Genemaster by email.";
...
$faqlist["FAQ_030_HELP"] = "<strong>HELP</strong>: It is amply provided on the site, in the header and elsewhere behind most links and terms with the \"?\" image. If you are still confused, simply ask us via email.";
...
$faqlist["FAQ_030_PLACES3"] = "There are two helpful methods of acquiring a place's correct format:<br /><ul><li>use the tiny \"world\" icon adjacent to the place field to see what places are already entered in our database. This is a good way to look up a city's county if you don't know it as it probably already exists in our data. Use the filter to narrow your search and simply click on the desired result which will then be copied to the empty PLAC field,</li><li>click on the + sign below the PLACE entry window. You will see a series of fields for country, state/province, county, city. Next to the country field is a drop down list of countries with their standard 3-letter designation.</li></ol>";
$faqlist["FAQ_030_PLACES4"] = "There are two helpful methods of acquiring a place's correct format:<br /><ul><li>use the tiny \"world\" icon adjacent to the place field to see what places are already entered in our database. This is a good way to look up a city's county if you don't know it as it probably already exists in our data. Use the filter to narrow your search and simply click on the desired result which will then be copied to the empty PLAC field,</li><li>click on the + sign below the PLACE entry window. You will see a series of fields for country, state/province, county (N/A), city. Next to the country field is a drop down list of countries with their standard 3-letter designation that we do not use.</li></ol>";
...
$faqlist["FAQ_030_PREFIX"] = "Name <u>PREFIXes</u> are usually titles or honorifics such as Dr, Rabbi, Hon, Judge, etc.";
...
$faqlist["FAQ_030_SURNAME"] = "<u>SURNAME</u> is the family or last name. This is the <u>maiden name</u> for a married woman, not her new married surname. See <i>married name</i> below.";
...
$faqlist["FAQ_030_NICKNAME"] = "<u>NICKNAME</u> is the name commonly used for the person if different from their GIVN name; e.g. <i>Jack</i> would be the nickname of John \"Jack\" Arnold, Daniel Wilson Avery had the nickname <i>Tuggy</i>, and many Margarets have the nickname <i>Maggie, Nancy, Peggy, Polly</i>, etc.";
...
$faqlist["FAQ_030_AKANAME"] = "<u>AKA NAME</u> is an additional name the person is known by. It could be the birth name of persons who changed their name later in life or it could be an alias, stage or pen name. It could also be a married name. The first name can be different from the first name of the main NAME. PhpGedView expects you to fill the surname in slashes. The name <i>James Adams</i> would be filled as <i>James /Adams/</i>. Additional Hebrew names or Yiddish names are also filled as AKA NAMEs.";
$faqlist["FAQ_030_MARRNAME"] = "<u>MARRIED NAMES</u> are the female's new name when assuming her spouse's SURN (surname). It is auto-created by the program when you enter her new surname in the Married Name field. i.e. <i>Mary Jane Smith</i> marries <i>John Jones</i> and becomes <i>Mary Jane Jones</i> when you enter <i>Jones</i> in the Married Surname field.";

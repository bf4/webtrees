...
$pgv_lang["pls_note07"]							= "~Επαλήθευση χρήστη~<br /><br />Για να επιβεβαιώσετε την αίτηση λογαριασμού που κάνατε, παρακαλώ πληκτρολογήστε το όνομα χρήστη, τον κωδικό σας και τον κωδικό επαλήθευσης που λάβατε με email.";
...
$pgv_lang["click_here_help"]		= "~Συνέχεια~<br /><br />Επιλέξτε αυτό το πλήκτρο για να αποθηκεύσετε τις αλλαγές.<br /><br />Θα επιστραφείτε στην σελίδα Καλωσόρισες ή Ατομική πύλη, αλλά οι αλλαγές μπορεί να μην εμφανιστούν. Μπορεί να χρειαστεί να χρησιμοποιήσετε τη λειτουργία Ανανέωση σελίδας στον φυλλομετρητή σας, για να προβάλετε τις αλλαγές σωστά.";
$pgv_lang["block_summaries"]		= "~Πλαίσιο περιγραφών~<br /><br />Εδώ υπάρχει μια σύντομη περιγραφή του κάθε πλαισίου που μπορείτε να τοποθετήσετε στη σελίδα Καλωσόρισες ή Ατομική πύλη.<br /><table border='1' align='center'><tr><td class='list_value'><b>Όνομα</b></td><td class='list_value'><b>Περιγραφή</b></td></tr>&nbsp;</table><br /><br />";

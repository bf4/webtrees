...
$pgv_lang["pls_note07"]							= "Για να επιβεβαιώσετε την αίτηση λογαριασμού που κάνατε, παρακαλώ πληκτρολογήστε το όνομα χρήστη, τον κωδικό σας και τον κωδικό επαλήθευσης που λάβατε με email.";
...
$pgv_lang["welcome_text_cust_head"]				= "<center><b>Καλώς ήλθατε σε αυτό τον γενεαλογικό ιστοτόπο</b></center><br />Η πρόσβαση επιτρέπεται σε χρήστες που έχουν λογαριασμό και κωδικό για αυτή την τοποθεσία.";
//-- mygedview page
...
$pgv_lang["no_favorites"]						= "Δεν έχετε επιλεγμένα κάποια αγαπημένα.<br /><br />Για να προσθέσετε ένα άτομο, μια οικογένεια ή μια πηγή στα αγαπημένα σας, κάντε κλικ στο σύνδεσμο <b>Προσθήκη νέου αγαπημένου</b> ώστε να αποκαλυφθούν κάποια πεδία όπου μπορείτε να εισάγετε ή να αναζητήσετε ένα αριθμό ID. Αντί αριθμού ID, μπορείτε να εισάγετε ένα URL και ένα τίτλο.";
...
$pgv_lang["mail04_line05"]			= "Αφού συνδεθείτε, επιλέξτε το σύνδεσμο «Ο λογαριασμός μου» κάτω από το μενού «Ατομική πύλη» και συμπληρώστε τα πεδία κωδικών για να αλλάξετε τον κωδικό σας.";
...
$pgv_lang["recent_changes_none"]	= "<b>Δεν υπάρχουν αλλαγές κατά τις τελευταίες #pgv_lang[global_num1]# ημέρες.</b>";
$pgv_lang["recent_changes_some"]	= "<b>Αλλαγές κατά τις τελευταίες #pgv_lang[global_num1]# ημέρες</b>";
...
$pgv_lang["click_here_help"]		= "Επιλέξτε αυτό το πλήκτρο για να αποθηκεύσετε τις αλλαγές.<br /><br />Θα επιστραφείτε στην σελίδα Καλωσόρισες ή Ατομική πύλη, αλλά οι αλλαγές μπορεί να μην εμφανιστούν. Μπορεί να χρειαστεί να χρησιμοποιήσετε τη λειτουργία Ανανέωση σελίδας στον φυλλομετρητή σας, για να προβάλετε τις αλλαγές σωστά.";
$pgv_lang["block_summaries"]		= "Εδώ υπάρχει μια σύντομη περιγραφή του κάθε πλαισίου που μπορείτε να τοποθετήσετε στη σελίδα Καλωσόρισες ή Ατομική πύλη.<br /><table border='1' align='center'><tr><td class='list_value'><b>Όνομα</b></td><td class='list_value'><b>Περιγραφή</b></td></tr>&nbsp;</table>";

...
##$pgv_lang["add_fav_or_enter_url"]	= "OR<br />Enter a URL and a title";
...
##$pgv_lang["mail04_line05"]			= "After you have logged in, select the «Moj nalog» link under the «Moj portal» menu and fill in the password fields to change your password.";
...
$pgv_lang["welcome_text_cust_head"] 	= "<center><b>Dobrodošli na Rodoslov bratstva Damjanci</b></center><br />Pristup podacima živih osoba u rodoslovu imaju samo prijavljeni korisnici sa lozinkom.";
...
##$pgv_lang["no_favorites"]			= "You have not selected any favorites.<br /><br />To add an individual, a family, or a source to your favorites, click on the <b>Dodaj novu omiljenu/često posećivanu stranicu</b> link to reveal some fields where you can enter or search for an ID number.  Instead of an ID number, you can enter a URL and a title.";
...
##$pgv_lang["click_here_help"]		= "Click this button to save your changes.<br /><br />You will be returned to the Dobrodošli or Moj portal page, but your changes may not be shown.  You may need to use the Page Reload function of your browser to view your changes properly.";
##$pgv_lang["block_summaries"]		= "Here is a short description of each of the blocks you can place on the Dobrodošli or Moj portal page.<br /><table border='1' align='center'><tr><td class='list_value'><b>Ime</b></td><td class='list_value'><b>Opis</b></td></tr>&nbsp;</table>";
...
$pgv_lang["no_favorites"]			= "Niste izabrali nijednu omiljenu stranicu ili upis.<br /><br />Da dodate pojedinačni upis, upis porodice, ili izvora podataka kliknite na <b>Dodaj novu omiljenu/često posećivanu stranicu</b> link da vam se otvore polja gde ih možete uneti ili ih pretraživati da nađete njihov identifikacioni broj. Umesto identifikacionog broja možete uneti URL ili naslov traženog parametra.";

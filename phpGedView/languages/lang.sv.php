...
$pgv_lang["pls_note07"]			= "~Användarverifiering~<br /><br />Skriv in ditt användarnamn, lösenord och verifieringskoden som du fick via e-post från systemet för att aktivera ditt konto.";
...
$pgv_lang["mail04_line05"]			= "Efter att du logat in, välj 'Mitt konto'-länken under 'Min GedViewPortal'-menyn, fyll i lösenordsfälten för att ändra dit lösenord.";
...
$pgv_lang["click_here_help"]	= "~Klicka här för att fortsätta~<br /><br />Klicka på denna knapp för att spara dina ändringarna.<br /><br />Du kommer att returneras till Välkommen eller Min GedViewPortal-sidan, men ändringar kanske inte syns. Du kan behöva att ladda om sidan för att den ska visa sidan korrekt.";
$pgv_lang["block_summaries"]	= "~Områdesbeskrivning~<br /><br />Här är en kort beskrivning för varje område som du kan placera på Välkommen eller Min GedViewPortal sidan.<br /><table border='1' align='center'><tr><td class='list_value'><b>Namn</b></td><td class='list_value'><b>Beskrivning</b></td></tr>&nbsp;</table><br /><br />";

...
$pgv_lang["click_here_help"]		= "~Devam etmek için burayı tıkla~<br /><br />Değişikliklerinizi kurtarması için bu düğmeyi tıklayın.<br /><br />Hoş geldiniz veya Benim GedView Anasayfam sayfasına dönmüş olacaksınız, ama değişikliklerinizi gösterilmeyebilir. Sayfanın uygun şekilde değişikliklerinizi görmeniz için tarayıcınızın görevini tekrar doldurduğunu kullanmaya ihtiyaç duyabilirsin.";
$pgv_lang["block_summaries"]		= "~Blok Detayları~<br /><br />Sizin Hoş geldiniz veya Benim GedView Anasayfam sayfasında yerleştirebileceğiniz blokların her birinin kısa bir tanımlaması buradadır.<br /><table border='1' align='center'><tr><td class='list_value'><b>İsim</b></td><td class='list_value'><b>Açıklaması</b></td></tr>&nbsp;</table><br /><br />";
...
$pgv_lang["portal_config_intructions"]	= "~Benim GedView Anasayfamı özelleştir <br /> Bu GEDCOM karşılama sayfasını özelleştirin~<br /><br />Bunları istediğiniz gibi sayfaya blokları yerleştirerek sayfayı ihtiyacınıza göre özelleştirebilirsiniz.<br /><br /> Sayfa <b>Ana</b> ve <b>Sağ</b> bölümler içine bölünür. <b>Ana</b> bölüm blokları geniş belirirler ve sayfa başlığın altında belirir. <b>Sağ</b> bölüm sağda belirir ve sayfa başlığın altının sağında listelenir.<br /><br />Her bir bölüm listelendiği düzende sayfada yazılan blokların kendi listesine sahip olur.<br /><br />Blok listelerinin biri boş olduğunda kalan bloklar sayfanın tümünün genişliğini kapsayacaktır.<br /><br />";

...
$pgv_lang["add_unlinked_person"]	= "Присоединить новую \"не привязанную\" персону";
...
$pgv_lang["accept_successful"]	= "Изменения успешно внесены в базу данных";
$pgv_lang["add_child"]			= "Добавить ребёнка";
$pgv_lang["add_child_to_family"]	= "Добавить ребёнка в эту семью";
...
$pgv_lang["hide_changes"]		= "Нажмите здесь чтобы скрыть изменения.";
$pgv_lang["highlighted"]		= "Выделенное изображение";
$pgv_lang["media_file"]			= "Файл фото/аудио/видео";
$pgv_lang["must_provide"]		= "Импортировать:";
$pgv_lang["new_source_created"]	= "Новый источник успешно создан";
$pgv_lang["no_changes"]			= "Сейчас нет изменений, которые должны быть просмотрены.";
...
$pgv_lang["privacy_prevented_editing"]	= "Настройки доступа не позволяют Вам редактировать эту запись.";
...
$pgv_lang["upload_media"]		= "Выгрузить медиа (фото/аудио/видео) файлы";

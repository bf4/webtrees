...
$pgv_lang['progress_bars_info']			= "Statusfältet nedan visar hur importen fortskrider. Om tidsgränsen nås kommer importen att stoppas och  du kommer att behöva trycka på fortsätt knappen. Om du inte ser någon fortsätt knapp, gå tillbaka och skriv in en lägre tidsgräns.";
...
$pgv_lang["translator_tools"]					= "Översättarverktyg";

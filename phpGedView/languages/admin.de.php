...
$pgv_lang["index_dir_cleanup_inst"]	= "Dateien werden aus dem Index-Verzeichnis gelöscht indem Sie die Namen in den Papierkorb verlegen oder sie in der Liste ankreuzen.<br /><br />Unbedingt erforderliche Dateien sind mit <img src=\"./images/RESN_confidential.gif\" /> gekennzeichnet; sie dürfen nicht gelöscht werden.<br />Dateien, die mit <img src=\"./images/RESN_locked.gif\" /> gekennzeichnet sind enthalten wichtige Datensätze und sollten deshalb nur gelöscht werden, wenn Sie dessen sicher sind.<br /><br />";

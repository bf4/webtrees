...
$pgv_lang["progress_bars_info"]			= "Die unten angezeigten Barren informieren Sie über den Fortschritt der Dateneinfuhr.  Wenn die angegebene Zeitlimit erreicht wird, wird die Dateneinfuhr unterbrochen.  Sie können dann auf einen «Weiter» Button klicken.  Falls Ihnen dieser Button nicht zugänglich ist, müssen Sie die Dateneinfuhr mit einer kleineren Zeitlimit neu starten.";

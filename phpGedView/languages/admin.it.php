...
$pgv_lang["admin_OK_message"]					= "L'amministratore del sito PhpGedView #SERVER_NAME# ha approvato la tua richiesta di un account. È ora possibile accedere connettendosi al seguente link: #SERVER_NAME#";
...
$pgv_lang["index_dir_cleanup_inst"]	= "Per cancellare un file o una sottocartella dall'Indice delle cartelle, trascinarli nel cestino o selezionare la casella di controllo. Cliccare il pulsante Cancella per rimuovere definitivamente i file indicati.<br /><br />I File contrassegnati con  <img src=\"./images/RESN_confidential.gif\" alt=\"\" /> richiedono appropriate operazioni e non possono essere rimossi.<br />I File contrassegnati con <img src=\"./images/RESN_locked.gif\" alt=\"\" /> hanno impostazioni importanti o modifiche pendenti e dovrebbero essere eliminati solo se sei sicuro di sapere cosa stai facendo.";
...
$pgv_lang["review_readme"]						= "Dovresti rivedere il file <a href=\"readme.txt\" target=\"_blank\">readme.txt</a> prima di continuare a configurare PhpGedView.";

...
$pgv_lang["INDI_FACTS_ADD_help"]        = "Liste des codes GEDCOM pour les événements qu'il sera possible d'ajouter à une fiche individu.  Vous pouvez librement ajouter ou supprimer des codes à cette liste, à l'exception de ceux figurant dans la liste <i>Événements uniques pour un individu</i>.";
...
$pgv_lang["more_help_advice"]           = "<br /> <b> Plus d'aide </ b> <br /> Plus d'aide est disponible en cliquant sur le <b>? </ b> qui se trouve à côté des éléments de la page. ";
$pgv_lang["THUMBNAIL_WIDTH"]            = "Largeur des vignettes";
$pgv_lang["THUMBNAIL_WIDTH_help"]       = "~ # pgv_lang [THUMBNAIL_WIDTH] # ~ <br /> <br /> C'est la largeur (en pixels) que le programme utilisera lors de la génération automatique de vignettes. Le réglage par défaut est 100. ";
...
$pgv_lang["GEDCOM_DEFAULT_TAB_help"]    = "Option permettant de pré-sélectionner un onglet à l'affichage de la page Individu.";
...
$pgv_lang["CHANGELOG_CREATE_help"]      = "~ # pgv_lang [CHANGELOG_CREATE] # ~ <br /> <br /> À quelle fréquence le programme doit archiver les fichiers de modifications des logs (Changelog). ";
$pgv_lang["CHART_BOX_TAGS"]             = "Autres événements à afficher dans les tableaux";
$pgv_lang["CHART_BOX_TAGS_help"]        = "Liste de codes GEDCOM, séparés par une virgule ou un espace, pour forcer l'affichage de certains événements dans les tableaux (ascendance, descendance...).<br />Exemple : pour afficher systématiquement la profession, ajouter le code «OCCU» dans cette zone.";
...
$pgv_lang["PREFER_LEVEL2_SOURCES_help"] = "Lors de la saisie, les sources peuvent être enregistrées au niveau de l'enregistrement complet (INDI, FAM) ou au niveau de l'évènement (BIRT, MARR, DEAT). Cette option permet de choisir le mode par défaut.";
...
$pgv_lang["DBTYPE_help"]                = "Type PEAR (PHP Extension and Application Repository) pour connexion à la base de données. À choisir parmi : MySQL, PostgreSQL, Oracle, SQLite... ";
$pgv_lang["DBHOST"]                     = "Serveur de la base de données";
$pgv_lang["DBHOST_help"]                = "Adresse DNS ou IP du système qui héberge le serveur de votre base de données.";
$pgv_lang["DBPORT"]                     = "Port de la base de données";
$pgv_lang["DBUSER"]                     = "Identificateur de connexion à la base de données";
$pgv_lang["DBUSER_help"]                = "Identificateur défini pour la connexion à la base de données.";
$pgv_lang["DBPASS"]                     = "Mot de passe de la base de données";
$pgv_lang["DBPASS_help"]                = "Mot de passe d'accès à la base de données pour l'identificateur défini.";
$pgv_lang["DBNAME"]                     = "Nom de la base de données";
$pgv_lang["DBNAME_help"]                = "Base de données du serveur qui sera utilisée par PhpGedView.  L'identificateur de connexion utilisé doit avoir les droits de création, d'insertion, de mise à jour, de suppression et de sélection sur cette base de données.";
$pgv_lang["TBLPREFIX_help"]             = "Préfixe ajouté au nom des tables créées par PhpGedView.  En changeant cette valeur vous pouvez gérer plusieurs sites PhpGedView qui utilisent la même base de données mais avec des tables différentes.";
$pgv_lang["ALLOW_CHANGE_GEDCOM_help"]   = "Permet aux visiteurs et aux utilisateurs de changer de fichier GEDCOM quand il en existent plusieurs sur le serveur.";
...
$pgv_lang["SHOW_AGE_DIFF_help"]         = "Option pour afficher les différences d'âge entre les époux, entre les enfants, ou après la date de mariage pour le premier enfant.";
...
$pgv_lang["SHOW_RELATIVES_EVENTS_help"] = "La naissance, le mariage ou le décès d'un proche sont des événements importants dans la vie de chacun. Cette option permet de les ajouter sur l'onglet «Faits et détails personnels» de la fiche individuelle.";
$pgv_lang["EXPAND_RELATIVES_EVENTS"]    = "Ouvrir automatiquement la liste d'événements";
$pgv_lang["EXPAND_RELATIVES_EVENTS_help"]= "Option pour ouvrir par défaut la liste <i>Afficher naissance, mariage et décès des proches sur la fiche individuelle</i>.";
$pgv_lang["EXPAND_SOURCES"]             = "Ouvrir automatiquement les sources";
$pgv_lang["EXPAND_SOURCES_help"]        = "Option pour afficher par défaut le contenu des <i>Sources</i> sur la page individuelle.";
$pgv_lang["EXPAND_NOTES"]               = "Ouvrir automatiquement les notes";
$pgv_lang["EXPAND_NOTES_help"]          = "Option pour afficher par défaut le contenu des <i>Notes</i> sur la page individuelle.";
...
$pgv_lang["WELCOME_TEXT_AUTH_MODE_help"]= "Choix du texte qui s'affichera sur l'écran de connexion, si le mode Authentification est actif. Choisir SVP le texte le plus approprié. Vous pouvez également saisir votre propre texte de bienvenue, mais il ne s'affichera pas dans la langue du visiteur.<br /><br />Liste des textes prédéfinis :<br /><br /><b>Texte indiquant que tous les visiteurs peuvent demander un compte :</b><br /><br /><center><b>Bienvenue à ce site généalogique.</b></center><br />L'accès à ce site est autorisé à tous les visiteurs ayant un compte.<br /><br />Si vous avez déjà un compte, vous pouvez vous connecter. Sinon, remplissez le formulaire.<br /><br />Après vérification, l'administrateur activera votre compte. Vous recevrez un message d'information.<br /><br /><b>Texte indiquant que l'administrateur décidera si besoin d'un compte :</b><br /><br /><center><b>Bienvenue à ce site généalogique.</b></center><br />L'accès à ce site est réservé aux utilisateurs <u>autorisés</u>.<br /><br />Si vous avez déjà un compte, vous pouvez vous connecter. >Sinon, remplissez le formulaire.<br /><br />Après vérification, l'administrateur acceptera ou refusera votre demande. Vous recevrez un message d'information.<br /><br /><b>Texte indiquant que seuls les membres de la famille peuvent demander un compte :</b><br /><br /><center><b>Bienvenue à ce site généalogique.</b></center><br />L'accès à ce site est réservé aux utilisateurs <u>membres de la famille</u>.<br /><br />Si vous avez déjà un compte, vous pouvez vous connecter. Sinon, remplissez le formulaire.<br /><br />Après vérification, l'administrateur acceptera ou refusera votre demande. Vous recevrez un message d'information.";
...
$pgv_lang["WELCOME_TEXT_AUTH_MODE_CUST_HEAD_help"]= "Affichage d'un en-tête standard multi-langues pour votre texte de bienvenue personnalisé.<br /><br />Il se présentera comme ceci :<br /><br /><center><b>Bienvenue à ce site généalogique.</b></center><br />L'accès à ce site est autorisé aux utilisateurs ayant un compte et un mot de passe.";
...
$pgv_lang["EDIT_AUTOCLOSE_help"]        = "Option pour fermer automatiquement la fenêtre d'édition après une mise à jour réussie, sans avoir besoin de cliquer sur le bouton «Fermer».";
$pgv_lang["INDEX_DIRECTORY_help"]       = "Le chemin vers un répertoire accessible en lecture et en écriture où PhpGedView doit stocker les fichiers d'index (avec le «/» final)";
$pgv_lang["POSTAL_CODE"]                = "Position du code postal";
$pgv_lang["POSTAL_CODE_help"]           = "Option pour afficher le code postal devant ou derrière le nom de la ville, selon le pays.";
...
$pgv_lang["SERVER_URL_help"]            = "Si vous utilisez le protocole <tt>https</tt>, ou un port autre que celui par défaut, entrez ici le chemin d'accès au serveur.";
...
$pgv_lang["PGV_SESSION_TIME_help"]      = "Durée, en secondes, pendant laquelle une session PhpGedView reste active avant de nécessiter une nouvelle connexion.  La valeur par défaut est de 30 minutes.";
...
$pgv_lang["USE_REGISTRATION_MODULE_help"]= "Autoriser les utilisateurs à demander l'ouverture d'un compte sur ce site. Les administrateurs devront approuver l'inscription pour que le compte devienne actif.";
$pgv_lang["ALLOW_USER_THEMES_help"]     = "Autoriser les utilisateurs à choisir leur propre thème.";
$pgv_lang["PGV_SIMPLE_MAIL_help"]       = "L'en-tête normal de courriel comporte l'adresse courriel et le nom du destinataire. Certains systèmes de messagerie ne l'acceptent pas. En choisissant cette option, seule l'adresse courriel sera utilisée.";
$pgv_lang["PGV_SMTP_ACTIVE_help"]       = "Utilisez le protocole SMTP pour envoyer des mail depuis PhpGedView.<br /><br />Cette option nécessite un une connexion à un serveur de mail SMTP.  Si désactivée, PhpGedView utilise le système de mail intégré sur ce serveur.";
$pgv_lang["PGV_SMTP_HOST_help"]         = "Nom du serveur de mail SMTP.  Exemple: <b>smtp.foo.bar.com</b>.";
$pgv_lang["PGV_SMTP_HELO_help"]         = "Nom de domaine d'une adresse e-mail valide pour ce serveur SMTP.<br /><br />Par exemple, si vous avez un compte e-mail tel que <b>votre.nom@abc.xyz.com</b>, entrez <b>abc.xyz.com</b>.";
$pgv_lang["PGV_SMTP_PORT_help"]         = "Port à utiliser sur le serveur SMTP. Il s'agit généralement du port <b>25</b>.";
$pgv_lang["PGV_SMTP_AUTH_help"]         = "Certains serveurs SMTP demandent une authentification afin d'envoyer un mail. Entrez le login et le mot de passe ci-dessous.";
$pgv_lang["PGV_SMTP_AUTH_USER_help"]    = "Login requis pour s'authentifier sur le serveur SMTP (si nécessaire).";
$pgv_lang["PGV_SMTP_AUTH_PASS_help"]    = "Mot de passe requis pour s'authentifier sur le serveur SMTP (si nécessaire).";
$pgv_lang["PGV_SMTP_SSL_help"]          = "Transport Layer Security (TLS) et Secure Sockets Layer (SSL) sont des protocoles d'encryption des données sur Internet.<br /><br />TLS 1.0, 1.1 et 1.2 sont des développements standardisés de SSL 3.0. TLS 1.0 et SSL 3.1 sont équivalents. Des travaux plus approfondis sur SSL sont effectués sous le nouveau nom TLS.<br /><br />Si votre serveur SMTP requiert les protocoles TLS ou SLL durant la connexion, sélectionnez l'option <b>Oui</b>.";
$pgv_lang["PGV_SMTP_FROM_NAME_help"]    = "Entrer le nom à utiliser dans le champ &laquo;De:&raquo; des mails provenant de ce site.<br /><br />Par exemple, si votre nom est <b>Pierre Martin</b> et que vous êtes l'administrateur du site <b>Généalogie Martin</b>, vous pouvez entrer quelque chose comme <b>Pierre Martin</b> or <b>Généalogie Martin</b> ou même <b>Pierre Martin, Administrateur de Généalogie Martin</b>. Vous pouvez entrer l'intitulé que vous souhaitez, mais le HTML n'est pas autorisé.";
...
$pgv_lang["META_AUTHOR_help"]           = "Contenu du champ «Author» (Auteur du site) de la balise META à insérer dans l'entête de chaque page HTML.";
...
$pgv_lang["META_PUBLISHER_help"]        = "Contenu du champ «Publisher» (Editeur du site) de la balise META à insérer dans l'entête de chaque page HTML.";
...
$pgv_lang["META_COPYRIGHT_help"]        = "Contenu du champ «Copyright» de la balise META à insérer dans l'entête de chaque page HTML.";
...
$pgv_lang["META_DESCRIPTION_help"]      = "Contenu du champ «Description» de la balise META à insérer dans l'entête de chaque page HTML.";
$pgv_lang["META_DESCRIPTION_descr"]     = "Si vide, le titre de la base GEDCOM sera utilisé.";
$pgv_lang["META_PAGE_TOPIC"]            = "META Page-Topic";
$pgv_lang["META_PAGE_TOPIC_help"]       = "Contenu du champ «Page-Topic» (sujet du site) de la balise META à insérer dans l'entête de chaque page HTML.";
$pgv_lang["META_PAGE_TOPIC_descr"]      = "Si vide, le titre de la base GEDCOM sera utilisé.";
$pgv_lang["META_AUDIENCE"]              = "META Audience";
$pgv_lang["META_AUDIENCE_help"]         = "Contenu du champ «Audience» (public visé par le site) de la balise META à insérer dans l'entête de chaque page HTML.";
$pgv_lang["META_PAGE_TYPE"]             = "META Page-Type";
$pgv_lang["META_PAGE_TYPE_help"]        = "Contenu du champ «Page-Type» (type de page) de la balise META à insérer dans l'entête de chaque page HTML.";
$pgv_lang["META_ROBOTS"]                = "META Robots";
$pgv_lang["META_ROBOTS_help"]           = "Contenu du champ «Robots» (instructions pour les robots) de la balise META à insérer dans l'entête de chaque page HTML.<br />Certains robots ne tiennent pas compte de cette balise.";
$pgv_lang["META_REVISIT"]               = "META Revisit";
$pgv_lang["META_REVISIT_help"]          = "Contenu du champ «Revisit» (fréquence de revisite de la page) de la balise META à insérer dans l'entête de chaque page HTML.<br />Certains navigateurs ne tiennent pas compte de cette balise.";
...
$pgv_lang["META_TITLE_help"]            = "Texte à ajouter au titre de chaque page HTML.";
...
$pgv_lang["return_editconfig"]          = "Vous pourrez revenir à cette configuration à tout moment en faisant pointer votre navigateur sur editconfig.php, ou par le lien <b>Configuration</b> du menu <b>Administration</b>.";
$pgv_lang["return_editconfig_gedcom"]   = "Vous pourrez revenir à cette configuration à tout moment en faisant pointer votre navigateur sur editconfig_gedcom.php, ou par le lien <b>GEDCOM</b> du menu <b>Administration</b>.";
...
$pgv_lang["SHOW_LIVING_NAMES_help"]     = "Montrer les noms des personnes en vie";
$pgv_lang["SHOW_RESEARCH_ASSISTANT"]    = "Montrer l'assistant de recherche";
$pgv_lang["SHOW_RESEARCH_ASSISTANT_help"]= "~ # pgv_lang [SHOW_RESEARCH_ASSISTANT] # ~ <br /> <br /> Quel type d'utilisateur peut afficher le module d'assistant de recherche s'il est installé? ";
$pgv_lang["USE_RELATIONSHIP_PRIVACY"]   = "Autoriser l'accès aux détails privés des proches";
$pgv_lang["USE_RELATIONSHIP_PRIVACY_help"]= "Autoriser l'accès aux détails privés des proches<br /><br />Option désactivée : les utilisateurs authentifiés peuvent voir les détails de toutes les personnes vivantes.<br />Option activée : accès aux détails privés des proches uniquement.";
$pgv_lang["MAX_RELATION_PATH_LENGTH"]   = "Degré de parenté pour l'accès aux détails privés";
$pgv_lang["MAX_RELATION_PATH_LENGTH_help"]= "Degré de parenté pour l'accès aux détails privés<br /><br />Si l'option Autoriser l'accès aux détails privés des proches est activée, les utilisateurs authentifiés auront accès aux détails des individus dans la limite de ce degré de parenté.";
$pgv_lang["CHECK_MARRIAGE_RELATIONS"]   = "Vérifier les liens par mariage";
$pgv_lang["CHECK_MARRIAGE_RELATIONS_help"]= "Accès aux détails privés des proches par alliance.";
...
$pgv_lang["commit_google_help"]         = "~ # pgv_lang [commit_google] # ~ <br /> <br /> En cliquant sur ce lien, vous sauvegardez toutes les traductions proposées par Google. L'indicateur de progression de l'écriture des traductions est affiché ci-dessous. <br /> ";
...
$pgv_lang["edit_lang_utility_warning"]  = "ATTENTION!<br />Le bouton <i>Fermer la fenêtre sans rafraîchir</i> oblige à recharger la page pour afficher les modifications.<br /><br />N'utilisez ce bouton qu'avec précaution.";
$pgv_lang["language_to_edit"]           = "Traduction en";
$pgv_lang["language_to_edit_help"]      = "~ # pgv_lang [language_to_edit] # ~ <br /> <br /> Dans cette liste, vous sélectionnez la langue avec laquelle vous souhaitez modifier les messages. ";
...
$pgv_lang["um_proceed"]                 = "Lancer l'export des comptes utilisateurs ?";
...
$pgv_lang["um_index_sql"]               = "Cet outil importera le fichier <i> authenticate.php </ i> et d'autres fichiers<i>. dat </ i> depuis votre le répertoire index de votre base de données. ";
...
$pgv_lang["um_bu_help"]                 = "Avec cet outil, sauvegardez vos données PhpGedView dans un fichier ZIP que vous pourrez ensuite télécharger.";
...
$pgv_lang["restore_faq_edits_help"]     = "~ # pgv_lang [restore_faq_edits] # ~ <br /> Cette option restaure la page FAQ à ce qu'un utilisateur administrateur voit normalement, de sorte que les éléments de la page FAQ puissent être modifiés. ";
$pgv_lang["add_faq_item"]               = "Ajouter FAQ";
$pgv_lang["add_faq_item_help"]          = "~ # pgv_lang [add_faq_item] # ~ <br /> Cette option vous permettra d'ajouter un élément à la page FAQ. ";
$pgv_lang["edit_faq_item"]              = "Editer FAQ";
$pgv_lang["edit_faq_item_help"]         = "~ # pgv_lang [edit_faq_item] # ~ <br /> Cette option vous permettra de modifier un élément sur la page FAQ. ";
$pgv_lang["delete_faq_item"]            = "Supprimer FAQ";
$pgv_lang["delete_faq_item_help"]       = "~ # pgv_lang [delete_faq_item] # ~ <br /> Cette option vous permettra de supprimer un élément de la page FAQ ";

...
$pgv_lang["INDI_FACTS_ADD_help"]        = "~Événements ajoutables pour un individu~<br /><br />Liste des codes GEDCOM pour les événements qu'il sera possible d'ajouter à une fiche individu.  Vous pouvez librement ajouter ou supprimer des codes à cette liste, à l'exception de ceux figurant dans la liste <i>Événements uniques pour un individu</i>.<br />";
...
$pgv_lang["PREFER_LEVEL2_SOURCES_help"] = "~Enregistrer les sources au niveau des évènements~<br /><br />Lors de la saisie, les sources peuvent être enregistrées au niveau de l'enregistrement complet (INDI, FAM) ou au niveau de l'évènement (BIRT, MARR, DEAT). Cette option permet de choisir le mode par défaut.<br />";
...
$pgv_lang["SHOW_AGE_DIFF_help"]         = "~Voir les écarts d'âge~<br /><br />Option pour afficher les différences d'âge entre les époux, entre les enfants, ou après la date de mariage pour le premier enfant.";
$pgv_lang["SHOW_PARENTS_AGE"]           = "Afficher l'âge des parents à la naissance de l'enfant";
$pgv_lang["SHOW_PARENTS_AGE_help"]      = "~Afficher l'âge des parents à la naissance de l'enfant~<br /><br />Option pour afficher l'âge du père et de la mère dans les tableaux à côté de la date de naissance de l'enfant.";
$pgv_lang["SHOW_RELATIVES_EVENTS"]      = "Afficher naissance, mariage et décès des proches sur la fiche individuelle";
$pgv_lang["SHOW_RELATIVES_EVENTS_help"] = "~Afficher naissance, mariage et décès des proches sur la fiche individuelle~<br /><br />La naissance, le mariage ou le décès d'un proche sont des événements importants dans la vie de chacun. Cette option permet de les ajouter sur l'onglet «Faits et détails personnels» de la fiche individuelle.";
$pgv_lang["EXPAND_RELATIVES_EVENTS"]    = "Ouvrir automatiquement la liste d'événements";
$pgv_lang["EXPAND_RELATIVES_EVENTS_help"]= "~Ouvrir automatiquement la liste d'événements~<br /><br />Option pour ouvrir par défaut la liste <i>Afficher naissance, mariage et décès des proches sur la fiche individuelle</i>.<br />";
$pgv_lang["EXPAND_SOURCES"]             = "Ouvrir automatiquement les sources";
$pgv_lang["EXPAND_SOURCES_help"]        = "~Ouvrir automatiquement les sources~<br /><br />Option pour afficher par défaut le contenu des <i>Sources</i> sur la page individuelle.<br />";
$pgv_lang["EXPAND_NOTES"]               = "Ouvrir automatiquement les notes";
$pgv_lang["EXPAND_NOTES_help"]          = "~Ouvrir automatiquement les notes~<br /><br />Option pour afficher par défaut le contenu des <i>Notes</i> sur la page individuelle.<br />";
...
$pgv_lang["WELCOME_TEXT_AUTH_MODE_CUST_HEAD_help"]= "Affichage d'un en-tête standard multi-langues pour votre texte de bienvenue personnalisé.<br /><br />Il se présentera comme ceci :<br /><br /><center><b>Bienvenue à ce site généalogique.</b></center><br />L'accès à ce site est autorisé aux utilisateurs ayant un compte et un mot de passe.<br />";
...
$pgv_lang["EDIT_AUTOCLOSE_help"]        = "~Fermer automatiquement la fenêtre d'édition~<br /><br />Option pour fermer automatiquement la fenêtre d'édition après une mise à jour réussie, sans avoir besoin de cliquer sur le bouton «Fermer».<br />";
...
$pgv_lang["POSTAL_CODE_help"]           = "~Position du code postal~<br /><br />Option pour afficher le code postal devant ou derrière le nom de la ville, selon le pays.<br />";
...
$pgv_lang["PGV_SMTP_ACTIVE_help"]       = "~Utiliser SMTP pour envoyer des mails externes~<br /><br />Utilisez le protocole SMTP pour envoyer des mail depuis PhpGedView.<br /><br />Cette option nécessite un une connexion à un serveur de mail SMTP.  Si désactivée, PhpGedView utilise le système de mail intégré sur ce serveur.<br />";
$pgv_lang["PGV_SMTP_HOST_help"]         = "~Nom du serveur sortant (SMTP) ~<br /><br />Nom du serveur de mail SMTP.  Exemple: <b>smtp.foo.bar.com</b>.<br />";
$pgv_lang["PGV_SMTP_HELO_help"]         = "~Envoi de nom de domaine~<br /><br />Nom de domaine d'une adresse e-mail valide pour ce serveur SMTP.<br /><br />Par exemple, si vous avez un compte e-mail tel que <b>votre.nom@abc.xyz.com</b>, entrez <b>abc.xyz.com</b>.<br />";
$pgv_lang["PGV_SMTP_PORT_help"]         = "~Port SMTP~<br /><br />Port à utiliser sur le serveur SMTP. Il s'agit généralement du port <b>25</b>.<br />";
$pgv_lang["PGV_SMTP_AUTH_help"]         = "~Utilisez le nom et le mot de passe~<br /><br />Certains serveurs SMTP demandent une authentification afin d'envoyer un mail. Entrez le login et le mot de passe ci-dessous.<br />";
$pgv_lang["PGV_SMTP_AUTH_USER_help"]    = "~Nom d'utilisateur~<br /><br />Login requis pour s'authentifier sur le serveur SMTP (si nécessaire).<br />";
$pgv_lang["PGV_SMTP_AUTH_PASS_help"]    = "~Mot de passe~<br /><br />Mot de passe requis pour s'authentifier sur le serveur SMTP (si nécessaire).<br />";
$pgv_lang["PGV_SMTP_SSL_help"]          = "~SSL requis~<br /><br />Transport Layer Security (TLS) et Secure Sockets Layer (SSL) sont des protocoles d'encryption des données sur Internet.<br /><br />TLS 1.0, 1.1 et 1.2 sont des développements standardisés de SSL 3.0. TLS 1.0 et SSL 3.1 sont équivalents. Des travaux plus approfondis sur SSL sont effectués sous le nouveau nom TLS.<br /><br />Si votre serveur SMTP requiert les protocoles TLS ou SLL durant la connexion, sélectionnez l'option <b>Oui</b>.<br />";
$pgv_lang["PGV_SMTP_FROM_NAME_help"]    = "~Nom de l'émetteur~<br /><br />Entrer le nom à utiliser dans le champ &laquo;De:&raquo; des mails provenant de ce site.<br /><br />Par exemple, si votre nom est <b>Pierre Martin</b> et que vous êtes l'administrateur du site <b>Généalogie Martin</b>, vous pouvez entrer quelque chose comme <b>Pierre Martin</b> or <b>Généalogie Martin</b> ou même <b>Pierre Martin, Administrateur de Généalogie Martin</b>. Vous pouvez entrer l'intitulé que vous souhaitez, mais le HTML n'est pas autorisé.<br />";
...
$pgv_lang["SHOW_LIVING_NAMES_help"]     = "Montrer les noms des personnes en vie<br />";
...
$pgv_lang["USE_RELATIONSHIP_PRIVACY_help"]= "Autoriser l'accès aux détails privés des proches<br /><br />Option désactivée : les utilisateurs authentifiés peuvent voir les détails de toutes les personnes vivantes.<br />Option activée : accès aux détails privés des proches uniquement.<br />";
...
$pgv_lang["file_to_edit_help"]          = "~Type de fichier à traduire~<br /><br />#pgv_lang[lang_file_descriptions]#";
...
$pgv_lang["lang_filenames_help"]        = "~Fichiers de langues~<br /><br />#pgv_lang[lang_file_descriptions]#";
...
$pgv_lang["um_tool_help"]               = "~Exporter les comptes utilisateurs pour passage mode Index <-> mode SQL~<br /><br />#pgv_lang[um_explain]#";
...
$pgv_lang["um_bu_help"]                 = "~Sauvegarde~<br /><br />Avec cet outil, sauvegardez vos données PhpGedView dans un fichier ZIP que vous pourrez ensuite télécharger.";

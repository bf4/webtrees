...
$pgv_lang["USE_MEDIA_VIEWER"]           = "Utiliser le viseur de multimédias";
...
$pgv_lang["MEDIA_FIREWALL_ROOTDIR"]     = "Répertoire racine du pare-feu multimédia";
...
$pgv_lang["SHOW_SPIDER_TAGLINE"]        = "Montrer un indicatif du moteur de recherche";
...
#pgv_lang["SYNC_GEDCOM_FILE_help"]      = "~#pgv_lang[SYNC_GEDCOM_FILE]#~<br /><br />In past versions of PhpGedView the pending edits were stored in the GEDCOM file and the changed records were then \"accepted\" into the database.  Starting with v4.1 pending changes are no longer stored in the GEDCOM file but in the changes file.  <br /><br />Setting this value to true will update the GEDCOM file when changes are accepted into the database.  This will keep the GEDCOM file synchronized with the database.  For greater compatibility with previous versions the default value of this field is on.<br /><br />You may want to turn it off to conserve memory when accepting changes.<br />";
...
$pgv_lang["SAVE_WATERMARK_THUMB"]       = "Stocker les vignettes filigranées au serveur ?";
...
$pgv_lang["SAVE_WATERMARK_IMAGE"]       = "Stocker les grands images filigranées au serveur ?";
...
#pgv_lang["QUICK_REQUIRED_FAMFACTS_help"]= "~#pgv_lang[QUICK_REQUIRED_FAMFACTS]#~<br /><br />This is a comma separated list of GEDCOM fact tags that will always be shown on the Family tabs of the Mise à jour rapide form whether or not they already exist in the individual's record.  For example, if MARR is in the list, then fields for marriage date and marriage place will always be shown on the form.<br />";
$pgv_lang["QUICK_ADD_FAMFACTS"]         = "Événements Famille à ajouter en mode <i>Mise à jour rapide</i>";
#pgv_lang["QUICK_ADD_FAMFACTS_help"]    = "~#pgv_lang[QUICK_ADD_FAMFACTS]#~<br /><br />This is a comma separated list of GEDCOM fact tags that will be shown on the Family tabs of the Mise à jour rapide form.  Only the facts in this list will be shown on the form or made available for selection in the area where you add new facts on the form.<br />";
$pgv_lang["QUICK_REQUIRED_FACTS"]       = "Événements à toujours afficher en mode <i>Mise à jour rapide</i>";
#pgv_lang["QUICK_REQUIRED_FACTS_help"]  = "~#pgv_lang[QUICK_REQUIRED_FACTS]#~<br /><br />This is a comma separated list of GEDCOM fact tags that will always be shown on the Mise à jour rapide form whether or not they already exist in the individual's record.  For example, if BIRT is in the list, fields for birth date and birth place will always be shown on the form.<br />";
$pgv_lang["QUICK_ADD_FACTS"]            = "Événements à ajouter en mode <i>Mise à jour rapide</i>";
#pgv_lang["QUICK_ADD_FACTS_help"]       = "~#pgv_lang[QUICK_ADD_FACTS]#~<br /><br />This is a comma separated list of GEDCOM fact tags that will be shown on the Mise à jour rapide form.  Only the facts in this list will be shown on the form or made available for selection in the area where you add new facts on the form.<br />";
...
$pgv_lang["SUBLIST_TRIGGER_I"]          = "Nombre maximale de noms de famille";
...
$pgv_lang["SUBLIST_TRIGGER_F"]          = "Nombre maximale de noms de famille";
...
$pgv_lang["SURNAME_LIST_STYLE"]         = "Genre de présentation des listes";
...
$pgv_lang["SHOW_MEDIA_FILENAME"]        = "Montrer le nom du fichier dans le viseur MultiMédia";
...
$pgv_lang["SHOW_MEDIA_DOWNLOAD"]        = "Montrer le lien de téléchargement dans le viseur MultiMédia";
...
#pgv_lang["PHPGEDVIEW_EMAIL_help"]      = "~#pgv_lang[PHPGEDVIEW_EMAIL]#~<br /><br />E-mail address to be used in the «From:» field of e-mails that PhpGedView creates automatically.<br /><br />PhpGedView can automatically create e-mails to notify administrators of changes that need to be reviewed.  PhpGedView also sends notification e-mails to users who have requested an account.<br /><br />Usually, the «From:» field of these automatically created e-mails is something like <i>From: phpgedview-noreply@yoursite</i> to show that no response to the e-mail is required.  To guard against spam or other e-mail abuse, some e-mail systems require each message's «From:» field to reflect a valid e-mail account and will not accept messages that are apparently from account <i>phpgedview-noreply</i>.<br />";
...
#pgv_lang["add_faq_header_help"]        = "~#pgv_lang[add_faq_header]#~<br />This is the title or subject of the FAQ item.<br /><br />What you enter here can be formatted. HTML tags such as &lt;b&gt; and &lt;br&gt; are allowed, as are HTML entities such as &amp;amp; and &amp;nbsp;.  There is no way to enter HTML tags so that they will be interpreted as text.<br /><br />#pgv_lang[add_faq_pgvLangRefs]#<br />";
#pgv_lang["add_faq_body_help"]          = "~#pgv_lang[add_faq_body]#~<br />The text of the FAQ item is entered here.<br /><br />The text can be formatted. HTML tags such as &lt;b&gt; and &lt;br&gt; are allowed, as are HTML entities such as &amp;amp; and &amp;nbsp;.  There is no way to enter HTML tags so that they will be interpreted as text.<br /><br />#pgv_lang[add_faq_pgvLangRefs]#<br />";

...
$pgv_lang["COMMIT_COMMAND_help"]="Deixe em branco caso não queira utilizar um sistema de controle de versão tal como o CVS para salvar as alterações e configurações do seu GEDCOM, caso contrário as opções são <b>cvs</b> e <b>svn</b>.";
$pgv_lang["SHOW_MULTISITE_SEARCH_help"]="Esta opção restringe ou não o uso da pesquisa Multi-Site aos usuários identificados. A pesquisa Multi-Site procura a informação nos sites cadastrados em \"Gerenciar Sites\" e nos sites remotos.";
$pgv_lang["SHOW_MULTISITE_SEARCH"]="Exibir Pesquisa Multi-Site";
$pgv_lang["INDI_FACTS_ADD"]="Fatos/Eventos da Pessoa";
$pgv_lang["INDI_FACTS_ADD_help"]="Esta é a lista de fatos que os usuários podem adicionar às pessoas da árvore. Você pode criar novos tipos ou remover alguns deles conforme sua necessidade. Tipos de fatos que aperecem nesta lista não devem aparecer na lista <i>Fatos Singulares da Pessoa</i>.";
$pgv_lang["INDI_FACTS_UNIQUE"]="Fatos Singulares da Pessoa";
$pgv_lang["INDI_FACTS_UNIQUE_help"]="Esta é a lista de fatos que podem ser adicionados <u>uma única vez</u> a uma pessoa. Fatos que estejam nesta lista não podem estar na lista <i>Fatos/Eventos da Pessoa</i>.";
$pgv_lang["FAM_FACTS_ADD"]="Fatos/Eventos da Família";
$pgv_lang["FAM_FACTS_ADD_help"]="Estes são os fatos e eventos que podem ser adicionados às famílias. É permitido adicionar ou remover fatos a lista, mesmo os customizados. Entretanto fatos que estejam nesta lista, não podem aparecer na lista <i>Fatos Singulares da Família</i>.";
$pgv_lang["FAM_FACTS_UNIQUE"]="Fatos Singulares da Família";
$pgv_lang["FAM_FACTS_UNIQUE_help"]="Esta é a lista de fatos/eventos da família, que os usuários podem adicionar uma <u>única</u> vez. Por exemplo, se MARR esta na lista, usuários não poderão adicionar mais de um MARR à família. Fatos e eventos que estejam nesta lista não podem estar na lista <i>Fatos/Eventos da Família</i>.";
$pgv_lang["SOUR_FACTS_ADD"]="Fatos/Eventos de Fonte";
$pgv_lang["SOUR_FACTS_ADD_help"]="Esta é a lista de fatos e eventos que os usuários podem adicionar a uma fonte. A lista pode ser alterada, inclusive com a adição de eventos e fatos customisados, porém fatos e eventos desta lista não podem estar na lista <i>Fatos/Eventos Singulares de Fonte</i>.";
$pgv_lang["SOUR_FACTS_UNIQUE"]="Fatos/Eventos Singulares de Fonte";
$pgv_lang["SOUR_FACTS_UNIQUE_help"]="Esta é a lista de fatos e eventos de fontes, que os usuário podem adicionar uma <u>única</u> vez. Por exemplo, se TITL esta na lista, usuários poderão adicionar apenas uma vez TITL a uma fonte. Fatos e eventos desta lista não podem estar na lista <i>Fatos/Eventos de Fonte</i>.";
$pgv_lang["LANG_SELECTION"]="Idiomas Disponíveis";
$pgv_lang["LANG_SELECTION_help"]="Selecione na lista, quais idiomas seu site PhpGedView oferecerá aos usuários.<br />O mesmo pode ser feito através do link <b>#pgv_lang[enable_disable_lang]#</b> no menu Administrador, onde também é possível alterar a bandeira do idioma, o formato de datas, ou se o sobrenome deve aparecer antes do nome.";
$pgv_lang["MEDIA_ID_PREFIX"]="Prefixo da ID da Mídia";
$pgv_lang["MEDIA_ID_PREFIX_help"]="Quando uma mídia é adicionada ao GEDCOM, uma nova ID é criada automaticamente para a mídia.";
$pgv_lang["FAM_ID_PREFIX"]="Prefixo da ID da Família";
$pgv_lang["FAM_ID_PREFIX_help"]="Quando um novo registro é adicionado à família, uma nova ID é atribuida a este registro com este prefixo.";
$pgv_lang["QUICK_REQUIRED_FAMFACTS"]="Fatos da Família sempre exibidios na Edição Simplificada";
$pgv_lang["QUICK_REQUIRED_FAMFACTS_help"]="Esta é uma lista de fatos e eventos separados por virgula, que sempre serão exibidos no formulário de edição simplificada, mesmo que estes fatos ainda não tenho sido informados.";
...
$pgv_lang["more_help_advice"]="<br /><b>Mais Ajuda</b><br />Mais ajuda pode ser obtida clicando em <b>?</b> ao lado dos itens da página.";
...
$pgv_lang["enter_db_pass"]="Por segurança, informe Database Username e Database Password antes de alterar a configuração.";

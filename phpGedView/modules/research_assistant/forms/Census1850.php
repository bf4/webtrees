...
//        Next Table
 ...
 <tr>
  <td class="descriptionbox">Families Numbered in the order of visitation</td>';
	...
	$out .='</tr>
 <tr>
  <td class="descriptionbox">The name of every Person whose usual place of <br /> abode on the first day of June, 1850, was in this family</td>';
  		for($i=0; $i<$_REQUEST['numOfRows']; $i++) {
  			$value = "";
...
<tr>
  ...
  $out .= '</tr>
 <tr>
  <td class="descriptionbox">Value of Real estate owned</td>';
	for($i=0; $i<$_REQUEST['numOfRows']; $i++) {
		$value = "";
  ...
  <td class="descriptionbox">Place of Birth Naming the State, Territory, or Country</td>';
	for($i=0; $i<$_REQUEST['numOfRows']; $i++) {
		$value = "";
  		...
  		$out .= '<td class="optionbox"><INPUT tabindex="'.($i*100+24).'"  TYPE="TEXT" SIZE="22" name = "PofB'.$i.'" value="'.htmlentities($value).'" /></td>';
		}
 		$out .='</tr>
 <tr>
  <td class="descriptionbox">Married within the year</td>';
	for($i=0; $i<$_REQUEST['numOfRows']; $i++) {
		$value = "";
  		...
  		$out .= '<td class="optionbox"><INPUT tabindex="'.($i*100+25).'"  TYPE="CHECKBOX" value="MarriedWithinYear" name="MarriedWithinYear'.$i.'" '.($value=='MarriedWithinYear'?' checked="checked"':'').' /></td>';
		}
 		$out .='</tr>
 <tr>
  <td class="descriptionbox">Attended School within the year 
	...
	for($i=0; $i<$_REQUEST['numOfRows']; $i++) {
		$value = "";
  		...
  		$out .= '<td class="optionbox"><INPUT tabindex="'.($i*100+26).'"  TYPE="CHECKBOX" value="school" name="school'.$i.'" '.($value=='school'?' checked="checked"':'').' /></td>';
		}
 		$out .='</tr>
 <tr>
  <td class="descriptionbox">Person\'s over 20 y\'rs of age who cannot read or write
	...
	for($i=0; $i<$_REQUEST['numOfRows']; $i++) {
		$value = "";
  		...
  		$out .= '<td class="optionbox"><INPUT tabindex="'.($i*100+27).'"  TYPE="TEXT" SIZE="22" name = "readwrite'.$i.'" value="'.htmlentities($value).'" /></td>';
		}
 		$out .='</tr>
 <tr>
  <td class="descriptionbox">Whether deaf and dumb, blind, insane, idiotic, pauper, or convict
	...
	for($i=0; $i<$_REQUEST['numOfRows']; $i++) {
		$value = "";
  		...
  		$out .= '<td class="optionbox"><INPUT tabindex="'.($i*100+28).'"  TYPE="TEXT" SIZE="22" name = "Disablity'.$i.'" value="'.htmlentities($value).'" /></td>';
		}
 		$out .='</tr>';
        $out .= 
'<tr>

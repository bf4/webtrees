...
$pgv_lang["ra_fold_name_help"]				= "<H2><B>Hakemistonäkymä:</B></H2><ul><li><B>Hakemiston nimi:</B> Tällä palstalla ovat kaikkien luomiesi hakemistojen nimet.</li><li><B>Kuvaus:</B> Tällä palstalla ovat hakemistojen kuvaukset.</li></ul><br /><br /><a href=\"helpvids/ResearchAssistantUserHelp.htm\">Tutkimusavustajan opas</a>";

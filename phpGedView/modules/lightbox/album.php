...
if (file_exists('modules/lightbox/lb_config.php')) require_once './modules/lightbox/lb_config.php';
//	require_once './modules/lightbox/functions/browser_detection_php_ar.php';

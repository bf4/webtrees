...
echo "כאשר תעביר את העכבר מעל התמונה לא בצורת הזום תווית <b>&gt;</b> תופיע בצד שמאל ותווית <b>&lt;</b>  בצד ימין. לחץ איפשהו על הצד הימני של התמונה כדי לראות את התמונה הבאה. לחץ על הצד השמאלי של התמונה כדי לראות את התמונה הקודמת. "; 
echo "<br /><br /></li>";
...
echo "אם קבצים מצורות רגילות של תמונות (jpg, bmp, gif, וכו') אשר מייצגות סוגי תמונות כגון תמונה, תעודה  מסמך וכו' מופיעות בשורת ה<b>אחר</b>, ששכחת להגדיר את סוג המדיה של הפריטים הללו. יתכן ותרצה להגדיר מחדש את סוג המדיה של הפריטים הללו.";
echo "</li>";

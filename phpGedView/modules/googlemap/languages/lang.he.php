...
$pgv_lang['placecheck_key4']            = "<font size=\"-2\">הרמה הזו ריקה בקובץ ה-GEDCOM שלך, אבל קיימת כ'בלתי ידוע'<br/>בטבלת המקומות של GoogleMap עם קואורדינטות. שום פעולה אינה נדרשת<br/>עד שמוסיפים את הרמה החסרה</font>"; 

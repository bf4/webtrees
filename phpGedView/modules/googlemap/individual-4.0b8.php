...
function tabswitchAndResizeMap(n) {
    tabswitch(n);
    ResizeMap();
    ResizeMap(); // After one time the map did not show properly
}
...
<dd id="door7"><a href="javascript:;" onclick="tabswitchAndResizeMap(7)" ><?php print $pgv_lang["googlemap"]?></a></dd>
<dd id="door0"><a href="javascript:;" onclick="tabswitchAndResizeMap(0)" ><?php print $pgv_lang["all"]?></a></dd>
</dl>
</div>
<br />
<?php

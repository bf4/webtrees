...
if ($view!='preview') {
	...
	echo i18n::translate('Day:').'</td><td colspan="7" class="optionbox">';
	...
	echo i18n::translate('Show events of:')."&nbsp;</td>";

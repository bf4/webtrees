...
echo '<ShortName>' . get_gedcom_setting(PGV_GED_ID, 'title') . ' ' . i18n::translate('Search')  . '</ShortName>';
echo '<Description>' .  get_gedcom_setting(PGV_GED_ID, 'title') . ' ' . i18n::translate('Search') . '</Description>';
